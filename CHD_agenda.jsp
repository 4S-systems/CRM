<%-- 
    Document   : CHD
    Created on : Aug 14, 2017, 9:42:17 AM
    Author     : fatma
--%>
...
<HTML>
    <head>
        <title> Client Help Desk Agenda </title>
    </head>
            ...
            <center>
                <div style="border:0px solid gray; width:100%; margin:auto; padding: 10px;margin-bottom: 0px;">
                    <div  dir="rtl" id="con1" style="display:block; border:0px solid gray; width:96%; margin: 0px;">
                        <jsp:include page="docs/general_complaint/general_complaint_client_prj.jsp" flush="true"></jsp:include>
                    </div>
