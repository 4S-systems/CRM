...
<html>
    ...
    <%
        ...
        String departmentTitle = "غير محدد";
        ...
        if (departmentList.size() > 0) {
            departmentTitle = (String) departmentList.get(0).getAttribute("projectName");
        }
        ...
        String selectedTab = selectedTabMap.get(CRMConstants.SELECTED_TAB_SLA_KEY);
        if (selectedTab == null) {
            selectedTab = "1";
            securityUser.getSelectedTab().put(CRMConstants.SELECTED_TAB_SLA_KEY, selectedTab);
        }
        if (stat.equals("En")) {
        } else {
        }
    ...
    <script language="javascript" type="text/javascript">
        ...
        function setSelectedTab(seletedTab) {
            $.ajax({
                type: "post",
    ...
    <center>
        <div style="border:0px solid gray; width:100%; margin:auto;float: left; padding: 10px;margin-bottom: 0px;" id="tab">
            <ul id="tabs" class="shadetabs" style="margin-right:21px;margin-bottom: 0px;">
                <li style="float: left;font-size: 16px;color: #005599; font-style: oblique"> <b>Service Level Agreement</b> &nbsp;-&nbsp; <b>خطة أدارة <%=departmentTitle%></b></li>
                <li style="border-bottom: none;"><a id="div2"  style="height: 30px;"href="javascript:showDev2();" ><SPAN style="display: inline-block;padding: 2px;">SLA Closed</SPAN></a></li>
                <li class="active"><a id="div1"  style="height: 30px;"href="javascript:showDev1();" ><SPAN style="display: inline-block;padding: 2px;">SLA Pending</SPAN></a></li>
            </ul>
            <div  dir="rtl" id="con1" style="display:block;border:0px solid gray; width:100%; margin: 0px; " >
                <jsp:include page="/docs/sla/sla_main.jsp" flush="true"></jsp:include>
                </div>
                <div  dir="rtl" id="con2" style="display:block;border:0px solid gray; width:100%; margin: 0px; " >
                <jsp:include page="/docs/sla/sla_closed.jsp" flush="true"></jsp:include>
            </div>
            <br>
        </div>
    </center>
