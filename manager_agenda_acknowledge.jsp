...
<HTML>
    ...
    <%
        ...
        String resp = "1";
        issuesVector = issueByComplaintMgr.getComplaintsWithoutDate(2, value, key, "key7", resp, null, null , null);//.getOnArbitraryKeyOrdered(userWbo.getAttribute("userId").toString(), "key3", "key7");
...
<!--                <TABLE class="blueBorder" DIR="<%=dir%>" CELLPADDING="0" cellspacing="0" style="padding-top: 2px; padding-bottom: 4px; padding-left: 10px; padding-right: 10px; margin-top: 10px; width: auto">
            ...
            <TABLE   id="acknowledgeMsg" align="center" DIR="<%=dir%>" WIDTH="100%" CELLPADDING="0" cellspacing="0">
                <thead><TR>
                        <TH   ><SPAN ></SPAN></TH>
...
%>
                        ...
                        <TD nowrap  STYLE="text-align:center;padding: 5px; font-size: 12px"><font color="red"><%=sDay%> - </font><b><%=sDate + " " + sTime%></b></TD>
