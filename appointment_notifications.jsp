...
<fmt:setBundle basename="Languages.employee_agenda.employee_agenda"  />
    <%
        ...
        List<WebBusinessObject> notifications = notificationMgr.getPastAppointmentsForUser(loggedUser.getAttribute("userId").toString());
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            $("#appointmentInPast").css("display", "none");
            oTable = $('#appointmentInPast').dataTable({
                bJQueryUI: true,
        ...
        <FORM NAME="APPOINTMENT_NOTIFICATION_FORM" METHOD="POST">
            <div style="margin-left: auto;margin-right: auto;width: 96%" class="set">
                ...
                <div style="width: 85%;margin-right: auto;margin-left: auto;" id="showClients">
                    ...
                    <TABLE ALIGN=<fmt:message key="align"/> dir=<fmt:message key="direction"/> WIDTH="100%" id="appointmentInPast" style="">
                        <thead>
                            <tr>
                ...
                function doUpdateAppointmentNotificationTable(data) {
                    var insertedTable = document.getElementById('appointmentInPast');
