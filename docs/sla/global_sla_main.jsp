...
<html>
    <%
        ...
        clientComplaintsSLAMgr.cashData();
        ArrayList<WebBusinessObject> complaintsList = clientComplaintsSLAMgr.getNotCompletedComplaintsGSLA();
            ...
            function getUnitsList(clientId, obj) {
                $.ajax({
                    ...
                    success: function (jsonString) {
                        ...
                        $(obj).attr("title", "الوحدة: " + info.unitsCodes);
                    }
                });
            }
        </SCRIPT>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="<%=className%>" nowrap>
                                    <a href="<%=context%>/IssueServlet?op=getCompl&issueId=<%=wbo.getAttribute("issueID")%>&compId=<%=wbo.getAttribute("clientComplaintID")%>&statusCode=<%=wbo.getAttribute("statusCode")%>&clientType=30-40"><b><font color="black"><%=wbo.getAttribute("businessID")%></font><font color="blue">/<%=wbo.getAttribute("businessIDbyDate")%></font></b></a>
                                </td>
                                <td class="<%=className%>">
