    ...
    <head>
        ...
        <script  type="text/javascript">
            ...
            function savePlan(){
                var flag = validate();
                if(flag == ""){
                    var insNum, insPres, insPay, insAmt, yearinsNum,yearInsPayID, yearinsAmt, yearinsPres;
                    if($("#insNumCheck").val() == "on"){
                        insNum = Number($("#insNum").val());
                        insPay = Number($("#insPayID option:selected").val());
                        console.log("insPay" +insPay);
                    ...
                    } else if($("#yearInsPayID").val() == "" || $("#yearInsPayID").val() == null){
                        alert("Please Select Intstallemet System");
                    }else {
                        document.standardPlanForm.action = "UnitServlet?op=detailedPaymentPlanSystem&save=yes&insPayNe="+insPay;
                ...
                <div id="payPlan" style="display: block;"> 
                    ...
                    <TABLE class="blueBorder" dir='<fmt:message key="direction"/>' align="center" width="90%" cellpadding="0" cellspacing="0">                        
                        <tr>
                            ...
                            <td style="width: 12.5%; text-align: center; border: 0;">
                                <b>
                                    <select id="insPayID" name="insPayID" style="font-size: medium;" disabled>
                                        <option value="">  </option>
                                    ...
                                    <!--<input type="text" id="insPayID" name="insPayID" value="Monthly" readonly/>-->
                                </b>
                            </td>
                    ...
                    <TABLE class="blueBorder" dir='<fmt:message key="direction"/>' align="center" width="90%" cellpadding="0" cellspacing="0">                        
                        <tr>
                            ...
                            <td style="width: 12.5%; text-align: center; border: 0;">
                                <b>
                                    <select id="yearInsPayID" name="yearInsPayID" style="font-size: medium;">
                                        <option value="">  </option>
                                        <option value="Annual"> Annual </option>
                                        <option value="Semi-annual"> Semi-annual </option>
                                        <option value="Quarterly"> Quarterly </option>
                                    </select>
                                    <input type="hidden" id="yearInsPayIDMsg" class="errorMsg" value="*" style="font-weight: bolder; width: 5%; border: none; color: red;" readonly>
                                </b>
                            </td>
                            ...
                            <td class="yearInsPayIDSelectDiv" style="width: 12.5%; text-align: center; border: 0; display: none;" colspan="3">
                                <b>
                                    <input type="number" id="yearInsMonNum" name="yearInsMonNum" style="width: 25%; float: right; margin-right: 1.5%;" min="1"> <fmt:message key="month"/>
                                </b>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td style="width: 12.5%; text-align: center; border: 0;">
                                <b>
                                    <select id="yearInsPayIDSelect" name="yearInsPayIDSelect" style="font-size: medium;" <!--onchange="zeroDate('yearInsPayIDSelect', 'yearInsPayIDSelectDiv');"-->>
                                        <option value="0"> 0% </option>
                                        <option value="12"> 12% </option>
                                        <option value="16"> 16% </option>
                                        <option value="20"> 20% </option>
                                    ...
                                    <input id="yearinsPayIDInput" name="yearinsPayIDInput" style="text-align: center; border: none; display: none; width: 100%; height: 100%; background-color: #D6FF5C" readonly>
                                </b>
                            </td>
                            ...
                            <td style="width: 12.5%; text-align: center; border: 0;">
                                <b>
                                    <input type="number" id="yearinsNum" name="yearinsNum" style="width: 25%; text-align: center;" min="0" > <fmt:message key="year"/>
                            ...
                            <td style="width: 12.5%; border: 0;">
                                <b>
                                    <input type="number" min="0" id="yearInsPayIDSelectMin" name="yearInsPayIDSelectMin" style="width: 75%;" onchange="checkValue('yearInsPayIDSelect');"> %
                                </b>
                            </td>-->
