...
<fmt:setBundle basename="Languages.Units.Units"  />
    ...
    <%
       ...
       //String[] apartmentListTitles = new String[9];        
...
//                var win = window.open(url, '');
            ...
            function changePrice(id) {
                $("#unitPrice" + id).val(parseInt($("#totalPrice" + id).html()));
                changeMeterPrice(id);
            }
        ...
        <fieldset align=center class="set" style="width: 85%; border-color: #006699;">
                    ...
                    <tr>
                        <td style="text-align:center" bgcolor="#dedede" valign="middle">
                            <select name="unitStatus" id="unitStatus">
                                <option value="8" <%="8".equals(unitStatusVal) ? "selected" : ""%>>متاحة</option>
                                <option value="9" <%="9".equals(unitStatusVal) ? "selected" : ""%>>محجوزة</option>
                                <option value="10" <%="10".equals(unitStatusVal) ? "selected" : ""%>>مباعة</option>
                            </select>
                        </td>
            ...
            <table width="50%" align="center">
                <tr>
                    ...
                    <td class="bar">
                        <b><font color="red" size="3">
                             <fmt:message key="updatenotdone" />'</font></b>
                    </td>
                    <%
                        }
                    %>
                ...
                <TABLE ALIGN="center" dir='<fmt:message key="direction" />' id="apartments" style="width:100%;">
                    <thead>
                        <tr>
                            <TH rowspan="2"><B>#</B></TH>
                            <TH rowspan="2"><B></B></TH>
                            <TH rowspan="2"><B><fmt:message key="unit" /></B></TH>
                            <TH rowspan="2"><B></B></TH>
                            <TH rowspan="2"><B></B></TH>
                            
                            <TH colspan="2"><B><fmt:message key="meterprice" /></B></TH>
                            <TH rowspan="2"><B><fmt:message key="unitArea" /></B></TH>
                            <TH rowspan="2"><B><fmt:message key="price" /></B></TH>
                            <TH rowspan="2"><B><fmt:message key="defaultPrice" /></B></TH>
                            <TH rowspan="2"><B><fmt:message key="commstate" /></B></TH>
                            <TH rowspan="2">
                                <%
                        ...
                        <tr>
                            <TH><B><fmt:message key="project"/></B></TH>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                %>
                                <div>
                                    <b id="meterUnitPrice<%=apartmentWbo.getAttribute("projectID")%>"><%=!area.equals("0") && !price.equals("0") ?Float.valueOf( Float.valueOf(price) / Float.valueOf(area)) : "0"%></b>
                                </div>
                            </td>
                            <td>
                                <%
                            ...
                            <td>
                                <%
                                    if (unitStatus.equalsIgnoreCase("8") && apartmentWbo.getAttribute("meterPrice") != null) {
                                %>
                                <img src="images/arrow_<fmt:message key="textalign"/>.png" style="width: 20px; vertical-align: middle; float: <fmt:message key="textalign"/>; cursor: hand;"
                                     onclick="JavaScript: changePrice('<%=apartmentWbo.getAttribute("projectID")%>');"/>
                                <%
                                    }
                                %>
                                <b id="totalPrice<%=apartmentWbo.getAttribute("projectID")%>">
                                    <%
                                        if (unitStatus.equalsIgnoreCase("8") && apartmentWbo.getAttribute("meterPrice") != null && apartmentWbo.getAttribute("area") != null) {
                                            try {
                                    %>
                                    <%=Long.valueOf((String) apartmentWbo.getAttribute("meterPrice")) * Long.valueOf((String) apartmentWbo.getAttribute("area"))%>
                                    <%
                            ...
                            <%--Kareem--%>
                            <td>
                                <%=apartmentWbo.getAttribute("newCode") != null ? apartmentWbo.getAttribute("newCode") : "---"%>
