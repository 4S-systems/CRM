        ...
        <script  type="text/javascript">
            ...
            function showInfo() {
                ...
                if (sPlanID != "") {
                    var resID, downPayID, downMonNum, insPayID, insPayIDSelect, insNumVal, insMonNum, resPriceCell,
                            downPayPriceCell, resIDMin,yearlyInsPayVal,yearinsNum, resIDMax,yearInsPayID, downPayIDMin, downPayIDMax, insPayIDSelectMax, insPayIDSelectMin;
            <%
            ...
            %>
                    if (sPlanID == <%=sPayPlanLst.get(i).getAttribute("ID")%>) {
                        ...
                        yearInsPayID = '<%=sPayPlanLst.get(i).getAttribute("yearlyInsPayTyp")%>';
                        insPayIDSelect = <%=sPayPlanLst.get(i).getAttribute("insAMT")%>;
                        yearlyInsPayVal = <%=sPayPlanLst.get(i).getAttribute("yearlyInsPayVal")%>;
                        insNumVal = <%=sPayPlanLst.get(i).getAttribute("insNum")%>;
                        yearinsNum = <%=sPayPlanLst.get(i).getAttribute("yearlyMinVal")%>;
            ...
            <% }%>
                    ...
                    $('#yearInsPayID option[value=' + yearInsPayID + ']').prop('selected', true);
                    $("#yearInsPayID").attr("value", yearInsPayID);
                    //$('#insPayIDSelect option[value=' + insPayIDSelect + ']').prop('selected', true);
                    $("#yearinsNum").val(yearinsNum);
                    $("#yearlyInsPayVal").val(yearlyInsPayVal);
            ...
            function getDates() {
                ...
                setDate('insMonNum', 'downMonNum', 'yearinsDate');
            }
            ...
            <legend align="center">
                ...
                <table dir=" <fmt:message key="dir"/>">
                    <tr>
                        ...
                        <td class="td">
                            <font color="blue" size="6"><fmt:message key="dualTitle"/>
                            </font>
                        </td>
                    </tr>
                </table>
            ...
            <fieldset class="set" style="border-color: #006699; width: 95%; min-height: 400px;">
                ...
                <div id="payPlan" style="display: block;"> 
                    ...
                    <div id="insDetailesDiv" name="insDetailesDiv" style="display: none;">
                        ...
                        <TABLE class="blueBorder" dir='<fmt:message key="direction"/>' align="center" width="95%" cellpadding="0" cellspacing="0" >        
                            ...
                            <tr>
                                ...
                                <td style="width: 16%; border: 0;">
                                    ...
                                    <b>
                                        <input type="number" id="downMonNum" name="downMonNum" style="width: 25%;" min="1" onchange="setDate('downMonNum', '', 'downDate');" <%=typ != null && (typ.equals("spp") || typ.equals("dpp")) ? "readonly" : ""%>>
                                    </b>
                                </td>
                        ...
                        <font style="color:red;font-size: 20px;"/>
                        ----------------------------------------------------
                         <fmt:message key="dualInstDetails"/>
                        ----------------------------------------------------
                        <br/><br/>
                        <TABLE class="blueBorder" dir='<fmt:message key="direction"/>' align="center" width="95%" cellpadding="0" cellspacing="0">                        
                            <tr>
                                ...
                                <td style="width: 16%; text-align: center; border: 0;">
                                    <b>
                                        <select id="insPayID" name="insPayID" style="font-size: medium;" <%=typ != null && (typ.equals("spp") || typ.equals("dpp")) ? "disabled" : ""%>>
                                ...
                                <td style="width: 16%; text-align: center; border: 0;">
                                    <b>
                                        <input type="number" id="insNum" name="insNum" style="width: 50%; text-align: center;" min="0" readonly="readonly" <%=typ != null && (typ.equals("spp") || typ.equals("dpp"))? "disabled" : ""%>> Month(s) 
                            ...
                            <tr>
                                ...
                                <td style="width: 16%; text-align: center; border: 0;">
                                    <b>
                                        <input class="button" type="button" onclick="calculate();" style="width: 90%; text-align: center;" value=" <fmt:message key="monthCalc"/> " readonly>
                                    </b>
                                </td>
                            </tr>
                        </TABLE>
                        ...
                        <font style="color:red;font-size: 20px;"/>
                        ----------------------------------------------------
                         <fmt:message key="yearlyInstDetails"/>
                        ----------------------------------------------------
                        <br/><br/>
                        <TABLE class="blueBorder" dir='<fmt:message key="direction"/>' align="center" width="95%" cellpadding="0" cellspacing="0">                        
                            <tr>
                                ...
                                <td style="width: 16%; text-align: center; border: 0;">
                                    <b>
                                        ...
                                        <select id="yearInsPayID" name="yearInsPayID" style="font-size: medium;" <%=typ != null && (typ.equals("spp") || typ.equals("dpp")) ? "disabled" : ""%>>
                                            <option value="">  </option>
                                ...
                                <td style="width: 16%; text-align: center; border: 0;">
                                    <b>
                                        <input id="yearlyInsPayVal" name="yearlyInsPayVal" type="number" min="0" max="100" readonly style="width: 30%;"> %
                                        <%--<input id="insPayIDSelectMin" name="insPayIDSelectMin" type="hidden" min="0" max="100" readonly>
                                        <input id="insPayIDSelectMax" name="insPayIDSelectMax" type="hidden" min="0" max="100" readonly>
                                        <%--<input id="insPayIDSelect" name="insPayIDSelect" type="number" min="0" max="100" onchange="checkTolerance('insPayIDSelect')" style="width: 30%;">-->
                                        <%--input id="insPayIDSelect" name="insPayIDSelect" type="number" min="0" max="100" readonly style="width: 30%;"--%>
                                ...
                                <td style="width: 16%; text-align: center; border: 0;">
                                    <b>
                                        <input type="number" id="yearinsNum" name="yearinsNum" style="width: 50%; text-align: center;" min="0"  <%=typ != null && (typ.equals("spp") || typ.equals("dpp"))? "disabled" : ""%>> <fmt:message key="year"/> 
                                        <input type="hidden" id="yearinsNumVal" name="yearinsNumVal">
                                    </b>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td style="width: 12%; border: 0;">
                                    <input id="yearinsDate" name="yearinsDate" type="text" style="width: 90%; text-align: center;" onclick="setDate('insMonNum', 'downMonNum', 'insDate');" readonly/>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td style="width: 16%; text-align: center; border: 0;">
                                    <b>
                                        <input class="button" type="button" onclick="calculateYearly();" style="width: 90%; text-align: center;" value=" <fmt:message key="yearlyCalc"/> " readonly>
                                    </b>
                                </td>
                            </tr>
                        </TABLE>            
