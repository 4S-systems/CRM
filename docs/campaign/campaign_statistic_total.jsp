            ...
            <TABLE ALIGN="<%=align%>" dir="<%=dir%>" WIDTH="50%" CELLPADDING="0" CELLSPACING="0" STYLE="border: 2px solid #d3d5d4">
                ...
                <TR>
                    ...
                    <TD width="50%" STYLE="text-align: right; color: blue; font-size: 14px; padding-left: 5px; border-left-width: 0px" nowrap CLASS="silver_even_main" colspan="5">
                        <select style="font-size: 14px;font-weight: bold; width: 80%;" id="campLstID" name="campLstID" onchange="getCampaignPrj();">
                ...
                <TR>
                    ...
                    <TD width="50%" STYLE="text-align: right; color: blue; font-size: 14px; padding-left: 5px; border-left-width: 0px" nowrap CLASS="silver_even_main" colspan="5">
                        <select style="font-size: 14px;font-weight: bold; width: 80%;" id="prjLstID" name="prjLstID" >
                ...
                <TR>
                    <TD width="2%" STYLE="text-align: left; color: blue; font-size: 14px; border-left-width: 0px" nowrap CLASS="silver_even_main" > <INPUT id="jspType" name="jspType" type="radio" value="details" <%if(jspType != null && jspType.equals("details")){%> checked <%}%>> </TD>
                    ...
                    <TD width="2%" STYLE="text-align: left; color: blue; font-size: 14px; border-left-width: 0px" nowrap CLASS="silver_even_main" > <INPUT id="jspType" name="jspType" type="radio" value="total" <%if(jspType != null && jspType.equals("total")){%> checked <%} else if(jspType != null && jspType.equals("")){%> checked <%}%> > </TD>
            ...
            <TABLE ALIGN="<%=align%>" dir="<%=dir%>" WIDTH="100%" id="Campaigns" style="">
                ...
                <tbody>
                    <%
                        ...
                        int grandTotalInbound = 0;
                        int grandTotalOutbound = 0;
                        int grandTotalClients = 0;
                        ...
                        for (Map.Entry m : groups.entrySet()) {
                            ...
                            for (int j = 0; j < campList.size(); j++) {
                                ...
                                grandTotalInbound += totalInbound;
                                grandTotalOutbound += totalOutbound;
                                grandTotalClients += totalClients;
                    ...
                    <tr style=" background-color: #D7D7D7">  
                        ...
                        <td>
                            <font color="red" size="3"><%=grandTotalCost%></font> 
                        </td>
                        <td>
                            <font color="red" size="3">---</font> 
                        </td>
                        <td>
                            <font color="red" size="3"><%=grandTotalInbound%></font> 
                        </td>
                        <td>
                            <font color="red" size="3"><%=grandTotalOutbound%></font>
                        </td>
                        <td>
                            <font color="red" size="3"><%=grandTotalClients%></font>
                        </td>
                    </tr>
