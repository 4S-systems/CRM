    ...
    <head>
        ...
        <SCRIPT LANGUAGE="JavaScript" TYPE="text/javascript">
            ...
            <%if (request.getAttribute("display") == null) {%>
                    document.COMP_FORM.action = "<%=context%>/SearchServlet?op=getRequests&beginDate=" + beginDate + "&endDate=" + endDate + "&contractorID=" + contractorID;
                    document.COMP_FORM.submit();
            <%} else {%>
                    document.COMP_FORM.action = "<%=context%>/SearchServlet?op=getAllRequests&beginDate=" + beginDate + "&endDate=" + endDate + "&contractorID=" + contractorID;
                    document.COMP_FORM.submit();
            <%}%>
                }
            }
                            ...
                            <table align="center" dir="rtl" width="50%" cellspacing="2" cellpadding="1">
                                ...
                                <tr>
                                    <td class="blueBorder blueHeaderTD" style="font-size:18px;" colspan="2">
                                        <b><font size=3 color="white"> <%=customerName%></b>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <table class="display" id="requests" align="center" DIR="<%=dir%>" WIDTH="100%" CELLPADDING="0" cellspacing="0">
                                        ...
                                        <tbody>
                                            ...
                                            <tr id="row">
                                                ...
                                                <td width="2.5%">
                                                    <a href="JavaScript: openCommentsDialog('<%=wbo.getAttribute("compId")%>');">
                                                ...
                                                <td  style="cursor: pointer" onmouseover="this.className = '<%=className%>'" onmouseout="this.className = ''">
                                                    <a href="<%=context%>/IssueServlet?op=requestComments&issueId=<%=wbo.getAttribute("issue_id")%>&clientComplaintId=<%=wbo.getAttribute("compId")%>&beginDate=<%=beDate%>&endDate=<%=eDate%>"><font color="red"><%=wbo.getAttribute("businessID")%></font><font color="blue">/<%=wbo.getAttribute("businessIDbyDate")%></font></a>
                                                </td>
                                                <td>
