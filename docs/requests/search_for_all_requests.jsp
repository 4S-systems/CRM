        ...
        <SCRIPT LANGUAGE="JavaScript" TYPE="text/javascript">
            ...
            function getComplaints() {
                ...
                if ((beginDate == null || beginDate == "")) {
                    ...
                    document.COMP_FORM.action = "<%=context%>/SearchServlet?op=getRequestsForAll&beginDate=" + beginDate + "&endDate=" + endDate + "&engineerID=" + engineerID + "&contractorID=" + contractorID + "&itemID=" + itemID + "&projectID=" +projectID + "&requestType=" + requestType;
            ...
            function getItemsReport(issueId) {
                divGallaryTag = $("div[name='divGallaryTag']");
                $.ajax({
                    type: "post",
                    url: '<%=context%>/IssueServlet?op=getRequestItemsDetails',
                    data: {
                        issueId: issueId
                    },
                    success: function (data) {
                            ...
                            <table align="center" style="margin-left: 20%; margin-right: 20%;" dir="rtl" width="60%" cellspacing="3" cellpadding="10">
                                ...
                                <tr>
                                    <td style="text-align:center" class="excelentCell" valign="MIDDLE" colspan="2">
                                        <select style="font-size: 14px;font-weight: bold; width: 250px;" id="requestType" >
                                            <option value="<%=CRMConstants.CLIENT_COMPLAINT_TYPE_REQUEST_EXTRADITION%>" <%=requestType.equals(CRMConstants.CLIENT_COMPLAINT_TYPE_REQUEST_EXTRADITION) ? "selected" : ""%>>طلب تسليم</option>
                                            <option value="<%=CRMConstants.CLIENT_COMPLAINT_TYPE_RE_REQUEST_EXTRADITION%>" <%=requestType.equals(CRMConstants.CLIENT_COMPLAINT_TYPE_RE_REQUEST_EXTRADITION) ? "selected" : ""%>>أعادة طلب تسليم</option>
                                        </select>
                                    </td>
                                </tr>
                                <tr>
                            ...
                            <center>
                                <div style="width: 97%">
                                    <table class="display" id="requests" align="center" DIR="<%=dir%>" WIDTH="100%" CELLPADDING="0" cellspacing="0">
                                        <thead>
                                            <tr>
                                                <TH STYLE="text-align:center;font-size:<%=(stat.equals("En")) ? "12px" : "14px"%>; font-weight: bold" width="10%" colspan="7"><img src="images/icons/operation.png" width="24" height="24"/></TH>  
                                                ...
                                                <TH STYLE="text-align:center;font-size:<%=(stat.equals("En")) ? "12px" : "14px"%>; font-weight: bold" width="15%" rowspan="2"><b>المصدر</b></TH>
                                        ...
                                        <tbody>
                                            <%
                                                ...
                                                String className = "", issueStatusName = "", issueStatusCode, statusCode, currentOwnerId;
...
//                                                        className = "canceled";
//                                                    }
                                                    issueStatusCode = (String) wbo.getAttribute("issueStatusCode");
                                                    statusCode = (String) wbo.getAttribute("statusCode");
                                                    currentOwnerId = (String) wbo.getAttribute("currentOwnerId");
                                            ...
                                            <tr id="row">
                                                ...
                                                <td width="2.5%">
                                                    <a href="JavaScript: getItemsReport('<%=wbo.getAttribute("issue_id")%>')">
                                                        <img style="margin: 3px" src="images/icons/show_event2.png" width="28" height="28" title="بنود الأعمال"/>
                                                    </a>
                                                </td>
                                                <td width="2.5%">
                                                    <%
                                                        if (statusCode != null && !statusCode.equals("7") && currentOwnerId != null && currentOwnerId.equals(securityUser.getUserId())) {
                                                    %>
                                                    <a href="<%=context%>/IssueServlet?op=requestComments&issueId=<%=wbo.getAttribute("issue_id")%>&clientComplaintId=<%=wbo.getAttribute("compId")%>&beginDate=<%=beDate%>&endDate=<%=eDate%>">
                                                        <img style="margin: 3px" src="images/icons/edit.png" width="28" height="28" title="تعديل طلب التسليم"/>
                                                    </a>
                                                    <%
                                                    } else {
                                                    %>
                                                    <img style="margin: 3px" src="images/icons/stop.png" width="28" height="28" title="لا يمكن تعديل الطلب"/>
                                                    <%
                                                        }
                                                    %>
                                                </td>
                                                <td width="2.5%">
                                                    <%
                                                        if (statusCode != null && !statusCode.equals("7") && currentOwnerId != null && currentOwnerId.equals(securityUser.getUserId())) {
                                                    %>
                                                    <a href="JavaScript: getUpdateCommentDialog('<%=wbo.getAttribute("issue_id")%>')">
                                                        <img style="margin: 3px" src="images/dialogs/comment_public.ico" width="28" height="28" title="تعديل أخر تعليق"/>
                                                    </a>
                                                    <%
                                                    } else {
                                                    %>
                                                    <img style="margin: 3px" src="images/icons/stop.png" width="28" height="28" title="لا يمكن تعديل أخر تعليق"/>
                                                    <%
                                                        }
                                                    %>
                                                </td>
