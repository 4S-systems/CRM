...
<%
    ...
    Map<String, WebBusinessObject> unitResult = (HashMap<String, WebBusinessObject>) request.getAttribute("unitResult");
        ...
        <SCRIPT LANGUAGE="JavaScript" TYPE="text/javascript">
            ...
            function getItems() {
                ...
                if ((beginDate == null || beginDate == "")) {
                    ...
                    document.ITEM_FORM.action = "<%=context%>/RequestItemServlet?op=getRequestItemsUnit&beginDate=" + beginDate + "&endDate=" + endDate;
                    ...
                    <td class="td">
                        <FIELDSET class="set" style="width:98%;border-color: #006699">
                            ...
                            <%
                                if (unitResult != null) {
                            %>
                            <table align="center" dir="rtl" width="75%" cellpadding="0" cellspacing="0" style="border: 2px solid #d3d5d4">
                                <tbody>  
                                    <%
                                        Set<String> keys = unitResult.keySet();
                                        for (String unitName : keys) {
                                            WebBusinessObject unitWbo = unitResult.get(unitName);
                                            ArrayList<WebBusinessObject> itemsList = dataResult.get(unitName);
                                    %>
                                    <tr>
                                        <td class="blueBorder blueHeaderTD" bgcolor="#669900" STYLE="text-align:center; color:white; font-size:14px" colspan="1"><b>كود الوحدة</b></td>
                                        <td colspan="3"><b><%=unitWbo.getAttribute("unitName")%></b></td>
                                    </tr>
                                    <tr>
                                        <td class="blueBorder blueHeaderTD" bgcolor="#669900" STYLE="text-align:center; color:white; font-size:14px"><span><b></b></span></td>
                                        <td class="blueBorder blueHeaderTD" bgcolor="#669900" STYLE="text-align:center; color:white; font-size:14px"><span><b>رقم المتابعة</b></span></td>
                                        <td class="blueBorder blueHeaderTD" bgcolor="#669900" STYLE="text-align:center; color:white; font-size:14px"><span><b>بند اﻷعمال</b></span></td>
                                        <td class="blueBorder blueHeaderTD" bgcolor="#669900" STYLE="text-align:center; color:white; font-size:14px"><span><b>المقاول</b></span></td>
                                    ...
                                    <%
                                        ...
                                        if (itemsList != null && !itemsList.isEmpty()) {
                                            for (WebBusinessObject wbo : itemsList) {
                                                if ((counter % 2) == 1) {
                                    ...
                                    <tr class="<%=clazz%>">
                                        ...
                                        <td>
                                            <b><font color="red"><%=wbo.getAttribute("businessID")%></font><font color="blue">/<%=wbo.getAttribute("businessIDByDate")%></font></b>
                                        </td>
                                        <td>
                                            <b><%=wbo.getAttribute("itemName")%></b>
                                        </td>
                                        <td>
                                            <b><%=wbo.getAttribute("contractorName")%></b>
                                        </td>
                                    </tr>
                                    <%
                                        }
                                    ...
                                    %>
                                    <tr>
                                        <td colspan="10"><b>لايوجد بنود أعمال</b></td>
                                    </tr>
                                    <%
                                        }
                                    %>
