        ...
        <SCRIPT LANGUAGE="JavaScript" TYPE="text/javascript">
            ...
            function getComplaints() {
                ...
                if ((beginDate == null || beginDate == "")) {
                    ...
                    document.COMP_FORM.action = "<%=context%>/SearchServlet?op=searchWithinComments&beginDate=" + beginDate + "&endDate=" + endDate + "&engineerID=" + engineerID + "&comment=" + comment;
                    ...
                    <td class="td">
                        <FIELDSET class="set" style="width:98%;border-color: #006699">
                            ...
                            <table align="center" style="margin-left: 20%; margin-right: 20%;" dir="rtl" width="60%" cellspacing="3" cellpadding="10">
                                ...
                                <tr>
                                    <td class="excelentCell"  style="text-align:center" valign="middle" colspan="2">
                                ...
                                <tr>
                                    <td style="text-align:center" class="excelentCell"  valign="MIDDLE" colspan="2">
                                        <input type="text" name="comment" id="comment" value="<%=comment%>" style="width: 500px; background-color: #FBEC88;"/>
                                    </td>
                                </tr>
                                <tr>
