...
<HTML>
    ...
    <SCRIPT LANGUAGE="JavaScript" TYPE="text/javascript">
        ...
        function submitForm()
        {    
        document.ISSUE_FORM.action = "<%=context%>/UnitDocReaderServlet?op=Delete&docID=<%=docID%>&equipmentID=<%=equipmentID%>";
        document.ISSUE_FORM.submit();  
        }
 function cancelForm()
        {    
        document.ISSUE_FORM.action = "<%=context%>/UnitDocReaderServlet?op=ListDoc&equipmentID=<%=equipmentID%>";
        document.ISSUE_FORM.submit();  
        }
    </SCRIPT>
