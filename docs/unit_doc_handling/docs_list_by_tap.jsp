 ...
 function cancelForm(url)
    ...
    <body>
        <!--DIV align="left" STYLE="color:blue;">
            ...
            <button    onclick="cancelForm('<%//=context%>/UnitDocReaderServlet?op=ViewImages&equipmentID=<%//=equipmentID%>')" class="button"><%//=cancel%> <IMG VALIGN="BOTTOM"  HEIGHT="15" SRC="images/leftarrow.gif"></button>
        </DIV--> 
       ...
       <% } %> 
        ...
        <TABLE ALIGN="<%=align%>" dir="<%=dir%>" WIDTH="400" CELLPADDING="0" CELLSPACING="0" STYLE="border-right-WIDTH:1px;">
            ...
            <TR>
                <TD CLASS="blueHeaderTD" COLSPAN="3" bgcolor="#808000" STYLE="text-align:center;color:white;font-size:16">
                    <B><%=QS%></B>
                </TD>
                <TD CLASS="blueHeaderTD" COLSPAN="1" bgcolor="#669900" STYLE="text-align:center;color:white;font-size:16">
                    <B><%=BO%></B>
                </TD>
            ...
            <TR CLASS="head">
                ...
                %>                
                <TD nowrap CLASS="silver_header" WIDTH="<%=columnWidth%>" bgcolor="<%=columnColor%>" STYLE="border-WIDTH:0; font-size:<%=font%>;color:white;" nowrap>
                    <B><%=docTitles[i]%></B>
                </TD>
                <%
                }
            ...
            <TR >
                <TD CLASS="silver_footer" COLSPAN="6" STYLE="<%=style%>;padding-right:5;border-right-width:1;">
                    <%=PN%>
                </TD>
                
                
                
                <TD STYLE="<%=style%>" CLASS="silver_footer" colspan="1">
