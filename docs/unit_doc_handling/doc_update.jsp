...
<HTML>
    ...
    String dir=null;
    String style=null;
    String lang,langCode,tit,save,cancel,TT,SNA,tit1,RU,EMP,STAT,NO,FTIT, FTYP,FDA,desc;
    if(stat.equals("En")){
    ...
    <SCRIPT LANGUAGE="JavaScript" TYPE="text/javascript">
        ...
        function submitForm()
        {    
        document.DOC_FORM.action = "<%=context%>/UnitDocWriterServlet?op=Update";
        ...
        <FORM NAME="DOC_FORM" METHOD="POST">  
            ...
            <fieldset align=center class="set">
                ...
                <table dir="<%=dir%>" align="<%=align%>" >
                    <tr>
                        <td class="td">
                            <b><FONT COLOR="red" size=4 ><%=STAT%> : <%=status%></font></b>
                </td></tr></table>
                <br>
            </fieldset>
            <%
