...
String dir=null;
String style=null;
String lang,langCode,tit,save,cancel,TT,SNA,tit1,RU,EMP,STAT,NO,Reading,Excellent,Good,Poor,eqType_odometer,eqType_continues,Countinous, By_Order;
                    ...
                    <TD CLASS="td">
                        <TABLE WIDTH="600" BORDER="0" CELLSPACING="0">
                            ...
                            <TR>
                                ...
                                <%
                                String status;
                                if (equipmentWBO.getAttribute("status").toString().equalsIgnoreCase("100%")) {
                                    status = Excellent;
                                } else if (equipmentWBO.getAttribute("status").toString().equalsIgnoreCase("75%")) {
                                    status = Good;
                                } else {
                                    status = Poor;
                                }
