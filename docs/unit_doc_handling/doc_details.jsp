...
<SCRIPT LANGUAGE="JavaScript" TYPE="text/javascript">
        ...
        document.IMG_FORM.submit();  
         ...
         function cancelForm()
        {    
        document.DOC_FORM.action = "<%=context%>/UnitDocReaderServlet?op=ListDoc&equipmentID=<%=equipmentID%>";
        document.DOC_FORM.submit();  
        } 
</SCRIPT>
...
<TR VALIGN="MIDDLE">
    ...
    %>                 
    <A HREF="<%=context%>/UnitDocReaderServlet?op=ViewDocument&docType=<%=doc.getDocumentType()%>&docID=<%=(String) doc.getAttribute("docID")%>&metaType=<%=(String) doc.getAttribute("metaType")%>">
    ...
    if(childDoc != null){
        bHasChild = true;
    %>
    <A HREF="<%=context%>/UnitDocReaderServlet?op=ViewDocument&docType=doc&docId=<%=(String) childDoc.getAttribute("docID")%>&metaType=<%=(String) childDoc.getAttribute("metaType")%>">
        <img  name='docImage' alt='document image' src="images/<%=fileDescriptor.getAttribute("iconFile")%>" >
    </A>
    <%
    } else {
