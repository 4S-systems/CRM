...
<html>
    <%
        ...
        ArrayList<WebBusinessObject> viewsLst = (ArrayList<WebBusinessObject>) request.getAttribute("viewsLst");

        String stat = (String) request.getSession().getAttribute("currentMode");
        String align = null;
        String dir = null;
        String title,clientNM, unitNM, note, emp, cT;
        if (stat.equals("En")) {
            dir = "LTR";
            align = "center";
            title = "Client Views In ";
            clientNM = "Client";
            unitNM = "Unit";
            ...
            <table align="center" width="100%" cellpadding="0" cellspacing="0" style="">
                ...
                <div style="width: 90%;margin-right: auto;margin-left: auto;" id="showClients">
                    <table width="100%" id="EmpRequests" align="<%=align%>" dir="<%=dir%>" cellpadding="0" cellspacing="0">
                        ...
                        <tbody>
                            <% for (WebBusinessObject wbo : viewsLst) {
                            %>
