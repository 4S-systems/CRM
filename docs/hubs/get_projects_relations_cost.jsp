                ...
                <table class="tableStyle" align="<%=align%>" style="text-align: center;" dir="<%=dir%>">
                    ...
                    <tbody>
                        ...
                        <TR>
                            ...
                            for (int l = j + 1; l < allProjects.size(); l++) {
                                ...
                                for (int m = 0; m < projectsRelations.size(); m++) {
                                    ...
                                    String costLabel = "";
                                    String disabled = "";
                                    event1 = "onclick=\"JavaScript: hideLabel('clickable1" + code + "', 'editCost" + code + "');\"";
                            ...
                            <td nowrap="nowrap" STYLE="<%=style%>; text-align: center;"class="silver_even">
                                <center>
                                    <div id="img<%=code%>"></div>
                                    <label id="clickable1<%=code%>" <%=event1%> <%=disabled%> class="clickable"><%=costLabel%></label>
                                    <input id="editCost<%=code%>" onblur="JavaScript: editLabel('clickable1<%=code%>', 'editCost<%=code%>', '<%=id%>', 'res<%=code%>', 'cost', '<%=code%>');" name="editCost<%=code%>" type="text" class="editable" size="10" maxlength="10" value="<%=cost%>" />
                                </center>
                            </td>
                            <%
                                break;
                        ...
                        <td nowrap="nowrap" STYLE="<%=style%>; font-size: 16px;"class="<%=bgColor%>">
                            <center>
                                <label id="clickable1<%=code%>" class="clickable">***</label>
                            </center>
                        </td>
                    <%}}%>
                    <TR>
