    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function refreshForm() {
                ...
                var url = "<%=context%>/UsersServlet?op=listManager&rowsPerPage=" + rowsPerPage + "&selectionType=" + selectionType + "&itemNo=<%=itemNo%>";
                if(fieldName != null){
            ...
            function goToPage(pageIndex) {
                ...
                var url = "<%=context%>/UsersServlet?op=listManager&Index=" + pageIndex + "&rowsPerPage=" + rowsPerPage + "&selectionType=" + selectionType + "&itemNo=<%=itemNo%>";
            ...
            function defaultView(){
                ...
                var url = "<%=context%>/UsersServlet?op=listManager&rowsPerPage=" + rowsPerPage + "&selectionType=" + selectionType ;
                if(fieldName != null){
                    url += "&fieldName=" + fieldName;
                    if(fieldValue != null || fieldValue != ""){
