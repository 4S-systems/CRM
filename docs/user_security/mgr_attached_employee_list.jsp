...
<%
    ...
    String mgrId = (String) request.getAttribute("mgrId");
    ...
    List<WebBusinessObject> listEmpAttachedEmployees = (List<WebBusinessObject>) request.getAttribute("usersList");
...
<html>
    <head>
        ...
        <script type="text/javascript">
            ...
            function refreshForm() {
                ...
                var firstEmpId=document.getElementById('firstEmpId').value;
                //alert('firstEmpId=== '+firstEmpId);
                ...
                //
                var url = "<%=context%>/UsersServlet?op=listAttachedEmployees&firstEmpId="+firstEmpId+"&rowsPerPage=" + rowsPerPage + "&selectionType=" + selectionType;
                if(fieldName != null){
            ...
            function goToPage(pageIndex) {
                ...
                var url = "<%=context%>/UsersServlet?op=listAttachedEmployees&firstEmpId="+firstEmpId+"&Index=" + pageIndex + "&rowsPerPage=" + rowsPerPage + "&selectionType=" + selectionType;
                submitForm(url);
            }
            ...
            function removeEmp(ids,mgrs){
                ...
                var url = "<%=context%>/UsersServlet?op=removeAttachedEmployees&empIds="+ids+"&mgrId="+mgrs;
                aler(ids.value)
                submitForm(url)
            }
    ...
    <script type="text/javascript">
        function send_Info(){
            ...
            var mgrId =document.getElementById('firstEmpId').value;
            ...
            $.ajax({
                type: "post",
                url: "<%=context%>/UsersServlet?op=removeAttachedEmployees",
                data: {
                    empIds:ids,
                    mgrId:mgrId
                            ...
                            <tr>
                                ...
                                <td>
                                    <a  href="#" <%=event%>>
                                        ...
                                        <input type="hidden" name="firstEmpId" id="firstEmpId" value="<%=mgrId%>"/>
                                    </a>
                                </td>
                            </tr>
