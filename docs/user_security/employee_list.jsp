    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function refreshForm() {
                ...
                var url = "<%=context%>/EmployeeServlet?op=listUnattachedEmployees&rowsPerPage=" + rowsPerPage + "&selectionType=" + selectionType + "&itemNo=<%=itemNo%>";
                if(fieldName != null){
            ...
            function goToPage(pageIndex) {
                ...
                var url = "<%=context%>/EmployeeServlet?op=listUnattachedEmployees&Index=" + pageIndex + "&rowsPerPage=" + rowsPerPage + "&selectionType=" + selectionType + "&itemNo=<%=itemNo%>";
            ...
            function defaultView(){
                ...
                var url = "<%=context%>/UsersServlet?op=listUnattachedUsers&rowsPerPage=" + rowsPerPage + "&selectionType=" + selectionType ;
                if(fieldName != null){
                    url += "&fieldName=" + fieldName;
                    if(fieldValue != null || fieldValue != ""){
            ...
            function sendEmployeeInfo(id, name) {
               //alert('entered')
               //alert('item no = '+<%=itemNo%>+' id = '+id+' name = '+name)
                window.opener.document.getElementById('userId<%=itemNo%>').value = id;
                window.opener.document.getElementById('userName<%=itemNo%>').value = name;
                window.close();
            }
        </script>
    </head>
