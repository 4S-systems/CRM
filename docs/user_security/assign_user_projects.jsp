...
<HTML>
    <%
        ...
        if (stat.equals("En")) {
            ...
            lang = "   &#1593;&#1585;&#1576;&#1610;    ";
            langCode = "Ar";
            title = "Add / Update Branches For User";
            ...
            lang = "English";
            langCode = "En";
            title = "&#1571;&#1590;&#1575;&#1601;&#1577; / &#1578;&#1593;&#1583;&#1610;&#1604; &#1575;&#1604;&#1601;&#1585;&#1608;&#1593; &#1604;&#1604;&#1605;&#1587;&#1578;&#1582;&#1583;&#1605;";
    ...
    <HEAD>
        ...
        <SCRIPT LANGUAGE="JavaScript" TYPE="text/javascript">
            function submitForm() {
                if (validateForm()) {
                    document.USER_STORES_FORM.action = "<%=context%>/UsersServlet?op=saveUserProjects";
                       ...
                       --%>
                        ...
                        <TR onmousemove="this.className = 'selectedRow'" onmouseout="this.className = ''">
                            ...
                            <TD style="cursor: pointer;text-align:<%=sPadding%>;padding-<%=sPadding%>:30px;" >
                                <INPUT TYPE="CHECKBOX" ID="checkSubProject<%=index%>" NAME="checkProject" value ="<%=index%>" <% if (checkProject_) {%> checked <% }%> onclick="checkedStores('<%=index%>', '<%=index%>');" />
                            ...
                            <TD STYLE="text-align:center;border-top-width: 0px;">
                                <input type="radio" id="isDefault<%=index%>" name="isDefault" <% if (!checkProject_) {%> disabled <% }%> <%=radioChecked_%> value="<%=projectCode_%>" />
