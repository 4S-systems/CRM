                    ...
                    <TABLE id="MaintNum" ALIGN="center" DIR="<%=dir%>" WIDTH="80%" CELLSPACING=0 CELLPADDING=0 BORDER="0" style="display: block;">
                        ...
                        <TR>
                            ...
                            <TD style="border: none; padding-<%=dir1%>: 5px;">
                                <input type="hidden" name="empOne" id="empOne" value="" />
                                <input type="text" name="empName" id="empName" value="" onchange="clearUnitId();" ondblclick="return getDataInPopup('UsersServlet?op=getManagerForDepartment&fieldName=USER_NAME&fieldValue=' + getASSCIChar(this.value));" readonly="readonly"/>
                                &nbsp;&nbsp;
                                <div style="text-align: center;background-image: url(images/icons/status_.png) ;background-repeat: no-repeat;width: 24px;height: 24px;display: inline-block" onclick="return getDataInPopup('UsersServlet?op=getManagerForDepartment&fieldName=USER_NAME&fieldValue=' + getASSCIChar(document.getElementById('empName').value)+'&formName=ATTACH_EMPS_FORM&selectionType=single');">
                        ...
                        <TR>
                            ...
                            <TD style="border: none; padding-<%=dir1%>: 5px;">
                                ...
                                &nbsp;&nbsp;&nbsp;<input type="button" id="listEmps" name="listEmps" value="List assigned" style="text-align: center;" onclick="return getDataInPopup('UsersServlet?op=listAttachedEmployees&fieldName=USER_NAME&fieldValue=&formName=ATTACH_EMPS_FORM&selectionType=multi&firstEmpId=' + document.getElementById('empOne').value);" disabled/>
                            </td>
                        </TR>
                    </TABLE>
                    <br /><br />
