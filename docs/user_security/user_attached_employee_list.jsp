...
<%
    ...
    List<WebBusinessObject> listUserAttachedEmployees = (List<WebBusinessObject>) request.getAttribute("usersList");
    WebBusinessObject wbo = null;
    String fieldId = "userId";
    String fieldName = "fullName";
    String fieldCode = "sodicId";

    String tableNameField = "USER_NAME", tableIdField = "ID", tableCodeField = "SODIC_ID";
%>
<html>
    <head>
        ...
        <script type="text/javascript">
            ...
            function goToPage(pageIndex) {
                ...
                var url = "<%=context%>/UsersServlet?op=listUserAttachedEmployees&Index=" + pageIndex + "&rowsPerPage=" + rowsPerPage + "&selectionType=" + selectionType;
                submitForm(url);
            }
                    ...
                    <div>
                        <table width="500">
                            ...
                            <%
                                ...
                                for (int i = 0; i < listUserAttachedEmployees.size(); i++) {

                                    wbo = (WebBusinessObject) listUserAttachedEmployees.get(i);
