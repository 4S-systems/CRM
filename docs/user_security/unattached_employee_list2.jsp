    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function refreshForm() {
                ...
                var url = "<%=context%>/UsersServlet?op=listAllUsers&rowsPerPage=" + rowsPerPage + "&selectionType=" + selectionType;
                if(fieldName != null){
            ...
            function goToPage(pageIndex) {
                ...
                var url = "<%=context%>/UsersServlet?op=listAllUsers&Index=" + pageIndex + "&rowsPerPage=" + rowsPerPage + "&selectionType=" + selectionType;
                submitForm(url);
            }
            ...
            function send_Info(){
                ...
                for(var i = 0; i < length; i++){
                    ...
                    if(check[i].checked == true){
                        ...
                        if(!opener.window.users[mgrId[i].value]){
                            // alert('test');
                            ++insertCount;
                            window.opener.document.getElementById('userId').value=mgrId[i].value;
                            window.opener.document.getElementById('userName').value=userName[i].value;
                ...
                if(count > 0){
                    window.opener.document.getElementById("listArea").disabled=false;
                    window.opener.document.getElementById("user_area").disabled=false;
                    this.close();
                }else{
