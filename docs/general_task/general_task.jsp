...
<html>
    <%
        ...
        ArrayList<WebBusinessObject> listTemp = new ArrayList<>();
        ArrayList<WebBusinessObject> complaints = new ArrayList<>();
        ArrayList<WebBusinessObject> requests = new ArrayList<>();
        if (!departmentsList.isEmpty()) {
            listTemp = new ArrayList<>(projectMgr.getOnArbitraryDoubleKeyOracle((String) departmentsList.get(0).getAttribute("projectID"), "key2", "cmplnt", "key4"));
            if (listTemp.size() > 0) {
                WebBusinessObject wboComplaint = (WebBusinessObject) listTemp.get(0);
                complaints.addAll(projectMgr.getOnArbitraryKeyOracle((String) wboComplaint.getAttribute("projectID"), "key2"));
            }
            listTemp = new ArrayList<>(projectMgr.getOnArbitraryDoubleKeyOracle((String) departmentsList.get(0).getAttribute("projectID"), "key2", "rqst", "key4"));
            if (listTemp.size() > 0) {
                WebBusinessObject wboRequest = (WebBusinessObject) listTemp.get(0);
                requests.addAll(projectMgr.getOnArbitraryKeyOracle((String) wboRequest.getAttribute("projectID"), "key2"));
            }
        }
        ...
        WebBusinessObject client = clientMgr.getOnSingleKey(CRMConstants.COMPANY_CLIENT_ID);
                                    ...
                                    <td>
                                        <div>
                                            <div style="display: block;float: right;width: 80%;">
                                                <SELECT id="department" name="department" STYLE="width:100%;font-size: medium; font-weight: bold;"onchange="getDepartmentEmployees(this);getComplaintsRequests(this, 'cmplnt');"  >
                        ...
                        <table width="99%;" border="1px" style="margin-top: 10px;" id="tableDATA" >
                            ...
                            <tr id="orderROW">
                                <td  style="">
                                    <div style="">
                                        <div style="display: block;float: right;width: 80%;">
                                            <SELECT id="department" name="department" STYLE="width:100%;font-size: medium; font-weight: bold;"onchange="getDepartmentEmployees(this);getComplaintsRequests(this, 'rqst');"  >
                                                <sw:WBOOptionList wboList='<%=departmentsList%>' displayAttribute = "projectName" valueAttribute="optionOne" />
                                            </SELECT> 
                                        </div>
