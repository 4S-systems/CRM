    ...
    <HEAD>
        ...
        <script type="text/javascript">
            ...
            function sendInfo(Name ,Id){
                ...
                opener.document.getElementById("regionName").value = Name;//window.opener.jQuery("[name=regionName]").val(Name);
                opener.document.getElementById("region").value = Id;//window.opener.jQuery("[name=region]").val(Id);
