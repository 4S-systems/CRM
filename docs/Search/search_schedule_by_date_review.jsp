...
<HTML>
    ...
    <BODY>
        ...
        <FORM NAME="ISSUE_FORM" METHOD="POST" action="ScheduleServlet?op=ViewSchByToReview&fieldName=CREATION_TIME&fieldName=CREATION_TIME">
            <center>
                                        ...
                                        <table align="<%=align%>" border="0" dir="<%=dir%>" width="100%" cellspacing="2">
                                            <tr>
                                                <td CLASS="tRow" bgcolor="white" STYLE="text-align:center;">
                                                    <button type="submit"  style="width:120"> <%=search%> <IMG VALIGN="BOTTOM" SRC="images/search.gif"/></button>
                                                </td>
                                                <td CLASS="tRow" bgcolor="white" STYLE="text-align:center;direction: ltr;">
                                                    <input readonly id="from" name="fieldValue" type="text" value="<%=nowTime%>" style="width:90%" /><br />
                                                    <input readonly id="to" name="fieldValue" type="text" value="<%=nowTime%>" style="width:90%" />
