...
if(!request.getParameter("filterValue").equalsIgnoreCase("")) {
    ...
    viewOrigin.setAttribute("filterValue",request.getParameter("receivedby"));
}
        ...
        <FORM NAME="ISSUE_LISTING_FORM" METHOD="POST">
            ...
            <fieldset >
                ...
                <TABLE ALIGN="center" DIR="<%=dir%>" WIDTH="100%" CELLPADDING="0" CELLSPACING="0" STYLE="border-right-WIDTH:1px;">
                    ...
                    <TR>
                        <TD CLASS="blueHeaderTD" COLSPAN="5" bgcolor="#808000" STYLE="text-align:center;color:white;font-size:18">
                            <B><%=QuikSummry%></B>
                        </TD>
                        <TD CLASS="blueHeaderTD" COLSPAN="2" bgcolor="#669900" STYLE="text-align:center;color:white;font-size:18">
                            <B><%=basicOP%></B>
                        </TD>
                        <TD CLASS="blueHeaderTD" COLSPAN="2" bgcolor="#999999" STYLE="text-align:center;color:white;font-size:18">
                            <B><%=workFlow%></B>
                        </TD>
                        <TD CLASS="blueHeaderTD" COLSPAN="4" bgcolor="#CC9900" STYLE="text-align:center;color:white;font-size:18">
                            <B><%=indGuid%></B>
                        </TD>
                    </TR>
                    <Tr >
                    ...
                    <td nowrap BGCOLOR="#FFBF00" colspan="4" CLASS="silver_header" WIDTH="60" STYLE="text-align:center;border-top-WIDTH:0; font-size:14" nowrap>
                        <font > &nbsp; </font>
                    </td>  
                    <tbody id="planetData2">
                        ...
                        <TR>
                            ...
                            %>
                            <TD nowrap BGCOLOR="#DDDD00" CLASS="<%=bgColor%>" STYLE="white-space: normal;padding-left:10;text-align:left;">
                                <DIV ID="links">
                                    <%=UnitName%>
