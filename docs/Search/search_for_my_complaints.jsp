...
<SCRIPT LANGUAGE="JavaScript" TYPE="text/javascript">
    ...
    function getComplaints() {
        ...
        if ((beginDate === null || beginDate === "")) {
            ...
            document.COMP_FORM.action = "<%=context%>/SearchServlet?op=searchForMyComplaints&beginDate=" + beginDate + "&endDate=" + endDate + "&ticketStatus=" + ticketStatus + "&compStatus=" + compStatus;
                            ...
                            <TABLE ALIGN="center" DIR="RTL" WIDTH=570 CELLSPACING=2 CELLPADDING=1>
                                ...
                                <tr>
                                    <TD STYLE="text-align:center" CLASS="td" colspan="3">  
                                        <button  onclick="JavaScript: getComplaints();"   STYLE="color: #27272A;font-size:15px;margin-top: 20px;font-weight:bold; ">بحث<IMG HEIGHT="15" SRC="images/search.gif" ></button>  
                                    </TD>
                                </tr>
                            </TABLE>
                        </fieldset>
                            ...
                            <TABLE ALIGN="center" DIR="RTL" WIDTH=600 CELLSPACING=2 CELLPADDING=1>
                                ...
                                <tr>
                                    <td class="td" colspan="2" style=" text-align: center">
                                        <br>
                                        <b><font size="3" color="red"> <%=PN%> : <%=data.size()%></font></b>
                                    </td>
                                </tr>
                            </TABLE>
                        </fieldset>
            ...
            <table class="blueBorder"  id="indextable" align="center" DIR="<%=dir%>" WIDTH="100%" CELLPADDING="0" cellspacing="0" style="display: none; text-align: center">
                <thead>
                    <TR>
                        ...
                        <TH CLASS="blueBorder backgroundTable" STYLE="text-align:center;font-size:<%=(stat.equals("En")) ? "12px" : "14px"%>; font-weight: bold; height: 25px" width="10%" rowspan="2"><b><%=ageComp%></b></TH>
                    </TR>
