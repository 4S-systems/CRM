                            ...
                            <TABLE ALIGN="center" DIR="RTL" WIDTH=570 CELLSPACING=2 CELLPADDING=1>
                                ...
                                <tr>
                                    <TD STYLE="text-align:center" CLASS="td" colspan="3">  
                                        <button  onclick="JavaScript: getComplaints();"   STYLE="color: #000;font-size:15px;margin-top: 20px;font-weight:bold; ">بحث<IMG HEIGHT="15" SRC="images/search.gif" ></button>  
                                    </TD>
                                </tr>
                            </TABLE>
                        </fieldset>
