                                        ...
                                        <table align="<%=align%>" border="0" dir="<%=dir%>" width="100%" cellspacing="2">
                                            <tr>
                                                <td CLASS="tRow" bgcolor="white" STYLE="text-align:center;">
                                                    <button  onclick="return getDataInPopup('ScheduleServlet?op=searchSchBySubNamePopup' + '&fieldName=MAINTENANCE_TITLE&fieldValue=' + getASSCIChar(document.getElementById('scheduleName').value) + '&formName=ISSUE_FORM');" style="width:120"> <%=search%> <IMG VALIGN="BOTTOM" SRC="images/search.gif"/></button>
                                                </td>
                                                <td CLASS="tRow" bgcolor="white" STYLE="text-align:center;">
                                                    <input type="text" name="scheduleName" id="scheduleName" ondblclick="return getDataInPopup('ScheduleServlet?op=searchSchBySubNamePopup' + '&fieldName=MAINTENANCE_TITLE&fieldValue=' + getASSCIChar(this.value) + '&formName=ISSUE_FORM');" >
                                                </td>                                       
                                            </tr>
                                        </table>
                                    </div>
