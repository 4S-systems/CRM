...
<%
    ...
    String currentOwnerID = (String) request.getAttribute("currentOwnerID");
  ...
  // String stat = "En";
    ...
    String sat, sun, mon, tue, wed, thu, fri, complaintCode, PN, noResponse, ageComp,source,responsible,all,
           searchButton,reqNumber,mobile,phone,status,nationalnumber,reqDate;
    String complStatus, senderName = null, fullName = null;
    String sDate, sTime = null, description, notes;
    if (stat.equals("En")) {
        dir = "LTR";
        ...
        phone="رقم التليفون";
        mobile="الموبايل";
        reqNumber="رقم الطالب";
        status="الحالة";
        nationalnumber="الرقم الدولي";
        reqDate="تاريخ الطلب";
        notes = "الملاحظات";
    }
%>
        ...
        <SCRIPT LANGUAGE="JavaScript" type="text/javascript">
            ...
            function getComplaints() {
                ...
                if ((beginDate == null || beginDate == "")) {
                    ...
                    document.COMP_FORM.action = "<%=context%>/SearchServlet?op=searchNewClients&beginDate=" + beginDate + "&endDate=" + endDate + "&description=" + description + "&senderID=" + senderID + "&currentOwnerID=" + currentOwnerID;
                            ...
                            <table align="center" dir="rtl" width="570" cellspacing="2" cellpadding="1">
                                ...
                                <tr>
                                    ...
                                    <td bgcolor="#dedede" style="text-align:center" valign="middle">
                                        ...
                                        %>
                                        <select style="font-size: 14px;font-weight: bold;" id="currentOwnerID" >
                                            <option value=""><%=all%></option>
                                        ...
                                        %>
                                        <input type="hidden" id="currentOwnerID" value="<%=securityUser.getUserId()%>"/>
                                        <b> <font size=3><%=securityUser.getFullName()%></b>
                                        <%
                                            }
                                        %>
                                        <br/>
    ...
    <table class="display" id="indextable" align="center" dir="<%=dir%>" width="100%" cellpadding="0" cellspacing="0">
        <thead>
            <tr>
                ...
                <th style="text-align:center;font-size:<%=(stat.equals("En")) ? "12px" : "14px"%>; font-weight: bold; height: 25px" width="7%"><b><%=phone%></b></th>
                <th style="text-align:center;font-size:<%=(stat.equals("En")) ? "12px" : "14px"%>; font-weight: bold; height: 25px" width="7%"><b><%=mobile%></b></th>
                <th style="text-align:center;font-size:<%=(stat.equals("En")) ? "12px" : "14px"%>; font-weight: bold; height: 25px" width="7%"><b><%=reqNumber%></b></th>
                <th style="text-align:center;font-size:<%=(stat.equals("En")) ? "12px" : "14px"%>; font-weight: bold; height: 25px" width="7%"><b><%=nationalnumber%></b></th>
                ...
                <th style="text-align:center;font-size:<%=(stat.equals("En")) ? "12px" : "14px"%>; font-weight: bold; height: 25px" width="10%"><b><%=notes%></b></th>
                <th style="text-align:center;font-size:<%=(stat.equals("En")) ? "12px" : "14px"%>; font-weight: bold; height: 25px" width="10%"><b><%=reqDate%></b></th>
        ...
        <tbody  id="planetData2">  
            ...
            <tr style="padding: 1px;">
                ...
                <td>
                    ...
                    <b title="<%=complStatus%>" style="cursor: hand"><%=wbo.getAttribute("customerName")%></b>
                    <%}%>
                </td>
                <td>
