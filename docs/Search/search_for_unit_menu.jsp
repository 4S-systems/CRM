...
<html>
    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function submitForm()
            {
                ...
                document.MainType_Form.action = "<%=context%>/SearchServlet?op=SearchForUnitsMenu&unitCategory=" + unitCategory;

                document.MainType_Form.submit();
            }
            
            function viewUnits(model)
            {  
                document.MainType_Form.action = "<%=context%>/ProjectServlet?op=getViewUnits&projectId="+model+"&status=ok";
                document.MainType_Form.submit();
            }
            ...
            function getUnits() {
                ...
                $.ajax({
                    type: "post",
                    url: "<%=context%>/SearchServlet?op=SearchForUnitsMenu",
                    data: {
                        unitDes: unitDes,
    ...
    <body>
        ...
        <form name="MainType_Form" method="post">
            <input type="hidden" id="mainProduct" name="mainProduct" value="----"/>
            <input type="hidden" id="subProduct" name="subProduct" value="----"/>
            <fieldset class="set" style="width:100%;border-color: #006699;" >
                ...
                <table ID="tableSearch" class="blueBorder" ALIGN="<%=align%>" DIR="<%=dir%>" CELLPADDING="3" CELLSPACING="1" width="50%">
                    ...
                    <TR>
                        <TD  STYLE="<%=style%>" class="blueBorder blueHeaderTD">
                            <LABEL style="text-align: center;">
                                <p><b>كود المبنى</b>&nbsp;
                            </LABEL>
                        </TD>
                        <TD STYLE="<%=style%>;background-color: #EDEDED;" class='td'>

                            <input type="TEXT"  id="unitDes" name="unitDes" />
                            <img src="images/multi_story.jpg"></img>
                        </TD>
                    </TR>
                    
                    <tr>
                        <td colspan="2" style="border: none;background-color: #EDEDED;">
                            <button id="showBtn" onclick="JavaScript:submitForm();" class="button" style="width:100px "> <%=Show%></button>
                        </td>
                    </tr>
                </table>
                ...
                <TABLE class="blueBorder"  id="indextable" align="center" DIR="<%=dir%>" WIDTH="90%" CELLPADDING="0" cellspacing="0" style="margin-top: 15px;">
                    <tr >
                        ...
                        <TH CLASS="blueBorder backgroundTable" STYLE="text-align:center;font-size:<%=(stat.equals("En")) ? "12px" : "14px"%>; font-weight: bold; height: 25px" width="1%">
                            <B></B>
                        </TH>                        
                        <TH CLASS="blueBorder backgroundTable" STYLE="text-align:center;font-size:<%=(stat.equals("En")) ? "12px" : "14px"%>; font-weight: bold; height: 25px" width="3%">
                            <B></B>
                    ...
                    <tbody  id="planetData2">  
                        ...
                        <tr style="padding: 1px;">
                            ...
                            <%//} else {%>
-->                         <TD class="blueBorder blueBodyTD" STYLE="text-align:center;padding: 5px;width: 1%">
                                <img src="images/multi_story.jpg"></img>
                            </TD>
                            <%//}%>
                            <TD class="blueBorder blueBodyTD" STYLE="text-align:center;padding: 5px; font-size: 12px;width: 3%" >
                                <input type="button" value="مشاهدة الوحدات" id="reservedBtn" onclick="viewUnits(<%=wbo.getAttribute("projectID")%>)" />
                            </TD>
