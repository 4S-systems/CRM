...
<SCRIPT LANGUAGE="JavaScript" TYPE="text/javascript">
    ...
    function getComplaints() {
        ...
        if((beginDate=null||beginDate=="")){
            ...
            document.COMP_FORM.action = "<%=context%>/SearchServlet?op=SearchForComplaints&beginDate="+beginDate +"&endDate="+endDate+"&type="+type+"&compStatus="+compStatus
            document.COMP_FORM.submit();
            //                $("#username").val("");
        }
    }
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <select style="font-size: 14px;font-weight: bold;"id="compStatus" >
                                            <option value="4">الوارد</option>
                                            <option value="7">مغلق</option>
            ...
            <tbody  id="planetData2">  
                ...
                <TR style="padding: 1px;">
                    ...
                    <TD style="border-left:0px; border-right:0px; border-bottom: 1px black; ">
                        ...
                        <%if (wbo.getAttribute("businessId") != null) {%>
                        <b><%=wbo.getAttribute("businessId")%></b>
                        <%}
                        %>
                    ...
                    <TD style="border-left:0px; border-right:0px; border-bottom: 1px black; ">
                        ...
                        <%if (wbo.getAttribute("businessComId") != null) {%>
                        <b><%=wbo.getAttribute("businessComId")%></b>
                        <%}%>
                    ...
                    <TD style="border-left:0px; border-right:0px; border-bottom: 1px black; ">
                        ...
                        <%if (wbo.getAttribute("managerComment") != null) {%>
                        <b><%=wbo.getAttribute("managerComment")%></b>
                        <%}%>
