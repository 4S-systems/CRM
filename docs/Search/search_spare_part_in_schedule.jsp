...
<HTML>
    ...
    String dir=null;
    String style=null;
    String lang, langCode, sTitle, sCancel, sOk, sparePartCodeStr, message;
    ...
    if(stat.equals("En")){
        ...
        sOk="Search";
        langCode="Ar";
        sparePartCodeStr = "Spare Part Code";
        message = "This spare part is not listed within any schedule";
        ...
        sOk="&#1576;&#1581;&#1579;";
        langCode="En";
        sparePartCodeStr = "كود قطعة غيار";
        message = "هذه القطعة غير مدرجة تحت أى جدول صيانة";
    }
    %>
    ...
    <SCRIPT LANGUAGE="JavaScript" TYPE="text/javascript">
        ...
        function submitForm()
        {    
        document.ISSUE_FORM.action = "<%=context%>/SearchServlet?op=searchSPInSchedule";
                ...
                <TABLE ALIGN="center" DIR="<%=dir%>"  CELLPADDING="0" CELLSPACING="0" BORDER="0">
                    <TR>
                        <TD STYLE="text-align:right" class='td'>
                            <LABEL>
                                <p><b><%=sparePartCodeStr%></b>&nbsp;
                            </LABEL>
                        </TD>
                        <TD STYLE="text-align:right" class='td'>
                            <input type="TEXT" value="" id="sparePartCode" name="sparePartCode">
                        </TD>
                    </TR>                         
                </TABLE>
