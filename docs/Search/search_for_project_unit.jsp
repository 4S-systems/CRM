...
<style>
    ...
    /* Units table (#clients): align icons, unify sizes, slightly smaller type */
    #showClients #clients {
        border-collapse: collapse;
        font-size: 12px;
    }
    #showClients #clients thead th {
    ...
    #showClients #clients thead input[type="text"] {
    ...
    #showClients #clients tbody td {
        font-size: 12px;
        padding: 2px 6px;
        vertical-align: middle;
        border-color: #e5e7eb;
    }
    #showClients #clients tbody td b {
        font-size: 12px;
        font-weight: 600;
    }
    /* Action icons: attach / docs / gallery */
    #showClients #clients tbody td:first-child {
        text-align: center;
        
        line-height: 1;
    }
    #showClients #clients tbody td:first-child img {
    ...
    /* Client column links (details, broker/owner) */
    #showClients #clients tbody td a img {
                            ...
                            <TD style="border: none" width="70%">
                                <TABLE WIDTH="100%" CELLPADDING="0" CELLSPACING="0" ALIGN="CENTER">
                                    ...
                                    <tr>
                                        ...
                                        <td style="<%=style%>" class='td'>
                                            <select id="unitAreaID" name="unitAreaID" style="width:170px; color: black;">
...
<table style="direction: <%=dir%>; width: 60%; padding-bottom: 2%; padding-top: 2%; margin-bottom: 2%; margin-top: 2%;">
                <tr>
                    ...
                    <td bgcolor="#F7F6F6" style="display: <%=userPrevList.contains("EXCEL") ? "" : "none"%>; text-align:center; width: 30%; border: none;" valign="middle" rowspan="2">
                        <input  class="button2" type="button" onclick="exportToExcel();" style="width: 50%; color: #27272A; font-size:15; font-weight:bold;" value="Excel">
