...
<SCRIPT LANGUAGE="JavaScript" TYPE="text/javascript">
   ...
   var dp_cal1;      
    ...
    function submitForm()
    {  
        document.ISSUE_FORM.action = "<%=context%>/SearchServlet?op=getByoneDate&searchType=end";
    ...
    <tr><td class="td">
        <fieldset >
            ...
            <TABLE ALIGN="CENTER" DIR="RTL" ID="code" CELLPADDING="0" CELLSPACING="0" width="650" STYLE="border-width:1px;border-color:white;">
                ...
                <TR>
                    <TD CLASS="silver_header" STYLE="text-align:center"  BGCOLOR="#cc6699" WIDTH="50%">
            ...
            <TABLE ALIGN="center" DIR="RTL" WIDTH=570 CELLSPACING=2 CELLPADDING=1>
                <TR>
                    <TD CLASS="silver_header"  BGCOLOR="#cc6699"  STYLE="border-left-WIDTH: 1;text-align:center;" WIDTH="50%">
                        <b> <font size=3 > &#1578;&#1575;&#1585;&#1610;&#1582; &#1575;&#1604;&#1606;&#1607;&#1575;&#1610;&#1577; </b>
                    </TD>
                </TR>
                <TR>
