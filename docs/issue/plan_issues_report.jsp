<%@page import="com.planning.db_access.PlanMgr"%>
...
boolean plansExist = planMgr.countAll() > 0;
...
String showDetails,searchRe,numTask,QuikSummry,basicOP,workFlow,signe,mark,viewD,DM,sta,schduled,Begined,Finished,Canceled,Holded,Rejected,external,em,pm,from,to,saveToPlanStr;
String scheduleTitle="";

String beginDate=(String)request.getAttribute("beginDate");
String endDate=(String)request.getAttribute("endDate");

String cancelIssue,keepIssue,all,eqpName,pageTitle;
...
if(stat.equals("En")){
    ...
    searchRe="Future Plan for Equipment '" + unitName + "'";
    ...
    cancelIssue="Cancel";
    keepIssue="View";
    all="Future Plan For All Equipments";
    eqpName="Equipment Name";
    scheduleTitle="Schedule Title";
    pageTitle="RPT-JO-LATE-4";
    saveToPlanStr="Save To Plan";
    
}else{
    
    cancel_button_label="&#1573;&#1606;&#1600;&#1607;&#1600;&#1600;&#1600;&#1600;&#1600;&#1600;&#1575;&#1569;";
    dir="RTL";
    ...
    searchRe="&#1575;&#1604;&#1582;&#1591;&#1607; &#1575;&#1604;&#1605;&#1587;&#1578;&#1602;&#1576;&#1604;&#1610;&#1607; &#1604;&#1604;&#1605;&#1593;&#1583;&#1607; '"+ unitName +"'";
    numTask="&#1593;&#1583;&#1583; &#1575;&#1604;&#1605;&#1607;&#1575;&#1605;  ";
    ...
    cancelIssue="&#1573;&#1604;&#1594;&#1575;&#1569;";
    keepIssue="&#1605;&#1588;&#1575;&#1607;&#1583;&#1607;";
    all="&#1575;&#1604;&#1582;&#1591;&#1607; &#1575;&#1604;&#1605;&#1587;&#1578;&#1602;&#1576;&#1604;&#1610;&#1607; &#1604;&#1603;&#1604; &#1575;&#1604;&#1605;&#1593;&#1583;&#1575;&#1578;";
    eqpName="&#1575;&#1587;&#1605; &#1575;&#1604;&#1605;&#1593;&#1583;&#1607;";
    scheduleTitle="&#1575;&#1587;&#1605; &#1575;&#1604;&#1580;&#1583;&#1608;&#1604;";
    pageTitle="RPT-JO-LATE-4";
    saveToPlanStr="سجل فى خطة";
}
%>
...
<html>
    <HEAD>
        ...
        <script src="js/GetSelectedRadioButtonOrCheckBox.js"></script>
    </HEAD>
    ...
    <script type="text/javascript">
     ...
     function reloadAE(nextMode){
      ...
      var checked = false;
      var checkJO = document.getElementsByName('checkJO');

      function checkAll() {
          var checkAll = document.getElementById('checkAllJO');
          checkJO = document.getElementsByName('checkJO');
        if (checkAll.checked != false) {
            checked = true;
        } else {
            checked = false;
        }
        for (var i = 0; i < checkJO.length; i++) {
            checkJO[i].checked = checked;
        }
      }
      ...
      function callbackFillreload(){
        ...
        {   
            ...
            if (r==true)
              {
                    var url ="<%=context%>/SearchServlet?op=cancelPlannedIssue&issueId="+issueId+"&unitId=<%=unitId%>&beginDate=<%=beginDate%>&endDate=<%=endDate%>";
                    window.navigate(url);
              }
        }
        ...
        {    
            ...
            var url ="<%=context%>/ProgressingIssueServlet?op=keepIssue&issueId="+issueId+"&scheduleId=<%=scheduleId%>&eqpId=<%=eqId%>";
           // window.navigate(url);
        }
        ...
        {
            if(<%=plansExist%>) {
                if(getSelectedCheckbox(checkJO).length > 0) {
                    document.SAVE_PLAN_ISSUE_FORM.action = "<%=context%>/PlanIssueServlet?op=getPlanIssueForm";
                    document.SAVE_PLAN_ISSUE_FORM.submit();

                } else {
                    alert("You must choose one or more issues!")
    ...
    <body>
        <FORM NAME="SAVE_PLAN_ISSUE_FORM" METHOD="POST">
        <table align="<%=align%>" border="0" width="80%">
                    ...
                    <div STYLE="width:99.5%;border:2px solid gray;background-color:#9db0c1;color:white;" bgcolor="#F3F3F3" align="<%=align%>">
                        ...
                        <div ALIGN="<%=align%>" STYLE="width:100%;background-color:#FFFFCC;color:white;display:none;text-align:right;border-top:2px solid gray;" ID="menu1">
                            <table align="<%=align%>" border="0" dir="<%=dir%>" width="100%" cellspacing="2">
                                <tr>
                                    <td CLASS="blueHeaderTD" bgcolor="#B7B700" STYLE="color:white;<%=style%>;" width="16%"><IMG SRC="images/view.png" ALIGN=""ALT="view file" > <b><%=attached%></b></td>
                                    <td CLASS="blueHeaderTD" bgcolor="#B7B700" STYLE="color:white;<%=style%>;" width="16%"><IMG SRC="images/unassign.gif"  ALT="Terminated Task" > <b><%=termainanted%></b></td>
                                    <td CLASS="blueHeaderTD" bgcolor="#B7B700" STYLE="color:white;<%=style%>;" width="16%"><IMG SRC="images/config.jpg"  ALT="Configured Schedule" > <b><%=Config%></b></td>
                                    <td CLASS="blueHeaderTD" bgcolor="#B7B700" STYLE="color:white;<%=style%>;" width="16%"><IMG SRC="images/timer.gif"  ALT="Update Job Date"> <b><%=updateTime%></b></td>
                                    <td CLASS="blueHeaderTD" bgcolor="#B7B700" STYLE="color:white;<%=style%>;" width="16%"><IMG WIDTH="20" HEIGHT="20" SRC="images/emr.gif" ALT="Emergency job order"> <b><%=em%></b></td>
                                    <td CLASS="blueHeaderTD" bgcolor="#B7B700" STYLE="color:white;<%=style%>;" width="16%"><IMG WIDTH="20" HEIGHT="20" SRC="images/external.gif" ALT="External job order"> <b><%=external%></b></td>
                                </tr>
                                <tr>
                                    <td CLASS="blueHeaderTD" bgcolor="#B7B700" STYLE="color:white;<%=style%>;"><IMG SRC="images/unview.gif" ALT="non attached file" > <b><%=notAattached%></b></td>
                                    <td CLASS="blueHeaderTD" bgcolor="#B7B700" STYLE="color:white;<%=style%>;"><IMG SRC="images/assign.gif" ALT="UnTerminated Task" > <b><%=notTermainanted%></b></td>
                                    <td CLASS="blueHeaderTD" bgcolor="#B7B700" STYLE="color:white;<%=style%>;"><IMG SRC="images/nonconfig.gif"  ALT="Un configure Schedule"> <b><%=nconfig%></b></td>
                                    <td CLASS="blueHeaderTD" bgcolor="#B7B700" STYLE="color:white;<%=style%>;"><IMG WIDTH="20" HEIGHT="20" src="images/metal-Inform.gif"  ALT="Un configure Schedule"> <b><%=showDetails%></b></td>
                                    <td CLASS="blueHeaderTD" bgcolor="#B7B700" STYLE="color:white;<%=style%>;"><IMG WIDTH="20" HEIGHT="20" SRC="images/internal.gif" ALT="Premaintative Maintenance"> <b><%=pm%></b></td>
                                    <td CLASS="blueHeaderTD" bgcolor="#B7B700" STYLE="color:white;<%=style%>;"></td>
                                </tr>                                
                            </table>
                        </div>
                    </div>
            ...
            <tr>
                <td width="100%" STYLE="border:0px;">
                    ...
                    <div STYLE="width:99.5%;border:2px solid gray;background-color:#9db0c1;color:white;" bgcolor="#F3F3F3" align="<%=align%>">
                        <div ONCLICK="JavaScript: changeMode('menu3');" STYLE="width:100%;background-color:#9db0c1;color:white;cursor:hand;font-size:14;">
                            <b>
                                <%=sta%>
                            </b>
                            <img src="images/arrow_down.gif">
                        ...
                        <div ALIGN="<%=align%>" STYLE="width:100%;background-color:#FFFFCC;color:white;display:none;text-align:right;border-top:2px solid gray;" ID="menu3">
                            <table width="100%">
                                <tr>
                                    <td CLASS="blueHeaderTD" bgcolor="#B7B700" STYLE="color:white;text-align:center;" width="16%"><b style="font-size:14px"><%=schduled%></b></td>
                                    <td CLASS="blueHeaderTD" bgcolor="#B7B700" STYLE="color:white;text-align:center;" width="16%"><b style="font-size:14px"><%=Begined%></b></td>
                                    <td CLASS="blueHeaderTD" bgcolor="#B7B700" STYLE="color:white;text-align:center;" width="16%"><b style="font-size:14px"><%=Finished%></b></td>
                                    <td CLASS="blueHeaderTD" bgcolor="#B7B700" STYLE="color:white;text-align:center;" width="16%"><b style="font-size:14px"><%=Canceled%></b></td>
                                    <td CLASS="blueHeaderTD" bgcolor="#B7B700" STYLE="color:white;text-align:center;" width="16%"><b style="font-size:14px"><%=Holded%></b></td>
                                    <td CLASS="blueHeaderTD" bgcolor="#B7B700" STYLE="color:white;text-align:center;" width="16%"><b style="font-size:14px"><%=Rejected%></b></td>
                                </tr>
                            </table>
                        </div>
                    </div>
        ...
        <DIV align="left" STYLE="color:blue;">
            ...
            <button  onclick="JavaScript: saveToPlan();" class="button"><%=saveToPlanStr%></button>
        </DIV>
        <FIELDSET>
        <legend align="center">
        ...
        <TABLE align="<%=align%>" WIDTH="800" border="0"  DIR= <%=dir%>  CELLPADDING="0" CELLSPACING="0" STYLE="border-right-WIDTH:1px;">
            <TR>
                <TD CLASS="blueHeaderTD" bgcolor="#808000" STYLE="text-align:center;color:white;font-size:18">
                    <B><%=QuikSummry%></B>
                </TD>
        ...
        <TABLE class="sortable" WIDTH="800" align="<%=align%>" border="0"  DIR= <%=dir%>  CELLPADDING="0" CELLSPACING="0" STYLE="border-right-WIDTH:1px;">
            <TR >
                <TH CLASS="silver_header" WIDTH="30">#</TH>
                
                <TH CLASS="silver_header" WIDTH="200">
                    <%=issueTitle[0]%>
                </TH>  
                <%if(unitId.equalsIgnoreCase("All")){%>
                <TH CLASS="silver_header" WIDTH="200">
                ...
                <TH CLASS="silver_header" COLSPAN="2" WIDTH="200">
                    <%=issueTitle[1]%>
                </TH>

                <TH CLASS="silver_header" WIDTH="100">
                    <%=saveToPlanStr%><br>
                    <input type="checkbox" id="checkAllJO" name="checkAllJO" onclick="checkAll();" />
                </TH>
            ...
            <tbody id="planetData2">  
                ...
                <TR>
                    ...
                    <TD  CLASS="<%=bgColor%>" >
                        ...
                        <%--<button style="width:80" onclick="JavaScript: keepIssue('<%=issueID%>');">
                            <font color="black" size="2"><B><%=keepIssue%></B></font>
                        </button>
                        --%>
                    </TD>                    
                    ...
                    <TD CLASS="<%=bgColor%>" >
                        <input type="checkbox" name="checkJO" value="<%=issueID%>"/>
                    </TD>
                    
                </TR>
                <%}}}%>
                <tr>
                    <TD CLASS="silver_footer" BGCOLOR="#808080" COLSPAN="3" STYLE="<%=style%>padding-right:5;border-right-width:1;">
                        <FONT color="black" size="3">  <B><%=numTask%></B></FONT>
                    </TD>
                    <%if(unitId.equalsIgnoreCase("All")){%>
                    <TD CLASS="silver_footer" BGCOLOR="#808080" colspan="4" STYLE="text-align:center;padding-left:5;;color:Black;font-size:16;">
