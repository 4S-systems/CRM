...
<script LANGUAGE="JavaScript" TYPE="text/javascript">
    ...
    function submitForm()
    {
        ...
        var fieldset = parent.document.getElementById("warrantyInfo");
        fieldset.style.display = "block";
        var table = parent.document.getElementById("table");
        var ref = parent.document.getElementById("<%=request.getParameter("partId")%>");
        ref.setAttribute("onclick","");
        ref.innerHTML = "<img src='images/down_16.png'>";
        ...
        C0.className = "blueBorder blueBodyTD";
        C1.className = "blueBorder blueBodyTD";
        C2.className = "blueBorder blueBodyTD";
        C3.className = "blueBorder blueBodyTD";
        C4.className = "blueBorder blueBodyTD";
        C5.className = "blueBorder blueBodyTD";
        C6.className = "blueBorder blueBodyTD";
        
        C0.innerHTML = "<input type='hidden' value='<%=request.getParameter("partId")%>' id='partId' name='partId'>" +
            "<input readonly style='width: 99%;text-align: center' type='text' value='<%=request.getParameter("itemCode")%>' id='partCode' name='partCode'>";
        C1.innerHTML = "<input readonly style='width: 99%;text-align: center' type='text' value='"+document.getElementById("vendor").value+"' id='vendor' name='vendor'>";
        C2.innerHTML = "<input readonly style='width: 99%;text-align: center' type='text' value='"+document.getElementById("beginDate").value+"' id='bDate' name='bDate'>";
        C3.innerHTML = "<input readonly style='width: 99%;text-align: center' type='text' value='"+document.getElementById("endDate").value+"' id='eDate' name='eDate'>";
        C4.innerHTML = "<input readonly style='width: 99%;text-align: center' type='text' value='"+document.getElementById("note").value+"' id='note' name='note'>";
        C5.innerHTML = "-";
        C6.innerHTML = "-";
            ...
            <fieldset class="set" style="border-color: #006699;width: 95%">
                ...
                <table align="<%=align%>" DIR="<%=dir%>" border="0" cellpadding="0" cellspacing="0" WIDTH=90%>
                    <tr>
                        ...
                        <td style="border-width: 0px"><input size="50" maxlength="100" type="text" name="vendor" id="vendor"></td>
                    </tr>
                    <tr>
                        <td style="border-width: 0px;background-color: window;color: black" class="blueHeaderTD"><%=note%></td>
                        <td style="border-width: 0px"><textarea rows=""  cols="39" name="note" id="note"></textarea> </td>
                    </tr>
                    <tr>
