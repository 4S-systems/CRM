...
<%
    ...
    String dir = null;
    String style = null;
    String lang, langCode, cancel, cost, maint, save, reason1, reason2, reason3, Titel, sTitel, MUnit, ReceivedBY, Fcode, uLevel, eBDate, pDesc, M1, M2, sNoData, sLaborCost, sPartCost, attache, externalType, part, total;
    if (stat.equals("En")) {
        align = "center";
        dir = "LTR";
...
<SCRIPT LANGUAGE="JavaScript" TYPE="text/javascript">
    ...
    function submitForm(){
        ...
        document.EXTERNAL_ORDER_FORM.action = "<%=context%>/IssueServlet?op=SaveEditExternalJob&issueId=<%=issueId%>&filterName=<%=filterName%>&filterValue=<%=filterValue%>";
...
<HTML>
    ...
    <BODY>
        <FORM action=""  NAME="EXTERNAL_ORDER_FORM" METHOD="POST">
                                ...
                                <TABLE ALIGN="<%=align%>" dir="<%=dir%>" CELLPADDING="0" CELLSPACING="0" BORDER="0">
                                    ...
                                    <TR>
                                        ...
                                        <td STYLE="<%=style%>"  class="calender">
                                            <input id="conversionDate" name="conversionDate" type="text" value="<%=externalWbo.getAttribute("conversionDate").toString().replace("-","/")%>" /><img alt="" src="images/showcalendar.gif" >
                                    ...
                                    <TR>
                                        ...
                                        <td STYLE="<%=style%>"  class="td">
                                            <input type="text" name="laborCost" id="laborCost" value="<%=externalWbo.getAttribute("laborCost")%>">
                                        </td>
                                    </TR>
                                    <!-- end -->
                                    ...
                                    <TR>
                                        ...
                                        <TD STYLE="<%=style%>"class='td' COLSPAN="3">
                                            <TEXTAREA rows="5" style="width:230px" name="maintStatment" id="maintView" cols="80"><%=externalWbo.getAttribute("maintStatment")%></TEXTAREA>
                                        </TD>
                                    </TR>
