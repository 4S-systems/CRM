...
<html>
     ...
     function reloadAE(nextMode){
      ...
      function callbackFillreload(){
        ...
        {   
            ...
            if (r==true)
              {
                    var url ="<%=context%>/ProgressingIssueServlet?op=cancelIssue&issueId="+issueId+"&scheduleId=<%=scheduleId%>&eqpId=<%=eqId%>";
                    window.navigate(url);
              }
        }
    ...
    <body>
            ...
            <table dir=" <%=dir%>" align="<%=align%>">
                <tr>
                    <td class="td" style="text-align:right">
                        <b>
                            <font color="blue" size="5"> <%=searchRe%>
                                <br>
                                <%=from%>                        
                            </font>
        ...
        <TABLE align="<%=align%>" border="0"  DIR= <%=dir%>  CELLPADDING="0" CELLSPACING="0" STYLE="border-right-WIDTH:1px;">
            ...
            <TR>
                <TD CLASS="header" COLSPAN="5" bgcolor="#808000" STYLE="text-align:center;color:white;font-size:18">
                    <B><%=QuikSummry%></B>
                </TD>
            ...
            <TR >
                ...
                <TH CLASS="header" WIDTH="200">
                    <%=scheduleTitle%>
                </TH> 
                
                <TD CLASS="header" COLSPAN="2" WIDTH="200">
                    <%=issueTitle[1]%>
                </TD> 
            ...
            <tbody id="planetData2">  
                ...
                <%}}}%>
                <tr>
                    <TD CLASS="bar" BGCOLOR="#808080" COLSPAN="2" STYLE="<%=style%>padding-right:5;border-right-width:1;">
                        <font color="black" size="3">  <B><%=numTask%></B></FONT>
                    </TD>
                    <TD CLASS="bar" BGCOLOR="#808080" colspan="3" STYLE="text-align:center;padding-left:5;;color:Black;font-size:14;">
