...
//Get request data
WebBusinessObject inspecWbo = (WebBusinessObject) request.getAttribute("inspecWbo");
String inspectionNumber = inspecWbo.getAttribute("code").toString() + "<font color=\"blue\">" + "/"+inspecWbo.getAttribute("codeByDate").toString() + "</font>";
String inspectionId = inspecWbo.getAttribute("id").toString();
String transNumber = (String) inspecWbo.getAttribute("trnsNo");

WebBusinessObject eqpWbo = (WebBusinessObject) request.getAttribute("mainUnitWbo");
...
String lang, langCode, cancel, save, Titel, JODetails, JONumber, workerEmp, eqpName, JOReq, MUnit, ReceivedBY,shift,
        ...
        selectDesc, noData,equipStatus,equipStatusMSG,equipStatusWorking,trade,estematedDuration,hourStr;
String sMinute,sHour,sDay;
String recommendInspec,mainUnitJob,subUnitJob,inspectionNo,transNo;
if (stat.equals("En")) {
    Time="Reporting Time";
    ...
    equipStatusWorking="Machine in service";
    ...
    sHour = "Hour";
    sDay = "Day";
    recommendInspec="Recommendation for inspection";
    mainUnitJob ="Equipment Name";
    subUnitJob ="Job order for extension";
    inspectionNo ="Inspection number";
    transNo ="Transport number";
    ...
    equipStatusWorking="&#1575;&#1604;&#1605;&#1575;&#1603;&#1610;&#1606;&#1577; &#1601;&#1609; &#1575;&#1604;&#1582;&#1583;&#1605;&#1577;";
    trade="&#1606;&#1608;&#1593; &#1575;&#1605;&#1585; &#1575;&#1604;&#1593;&#1605;&#1604;";
    shift="&#1575;&#1604;&#1608;&#1585;&#1583;&#1610;&#1607;";
    shifts[0]="&#1575;&#1604;&#1608;&#1585;&#1583;&#1610;&#1607; : 1";
    shifts[1]="&#1575;&#1604;&#1608;&#1585;&#1583;&#1610;&#1607; : 2";
    ...
    sHour = "&#1587;&#1575;&#1593;&#1577;";
    sDay = "&#1610;&#1608;&#1605;";
    recommendInspec="&#1578;&#1608;&#1589;&#1610;&#1575;&#1578; &#1575;&#1604;&#1601;&#1581;&#1589; &#1575;&#1604;&#1601;&#1606;&#1609;";
    mainUnitJob ="&#1571;&#1605;&#1585; &#1588;&#1594;&#1604; &#1604;&#1604;&#1605;&#1575;&#1603;&#1610;&#1606;&#1577;";
    subUnitJob ="&#1571;&#1605;&#1585; &#1575;&#1604;&#1588;&#1594;&#1604; &#1604;&#1604;&#1605;&#1604;&#1581;&#1602;";
    inspectionNo ="&#1585;&#1602;&#1605; &#1591;&#1604;&#1576; &#1575;&#1604;&#1601;&#1581;&#1589;";
    transNo ="&#1578;&#1593;&#1578;&#1605;&#1583; &#1593;&#1604;&#1609; &#1575;&#1605;&#1585; &#1588;&#1594;&#1604; &#1606;&#1602;&#1604;";
}

MainCategoryTypeMgr mainCategoryTypeMgr = MainCategoryTypeMgr.getInstance();
WebBusinessObject mainTypeWbo = new WebBusinessObject();
mainTypeWbo = (WebBusinessObject) mainCategoryTypeMgr.getOnSingleKey(eqpWbo.getAttribute("maintTypeId").toString());
...
<HTML>
    ...
    <SCRIPT LANGUAGE="JavaScript" TYPE="text/javascript">
        ...
        function submitForm()
        {
            ...
            //}else if (!validateData("req", this.ISSUE_FORM.duration, "Please, enter Duration.") || !validateData("numeric", this.ISSUE_FORM.duration, "Please, enter a valid Number for Duration.")){
           //     this.ISSUE_FORM.duration.focus();
                ...
                this.ISSUE_FORM.issueDesc.focus();
                 ...
                 document.ISSUE_FORM.action = "<%=context%>/IssueServlet?op=saveEmIssueFromInspection&issueDesc=No Description";
                 document.ISSUE_FORM.submit();
            }
        }
        ...
        <center>
            <FORM NAME="ISSUE_FORM" METHOD="POST">
                ...
                <fieldset class="set">
                    ...
                    <%
                    if ((deptAL.size() <= 0 || urrgencyAL.size() <= 0 || tradesAL.size() <= 0) && !source.equalsIgnoreCase("viewImages")) {
                    %>
                    ...
                    <table border="0" ALIGN="<%=align%>" dir="<%=dir%>" width="800">
                        ...
                        <tr>
                            <td width="250" bgcolor="#CCCCCC" style="text-align:<%=cellAlign%>; padding-<%=cellAlign%>:10"><b><font size="3" color="black"><%=mainUnitJob%></font></b></td>
                            <td colspan="3" style="border-right-width:1px"><b><font size="3" color="red"><%=unitName%></font></b></td>
                        </tr>
                        ...
                        <%  }else{ %>
                            <tr>
                            <td width="250" bgcolor="#CCCCCC" style="text-align:<%=cellAlign%>; padding-<%=cellAlign%>:10"><b><font size="3" color="black"><%=equipStatus%></font></b></td>
                            <td colspan="3" style="border-right-width:1px"><b><font size="3" color="blue"><%=equipStatusWorking%></font></b></td>
                        </tr>
                        <%}%>
                        <tr>
                            <td width="250" bgcolor="#CCCCCC" ALIGN="<%=align%>" style="text-align:<%=cellAlign%>; padding-<%=cellAlign%>:10px;"><b><font size="3" color="black"><%=JONumber%></font></b></td>
                            <td colspan="3" style="border-right-width:1px"><b><font size="3" color="red"><%=jobOrderNumber%></font></b></td>

                        </tr>
                        <tr>
                            <td width="250" bgcolor="#CCCCCC" ALIGN="<%=align%>" style="text-align:<%=cellAlign%>; padding-<%=cellAlign%>:10"><b><font size="3" color="black"><%=inspectionNo%></font></b></td>
                            <td colspan="3" style="border-right-width:1px"><b><font size="3" color="red"><%=inspectionNumber%></font></b></td>

                        </tr>
                        <tr>
                            <td width="250" bgcolor="#CCCCCC" ALIGN="<%=align%>" style="text-align:<%=cellAlign%>; padding-<%=cellAlign%>:10"><b><font size="3" color="black"><%=transNo%></font></b></td>
                            <td colspan="3" style="border-right-width:1px"><b><font size="3" color="red"><%=transNumber%></font></b></td>
                        </tr>
                        ...
                        <tr style="display:none;">
                            ...
                            <td width="250" bgcolor="#CCCCCC" ALIGN="<%=align%>" style="text-align:<%=cellAlign%>; padding-<%=cellAlign%>:10">
                                <b><font size="3" color="black"><%=MUnit%></font></b>
                                <input type="hidden" name="unitName" value="<%=eqpWbo.getAttribute("id").toString()%>">
                            </td>
                            <%}%>
                        </tr>
                        ...
                        <tr style="display:none;">
                            ...
                            <td width="5%" style="border-right-width:1px;border-left-width:1px"><input style="width:20px;" type="text" name="day" id="day" maxlength="2" value="1" ONBLUR="IsNumeric(this.id);"></td>
                            </tr>
                        ...
                        <tr style="display:none;">
                            <td width="250" bgcolor="#CCCCCC" ALIGN="<%=align%>" style="text-align:<%=cellAlign%>; padding-<%=cellAlign%>:10"><b><font size="3" color="black"><%=recommendInspec%></font></b></td>
                            <td ALIGN="<%=align%>" colspan="3" valign="middel" style="border:0px; text-align:<%=cellAlign%>">
                                <input type="checkbox" style="display:none;" name="desc" id="desc" checked onclick="javascript: openDesc(this);" onmouseover="Tip('<%=checkboxTip%>',CENTERMOUSE, true, OFFSETX, 0, BGCOLOR, '#FFFF99' , FONTCOLOR, 'BLACK', FONTSIZE, '10pt', FONTWEIGHT ,'BOLD', SHADOW, true, SHADOWWIDTH, 7,TEXTALIGN ,'CENTER', TITLE ,'Enetr Description help',TITLEALIGN ,'center' ,TITLEFONTCOLOR ,'White', TITLEBGCOLOR ,'#6699FF')" onmouseout="UnTip()"><%//=selectDesc%><br>
                                <TEXTAREA rows="3" name="issueDesc" id="issueDesc" cols="80" >No Desc.</TEXTAREA>
                            </td>
                        </tr>
                    </table>
