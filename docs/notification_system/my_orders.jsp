...
<HTML>
    ...
    <%
        ...
        if(request.getParameter("toDateMyComp") != null) {
            toDateVal = request.getParameter("toDateMyComp");
            withinIntervals.put("toDateMyComp", "" + toDateVal);
        } else if (withinIntervals.containsKey("toDateMyComp")) {
            toDateVal = withinIntervals.get("toDateMyComp");
        }
        cal.add(Calendar.DAY_OF_MONTH, -1);
        String fromDateVal = sdf.format(cal.getTime());
        if(request.getParameter("fromDateMyComp") != null) {
            fromDateVal = request.getParameter("fromDateMyComp");
            withinIntervals.put("fromDateMyComp", "" + fromDateVal);
        } else if (withinIntervals.containsKey("fromDateMyComp")) {
            fromDateVal = withinIntervals.get("fromDateMyComp");
        }
        
        issuesVector = issueByComplaintAllCaseMgr.getAllCaseWithinTimeAndCreatedBy(new java.sql.Date(sdf.parse(fromDateVal).getTime()), new java.sql.Date(sdf.parse(toDateVal).getTime()),
                loggedUser.getAttribute("userId").toString());
                   ...
                   style="border-width:1px;border-color:white;display: block;">
                    ...
                    <tr>
                        <td style="text-align: center; font-size: 14px; border-width: 1px; border-color: white;" bgcolor="#EEEEEE" valign="middle">
                            <input class="fromToDate" id="fromDateMyComp" name="fromDateMyComp" type="text" title="تاريخ التوزيع" value="<%=fromDateVal%>" readonly/><img src="images/showcalendar.gif"/>
                            <br/><br/>
                        </td>
                        <td style="text-align: center; font-size: 14px; border-width: 1px; border-color: white;" bgcolor="#EEEEEE" style="text-align:right" valign="middle">
                            <input class="fromToDate" id="toDateMyComp" name="toDateMyComp" type="text" title="تاريخ التوزيع" value="<%=toDateVal%>" readonly/><img src="images/showcalendar.gif"/>
                            <br/><br/>
                        </td>
                    </tr>
                </table>
