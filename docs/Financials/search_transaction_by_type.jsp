...
<%
    ...
    ArrayList<WebBusinessObject> transactionTypeList=request.getAttribute("FAccountType") != null ? (ArrayList<WebBusinessObject>) request.getAttribute("FAccountType") : new ArrayList<WebBusinessObject>();
    String stat = (String) request.getSession().getAttribute("currentMode");
    String TransactionType=request.getAttribute("TransactionType")==null?"":request.getAttribute("TransactionType").toString();
    String dir, title,excel, fromDate, toDate,type1,  search,total, credit, debit, type, account, openingBalance, balance, note, operationType, recipient, date;
    if (stat.equals("En")) {
        dir = "ltr";
        ...
        dir = "rtl";
        title = "بحث الحركات المحاسبيه بنوع الحركه";
        fromDate = " من تاريخ ";
        toDate = " إلى تاريخ ";
        search = " بحث ";
        credit = "دائن";
...
<html>
    ...
    <body>
        <form NAME="BALANCE_REPORT_FORM" METHOD="POST" action="<%=context%>/FinancialServlet?op=financialTransactionSearchByType">
            <fieldset class="set" style="width: 95%; padding-bottom: 20px;">
                ...
                <table align="center" style="direction: <%=dir%>; width: 50%;">
                    <tr>
                        <td class="blueBorder blueHeaderTD" style="font-size: 15px; font-weight:bold; width: 50%;">
                    ...
                    <tr>
                        <td style="text-align: center; border: none;" bgcolor="#F7F6F6" valign="middle" >
                            <input id="fromDate" name="fromDate" type="text" value="<%=fromDateVal%>" style="width:50%;" readonly />
                            <img src="images/showcalendar.gif" > 
                        </td>

                        <td bgcolor="#F7F6F6" style="text-align: center; border: none;" valign="middle">
                            <input id="toDate" name="toDate" type="text" value="<%=toDateVal%>" style="width: 50%;" readonly />
                            <img src="images/showcalendar.gif" >
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td bgcolor="#F7F6F6" style="text-align: center; border: none;" valign="middle">
                            <select style="width: 50%;height: 30px; font-weight: bold; font-size: 13px;" id="accountID" name="accountID">
                                <option></option>
                            </select>
                        </td>
                    </tr>
                    <tr>
                        <td class="blueBorder blueHeaderTD" style="font-size: 15px; font-weight:bold; width: 50%;">
                            <font size=3 color="white"><%=type1%></font>
                        </td>
                        <td class="blueBorder blueHeaderTD" style="font-size: 15px; font-weight:bold; width: 50%;">
                            <font size=3 color="white"><%=search%></font>
                        </td>
                       
                    </tr>
                    <tr>
                        <td style="text-align: center; border: none;" bgcolor="#F7F6F6" valign="middle" >
                            <select style="width: 50%;height: 30px; font-weight: bold; font-size: 13px;" id="transactionType" name="transactionType" >
                                <option></option>
                                <sw:WBOOptionList displayAttribute="projectName" valueAttribute="projectID" wboList="<%=transactionTypeList%>" scrollToValue="<%=TransactionType%>"/>
                            </select>
                        </td>
                        <td style="text-align: center; border: none;" bgcolor="#F7F6F6" valign="middle" >
