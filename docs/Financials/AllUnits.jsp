...
<%
    ...
    if (stat.equals("Ar")) {
        ...
        msg = "Please select units, Or Click close to exit page.";
        pageLabel = "Page";
        ofLabel = "of";
        cancel = "Close";
    ...
    List<WebBusinessObject> unitsLst = (List<WebBusinessObject>) request.getAttribute("unitsLst");
    WebBusinessObject wbo = null;
    String fieldId = "projectID";
    String fieldName = "projectName";
    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function sendInfo(id, name) {
                ...
                window.opener.document.getElementById('unitName').value = name;
            ...
            function refreshForm() {
                ...
                var url = "<%=context%>/ProjectServlet?op=getAllUnitsData&rowsPerPage=" + rowsPerPage + "&selectionType=" + selectionType+"&fieldValue="+fieldValue;
                        ...
                        <TABLE ID="tableSearch" class="blueBorder" ALIGN="center" DIR="<%=dir%>" CELLPADDING="0" CELLSPACING="0" width="90%">
                            ...
                            <TR>
                                <TD CLASS="" STYLE="text-align: <%=textAlign%>;font-size:15px;">
                                    <input type="hidden" name="fieldName" id="fieldName"  value="PROJECT_NAME"/><b><%=name%> :</b>
                                </TD>
                    ...
                    <div>
                        <table width="500">
                            ...
                            <%
                                ...
                                for (int i = 0; i < unitsLst.size(); i++) {

                                    wbo = (WebBusinessObject) unitsLst.get(i);
