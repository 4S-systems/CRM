    ...
    <head>
        ...
        if (stat.equals("En")) {
            ...
            align = "center";
             ...
             title="Financial Transaction Search By Value" ;
             ByDocu="By Document Code";
             BytransCode="By Transaction Code";
             entrerNum="Enter The Value";
            ...
            title="بحث عن الحركات المحاسبيه بالقيمه الماليه";
            ByDocu="بكود المستند";
            BytransCode="بالقيد المحاسبى";
            entrerNum="ادخل القيمه";
            DocNum="كود المستند";
            TransNum="كود الحركه";
            Date="تاريخ الحركه";
        ...
        <script  type="text/javascript">
            ...
            function submitForm(){
                ...
                document.finanTransaction.action = "<%=context%>/FinancialServlet?op=financialTransactionSearchValue&fromDate="+fromDate + "&toDate=" + toDate;
