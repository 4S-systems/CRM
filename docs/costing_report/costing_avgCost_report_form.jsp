...
// get current date
    ...
    <SCRIPT LANGUAGE="JavaScript" TYPE="text/javascript">
        ...
        function submitForm()
        {
            ...
            var url = "<%=context%>/PDFReportServlet?op=avgCostingFullReportResult&beginDate=" + beginDate + "&endDate=" + endDate + "&unitId=" + unitId + "&unitName=" + unitName + "&issueTitle=" + issueTitle + "&orderBy=" + orderBy;
            openWindow(url);
        }
