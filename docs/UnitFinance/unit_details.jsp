...
<%
    ...
    if (fromPage != null && fromPage.equalsIgnoreCase("listApartment")) {
...
<html>
    ...
    <script type="text/javascript">
        ...
        function createPDF() {
            document.UNIT_FORM.action = "<%=context%>/UnitDocWriterServlet?op=unitInstallmentPDF";
            document.UNIT_FORM.submit();
        }
        ...
        function calcInitial()
        {
            ...
            for(var i=1; i<=5; i++){
                $('#installment'+i).html(rest/(12*i)+'/شهر');
            }
        }
    </script>
    ...
    <body>
        <FORM NAME="UNIT_FORM" id="new_location_type_Form" METHOD="POST">
            ...
            <DIV align="left" STYLE="color:blue; margin-left: 30px">
                ...
                <button  class="button"> PDF <IMG VALIGN="BOTTOM"   SRC="images/pdf.gif"> </button>
            </DIV>
            ...
            <fieldset class="set" style="border-color: #006699; width: 95%; min-height: 400px;">
                <TABLE class="backgroundTable" width="80%" CELLPADDING="0" CELLSPACING="8" ALIGN="CENTER" DIR="<%=dir%>">
                    <TR>
                    ...
                    <tr>
                        <td style="width: 600px; vertical-align: top;">
                            <TABLE class="backgroundTable" width="100%" CELLPADDING="0" CELLSPACING="8" ALIGN="CENTER" DIR="<%=dir%>">
                                ...
                                %>
                                <tr>
                                    <TD style="<%=style%>; text-align:center; border:1px" class="backgroundHeader" id="CellData">
                                ...
                                <tr>
                                    <TD style="<%=style%>; text-align:center; border:1px" class="backgroundHeader" id="CellData">
                                        <b>
                                            <font size="3" color="black">سعر الوحدة</font>
                                        </b>
                                    </td>
                                    <TD style=" background-color: white">
                                        <b>
                                ...
                                <tr>
                                    <TD style="<%=style%>; text-align:center; border:1px" class="backgroundHeader" id="CellData">
                                        <b>
                                            <font size="3" color="black">نسبة المقدم</font>
                                        </b>
                                    </td>

                                    <TD style=" background-color: white">
                                        <input type="TEXT" style="width: 70%;text-align: center" name="reservePrecen" dir="<%=dir%>" ID="reservePrecen"  size="15" maxlength="255"> %  
                                        <input type="button" id="calculate" value="احسب" onClick="JavaScript: calcInitial();">
                                    </td>
                                </tr>
                                <%
                                    }
                ...
                <TABLE class="backgroundTable" width="80%" CELLPADDING="0" CELLSPACING="8" ALIGN="CENTER" DIR="<%=dir%>">
                    <TR>
                        <TD style="text-align:center;border-color: #006699;" colspan="2" width="100%" class="blueBorder blueHeaderTD"><FONT color='white' SIZE="+1"> نظام تقسيط الوحدة </FONT><BR></TD>
                    </TR>

                    <TR>
                        <TD style="<%=style%>; text-align:center; border:1px" width="50%" class="backgroundHeader" id="CellData">
                            <b style="margin-left: 5px;padding-left: 5px;font-weight: bold">
                                <font size="3" color="black">مقدم الدفع</font>
                            </b>
                        </td>
                    ...
                    <TR>
                        <TD colspan="2">
                            <TABLE class="backgroundTable" width="100%" CELLPADDING="0" CELLSPACING="8" ALIGN="CENTER" DIR="<%=dir%>">
                                <thead>
                                    <tr>
                                        <th style="color: #005599; font: 20px; font-weight: bold;" width="50%" class="blueBorder blueHeaderTD" >السنة</th>
                                        <th style="color: #005599; font: 20px; font-weight: bold;" width="50%" class="blueBorder blueHeaderTD">القسط</th>
                                    </tr>
                                <thead>
                                ...
                                <tbody>
                                    ...
                                    %>
                                    <tr>
                                        <TD style="<%=style%>; text-align:center; border:1px" width="50%" class="backgroundHeader">
                                            <%=i%>
                                        </td>
                                        <TD style="<%=style%>; text-align:center; border:1px" width="50%" class="backgroundHeader" id="installment<%=i%>">
                                        </td>    
                                    </tr>
                                    <%
                                        }
