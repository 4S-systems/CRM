        ...
        <script type="text/javascript">
            function View() {
                $.ajax({
                    ...
                    url: "<%=context%>/UnitFinanceServlet?op=buildUnitsTree",
                    success: function (jsonString) {
                        ...
                        $("#jqxMenu").on('itemclick', function (event) {
                            ...
                            switch (item) {
                                case '\u0627\u0636\u0627\u0641\u0629 \u0645\u0634\u0631\u0648\u0639 \u062c\u062f\u064a\u062f':
                                    alert("new project");
                                case '\u0639\u0631\u0636 \u062e\u0631\u064a\u0637\u0629 \u0627\u0644\u0645\u0634\u0631\u0648\u0639':
                                    $("#plan").attr("src", "img/plan.jpg");
                                    $("#plan").attr("width", "650px");
                                    $("#plan").attr("height", "500px");
                                    break;
                                case '\u0639\u0631\u0636':
                                    alert("view details");
                                    break;
                                case 'نموذج سكني':
                                    getDataInPopup('<%=context%>/UnitDocWriterServlet?op=getNewModelForm&projId=' + projectId);
                                    break;
                                case 'أرفاق خريطة للمشروع':
                                    getDataInPopup('<%=context%>/UnitDocWriterServlet?op=attachMasterPlan&projId=' + projectId);
                                    break;
                            }
                        });
    ...
    <body>
        <FORM NAME="UNIT_FORM" id="Units_Tree_Form" METHOD="POST">
            <fieldset class="set" style="border-color: #006699; width: 95%; min-height: 400px;">
                <TABLE class="backgroundTable" width="30%" CELLPADDING="0" CELLSPACING="8" ALIGN="LEFT">
                    <TR>
                        <TD style="border: 0px">
                            <TABLE class="backgroundTable" width="30%" CELLPADDING="0" CELLSPACING="8" ALIGN="LEFT" DIR="<%=dir%>">
                                <TR>
                                    <TD style=" background-color: lightsteelblue; border: 0px">
                                        <p><b style="font-weight: bold"><fmt:message key="project" /></b></p>
                                    </TD>

                                    <TD style=" background-color: lightsteelblue; border: 0px; width: 200px">
                                        <SELECT name='project' id='project' style='font-size:16px;' onchange="getModels(this.value)">
                                            <option value="1364111290870" style="color: blue"><fmt:message key="all" /></option>
                                            <%
                                    ...
                                    <TD style=" background-color: lightsteelblue; border: 0px; width: 20px">
                                        <input type="button" id="view" value='<fmt:message key="show" />' onClick="JavaScript: View();">
                                    </td>
                                </tr>
                                ...
                                <TR>
                                    ...
                                    <TD>
                                        <input type="button" id="search" value='<fmt:message key="search" />' onClick="JavaScrip: Search();" width="50px" disabled="false">
                                    </TD>
                                </TR>

                                <TR>
                                    <TD colspan="3">
                                        <div id='jqxTree' DIR="<%=dir%>">
                                        </div>
                                        <div id='jqxMenu'>
                                        </div>
                                    </TD>
                        ...
                        <TD style="border: 0px">
                            <TABLE class="backgroundTable" width="50%" CELLPADDING="0" CELLSPACING="8" ALIGN="LEFT" DIR="<%=dir%>">
                                <TR>
                                    <TD style=" background-color: lightsteelblue; border: 0px">
                                        <img id="plan" style="background-repeat: no-repeat; -webkit-box-shadow: 0px 0px 17px rgba(255, 255, 255, 1.0);
                                             -moz-box-shadow:    0px 0px 17px rgba(255, 255, 255, 1.0);
                                             box-shadow:         0px 0px 17px rgba(255, 255, 255, 1.0);
                                             -webkit-border-radius: 20px;
                                             -moz-border-radius: 20px;
                                             border-radius: 20px;" onClick="popupPlan()"/>

                                        <div id="ViewDetailes" style="width: 70%;display: none;position: fixed;margin-left: auto;margin-right: auto" >
