        ...
        <script type="text/javascript">
                function View() {
                    $.ajax({
                        ...
                        url: "<%=context%>/FinancialServlet?op=buildCostCenterTree",
                        success: function (jsonString) {
                            ...
                            $("#jqxMenu").on('itemclick', function (event) {
                                ...
                                switch (item) {
                                    case 'اضافة مركز تكلفة':
                                        newCostCenter(projectId);
                                        break;
                                    case 'حذف مركز تكلفة':
                                        
                                        break;
                                    case 'تعديل مركز تكلفة':
                ...
                function newCostCenter(id) {
                    $("#viewer").html('<img src="images/Loading2.gif"> loading ...');
                    $.ajax({
                        type: "POST",
                        success: function (msg) {
                            $('#viewer').html('<iframe src="<%=context%>/ProjectServlet?op=getNewCostCenterForm&projectId=' + id + '&type=tree" width="100%" height="500" scrolling="no"></iframe>');
                        }
                    });
                }
                ...
                <tr>
                    ...
                    <TD align style="width: 50px;border: 0px;">
                        <SELECT name='project' id='project' style='font-size:16px;height: 27px;width: 120px' onchange="getModels(this.value)">
                            <option value="1475660555820" style="color: blue;">الكل</option>
                            <%
