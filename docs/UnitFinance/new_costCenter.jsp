...
<html>
    ...
    <HEAD>
        ...
        <SCRIPT LANGUAGE="JavaScript" TYPE="text/javascript">
            ...
            function submitForm()
            {
                if (!validateData("req", document.ACCOUNT_FORM.accountName, "من فضلك ادخل اسم مركز التكلفة...")) {
                    $("#accountName").focus();
                  ...
                  //  alert(creditor);
                    ...
                    $.ajax({
                        type: "post",
                        url: "<%=context%>/ProjectServlet?op=saveNewCostCenter",
                        data: {
                            projectId: projectId,
    ...
    <body>
        ...
        <fieldset class="set" style="border-color: #006699; width: 99%">
            ...
            <FORM NAME="ACCOUNT_FORM" id="updateForm" METHOD="POST">
                ...
                <table dir="RTL" cellpadding="0" cellspacing="0" style="border-width: 0;margin-left: -20px">
                    <tr>
                        <td class="td">
                            <div style="text-align:center;width: 160px; display: inline-block" class="selver2">
                                <LABEL FOR="str_EQ_NO">
                                    <p style="margin-top: 5px"><b>اسم مركز التكلفة</b></p>
                                </LABEL>
                            </div>
                        </td>
                    ...
                    <tr>
                        <td class="td">
                            <div style="text-align:center;width: 160px; display: inline-block;m" class="selver2">
                                <LABEL FOR="str_EQ_NO">
                                    <p style="margin-top: 5px"><b>نوع مركز التكلفة</b></p>
                                </LABEL>
                            </div>
                        </td>
                    ...
                    <tr>
                        <td class="td">
                            <div style="text-align:center;width: 160px; display: inline-block;" class="selver2">
                                <LABEL FOR="str_EQ_NO">
                                    <p style="margin-top: 5px"><b>عملة مركز التكلفة</b></p>
                                </LABEL>
                            </div>
                        </td>
                        <td class="td">
                    ...
                    <tr>
                        <td class="td">
                            <div style="text-align:center;width: 160px; display: inline-block;" class="selver2">
                                <LABEL FOR="str_EQ_NO">
                                    <p style="margin-top: 5px"><b>تاريخ انشاء مركز التكلفة</b></p>
                                </LABEL>
                            </div>
                        </td>
