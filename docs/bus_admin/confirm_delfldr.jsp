...
<%
   String fldrId = (String) request.getAttribute("fldrId");
   String fldrTitle = (String) request.getAttribute("fldrTitle");
...
%>
   ...
   <HEAD>
      <TITLE>Document Viewer - Confirm Delete Account</TITLE>
   ...
   function submitForm()
   {    
      document.ISSUE_FORM.action = "<%=context%>/AccountServlet?op=Delete&fldrId=<%=fldrId%>";
      ...
      <left>
	    ...
	    <TR VALIGN="MIDDLE">
               ...
               <TD CLASS="tableright" colspan="3">
                  ...
                  <A HREF="<%=context%>/AccountServlet?op=ListAll">
            ...
            <TR>
                    <TD class='td'>
                        <LABEL FOR="ISSUE_TITLE">
                            <p><b><font color="#FF0000"><%=tGuide.getMessage("fldrwarning")%> </font></b>&nbsp;
                        </LABEL>
                    </TD>
                </TR>
              ...
              <TR>
               ...
               <TD class='td'>
                 <input disabled type="TEXT" name="userName" value="<%=fldrTitle%>" ID="<%=fldrTitle%>" size="33"  maxlength="50">
               </TD>
            </TR>

            <input  type="HIDDEN" name="fldrId" value="<%=fldrId%>">
