...
<HTML>
    <%
                ...
                String submit_button_label, save_button_label, arDescLable, enDescLable, codeLable, minAllowLable, maxAllowLable,
        ...
        <script LANGUAGE="JavaScript" TYPE="text/javascript">
            function submitForm()
            {
                ...
                }else
                {
                    ...
                    document.Measuerment_form.action = "<%=context%>/MeasurementsServlet?op=saveUpdateMeasurement";
                ...
                <table style="margin-bottom: 20px; margin-top: 20px" ALIGN="center"  dir="<%=dir%>" border="0" width="50%" cellpadding="4" cellspacing="2" >
                    <tr onmouseover="this.className = 'rowHilight'" onmouseout="this.className = ''">
                        ...
                        <td style="<%=style%>" class="td2 blackFont fontInput" id="CellData">
                            <input class="blackFont fontInput" type="TEXT" name="arDesc" ID="arDesc" size="33" value="<%=data.getAttribute("arDesc").toString()%>"  maxlength="20">
                            <input class="blackFont fontInput" type="hidden" name="id" ID="id" size="33" value="<%=data.getAttribute("id").toString()%>"  maxlength="20">
                        </td>
                    </tr>
                    <tr onmouseover="this.className = 'rowHilight'" onmouseout="this.className = ''">
                        ...
                        <td style="<%=style%>" class="td2 blackFont fontInput" id="CellData">
                            <input class="blackFont fontInput" type="TEXT" name="enDesc" ID="enDesc" size="33" value="<%=data.getAttribute("enDesc").toString()%>"  maxlength="20">
                        </td>
                    </tr>
                    <tr onmouseover="this.className = 'rowHilight'" onmouseout="this.className = ''">
                        ...
                        <td style="<%=style%>" class="td2 blackFont fontInput" id="CellData">
                            <input class="blackFont fontInput" type="TEXT" name="code" ID="code" size="33" value="<%=data.getAttribute("code").toString()%>"  maxlength="20">
                        </td>
                    </tr>
                    <tr onmouseover="this.className = 'rowHilight'" onmouseout="this.className = ''">
                            ...
                            <select style="width: 100%; height: 30px; font: 15px; font-weight: bold;" name="frequency" ID="frequency">
                                <%
                                            ...
                                            for (Entry<String, String> entry : frequency.entrySet()) {
                                                select = "";
                                                if (entry.getKey().equalsIgnoreCase(data.getAttribute("frequency").toString())) {
                                                    select = "selected";
                                                }
                                %>
                                <option <%=select%> value="<%=entry.getKey()%>"><%=entry.getValue()%></option>
                                <%}%>
                            </select>
                        </td>
                    </tr>
                    <tr onmouseover="this.className = 'rowHilight'" onmouseout="this.className = ''">
                        ...
                        <td style="<%=style%>" class="td2 blackFont fontInput" id="CellData">
                            <%
                                ...
                                String unitName = measurementUnitsMgr.getOnSingleKey(data.getAttribute("measurementUnitId").toString()).getAttribute(displayName).toString();
                            %>
                            <select name="measurementUnitId" id="measurementUnitId" style="width: 100%; height: 30px; font: 15px; font-weight: bold;">
                                <sw:WBOOptionList wboList='<%=measurementUnits%>' scrollTo="<%=unitName%>" displayAttribute="<%=displayName%>" valueAttribute="id"/>
                            </select>
                        </td>
                    </tr>
                    <tr onmouseover="this.className = 'rowHilight'" onmouseout="this.className = ''">
                        ...
                        <td style="<%=style%>" class="td2 blackFont fontInput" id="CellData">
                            <input class="blackFont fontInput" type="TEXT" name="minAllow" ID="minAllow" size="33" value="<%=data.getAttribute("minAllow").toString()%>"  maxlength="20">
                        </td>
                    </tr>
                    <tr onmouseover="this.className = 'rowHilight'" onmouseout="this.className = ''">
                        ...
                        <td style="<%=style%>" class="td2 blackFont fontInput" id="CellData">
                            <input class="blackFont fontInput" type="TEXT" name="maxAllow" ID="maxAllow" size="33" value="<%=data.getAttribute("maxAllow").toString()%>"  maxlength="20">
                        </td>
                    </tr>
                    <tr onmouseover="this.className = 'rowHilight'" onmouseout="this.className = ''">
                        ...
                        <td style="<%=style%>" class="td2 blackFont fontInput" id="CellData">
                            <input class="blackFont fontInput" type="TEXT" name="action_Taken_Before_Allow" ID="action_Taken_Before_Allow" size="33" value="<%=data.getAttribute("action_Taken_Before_Allow").toString()%>"  maxlength="20">
                        </td>
                    </tr>
                    <tr onmouseover="this.className = 'rowHilight'" onmouseout="this.className = ''">
                        ...
                        <td style="<%=style%>" class="td2 blackFont fontInput" id="CellData">
                            <input class="blackFont fontInput" type="TEXT" name="action_Taken_Above_Allow" ID="action_Taken_Above_Allow" size="33" value="<%=data.getAttribute("action_Taken_Above_Allow").toString()%>"  maxlength="20">
                        </td>
                    </tr>
                </table>
            </fieldset>
