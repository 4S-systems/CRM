...
WebBusinessObject wboMainCatName = new WebBusinessObject();
...
wboMainCatName = mainCategoryTypeMgr.getOnSingleKey(task.getAttribute("mainTypeId").toString());
...
String save_button_label,Jops,EstimatedHours,Houre,tradeName,taskType,Category,eng_Desc;
...
<TABLE DIR="<%=dir%>" ALIGN="<%=align%>" CELLPADDING="0" CELLSPACING="0" BORDER="0">
    <TR>
        ...
        <TD STYLE="<%=style%>" class='td'  WIDTH="33">
            <input readonly style="width:230px" name="categoryName" value="<%=wboMainCatName.getAttribute("typeName")%>" ID="categoryName" >
    ...
    <TR>
        ...
        <TD  STYLE="<%=style%>" class='td'>
            <input readonly style="width:230px" name="empTitle" value="<%=wboEmpTitle.getAttribute("name")%>" ID="empTitle" >
        </TD>
    </TR>
