...
<HTML>
    ...
    <SCRIPT LANGUAGE="JavaScript" TYPE="text/javascript">
        ...
        function submitForm()
        {
            if (!validateData("req", this.STATE_FORM.stateName, "Please, enter State Name.") || !validateData("minlength=3", this.STATE_FORM.stateName, "Please, enter a valid State Name.")){
                ...
                document.STATE_FORM.action = "<%=context%>/EqStateTypeServlet?op=SaveState";
    ...
    function clearValue(no){
     ...
     function cancelForm()
        {    
        document.STATE_FORM.action = "main.jsp";
        document.STATE_FORM.submit();  
        }
    </SCRIPT>
        ...
        if(status.equalsIgnoreCase("ok")){
            ...
            <TABLE align="<%=align%>" dir=<%=dir%> CELLPADDING="0" CELLSPACING="0" BORDER="0">
                ...
                <TR>
                    ...
                    <TD STYLE="<%=style%>" class='td'>
                        <input type="TEXT" style="width:230px" name="stateName" ID="stateName" size="33" value="" maxlength="255">
                    </TD>
                </TR>
                <TR>
                    <TD STYLE="<%=style%>" class='td'>
                    ...
                    <TD STYLE="<%=style%>" class='td'>
                        <textarea name="note" style="width:230px" ID="note" cols="27" rows="5" ></textarea>
                    </TD>
                </TR>
            </TABLE>
        </FORM>
