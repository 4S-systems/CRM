...
String[] failureAttributes = {"title"};
String[] failureListTitles =new String[4];

int s = failureAttributes.length;
int t = s+3;
int iTotal = 0;
...
Vector  failureList = (Vector) request.getAttribute("data");
...
if(stat.equals("En")){
    ...
    QS="Quick Summary";
    BO="Basic Operations";
    failureListTitles[0]="Failure Code Name";
    failureListTitles[1]="View";
    failureListTitles[2]="Edit";
    failureListTitles[3]="Delete";
    CD="Can't Delete Code";
    PN="Failure Code No.";
    PL="Failure Code List";
}else{
    ...
    QS="&#1605;&#1593;&#1604;&#1608;&#1605;&#1575;&#1578; &#1587;&#1585;&#1610;&#1593;&#1577;";
    BO="&#1593;&#1605;&#1604;&#1610;&#1575;&#1578; &#1571;&#1587;&#1575;&#1587;&#1610;&#1577;";
    failureListTitles[0]="&#1573;&#1587;&#1605; &#1603;&#1608;&#1583; &#1575;&#1604;&#1593;&#1591;&#1604;";
    failureListTitles[1]="&#1605;&#1588;&#1575;&#1607;&#1583;&#1607;";
    failureListTitles[2]="&#1578;&#1581;&#1585;&#1610;&#1585;";
    failureListTitles[3]="&#1581;&#1584;&#1601;";
    CD="&#1604;&#1575; &#1610;&#1605;&#1603;&#1606; &#1581;&#1584;&#1601; &#1575;&#1604;&#1603;&#1608;&#1583;";
    PN=" &#1593;&#1583;&#1583; &#1571;&#1603;&#1608;&#1575;&#1583; &#1575;&#1604;&#1571;&#1593;&#1591;&#1575;&#1604;";
    PL="&#1593;&#1585;&#1590; &#1571;&#1603;&#1608;&#1575;&#1583; &#1575;&#1604;&#1571;&#1593;&#1591;&#1575;&#1604;";
}
%>
...
<center> <b> <font size="3" color="red"> <%=PN%> : <%=failureList.size()%> </font></b></center> 
<br>
...
<TR >
    ...
    if(failureListTitles[i].equalsIgnoreCase("")){
    columnWidth = "1";
    columnColor = "black";
    font = "1";
    } else {
...
Enumeration e = failureList.elements();
...
<TD  CLASS="<%=bgColor%>"  BGCOLOR="#D7FF82" STYLE="<%=style%>">
    <DIV ID="links">
        <A HREF="<%=context%>/FailureCodeServlet?op=ViewFailure&failureId=<%=wbo.getAttribute("id")%>">
            <%=failureListTitles[1]%>
        </A>
    </DIV>
</TD>
...
<TD  CLASS="<%=bgColor%>"  BGCOLOR="#D7FF82" STYLE="<%=style%>">
    <DIV ID="links">
        <A HREF="<%=context%>/FailureCodeServlet?op=GetUpdateFailure&failureId=<%=wbo.getAttribute("id")%>">
            <%=failureListTitles[2]%>
        </A>
    </DIV>
</TD>
...
<%
if(failureCodeMgr.getActiveFailure(wbo.getAttribute("id").toString())||wbo.getAttribute("id").toString()=="1") {
...
<TD nowrap CLASS="<%=bgColor%>"  BGCOLOR="#D7FF82" STYLE="<%=style%>">
    <DIV ID="links">
        <A HREF="<%=context%>/FailureCodeServlet?op=ConfirmDeleteFailure&failureId=<%=wbo.getAttribute("id")%>&failureTitle=<%=wbo.getAttribute("title")%>">
            <%=failureListTitles[3]%>
        </A>
    </DIV>
</TD>
...
<TD WIDTH="20px" nowrap BGCOLOR="#FFE391" CLASS="<%=bgColor%>">
    <%
    if(failureCodeMgr.getActiveFailure(wbo.getAttribute("id").toString())) {
    %>
    <IMG SRC="images/active.jpg"  ALT="Active Failure Code by Schedule"> 
    ...
    <IMG SRC="images/nonactive.jpg"  ALT="Non Active Failure Code">
    <% } %>
</TD>        
