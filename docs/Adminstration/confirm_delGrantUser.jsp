...
<HTML>
    ...
    <%
    String grantId = (String) request.getAttribute("grantId");
    String grantName = (String) request.getAttribute("grantName");
   ...
   function submitForm()
   {    
      document.DEPARTMENT_DEL_FORM.action = "<%=context%>/GrantsServlet?op=Delete&grant_id=<%=grantId%>&grant_name=<%=grantName%>";
      document.DEPARTMENT_DEL_FORM.submit();  
   }
   
   function cancelForm()
        {    
        document.DEPARTMENT_DEL_FORM.action = "<%=context%>/GrantsServlet?op=ListGrants";
        document.DEPARTMENT_DEL_FORM.submit();  
        }
            ...
            <FORM NAME="DEPARTMENT_DEL_FORM" METHOD="POST">
                ...
                <TABLE ALIGN="<%=align%>" DIR="<%=dir%>" CELLPADDING="0" CELLSPACING="0" BORDER="0">
                    ...
                    <TR>
                        ...
                        <TD STYLE="<%=style%>" class='td'>
                            <input disabled type="TEXT" name="grant_name" value="<%=grantName%>" ID="grant_name" size="33"  maxlength="50">
                        </TD>
                    </TR>
