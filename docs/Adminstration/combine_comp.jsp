...
String message = null;
String lang, langCode, cancel, save, title, JOData, JONo, forEqp, task, complaint, entryTime,
        notes, add, delete, noComplaints, M, M2;
            ...
            <fieldset class="set" align="center">
                ...
                <TABLE ALIGN="<%=align%>" DIR="<%=dir%>" CELLPADDING="0" CELLSPACING="0" STYLE="border-width:1px;border-color:white;" ID="listTable">
                    ...
                    <TR>
                        ...
                        <TD bgcolor="lightblue" STYLE="text-align:center;font-size:14; border-width:1px">
                            <input type='checkbox' name='del<%=i%>' ID='del<%=i%>' value="<%=i%>" onclick="delcheck('<%=i%>')">
                        </TD>
                    </TR>
                    <%
                    }
