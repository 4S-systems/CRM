...
<HTML>
    ...
    String crew_name, crew_code, crew_typcalDuration, crew_description,Dupname,description,code;
    ...
    <SCRIPT LANGUAGE="JavaScript" TYPE="text/javascript">
        ...
        function submitForm()
        {
            if (!validateData("req", this.production_FORM.code, "Please, enter Code for production Line.") || !validateData("minlength=3", this.production_FORM.code, "Please, enter a valid Code.")){
                ...
                document.production_FORM.action = "<%=context%>/ProductionLineServlet?op=SaveProduction";
    ...
    function clearValue(no){
     ...
     function cancelForm()
        {    
        document.production_FORM.action = "main.jsp";
        document.production_FORM.submit();  
        }
    </SCRIPT>
        ...
        if(status.equalsIgnoreCase("ok")){
            ...
            <TABLE dir="<%=dir%>" align="<%=align%>" CELLPADDING="0" CELLSPACING="0" BORDER="0">
                ...
                <TR>
                    ...
                    <TD STYLE="<%=style%>" class='td'>
                        <TEXTAREA type="TEXT" style="width:230px" name="Desc" ID="Desc" ROWS="4" COLS="25" size="33" value="" maxlength="255"></textarea>
                    </TD>
                </TR>
