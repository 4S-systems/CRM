...
//
        String url = context + "/ScheduleServlet?op=SearchTables";

//paging
        Vector issueList = (Vector) request.getAttribute("data");
        int noOfLinks = 0;
        int count = 0;
        String[] projectAttributes = {"maintTitle","typeName"};
...
// get current date
        ...
        String task_subject;
        String saving_status, Dupname,Header,TotalCount;
        ...
        String code, department, taskType, orderDate, userName, service, altIm, po, account, develop, management,
                attachFile, sNotify, sAll, mailForNotify, fileTypeError, customerName, relationType, search;

        if (stat.equals("En")) {

            TotalCount="Total numbers of Tables = "+codes.size();
            Header="List Of Main Types Tables";
            projectListTitles[0]="Table Name";
            projectListTitles[1]="Main Type Name";
            ...
            TotalCount="&#1593;&#1583;&#1583; &#1575;&#1604;&#1580;&#1583;&#1575;&#1608;&#1604; &#1575;&#1604;&#1605;&#1578;&#1575;&#1581;&#1577; = "+codes.size();
            Header="&#1575;&#1604;&#1580;&#1583;&#1575;&#1608;&#1604; &#1575;&#1604;&#1605;&#1578;&#1575;&#1581;&#1577; &#1593;&#1604;&#1610; &#1580;&#1605;&#1610;&#1593; &#1575;&#1604;&#1575;&#1606;&#1608;&#1575;&#1593; &#1575;&#1604;&#1575;&#1587;&#1575;&#1587;&#1610;&#1577;";
            projectListTitles[0]="&#1575;&#1587;&#1605; &#1575;&#1604;&#1580;&#1583;&#1608;&#1604;";
            projectListTitles[1]="&#1575;&#1604;&#1606;&#1608;&#1593; &#1575;&#1604;&#1575;&#1587;&#1575;&#1587;&#1610;";
...
<legend align="center">
    <table dir="<%=dir%>" align="<%=align%>">
        <tr>
            ...
            <td class="td">
                <font color="blue" size="6"><%=Header%></font>
            </td>
        </tr>
    </table>
</legend>
...
%>
                ...
                <% }%>
<TR CLASS="header" >
    <TD nowrap CLASS="header" bgcolor="<%=columnColor%>" STYLE="border-WIDTH:0;<%=style%>;padding-justify:140;font-size:16;color:white;height:30;" nowrap>
                        <B><%=TotalCount%></B>
    </TD>
    <TD nowrap CLASS="header" bgcolor="<%=columnColor%>" STYLE="border-WIDTH:0;<%=style%>;padding-right:100;font-size:16;color:white;height:30;" nowrap>
