...
<HTML>
 ...
 <SCRIPT LANGUAGE="JavaScript" TYPE="text/javascript">
        function cancelForm()
        {    
        document.PROJECT_VIEW_FORM.action = "<%=context%>//ItemsServlet?op=ListCategory";
        ...
        <FORM NAME="PROJECT_VIEW_FORM" METHOD="POST">
            ...
            <TABLE align="<%=align%>" dir=<%=dir%> CELLPADDING="0" CELLSPACING="0" BORDER="0">
                ...
                <TR>
                    ...
                    <TD STYLE="<%=style%>" class='td'>
                        <input style="width:230px" disabled type="TEXT" name="categoryName" ID="categoryName" size="33" value="<%=category.getAttribute("categoryName")%>" maxlength="255">
                    </TD>
                </TR>
                <!--
                <TR>
          ...
          -->
                <TR>
                    ...
                    <TD STYLE="<%=style%>" class='td'>
                        <TEXTAREA style="width:230px" DISABLED  rows="5" name="catDsc" ID="catDsc" cols="25"><%=category.getAttribute("catDsc")%></TEXTAREA>
                        <!--
                        <input disabled type="TEXT" name="catDsc" ID="catDsc" size="33" value="<%//=category.getAttribute("catDsc")%>" maxlength="255">
                    -->
                    </TD>
                </TR>
            </TABLE>
