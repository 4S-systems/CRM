...
<HTML>
    ...
    if(stat.equals("En")){
        ...
        title_1="Add a supplier to a spare part";
    ...
    <SCRIPT LANGUAGE="JavaScript" TYPE="text/javascript">
        ...
        function submitForm()
        {  
        if (this.ITEM_FORM.supplierID.value ==""){
        alert ("Enter Category Name");
        this.ITEM_FORM.supplierID.focus();
    } else if (this.ITEM_FORM.partNO.value ==""){
        ...
        document.ITEM_FORM.action = "<%=context%>/SupplierServlet?op=SaveItemSupplier&pIndex=<%=pIndex%>";
    ...
    <BODY>
        ...
        if(status.equalsIgnoreCase("ok")){
            ...
            <TABLE align="<%=align%>" dir=<%=dir%> CELLPADDING="0" CELLSPACING="0" BORDER="0">
                ...
                arrayList = supplierMgr.getCashedTableAsBusObjects();
                %>
                ...
                <TR>
                    ...
                    <TD STYLE="<%=style%>" class='td'>
                        <SELECT name="supplierID" ID="supplierID">
                            <sw:WBOOptionList wboList='<%=arrayList%>' valueAttribute="id" displayAttribute="name" scrollTo = ""/>
                        </SELECT>
                    </TD>
                ...
                <TR>
                    ...
                    <TD STYLE="<%=style%>" class='td'>
                        <input type="TEXT" name="partNO" ID="partNO" size="33" value="" maxlength="255">
                    </TD>
                ...
                <TR>
                    ...
                    <TD STYLE="<%=style%>" class='td'>
                        <input type="TEXT" CLASS="shaded" name="unitPrice" ID="unitPrice" size="33" value="" maxlength="255">
                    </TD>
                </TR>
