...
String isDefault,sGrantUser,sSelectAll,filterQuery,sFullName,changeGroup;
...
//                        if(checkGrant() == true){
                ...
                document.USERS_FORM.action = "<%=context%>/UsersServlet?op=saveGroups";
                ...
                <legend align="center">
                    <table align="<%=align%>" dir=<%=dir%>>
                        <tr>
                            ...
                            <td class="td">
                                <font color="blue" size="6">    <%=changeGroup%>                
                                </font>
