...
<HTML>
    ...
    <%
                ...
                if (stat.equals("En")) {
                    ...
                    unit_name = "Unit name";
                    title_1 = "Delete Unit - Are You Sure? ";
                    ...
                    title_1 = "&#1581;&#1584;&#1601; &#1608;&#1581;&#1583;&#1577; &#1575;&#1604;&#1602;&#1610;&#1575;&#1587; - &#1607;&#1604; &#1571;&#1606;&#1578; &#1605;&#1578;&#1571;&#1603;&#1583;&#1567;";
    ...
    <MEeTA HTTP-EQUIV="Expires" CONTENT="0">
        ...
        <SCRIPT LANGUAGE="JavaScript" TYPE="text/javascript">
            ...
            function submitForm()
            {
                document.PROJECT_DEL_FORM.action = "<%=context%>/MeasurementUnitsServlet?op=deleteMeasureUnit&unitID=<%=unitID%>&unitName=<%=unitName%>";
                document.PROJECT_DEL_FORM.submit();
            }
            function cancelForm()
            {
                document.PROJECT_DEL_FORM.action = "<%=context%>/MeasurementUnitsServlet?op=ListMeasuerUnits";
                document.PROJECT_DEL_FORM.submit();
            }
        </SCRIPT>
