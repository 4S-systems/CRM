...
<HTML>
    ...
    //AppConstants appCons = new AppConstants();
        ...
        String[] taskAttributes = {"title", "name", "trade"};
    ...
    <script language="javascript" type="text/javascript">
        ...
        function cancelForm()
        {    
            document.ITEM_FORM.action = "<%=context%>/TaskServlet?op=tasksByTrade";
    ...
    <body>
        ...
        <FORM NAME="ITEM_FORM" METHOD="POST">
            ...
            <fieldset align=center class="set">
                ...
                <center> <b> <font size="3" color="red"> <%=Category%> : <font color="green"><%=tradeName%> </font></font></b></center> 
                <br>
                ...
                <TABLE ALIGN="<%=align%>" dir="<%=dir%>" WIDTH="400" CELLPADDING="0" CELLSPACING="0" STYLE="border-right-WIDTH:1px;">
                    ...
                    <TR>
                        <TD CLASS="silver_footer" BGCOLOR="#808080"colspan="2"  STYLE="<%=style%>;padding-right:5;border-right-width:1;font-size:14;">
                            <B><%=PN%></B>
                        </TD>
