...
<HTML>
    ...
    String[] stateAttributes = {"name"};
    String[] stateListTitles =new String[4];
    
    int s = stateAttributes.length;
    int t = s+3;
    int iTotal = 0;
    ...
    Vector  statesList = (Vector) request.getAttribute("data");
    ...
    if(stat.equals("En")){
        ...
        QS="Quick Summary";
        BO="Basic Operations";
        stateListTitles[0]="Status Name";
        stateListTitles[1]="View";
        stateListTitles[2]="Edit";
        stateListTitles[3]="Delete";
        CD="Can't Delete Site";
        PN="Equipment Status No.";
        PL="Equipment Status List";
    }else{
        ...
        QS="&#1605;&#1593;&#1604;&#1608;&#1605;&#1575;&#1578; &#1587;&#1585;&#1610;&#1593;&#1577;";
        BO="&#1593;&#1605;&#1604;&#1610;&#1575;&#1578; &#1571;&#1587;&#1575;&#1587;&#1610;&#1577;";
        stateListTitles[0]="&#1573;&#1587;&#1605; &#1575;&#1604;&#1581;&#1575;&#1604;&#1607;";
        stateListTitles[1]="&#1605;&#1588;&#1575;&#1607;&#1583;&#1607;";
        stateListTitles[2]="&#1578;&#1581;&#1585;&#1610;&#1585;";
        stateListTitles[3]="&#1581;&#1584;&#1601;";
        CD=" &#1604;&#1575; &#1578;&#1587;&#1578;&#1591;&#1610;&#1593; &#1581;&#1584;&#1601; &#1575;&#1604;&#1605;&#1608;&#1602;&#1593;";
        PN=" &#1593;&#1583;&#1583; &#1575;&#1604;&#1581;&#1575;&#1604;&#1575;&#1578;";
        PL=" &#1593;&#1585;&#1590; &#1575;&#1606;&#1608;&#1575;&#1593; &#1581;&#1575;&#1604;&#1575;&#1578; &#1575;&#1604;&#1605;&#1593;&#1583;&#1575;&#1578;";
    }
    ...
    <body>
        ...
        <fieldset align=center class="set">
            ...
            <center> <b> <font size="3" color="red"> <%=PN%> : <%=statesList.size()%> </font></b></center> 
            <br>
            <TABLE ALIGN="<%=align%>" dir="<%=dir%>" WIDTH="400" CELLPADDING="0" CELLSPACING="0" STYLE="border-right-WIDTH:1px;">
                ...
                <TR CLASS="head">
                    ...
                    if(stateListTitles[i].equalsIgnoreCase("")){
                    columnWidth = "1";
                    columnColor = "black";
                    font = "1";
                    } else {
                ...
                Enumeration e = statesList.elements();
                ...
                <TR bgcolor="<%=bgColor%>">
                    ...
                    <TD nowrap CLASS="cell" BGCOLOR="#D7FF82" STYLE="<%=style%>">
                        <DIV ID="links">
                            <A HREF="<%=context%>/EqStateTypeServlet?op=ViewStateType&stateID=<%=wbo.getAttribute("id")%>">
                                <%=stateListTitles[1]%>
                            </A>
                        </DIV>
                    </TD>
                    ...
                    <TD nowrap CLASS="cell" BGCOLOR="#D7FF82" STYLE="<%=style%>">
                        <DIV ID="links">
                            <A HREF="<%=context%>/EqStateTypeServlet?op=GetUpdateStateForm&stateID=<%=wbo.getAttribute("id")%>">
                                <%=stateListTitles[2]%>
                            </A>
                        </DIV>
                    </TD>
                    ...
                    <TD nowrap CLASS="cell" BGCOLOR="#D7FF82" STYLE="<%=style%>">
                        <DIV ID="links">
                            <A HREF="<%=context%>/EqStateTypeServlet?op=ConfirmStateDelete&stateID=<%=wbo.getAttribute("id")%>&stateName=<%=wbo.getAttribute("name")%>">
                                <%=stateListTitles[3]%>
                            </A>
                        </DIV>
                    </TD>
