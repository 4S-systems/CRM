...
<HTML>
    ...
    <%
                ...
                String tasksWithoutItems, tasksWithItems;
                if (stat.equals("En")) {
                    ...
                    lang = "   &#1593;&#1585;&#1576;&#1610;    ";
                    title_1 = "Maintenance Tasks Items Review";
                    ...
                    searchTitleName = "Maintenance Tasks Items Review";
                    ...
                    dateFrom = " From ";
                    dateTo = " To ";
                    tasksWithoutItems         = "Maintenance Tasks WithOut Items";
                    tasksWithItems            = "Maintenance Tasks With Items";
                    ...
                    lang = "English";
                    title_1 = "بنود الصيانة وقطع الغيار";
                    ...
                    searchTitleName = "بنود الصيانة وقطع الغيار";
                    ...
                    dateFrom = " من ";
                    dateTo = " الى ";
                    tasksWithoutItems         = "تقرير بنود الصانة بدون قطع غيار";
                    tasksWithItems            = " تقرير بنود الصيانة الموجود عليها قطع غيار";
                }
    ...
    <script>
        ...
        <%--------------Popup window-------------------%>
           ...
           {
               //var formName = document.getElementById('SEARCH_FORM').getAttribute("name");
               document.SEARCH_FORM.action="PDFReportServlet?op=tasksWithItems";
                                    ...
                                    <table align="<%=align%>" border="0" dir="<%=dir%>" width="100%" cellspacing="2">
                                        <tr>
                                            <td CLASS="tRow" bgcolor="white" STYLE="text-align:center;">
                                                <a id="mainLink" href="<%=context%>/PDFReportServlet?op=tasksWithoutItems&type=item" onmouseover="Tip('<%=tasksWithoutItems%>',CENTERMOUSE, true, OFFSETX, 0, BGCOLOR, '#ffff99' , FONTCOLOR, 'BLACK', FONTSIZE, '10pt', FONTWEIGHT ,'BOLD', SHADOW, true, SHADOWWIDTH, 7,TEXTALIGN ,'CENTER', TITLE ,'<%=tasksWithoutItems%>',TITLEALIGN ,'center' ,TITLEFONTCOLOR ,'White', TITLEBGCOLOR ,'#FF9900')"  onmouseout="UnTip()"><%=tasksWithoutItems%></a>
                                            </td>
                                            <td CLASS="tRow" bgcolor="white" STYLE="text-align:center;">
                                                        <a id="mainLink" href="<%=context%>/PDFReportServlet?op=tasksWithItems&type=item" onmouseover="Tip('<%=tasksWithItems%>',CENTERMOUSE, true, OFFSETX, 0, BGCOLOR, '#ffff99' , FONTCOLOR, 'BLACK', FONTSIZE, '10pt', FONTWEIGHT ,'BOLD', SHADOW, true, SHADOWWIDTH, 7,TEXTALIGN ,'CENTER', TITLE ,'<%=tasksWithItems%>',TITLEALIGN ,'center' ,TITLEFONTCOLOR ,'White', TITLEBGCOLOR ,'#FF9900')"  onmouseout="UnTip()"><%=tasksWithItems%></a>
                                            </td>
                                        </tr>
                                    </table>
                                </div>
