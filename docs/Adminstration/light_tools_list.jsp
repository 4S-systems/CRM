...
<HTML>
    ...
    String dir=null;
    String style=null;
    String lang,langCode,cancel,toolName,toolCode,selectTool,viewEq,toolNum,totalNum;
    ...
    <BODY>
        <FORM NAME="tool_form" METHOD="POST">
            ...
            <table align="center">
                <tr>
                    <td class="td" >
                        ...
                        <input type="hidden" name="unitName" id="unitName" value="<%=toolName%>">
                    </td>
                    <td class="td"  >
            ...
            <TABLE ALIGN="CENTER" dir="<%=dir%>" WIDTH="600" CELLPADDING="0" CELLSPACING="0" STYLE="border-style:solid;border-width:2;border-color:black;border-right-WIDTH:2px;">
                ...
                <%
                String toolId,toolName2,toolCode2;
                int iTotal=0;
                ...
                while(e.hasMoreElements()) {
                    ...
                    toolId = wbo.getAttribute("id").toString();
                    toolName2 = wbo.getAttribute("toolName").toString();
                    toolCode2 = wbo.getAttribute("toolCode").toString();
                ...
                <TR>
                    ...
                    <TD  STYLE="<%=style%>;padding-right:40;height:20;" nowrap  CLASS="<%=classStyle%>" BGCOLOR="#DDDD00">
                        <input type="checkbox" name="tool" id="tool" value="<%=toolId%>!#<%=toolCode2%>!#<%=toolName2%>">
                        <input type='hidden' name='id' ID='id' value="<%=toolId%>">
                    </TD>
                    
                    <TD  STYLE="<%=style%>;padding-right:40;height:20;" nowrap  CLASS="<%=classStyle%>" BGCOLOR="#DDDD00">
                        <b style="text-decoration: none"><font color="black" size="3"> <%=toolName2%></font> </b> 
                    </TD>
                    
                    <TD  STYLE="<%=style%>;padding-right:40;height:20;" nowrap  CLASS="<%=classStyle%>" BGCOLOR="#DDDD00">
                        <b style="text-decoration: none"><font color="black" size="3"> <%=toolCode2%></font> </b> 
                    </TD>
                </tr>
                <% }%>
            </TABLE>
            
            <TABLE ALIGN="CENTER" dir="<%=dir%>" WIDTH="600" CELLPADDING="0" CELLSPACING="0" STYLE="border-style:solid;border-width:2;border-color:white;border-right-WIDTH:2px;">
                <TR>
