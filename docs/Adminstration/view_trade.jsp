...
<HTML>
    ...
    <script language="javascript" type="text/javascript" >
         ...
         function cancelForm()
        {    
        document.PROJECT_VIEW_FORM.action = "<%=context%>//TradeServlet?op=ListTrades";
            ...
            <table ALIGN="<%=align%>" DIR="<%=dir%>" >
                <TR>
                    ...
                    <TD STYLE="<%=style%>" class='td'>
                        <input disabled type="TEXT" STYLE="width:230px" name="tradeName" ID="tradeName" size="33" value="<%=tradeWbo.getAttribute("tradeName")%>" maxlength="255">
                    </TD>
                </TR>
                ...
                <TR>
                    ...
                    <TD STYLE="<%=style%>" class='td'>
                        <input disabled type="TEXT" STYLE="width:230px" name="tradeNO" ID="tradeNO" size="33" value="<%=tradeWbo.getAttribute("tradeCode")%>" maxlength="255">
                    </TD>
                </TR>
