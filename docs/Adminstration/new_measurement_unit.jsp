...
<html>
    <%
                ...
                String save_button_label, name_ar, name_en, unit_system, unitbase;
                if (stat.equals("En")) {
    ...
    <script LANGUAGE="JavaScript" TYPE="text/javascript">
        ...
        function submitForm()
        {
            ...
            {
                document.MeasuermentUnit_form.action = "<%=context%>/MeasurementUnitsServlet?op=SaveMeasuerUnit";
                ...
                <table style="margin-bottom: 20px; margin-top: 20px" ALIGN="center"  dir="<%=dir%>" border="0" width="50%" cellpadding="4" cellspacing="2" >
                    ...
                    <tr onmouseover="this.className = 'rowHilight'" onmouseout="this.className = ''">
                        ...
                        <td style="<%=style%>" class="td2 blackFont fontInput" id="CellData">
                            <input class="blackFont fontInput" type="TEXT" name="unitbase" ID="unitbase" size="33" value=""  maxlength="20">
                        </td>
                    </tr>
                    <tr onmouseover="this.className = 'rowHilight'" onmouseout="this.className = ''">
                        ...
                        <td style="<%=style%>" class="td2 blackFont fontInput" id="CellData">
                            <input class="blackFont fontInput" type="TEXT" name="arabicname" ID="arabicname" size="33" value=""  maxlength="20">
                        </td>
                    </tr>
                    <tr onmouseover="this.className = 'rowHilight'" onmouseout="this.className = ''">
                        ...
                        <td style="<%=style%>" class="td2 blackFont fontInput" id="CellData">
                            <input class="blackFont fontInput" type="TEXT" name="englishname" ID="englishname" size="33" value=""  maxlength="20">
                        </td>
                    </tr>
                    <tr onmouseover="this.className = 'rowHilight'" onmouseout="this.className = ''">
                        ...
                        <td style="<%=style%>" class="td2 blackFont fontInput" id="CellData">
                            <input class="blackFont fontInput" type="TEXT" name="unitsystem" ID="unitsystem" size="33" value=""  maxlength="20">
                        </td>
                    </tr>
                </table>
            </fieldset>
