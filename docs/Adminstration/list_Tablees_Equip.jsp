...
//
        String url = context + "/ScheduleServlet?op=SearchEquipTables";

//paging
        Vector issueList = (Vector) request.getAttribute("data");
        int totalTables =Integer.parseInt((String)request.getAttribute("TotalTables"));
        int noOfLinks = 0;
        int count = 0;
        String[] projectAttributes = {"maintenanceTitle"};
        String[] projectListTitles = new String[1];
        ...
        String bgColor = null,listOfTables;
        int flipper = 0;
// get current date
        ...
        if (stat.equals("En")) {
            TotalTablesMsg="Total Numbers Of Tables is "+totalTables;
            noTables="No Tables For This Equipment";
            listOfTables="List Of Tables";
            projectListTitles[0]="Unit Name";
            ...
            TotalTablesMsg="&#1593;&#1583;&#1583; &#1575;&#1604;&#1580;&#1583;&#1575;&#1608;&#1604; &#1575;&#1604;&#1605;&#1578;&#1575;&#1581;&#1577; &#1604;&#1607;&#1584;&#1577; &#1575;&#1604;&#1605;&#1593;&#1583;&#1577; = " +totalTables;
            noTables="&#1604;&#1575; &#1578;&#1608;&#1580;&#1583; &#1580;&#1583;&#1575;&#1608;&#1604; &#1604;&#1607;&#1584;&#1577; &#1575;&#1604;&#1605;&#1593;&#1583;&#1577;";
            listOfTables="&#1575;&#1604;&#1580;&#1583;&#1575;&#1608;&#1604; &#1575;&#1604;&#1605;&#1578;&#1575;&#1581;&#1577; &#1604;&#1604;&#1605;&#1593;&#1583;&#1577;";
...
<legend align="center">
    <table dir="<%=dir%>" align="<%=align%>">
        <tr>
            <td class="td">
                <font color="blue" size="6"><%=listOfTables%></font>
            </td>
        </tr>
        <BR>
</legend>
...
<% 
                    ...
                    %>
                    <TD nowrap CLASS="header" bgcolor="<%=columnColor%>" STYLE="border-WIDTH:0;<%=style%>;padding-right:170;font-size:16;color:white;height:30;" nowrap>
...
%>
                <TR>
                    ...
                    <TD  STYLE="<%=style%>;padding-right:120;height:20;" nowrap  CLASS="<%=classStyle%>" BGCOLOR="#DDDD00">

                        <b style="text-decoration: none"> <font color="black" size="3"> <%=attValue%> </font> </b>
                    </TD>
                ...
                <% } }%>
  <TR CLASS="header" >
          <TD NOWRAP CLASS="header" bgcolor="#9B9B00" STYLE="border-WIDTH:0;<%=style%>;padding-right:110;font-size:16;color:white;height:30;" nowrap>
                        <B><%=TotalTablesMsg%></B>
          </TD>
     </TR>
</TABLE>
