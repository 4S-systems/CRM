...
%>
   ...
   function submitForm()
   {    
      document.MILESTONE_DEL_FORM.action = "<%=context%>/MilestoneServlet?op=Delete&milestoneId=<%=milestoneId%>&milestoneName=<%=milestoneName%>";
      document.MILESTONE_DEL_FORM.submit();  
   }
   ...
   <BODY>
      <left>
        ...
        <FORM NAME="MILESTONE_DEL_FORM" METHOD="POST">
	    ...
	    <TR VALIGN="MIDDLE">
               <TD COLSPAN="2" CLASS="tabletitle" STYLE="border-left-WIDTH: 1;text-align:left;">
                  <%=tGuide.getMessage("deletemilestone")%> - <%=tGuide.getMessage("areyousure")%>
               </TD>
               ...
               <TD CLASS="tableright" colspan="3">
                  ...
                  <A HREF="JavaScript: submitForm();">
                     <%=tGuide.getMessage("deletemilestone")%>
                  </A>
               </TD>
            </TR>
         </TABLE>
              ...
              <TR>
               <TD class='td'>
                  <LABEL FOR="ISSUE_TITLE">
                       <p><b><%=tGuide.getMessage("milestonename")%><font color="#FF0000"> </font></b>&nbsp;
                    </LABEL>
               </TD>
               <TD class='td'>
                 <input disabled type="TEXT" name="milestoneName" value="<%=milestoneName%>" ID="<%=milestoneName%>" size="33"  maxlength="50">
               </TD>
            </TR>
