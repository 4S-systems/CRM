    ...
    <SCRIPT LANGUAGE="JavaScript" TYPE="text/javascript">
        ...
        function submitForm()
        {
           ...
           //     this.ITEM_FORM.executionHrs.focus();
                ...
                document.ITEM_FORM.action = "<%=context%>/TaskServlet?op=saveTaskMain";
                ...
                <tr>
                    ...
                    <TD STYLE="<%=style%>"  class='td'>
                        <table ALIGN="<%=align%>" DIR="<%=dir%>">
                            ...
                            <% } else { %>
                            <tr>
                            <td width="5%"><input style="width:20px;" type="text" name="minute" id="minute" maxlength="2" ONBLUR="IsNumeric(this.id);"></td>
                            <td width="5%"><input style="width:20px;" type="text" name="hour" id="hour" maxlength="2" ONBLUR="IsNumeric(this.id);"></td>
                            <td width="5%"><input style="width:20px;" type="text" name="day" id="day" maxlength="2" ONBLUR="IsNumeric(this.id);"></td>
                            </tr>
                            <% } %>
                        </table>
                    </TD>
