    ...
    <body>
        ...
        <FORM NAME="Equipment_FORM" METHOD="POST">
            ...
            <fieldset align="center" class="set" style="width:80%">
                <br>     
                <table class="table_style" border="0" width="500" align="center" id="table1" dir="<%=dir%>">
                    <tr>
                        <td width="50%" colspan="2" style="text-align:center;border-width:0px;">
                            <img border="0" src="images/<%=logos.get("taskSheet")%>" width="356" height="57">
                        </td>
                        
                        <td width="50%" colspan="2" style="text-align:center;border-width:0px;">
                            <img border="0" src="images/<%=logos.get("comLogo1")%>" width="270" height="120">
                        </td>
                    </tr>
                    
                    <tr>
                        <td colspan="4" class="td">
                            <hr width="100%" style="color:blue;size:2;">
                            <br>
                        </td>    
                    </tr>
                    
                    <tr>
                        <td colspan="4" class="header" bgcolor="#FFFFFF">
                            <p align="center"><b>                                
                                    <font size="5">  <%=title%>:</font>
                                    <br>
                                    <font size="4"><%=taskWbo.getAttribute("title").toString()%></font>
                                </b>
                            </p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td width="25%" class="tRow"  bgcolor="#CCCCCC" style="align:left;font-size:14;<%=padding%>0.75cm">
                            <b>
                                <%=taskName%>
                            </b>
                        </td>
                    ...
                    <tr>
                        ...
                        <td width="25%" class="tRow"  bgcolor="#CCCCCC" style="<%=style%>;font-size:14;<%=padding%>0.75cm">
                            <b>
                                <%=trade%>  
                            </b>
                        </td>
         ...
         <td  class="tRow" bgcolor="#CCCCCC" style="<%=style%>;font-size:14;<%=padding%>0.75cm">
            <LABEL FOR="str_Function_Desc">
               <b> <%=EstimatedHours%><font color="#FF0000">*</font></b>&nbsp;
            </LABEL>
        </TD>
        <td>
            <table class="table_style" DIR="<%=dir%>">
                            <tr>
                ...
                <table class="table_style" border="0" dir="<%=dir%>" align="center" width="70%">
                    <tr >
