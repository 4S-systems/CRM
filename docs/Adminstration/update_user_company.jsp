...
<%
    ...
    companies = (ArrayList) request.getAttribute("companies");
    ...
    if (stat.equals("En")) {
        ...
        saving_status_repeated = "This User is Associated to a company";
        ...
        saving_status_repeated  = "هذا المستخدم مرتبط بشركة اخري";
        isDefault = "&#1573;&#1601;&#1578;&#1585;&#1575;&#1590;&#1609;";
...
<HTML>
    ...
    <SCRIPT LANGUAGE="JavaScript" TYPE="text/javascript">
        ...
        function submitForm()
        {
            document.USERS_FORM.action = "<%=context%>/UsersServlet?op=saveCompany";
            ...
            <fieldset class="set" align="center">
                ...
                <TABLE CELLPADDING="0" CELLSPACING="0" BORDER="0" ALIGN="CENTER" DIR="<%=dir%>">
                    <TR>
                        ...
                        <TD class="td">
                            <div align="<%=divAlign%>">
                                <SELECT name="company" ID="company" STYLE="width:255px">
                                    <option value="0"><%=noCompany%></OPTION>>
                                    <sw:WBOOptionList wboList='<%=companies%>' displayAttribute = "projectName" valueAttribute="projectID" scrollTo=""/>
                                </SELECT>
                            </div>
                        </TD>
                    </TR>  
