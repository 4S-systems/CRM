...
<HTML>
    ...
    <%
        ...
        String AddCode, AddName, itemCode, name, price, count, cost, Mynote, del, updateParts, classGroup, totalCost, setupStoreNote, storeAva, select, notFoundItemForm;
    ...
    <SCRIPT LANGUAGE="JavaScript" TYPE="text/javascript">
        ...
        function submitForm() {
            ...
            if(document.getElementsByName('check').length>0){
                if(checkQuantity()) {
                    document.ITEM_FORM.action = "<%=context%>/TaskServlet?op=saveItemParts&taskId=<%=taskId%>";
            ...
            <CENTER>
                <FIELDSET class="set" STYLE="width:95%;border-color: #006699;" >
                    <TABLE class="blueBorder" dir="<%=dir%>" align="center" width="100%" cellpadding="0" cellspacing="0" >
                        <TR>
                            <TD STYLE="text-align:center;border-color: #006699;" width="100%" class="blueBorder blueHeaderTD">
                                <font color="#F3D596" size="4"><%=updateParts%>&ensp;<font color="white" size="4">-</font>&ensp;<%=title_2%></font>
                            </TD>
                        </TR>
                    </TABLE>
                    <% if(!status.equals("")) { %>
                    ...
                    <TR>
                        ...
                        <TD CLASS="blueBorder blackFont">
                            <input type="text" name="name1" id="name1" style="width: 100%;font-size: 12px;color: black;text-align: center" value="<%=taskPartWbo.getAttribute("itemName")%>" />
                        </TD>
                        <TD CLASS="blueBorder blackFont">
