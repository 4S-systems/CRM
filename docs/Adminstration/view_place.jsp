...
<HTML>
    ...
    <BODY>
        <left>
        <FORM NAME="PLACE_VIEW_FORM" METHOD="POST">
            ...
            <TABLE CELLPADDING="0" CELLSPACING="0" BORDER="0">
                ...
                <TR>
                    ...
                    <TD class='td'>
                        <TEXTAREA DISABLED rows="5" name="place_desc" cols="25"><%=place.getAttribute("placeDesc")%></TEXTAREA>
                    </TD>
                </TR>
            </TABLE>
        </FORM>
