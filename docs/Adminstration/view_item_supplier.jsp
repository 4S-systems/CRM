...
if(stat.equals("En")){
    ...
    title_1="View supplier of a spare part";
    ...
    title_1="&#1605;&#1588;&#1575;&#1607;&#1583;&#1577; &#1605;&#1608;&#1585;&#1583; &#1602;&#1591;&#1593; &#1575;&#1575;&#1604;&#1594;&#1610;&#1575;&#1585; ";
    ...
    <SCRIPT LANGUAGE="JavaScript" TYPE="text/javascript">
        ...
        document.ITEM_FORM.action = "<%=context%>/SupplierServlet?op=SaveItemSupplier";
        ...
        <FORM NAME="ITEM_FORM" METHOD="POST">
            ...
            <TABLE align="<%=align%>" dir=<%=dir%> CELLPADDING="0" CELLSPACING="0" BORDER="0">
                ...
                <TR>
                    ...
                    <TD STYLE="<%=style%>" class='td'>
                        <input disabled type="TEXT" name="partNO" ID="partNO" size="33" value="<%=supplierItem.getAttribute("partNO").toString()%>" maxlength="255">
                    </TD>
                ...
                <TR>
                    ...
                    <TD STYLE="<%=style%>" class='td'>
                        <input disabled type="TEXT" CLASS="shaded" name="unitPrice" ID="unitPrice" size="33" value="<%=supplierItem.getAttribute("unitPrice").toString()%>" maxlength="255">
                    </TD>
                </TR>
