...
<html>
    <%
        ...
        ArrayList<LiteWebBusinessObject> educationList = (ArrayList<LiteWebBusinessObject>) request.getAttribute("educationList");
        LiteWebBusinessObject EmployeeWbo = (LiteWebBusinessObject) request.getAttribute("EmployeeWbo");
        ArrayList<WebBusinessObject> educaionTypes = EmployeeTypeMgr.getInstance().getOnArbitraryKey2("4", "key3");
                    ...
                    <table  border="0px"  style="width:100%;"  class="table">
                        <tr>
                            ...
                            <td style="width: 80%; text-align: right;" colspan="3">
                                <input type="text" style="float: right; border: 1px solid silver;border-radius: 5px;height: 20px;padding-left: 10px; width: 90%;" ID="education" name="value" value="" required />
                ...
                <table  border="0px" dir="<%=dir%>" class="table" style="width:90%;text-align: right;margin-bottom: 10px !important;margin-left: auto;margin-right: auto;" >
                    <tr>
                        <td class="td titleTD" style="width: 50%; padding-left: 20px;">
                            المؤهلات الدراسية
                            <img src="images/icons/department.png" style="width: 30px;float: left; cursor: pointer;"
                                 onclick="JavaScript: showAddEducation();"/>
                        </td>
                    </tr>
                    <tr>
                            ...
                            <table width="100%">
                                <%
                                    if (educationList != null && educationList.size() > 0) {
                                        for (LiteWebBusinessObject email : educationList) {
                                %>
                                <tr>
