...
<HTML>
    ...
    if(stat.equals("En")){
        ...
        lang="   &#1593;&#1585;&#1576;&#1610;    ";
        title_1="Add Light Tools On Maintenance Item";
        ...
        lang="English";
        title_1="&#1573;&#1590;&#1575;&#1601;&#1607; &#1571;&#1583;&#1608;&#1575;&#1578; &#1582;&#1601;&#1610;&#1601;&#1607; &#1604;&#1576;&#1606;&#1583; &#1575;&#1604;&#1589;&#1610;&#1575;&#1606;&#1607;";
    ...
    <HEAD>
        ...
        function submitForm()
        {
             ...
             if(count>0){
                checkNotes();
                document.ITEM_FORM.action = "<%=context%>/TaskServlet?op=saveTaskTools&toolType=light&taskId="+<%=taskWbo.getAttribute("id").toString()%>;
        ...
        function getTools()
            {
                ...
                count=document.getElementById('nRows').value;
                openWindowTools('TaskServlet?op=listLightTools&searchType=name&toolName='+res+'&formName='+formName+'&numRows='+count);
            }
        function getToolsByCode()
            {
                ...
                res = res.substr(0, res.length - 1);
                count=document.getElementById('nRows').value;
                openWindowTools('TaskServlet?op=listLightTools&searchType=code&toolCode='+res+'&formName='+formName+'&numRows='+count);
            }
        <%---------------------------------%> 
