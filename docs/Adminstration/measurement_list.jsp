...
<%
    ...
    List<WebBusinessObject> measurementList = (List<WebBusinessObject>) request.getAttribute("measurementList");
    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function refreshForm() {
                ...
                var url = "<%=context%>/MeasurementsServlet?op=getMeasurementList&formName=ATTACH_MEASUREMENTS_FORM&rowsPerPage=" + rowsPerPage;
                if(fieldName != null){
            ...
            function goToPage(pageIndex) {
                ...
                var url = "<%=context%>/SeasonServlet?op=getSeasonList&formName=ATTACH_MEASUREMENTS_FORM&Index=" + pageIndex+"&rowsPerPage=" + rowsPerPage;
            ...
            function defaultView(){
                ...
                var url = "<%=context%>/SeasonServlet?op=getSeasonList&formName=ATTACH_MEASUREMENTS_FORM&rowsPerPage=" + rowsPerPage;
            ...
            function sendInfo(){
                ...
                var arDesc = document.getElementsByName('arDesc');
                var enDesc = document.getElementsByName('enDesc');
                ...
                for(var i = 0; i < length; i++){
                    if(check[i].checked == true){
                        ...
                        insertCells(row, id[i].value, arDesc[i].value, enDesc[i].value, count + lastrow);
                        count++;
                    }
                }
            ...
            function insertCells(row, id, arDesc, enDesc, index) {
                ...
                cell0.innerHTML = index + "<input type=\"hidden\" name=\"measurementId\" value="+ id +" />"+
                    "<input type=\"hidden\" name=\"arDesc\" value="+ arDesc +" />"+
                    "<input type=\"hidden\" name=\"enDesc\" value="+ enDesc +" />";

                cell1.className =classname;
                cell1.innerHTML = enDesc;

                cell2.className = classname;
                cell2.innerHTML = arDesc;
                        ...
                        <table id="contenttable" width="500" CELLPADDING="0" CELLSPACING="0" >
                            ...
                            <%
                                ...
                                for (int i = 0; i < measurementList.size(); i++) {
                                    ...
                                    wbo = (WebBusinessObject) measurementList.get(i);

                                    id = (String) wbo.getAttribute("id");
                                    arDesc = (String) wbo.getAttribute("arDesc");
                                    enDesc = (String) wbo.getAttribute("enDesc");
                            ...
                            <tr>
                                ...
                                <td class="<%=classStyle%>">
                                    <a href="#">
                                        <b style="text-decoration: none"><font color="black" size="3"> <%=enDesc%> </font> </b>
                                        <input type="hidden" name="arDesc" value="<%=arDesc%>"/>
                                    </a>
                                </td>
                                ...
                                <td class="<%=classStyle%>">
                                    <a href="#">
                                        <b style="text-decoration: none"><font color="black" size="3"> <%=wbo.getAttribute("arDesc")%> </font> </b>
                                        <input type="hidden" name="enDesc" value="<%=enDesc%>"/>
                                    </a>
                                </td>
                            </tr>
