...
if(stat.equals("En")){
    ...
    lang="   &#1593;&#1585;&#1576;&#1610;    ";
    dept_name_label="Grant name";
    dept_desc_label="Grant decription";
    title_1="Adding a new grant";
    title_2="All information are needed";
    cancel_button_label="Cancel ";
    save_button_label="Save ";
    langCode="Ar";
    Dupname = "Name is Duplicated Chane it";
    sStatus="Grant Saved Successfully";
    ...
    lang="English";
    dept_name_label="&#1575;&#1587;&#1605; &#1575;&#1604;&#1589;&#1604;&#1575;&#1581;&#1610;&#1577; ";
    dept_desc_label="&#1608;&#1589;&#1601; &#1575;&#1604;&#1589;&#1604;&#1575;&#1581;&#1610;&#1577; ";
    title_1="&#1589;&#1604;&#1575;&#1581;&#1610;&#1577; &#1580;&#1583;&#1610;&#1583;&#1577;";
...
<SCRIPT LANGUAGE="JavaScript" TYPE="text/javascript">
        ...
        function submitForm()
        {    
            if (!validateData("req", this.grant_form.grant_name, "Please, enter grant name.") || !validateData("minlength=3", this.grant_form.grant_name, "Please, enter a valid grant name.")){
                this.grant_form.grant_name.focus();
            }else if (!validateData("req", this.grant_form.grant_desc, "Please, enter grant description.")){
                this.grant_form.grant_desc.focus();
            }  else{
                document.grant_form.action = "<%=context%>/GrantsServlet?op=create";
                document.grant_form.submit();
            } 
        }
         function cancelForm()
        {    
        document.grant_form.action = "main.jsp";
        document.grant_form.submit();
        }
</SCRIPT>
...
<FORM NAME="grant_form" METHOD="POST">
...
<TABLE ALIGN="<%=align%>" dir=<%=dir%> CELLPADDING="0" CELLSPACING="0" BORDER="0">
    ...
    <TR>
        ...
        <TD STYLE="<%=style%>" class='td'>
            <input type="TEXT" dir="<%=dir%>" name="grant_name" ID="grant_name" size="32" value="" maxlength="255">
        </TD>
    ...
    <TR>
        ...
        <td class='td'><b>:</b></td>
        <TD STYLE="<%=style%>" class='td'>
            <TEXTAREA rows="5" dir="<%=dir%>" name="grant_desc" ID="grant_desc" cols="26"></TEXTAREA>
        </TD>
        <td class='td'></td><td class='td'></td>
    </TR>
</TABLE>
