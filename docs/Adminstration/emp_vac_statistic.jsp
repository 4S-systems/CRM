...
<html>
    ...
    <%
        ...
        String stat = cMode;
        String align = null;
        String dir = null, tit, empNm, EDEP, LATT, STANDARDH, EMRGH, HEALTHVAC, from, to, dep, noDep, disp, inter, total;

        if (stat.equals("En")) {
            align = "center";
            dir = "LTR";
            tit = "Employees Vacation Statistics";
            empNm = "Employee Name";
            EDEP = "Early Depature";
            LATT = "Late Attendance";
            STANDARDH = "Regular Vacation";
            EMRGH = "Emergency Vacation";
            HEALTHVAC = "Sick Leave";
            from = "From :";
            to = "To :";
            dep = "Department :";
            noDep = "No Department";
            ...
            align = "center";
            dir = "RTL";
            tit = "احصائيات طلبات العاملين";
            empNm = "اسم الموظف";
            EDEP = "الانصراف المبكر";
            LATT = "الحضور المتاخر";
            STANDARDH = "اجازة اعتيادية";
            EMRGH = "اجازة عارضه";
            HEALTHVAC = "اجازة مرضيه";
            inter = "خلال:";
            from = "من :";
            to = "الى :";
            dep = "الاداره :";
    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function getResults() {
                ...
                document.stat_form.action = "<%=context%>/EmployeeServlet?op=viewEmpVacStat&depratmentID=" + depratmentID + "&beginDate=" + beginDate + "&endDate=" + endDate;
                ...
                <TABLE ALIGN="<%=align%>" dir="<%=dir%>" WIDTH="100%" id="Employee" style="">
                    <thead>
                        <tr>
                            ...
                            <th style="color: #005599 !important;font-size: 15px; font-weight: bold;"><%=EDEP%> </th>
                            <th style="color: #005599 !important;font-size: 15px; font-weight: bold;"><%=LATT%> </th>
                            <th style="color: #005599 !important;font-size: 15px; font-weight: bold;"> <%=STANDARDH%> </th>
                            <th style="color: #005599 !important;font-size: 15px; font-weight: bold;"> <%=EMRGH%> </th>
                            <th style="color: #005599 !important;font-size: 15px; font-weight: bold;"> <%=HEALTHVAC%></th>
                    ...
                    <tbody >  
                        <%
                            for (WebBusinessObject wbo : data) {
                                int EDEP_hours = Integer.parseInt(wbo.getAttribute("EDEP").toString()) / 60;
                                int EDEP_minutes = Integer.parseInt(wbo.getAttribute("EDEP").toString()) % 60;
                                
                                int LATT_hours = Integer.parseInt(wbo.getAttribute("LATT").toString()) / 60;
                                int LATT_minutes = Integer.parseInt(wbo.getAttribute("LATT").toString()) % 60;
                                
                                int STANDARDH_hours = Integer.parseInt(wbo.getAttribute("STANDARDH").toString()) / 60;
                                int STANDARDH_minutes = Integer.parseInt(wbo.getAttribute("STANDARDH").toString()) % 60;
                                
                                int EMRGH_hours = Integer.parseInt(wbo.getAttribute("EMRGH").toString()) / 60;
                                int EMRGH_minutes = Integer.parseInt(wbo.getAttribute("EMRGH").toString()) % 60;
                                
                                int HEALTHVAC_hours = Integer.parseInt(wbo.getAttribute("HEALTHVAC").toString()) / 60;
                                int HEALTHVAC_minutes = Integer.parseInt(wbo.getAttribute("HEALTHVAC").toString()) % 60;
                                
                                int tot = Integer.parseInt(wbo.getAttribute("EDEP").toString())+Integer.parseInt(wbo.getAttribute("LATT").toString())+Integer.parseInt(wbo.getAttribute("STANDARDH").toString())+Integer.parseInt(wbo.getAttribute("EMRGH").toString())+Integer.parseInt(wbo.getAttribute("HEALTHVAC").toString());
                                int total_hours = tot / 60;
                                int total_minutes = tot % 60;
                        %>
                        <tr>
                            <TD>
                            ...
                            <TD>
                                <%=EDEP_hours%>/<%=EDEP_minutes%>
                            </TD>

                            <TD>
                                <%=LATT_hours%>/<%=LATT_minutes%>
                            </TD>

                            <TD>
                                <%=STANDARDH_hours%>/<%=STANDARDH_minutes%>
                            </TD>

                            <TD>
                                <%=EMRGH_hours%>/<%=EMRGH_minutes%>
                            </TD>

                            <TD>
                                <%=HEALTHVAC_hours%>/<%=HEALTHVAC_minutes%>
                            </TD>
                            
                            <TD style="background-color: #DADCFF">
