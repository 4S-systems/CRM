...
<html>
    ...
    <%
        ...
        String align, xAlign, dir, style, noClientExistMsg, successMsg, failMsg, sendEmail, client, possible, chance, oncontact, notfound,
            sendsmsT, Send,   Sent, yes, no, addBy, addTm, dltErrMsg, chkMsg, onlyNo, clntInfo,clnt,
              writeMsg,  age, noKids, clntSchool, religion, favSport, favMusic, clubMemb, desc, save, noteMessage;
        String localWhatsapp,interWhatsapp,legalDispute,legalDispute1,confirmed,chooseReason,confirm;
        if (stat.equals("En")) {
            align = "left";
            xAlign = "left";
            dir = "ltr";
  ...
  function closeRentPopup(obj) {
            ...
            function callResultsChng() {
                ...
                if (callResult.indexOf("meeting") > -1) {
 ...
 */
    ...
    function callStatusChange() {
                ...
                if (selectedValue == "answered"){
                   ...
                   $("#timeflag").val("2");
                    ...
                    $("#nextAction").css("display", "block");
                    $("#timeflag").val("3");
                } else if (selectedValue == "Unreachable"){
                    $("#appointmentPlacelbl").css("display", "none");
                    $("#appointmentPlaceDDL").css("display", "none");
                    $("#meetingDateTD").css("display", "none");
                    $("#meetresaultlbl").css("display", "none");
    ...
    //                                        });
                                                if (isExists) {
                                                    ...
                                                    $("#clientRate option").filter(function() {
                                                        return this.text == rateText; 
                                                    }).attr('selected', true);
                                                    //$("#clientRate").find("option[html=" + rateText + "]").attr("selected", "selected");
                                                    //$('#clientRate').find('option[text = "Unreachable"]').attr('selected', true);
                                                    //$("#clientRate option:contains(Unreachable)").attr('selected', true);
                                                    //$("#clientRate option[text=\"Unreachable\"]").attr('selected', true);
                                                    //$("#clientRate option[text='"+ rateText +"']").attr('selected', true);
                    ...
                    function  resetfollowup(){
                        ...
                        $('#callResult option[<%=CRMConstants.CALL_RESULT_MEETING%>]').attr("checked", true);
                    }
                                    ...
                                    %>
                                            {
                                                ...
                                                id: 'gallery',
                                                html: function (item) {
                                                    var html = '<a href="#"><img style="height:35px;" src="images/gallery.png" title="عرض الصور" onclick="JavaScript: openGalleryDialog();"/></a>';
                                                    return html;
                                                }
                                            }, {
                                                type: 'break'
                                    ...
                                    %>
                                            {
                                                type: 'html', id: 'unit',
                                                html: function (item) {
                                                    var html = '<a href="#"><img style="height:35px;" src="images/icons/units.png" title="Units" onclick="JavaScript: openInNewWindow(\x27<%=context%>/IssueServlet?op=clientUnits&clientID=<%=clientWbo.getAttribute("id")%>\x27);"/></a>';
                                                    return html;
                                                }
                                            }, {
                                                type: 'break'
                                    ...
                                    %>
                                            {
                                                type: 'html', id: 'email',
                                                html: function (item) {
                                                    var html = '<a href="#"><img style="height:35px;" src="images/icons/email.png" title="Send Email" onclick="JavaScript: openEmailDialog(\x27<%=((String) clientWbo.getAttribute("name")).trim()%>\x27,\x27<%=clientWbo.getAttribute("email")%>\x27,\x27<%=sendEmail%>\x27);"/></a>';
                                                    return html;
                                                }
                                            }, {
                                                type: 'break'
                            ...
                            <td class="td">
                                <table style="width: 100%;">
                                    <tr>
                                        ...
                                        <td colspan="2">
                                            <div style="width: 70%; height: 65px; background-color: #fff019; font-size: 16px; margin-left: auto; margin-right: auto; vertical-align: middle; color: red; border: #000033 groove medium;">
                                                <img src="images/icons/warning-icon.png" style="height: 60px; float: <%=align%>; margin-top: auto; margin-bottom: auto;"/>
                                                <div style="float: <%=align%>; margin-top: auto; margin-bottom: auto; padding-top: 8px; font-weight: bolder;">&nbsp;&nbsp;<%=noteMessage%></div>
                                            </div>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="td dataTD">
                                            ...
                                            %>
                                                    ...
                                                    <a href="https://web.whatsapp.com/send?phone=2<%=mobile%>" target="_blank" title="<%=localWhatsapp%>"><img style="float: left;margin-left: 7px;" width="5%" src="images/whatsappIcon.png"/></a>
                                            <%
                                                } else {
                                            %>
                                    ...
                                    <tr>
                                        ...
                                        <td class="td dataTD">
                                            ...
                                            %>
                                                    ...
                                                    <% if (!interPhone.isEmpty() && !interPhone.equalsIgnoreCase("ul") && !interPhone.equals(mobile)){%><a href="https://web.whatsapp.com/send?phone=<%=interPhone%>" target="_blank" title="<%=interWhatsapp%>"></a><%}%><img style="float: left;margin-left:7px;" width="5%" src="images/whatsappIcon2.png"/>
                                            <%
                                                } else {
                                            %>
                                    ...
                                    <tr>
                                        ...
                                        <td class="td dataTD" style="text-align: <fmt:message key="align" /> ">
                                            <textarea readonly rows="8" cols="55">
                                                <%
                                                    for(int i=0; i < intersLst.size(); i++){
                                                    WebBusinessObject prjWbo = intersLst.get(i);
                                                    interests += prjWbo.getAttribute("productCategoryName").toString();
                                                    if(i == intersLst.size()-1){
                                                       interests += " . " ;
                                                    } else {
                                                       interests += " , " ;
                                                    }
                ...
                <div id="createClient"  style="width: 40% ;margin-right: auto ;margin-left: auto;display: none;position: fixed;top: 0%;">
                    ...
                    <div class="login" style="width: 85%;margin-bottom: 10px;margin-left: auto;margin-right: auto;">
                        ...
                        <div style="text-align: center;margin-left: auto;margin-right: auto;clear: both" > 
                            <input type="button" value="حفظ"   onclick="JavaScript:createClient();" id="saveClient"class="login-submit"/>
                        </div>                             </form>
                                    ...
                                    <div id="follow_up_content" style="width: 70% !important;display: none;position: fixed">
                                        ...
                                        <div class="login" style="width: 60%;margin-bottom: 10px;margin-left: auto;margin-right: auto;">
                                            ...
                                            <table class="table">
                                                <tr>
                                                    ...
                                                    <td td style="text-align:right">
                                                        <select id="callResult" name="callResult" STYLE="width: 225px;font-size: medium; font-weight: bold;" onchange="JavaScript: callResultsChng()">
                                                            ...
                                                            <option value="<%=CRMConstants.CALL_RESULT_TS_MEETING%>">TS Meeting</option>
                                                            <option value="<%=CRMConstants.CALL_RESULT_SLS_MEETING%>">SLS Meeting</option>
                                                            <option value="<%=CRMConstants.CALL_RESULT_BKR_MEETING%>">BKR Meeting</option>
                                                ...
                                                <tr>
                                                    ...
                                                    <td td style="text-align:right;" id="callResultTD">
                                                        <select id="nextAction" name="nextAction" STYLE="width: 225px;font-size: medium; font-weight: bold;" onchange="JavaScript: callResultsChange()">
                                                            ...
                                                            <% if (userPrevList.contains("VISIT")) { %><option value="meeting">Visit</option><% } %>
                                                            <% if (userPrevList.contains("SEND_EMAIL")) { %><option value="Send Email">Send Email</option><% } %>
                                                            <% if (userPrevList.contains("SEND_SMS")) { %><option value="Send SMS">Send SMS</option><% } %>
                                                            <% if (userPrevList.contains("SEND_OFFER")) { %><option value="Send Offer">Send Offer</option><% } %>
                                                            ...
                                                            <% if (userPrevList.contains("NOT_SERIOUS")) { %><option value="Not Serious">Not Serious</option><% } %>
                                                            <% if (userPrevList.contains("OUT_OF_SEGMENT")) { %><option value="Out of segment">Out of segment</option><% } %>
                                                            <% if (userPrevList.contains("EXISTING_OWNER")) { %><option value="Existing Owner">Existing Owner</option><% } %>
                                                            <% if (userPrevList.contains("WAIT")) { %><option value="Wait">Wait</option><% } %>
                                                            ...
                                                            <% if (userPrevList.contains("NOT_ANSWERED")) { %><option value="not answered">not answered</option><% } %>
                                                            <% if (userPrevList.contains("UNREACHABLE")) { %><option value="Unreachable">Unreachable</option><% } %>
                                                            <% if (userPrevList.contains("UNREACHABLE_WTS")) { %><option value="Unreachable WTS">Unreachable WTS</option><% } %>
                                                            <% if (userPrevList.contains("HOLD")) { %><option value="Hold">Hold</option><% } %>
                                                            <% if (userPrevList.contains("QUALITY_ASSURANCE")) { %><option value="Quality Assurance">Quality Assurance</option><% } %>
                                                            <% if (userPrevList.contains("CUSTOMER_SERVICE")) { %><option value="Customer Service">Customer Service</option><% } %>
                                                ...
                                                <tr>
                                                    <td id="meetresaultlbl" style="color:#f1f1f1; font-size: 16px; font-weight: bold; text-align: <%=xAlign%>; display:none">وقت المتابعة:  </td>
                                                    <td>
                                                        <table>
                                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td style="width:60px">
                                                    <select id="disputeReason" name="disputeReason"> 
                                                        <option value="عدم الوفاء بالواجبات الماديه">عدم الوفاء بالواجبات الماديه</option>
                                                        <option value="الأخلال بشروط التعاقد">الأخلال بشروط التعاقد</option>
                                                        <option value="عدم احترام الجداول الزمنيه">عدم احترام الجداول الزمنيه</option>
                                                    </select>
                                                </td>
                                        ...
                                        <div class="login" style="width: 60%;margin-bottom: 10px;margin-left: auto;margin-right: auto;">
                                            ...
                                            <table class="table" dir="<%=dir%>">
                                                <tr>
                                                    ...
                                                    <td td style="text-align:<%=align%>" id="callResultTD">
                                                ...
                                                <tr>
                                                    <td style="color:#f1f1f1; font-size: 16px; font-weight: bold; text-align: <%=xAlign%>;">وقت المقابلة:  </td>
                                                ...
                                                <tr>
                                                    <td style="color:#f1f1f1; font-size: 16px; font-weight: bold; text-align: <%=xAlign%>;">الفرع : </td>
                                                    <td td style="text-align:<%=align%>">
