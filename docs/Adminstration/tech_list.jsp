...
String[] techAttributes = {"techName"};
String[] techListTitles = {"Technician Name", "View", "Edit", "Delete"};  

int s = techAttributes.length;
int t = s+3;
int iTotal = 0;
...
Vector  techsList = (Vector) request.getAttribute("data");
...
<body>
    ...
    Enumeration e = techsList.elements();
    ...
    <TR bgcolor="<%=bgColor%>">
        ...
        <TD nowrap CLASS="cell" STYLE="padding-left:10;text-align:left;">
            <DIV ID="links">
                <A HREF="<%=context%>/TechServlet?op=ViewTechnician&techId=<%=wbo.getAttribute("tech_Id")%>">
        ...
        <TD nowrap CLASS="cell" STYLE="padding-left:10;text-align:left;">
            <DIV ID="links">
                <A HREF="<%=context%>/TechServlet?op=GetUpdateForm&techId=<%=wbo.getAttribute("tech_Id")%>">
        ...
        <TD nowrap CLASS="cell" STYLE="padding-left:10;text-align:left;">
            <DIV ID="links">
                <A HREF="<%=context%>/TechServlet?op=ConfirmDelete&techId=<%=wbo.getAttribute("tech_Id")%>&techName=<%=wbo.getAttribute("techName")%>">
