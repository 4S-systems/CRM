...
<HTML>
    <%
        ...
        WebBusinessObject wboTrade = (WebBusinessObject) request.getAttribute("wboTrade");
        ...
        if (stat.equals("En")) {
            ...
            title_1 = "هل أنت متأكد من حذف هذا النوع";
    ...
    <SCRIPT  TYPE="text/javascript">
        ...
        function submitForm(){
            document.SEASON_FORM.action = "<%=context%>/ClientServlet?op=deleteJob";
                ...
                <TABLE align="<%=align%>" dir=<%=dir%> CELLPADDING="0" CELLSPACING="0" BORDER="0" id="MainTable">
                    ...
                    <TR>
                        ...
                        <TD  STYLE="<%=style%>"class='td' id="CellData">
                            <input readonly type="TEXT" style="width:230px" name="code" ID="code" size="33" value="<%=wboTrade.getAttribute("tradeCode")%>" maxlength="255" autocomplete="off" >
                            <input readonly type="hidden" style="width:230px" name="seasonTypeId" ID="seasonTypeId" size="33" value="<%=wboTrade.getAttribute("tradeId")%>" maxlength="255" autocomplete="off" >
                        </TD>
                    </TR>
                    <TR>
                        <TD STYLE="<%=style%>" class='td'>
                    ...
                    <TR>
                        ...
                        <TD STYLE="<%=style%>"class='td'>
                            <input readonly type="TEXT" style="width:230px" name="english_name" ID="englishName" size="33" value="<%=wboTrade.getAttribute("enName")%>" maxlength="255">
                        </TD>
                    </TR>
