...
<!--            <TABLE class="blueBorder" dir="<%=dir%>" align="center" width="100%" cellpadding="0" cellspacing="0" style="">
            ...
            <FORM NAME="PROJECT_VIEW_FORM" METHOD="POST">
                ...
                <table ALIGN="<%=align%>" DIR="<%=dir%>" style=" ">
                    <TR>
                    ...
                    <TR>
                        <TD style="<%=style%>;text-align: center" class="td2 formInputTag boldFont boldFont backgroundHeader">
...
<!--                    <TR>
                        <TD style="<%=style%>" class="td2 formInputTag boldFont boldFont backgroundHeader">
                            <LABEL FOR="is_transport_station">
                                <p><b><%=isTrnsprtStn%></b>&nbsp;
                            </LABEL>
                        </TD>
                        <TD colspan="3" class="blueBorder backgroundTable" >
                            <%if (project.getAttribute("isTrnsprtStn").equals("1")) {%>
                            <INPUT type="checkbox" name="isTrnsprtStn" checked>
                            <%} else {%>
                            <LABEL>Not Transport Station </LABEL>
                            <%}%>
                        </TD>
                    </TR>
                    <TR>
                        <TD style="<%=style%>" class="td2 formInputTag boldFont boldFont backgroundHeader">
                            <LABEL FOR="is_Management_station">
                                <p><b><%=isMngmntStn%></b>&nbsp;
                            </LABEL>
                        </TD>
                        <TD colspan="3" class="blueBorder backgroundTable" >
                            <%if (project.getAttribute("isMngmntStn").equals("1")) {%>
                            <INPUT type="checkbox" name="isMngmntStn" checked>
                            <%} else {%>
                            <LABEL>Not management Station </LABEL>
                            <%}%>
                        </TD>
                    </TR>-->
                </TABLE>
