...
String[] categoryAttributes = {"catName"};
String[] categoryListTitles = {"Category Name", "View", "Edit", "Delete"};  
...
<table border="0" dir="ltr">
    ...
    <TR bgcolor="<%=bgColor%>">
        ...
        <TD nowrap CLASS="cell" STYLE="padding-left:10;text-align:left;">
            <DIV ID="links">
                <A HREF="<%=context%>/OperationCatServlet?op=ViewEmployee&employeeId=<%=wbo.getAttribute("empId")%>&departmentId=<%=wbo.getAttribute("department")%>">
        ...
        <TD nowrap CLASS="cell" STYLE="padding-left:10;text-align:left;">
            <DIV ID="links">
                <A HREF="<%=context%>/OperationCatServlet?op=GetUpdateEmployee&employeeId=<%=wbo.getAttribute("empId")%>&departmentId=<%=wbo.getAttribute("department")%>">
        ...
        <TD nowrap CLASS="cell" STYLE="padding-left:10;text-align:left;">
            <DIV ID="links">
                <A HREF="<%=context%>/OperationCatServlet?op=ConfirmDeleteEmployee&employeeId=<%=wbo.getAttribute("empId")%>&employeeName=<%=wbo.getAttribute("empName")%>&departmentId=<%=wbo.getAttribute("department")%>">
