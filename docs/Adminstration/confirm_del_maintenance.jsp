...
<%
   String maintenanceName = (String) request.getAttribute("maintenanceName");
...
%>
   ...
   function submitForm()
   {    
      document.MAINTENANCE_FORM.action = "<%=context%>/MaintenanceServlet?op=Delete&maintenanceName=<%=maintenanceName%>";
      ...
      <left>
	    ...
	    <TR VALIGN="MIDDLE">
               <TD COLSPAN="2" CLASS="tabletitle" STYLE="border-left-WIDTH: 1;text-align:left;">
                  <%=tGuide.getMessage("deletemaintenance")%> - <%=tGuide.getMessage("areyousure")%>
               </TD>
               ...
               <TD CLASS="tableright" colspan="3">
                  ...
                  <A HREF="JavaScript: submitForm();">
                     <%=tGuide.getMessage("deletemaintenance")%>
                  </A>
               </TD>
            </TR>
         </TABLE>
  ...
  <TABLE CELLPADDING="0" CELLSPACING="0" BORDER="0">
       ...
       <TABLE ALIGN="LEFT" CELLPADDING="0" CELLSPACING="0" BORDER="0">
              ...
              <TR>
               ...
               <TD class='td'>
                 <input disabled type="TEXT" name="maintenanceName" value="<%=maintenanceName%>" ID="<%=maintenanceName%>" size="33"  maxlength="50">
               </TD>
            </TR>
         </TABLE>
      </FORM>
