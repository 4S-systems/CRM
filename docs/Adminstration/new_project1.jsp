...
<HTML>
    ...
    <%
        ...
        String sStatus;
        String futileMsg = "";
        String isTrnsprtStn, isMngmntStn;
        ...
        if (stat.equals("En")) {
            ...
            lang = "   &#1593;&#1585;&#1576;&#1610;    ";
            project_code_label = "Item name";
            project_name_label = "Item code";
            project_desc_label = "Item decription";
            futile_label = "Adding sub Item ";
            location_type_label = "Item Type";

            title_1 = "Adding a new Item";
    ...
    <SCRIPT LANGUAGE="JavaScript" TYPE="text/javascript">
        ...
        function submitForm()
        {
            ...
            } else if (!validateData("req", this.PROJECT_FORM.eqNO, "Please, enter Site Code.") || !validateData("alphanumeric", this.PROJECT_FORM.eqNO, "Please, enter a valid Number for Site Number.")){
