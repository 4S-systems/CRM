...
String[] issueTypeAttributes = {"issueName"};
String[] issueTypeListTitles = {"Task Type Name", "View", "Edit", "Delete"};  

int s = issueTypeAttributes.length;
int t = s+3;
int iTotal = 0;
...
Vector  issueTypeList = (Vector) request.getAttribute("data");
...
<body>
    ...
    <TABLE  stylel="position:absolute;top:400px;left:30px;border-right-WIDTH:1px"  WIDTH="200" CELLPADDING="0" CELLSPACING="0">
        ...
        <TD nowrap COLSPAN="2" CLASS="tabletitle" STYLE="border-left-WIDTH: 1;text-align:left;">
            ...
            <%=tGuide.getMessage("issuetypelist")%>
        </TD>
    ...
    Enumeration e = issueTypeList.elements();
    ...
    <TR bgcolor="<%=bgColor%>">
        ...
        <TD nowrap CLASS="cell" STYLE="padding-left:10;text-align:left;">
            <DIV ID="links">
                <A HREF="<%=context%>/IssueTypeServlet?op=ViewIssueType&issueName=<%=wbo.getAttribute("issueName")%>">
        ...
        <TD nowrap CLASS="cell" STYLE="padding-left:10;text-align:left;">
            <DIV ID="links">
                <A HREF="<%=context%>/IssueTypeServlet?op=GetUpdateForm&issueName=<%=wbo.getAttribute("issueName")%>">
        ...
        <TD nowrap CLASS="cell" STYLE="padding-left:10;text-align:left;">
            <DIV ID="links">
                <A HREF="<%=context%>/IssueTypeServlet?op=ConfirmDelete&issueName=<%=wbo.getAttribute("issueName")%>">
