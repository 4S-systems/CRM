...
<HTML>
   ...
   function submitForm()
   {    
      document.PROJECT_DEL_FORM.action = "<%=context%>/ItemsServlet?op=DeleteUnit&unitID=<%=unitID%>&unitName=<%=unitName%>";
      document.PROJECT_DEL_FORM.submit();  
   }
 function cancelForm()
        {    
        document.PROJECT_DEL_FORM.action = "<%=context%>/ItemsServlet?op=ListUnits";
        document.PROJECT_DEL_FORM.submit();  
        }
    </SCRIPT>
