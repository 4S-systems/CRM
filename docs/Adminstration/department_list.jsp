...
<HTML>
    ...
    String[] departmentAttributes = {"departmentName"};
    ...
    if(stat.equals("En")){
        ...
        QS="Quick Summary";
        BO="Basic Operations";
        departmentListTitles[0]="Department Name";
        ...
        QS="&#1605;&#1593;&#1604;&#1608;&#1605;&#1575;&#1578; &#1587;&#1585;&#1610;&#1593;&#1577;";
        BO="&#1593;&#1605;&#1604;&#1610;&#1575;&#1578; &#1571;&#1587;&#1575;&#1587;&#1610;&#1577;";
        departmentListTitles[0]="&#1573;&#1587;&#1605; &#1575;&#1604;&#1602;&#1587;&#1605;";
    ...
    <body>
        ...
        <fieldset align=center class="set">
            ...
            <center> <b> <font size="3" color="red"> <%=PN%> : <%=departmentsList.size()%> </font></b></center> 
            <br>   
            <TABLE ALIGN="<%=align%>" dir="<%=dir%>" WIDTH="400" CELLPADDING="0" CELLSPACING="0" STYLE="border-right-WIDTH:1px;">
                ...
                <TR >
                    ...
                    <TD nowrap CLASS="<%=bgColor%>" BGCOLOR="#D7FF82" STYLE="padding-left:10;<%=style%>">
                        <DIV ID="links">
                            <A HREF="<%=context%>/DepartmentServlet?op=ViewDepartment&departmentId=<%=wbo.getAttribute("departmentID")%>">
                    ...
                    <TD nowrap CLASS="<%=bgColor%>" BGCOLOR="#D7FF82" STYLE="padding-right:10;<%=style%>">
                        <DIV ID="links">
                            <A HREF="<%=context%>/DepartmentServlet?op=GetUpdateForm&departmentId=<%=wbo.getAttribute("departmentID")%>">
                    ...
                    <TD nowrap CLASS="<%=bgColor%>" BGCOLOR="#D7FF82" STYLE="padding-right:10;<%=style%>">
                        <DIV ID="links">
                            <A HREF="<%=context%>/DepartmentServlet?op=ConfirmDelete&departmentId=<%=wbo.getAttribute("departmentID")%>&departmentName=<%=wbo.getAttribute("departmentName")%>">
