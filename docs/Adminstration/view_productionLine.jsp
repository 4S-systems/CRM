...
<HTML>
    ...
    String dir=null;
    String style=null;
    String lang,langCode,tit,save,cancel,TT,SNA,SNO,DESC,CRM,CRC,DU,CO,desc,code,description;
    if(stat.equals("En")){
    ...
    function cancelForm()
        {    
        document.CREW_FORM.action = "<%=context%>/ProductionLineServlet?op=ListProductionLine";
        document.CREW_FORM.submit();  
        }
        ...
        <fieldset align=center class="set">
            ...
            <FORM NAME="CREW_FORM" METHOD="POST">
                ...
                <TABLE ALIGN="<%=align%>" DIR="<%=dir%>" CELLPADDING="0" CELLSPACING="0" BORDER="0">
                    ...
                    <TD STYLE="<%=style%>"class='td'>
                        <input type="TEXT" style="width:230px" name="code" ID="code" size="33" value="<%=productionLineWbo.getAttribute("code").toString()%>" maxlength="255" readonly>
                    </TD>
                </TR>
                    ...
                    <TD STYLE="<%=style%>" class='td'>
                        <TEXTAREA type="TEXT" style="width:230px" name="Desc" ID="Desc" ROWS="4" COLS="25" size="33" value="" maxlength="255" readonly><%=productionLineWbo.getAttribute("Desc").toString()%></textarea>
                    </TD>
                </TR>
                </TABLE>
            </FORM>
