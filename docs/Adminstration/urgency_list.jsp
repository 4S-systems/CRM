...
String[] urgencyAttributes = {"urgencyName"};
String[] urgencyListTitles = {"Urgency Name", "View", "Edit", "Delete"};  

int s = urgencyAttributes.length;
int t = s+3;
int iTotal = 0;
...
Vector  urgencyList = (Vector) request.getAttribute("data");
...
<body>
    ...
    Enumeration e = urgencyList.elements();
    ...
    <TR bgcolor="<%=bgColor%>">
        ...
        <TD nowrap CLASS="cell" STYLE="padding-left:10;text-align:left;">
            <DIV ID="links">
                <A HREF="<%=context%>/UrgencyServlet?op=ViewUrgency&urgencyName=<%=wbo.getAttribute("urgencyName")%>">
        ...
        <TD nowrap CLASS="cell" STYLE="padding-left:10;text-align:left;">
            <DIV ID="links">
                <A HREF="<%=context%>/UrgencyServlet?op=GetUpdateForm&urgencyName=<%=wbo.getAttribute("urgencyName")%>">
        ...
        <TD nowrap CLASS="cell" STYLE="padding-left:10;text-align:left;">
            <DIV ID="links">
                <A HREF="<%=context%>/UrgencyServlet?op=ConfirmDelete&urgencyName=<%=wbo.getAttribute("urgencyName")%>">
