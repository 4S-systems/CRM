        ...
        <FORM NAME="ITEM_FORM" METHOD="POST">
            ...
            <fieldset class="set" align="center">
                ...
                <table align="<%=align%>" dir=<%=dir%>>
                    <tr>
                        <td class="td">
                            <font color="red" size=4 ><%=saving_status%> : <%=status%></font> 
                        </td>
                ...
                <TABLE ALIGN="<%=align%>" DIR="<%=dir%>" CELLPADDING="0" CELLSPACING="0" BORDER="0">
                    ...
                    <!--TR>
                        ...
                        <SELECT name="categoryName" id="categoryName" STYLE="width:230px">
                            <//sw:WBOOptionList wboList='<%//=parentUnitList%>' displayAttribute = "unitName" valueAttribute="id" scrollTo="<%//=wboCategoryName.getAttribute("unitName").toString()%>"/>
                    ...
                    <!--TR>
                       ...
                       <TD  STYLE="<%=style%>" class='td'>
                        ...
                        <SELECT name="empTitle" id="empTitle" STYLE="width:230px">
                            <//sw:WBOOptionList wboList='<%//=EmpTitleList%>' displayAttribute = "name" valueAttribute="id" scrollTo="<%//=wboEmpTitle.getAttribute("name").toString()%>"/>
                        ...
                        <SELECT name="tradeName" id="tradeName" STYLE="width:230px">
                            <sw:WBOOptionList wboList='<%=tradeList%>' displayAttribute = "tradeName" valueAttribute="tradeId" scrollTo="<%=wboTrade.getAttribute("tradeName").toString()%>"/>
                        ...
                        <SELECT name="taskType" id="taskType" STYLE="width:230px">
                            <//sw:WBOOptionList wboList='<%//=tasktypeList%>' displayAttribute = "name" valueAttribute="id" scrollTo="<%//=wboTasktype.getAttribute("name").toString()%>"/>
                    ...
                    <!--TR>
                        ...
                        <TD STYLE="<%=style%>"  class='td'>
                            <input type="TEXT" name="executionHrs" ID="executionHrs" size="4" value="<%=task.getAttribute("executionHrs")%>" maxlength="255"><font color="red"><%=Houre%>
                        </TD>
