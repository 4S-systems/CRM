        ...
        <FORM NAME="USERS_FORM" METHOD="POST">
            ...
            <fieldset align=center class="set">
                <legend align="center">
                 ...
                 <br>
                <center><b>  <font color="red" size=4 dir="<%=dir%>"> <%=TT%> : <%=status%></font></b></center> 
            <br>
            </fieldset>
            <%
           ...
           // wbo = (WebBusinessObject) employeeList.get(i);
            ...
            <!--TR>
                ...
                <TD STYLE="<%//=style%>">
                    <INPUT TYPE="CHECKBOX" NAME="staff" value ="<%//=wbo.getAttribute("empId")%>"<%//if(vecStaff.contains(wbo.getAttribute("empId").toString())){%> CHECKED <%//}%>>
          ...
          //  }
            ...
            <TR>
                ...
                <TD STYLE="<%=style%>">
                    <INPUT TYPE="CHECKBOX" NAME="staff" value ="<%=wbobasic.getAttribute("empId")%>"<%if(vecStaff.contains(wbobasic.getAttribute("empId").toString())){%> CHECKED <%}%>>
