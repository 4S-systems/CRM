...
<%
    ...
    String title, contractNumber, contractSupervisor, contractPeriod, from, tto, contactValue, note, uploadDocument, paymentType, cash, installment,
            newContract, save, clientName, addEmployee, contractName, contractRegistrationDate, day, week, month, year, laborsCount, shiftNo, contractDetailes, contractCalcPeriod,
    ...
    if (stat.equals("En")) {
        ...
        month = "Month";
        year = "Year";
        laborsCount = "Laborers count/shift";
        shiftNo = "No. of Shifts";
        ...
        month = "شهر";
        year = "سنة";
        laborsCount = "عدد العمال في الوردية";
        shiftNo = "عدد الورديات";
	...
	<script type="text/javascript" src="jquery-ui/ui/jquery-ui-timepicker-addon.js"></script>
        ...
        <SCRIPT LANGUAGE="JavaScript" TYPE="text/javascript">
            ...
            function saveContract() {
                ...
                var otherReq = $("#otherReq option:selected").val();
                ...
                if (!$("#automatedContractID").is(':checked') && contractNo === '') {
                    ...
                    $("#message").html("أدخل عدد الورديات");
                    $("#shiftNo").focus();
                } else if (!laborerNo) {
                    $("#message").html("أدخل عدد العاملين بالوردية");
                    $("#laborerNo").focus();
                } else {
                    $.ajax({
                        type: "post",
                        url: "<%=context%>/ContractsServlet?op=saveContract",
                        data: formData,
                ...
                <div style="width: 60%; text-align: center; margin: auto;">
                    <form id="EQUIPMENT_FORM" name="EQUIPMENT_FORM" method="POST" enctype="multipart/form-data">
                        ...
                        <table class="display" align="center" DIR="<%=dir%>" WIDTH="100%" CELLPADDING="0" cellspacing="0" >
                            ...
                            <tr>
                                <TD class="silver_header td2 formInputTag boldFont" STYLE="text-align:center;ont-weight: bold; height: 25px"><b><%=laborsCount%></b></TD>
                                <TD class="td2" STYLE="text-align:right;font-size:14px;ont-weight: bold; height: 25px; padding: 5px">
                                    <input type="number"  name="laborerNo" ID="laborerNo" size="20" value="" maxlength="10" style="width: 100%;"/></TD>
                                </TD>
                                <TD class="silver_header td2 formInputTag boldFont" STYLE="text-align:center;ont-weight: bold; height: 25px"><b><%=shiftNo%></b></TD>
                                <TD class="td2" STYLE="text-align:right;font-size:14px;ont-weight: bold; height: 25px; padding: 5px">
                                    <input type="number"  name="shiftNo" ID="shiftNo" size="20" value="" maxlength="10" style="width: 100%;"/></TD>
                                </TD>
                            </tr>
