...
String style=null;
String message=null;
String lang,langCode,tit,save,cancel,TT,M1,M2,SNA,tit1,RU,EMP,STAT,NO;
if(stat.equals("En")){
...
<SCRIPT LANGUAGE="JavaScript" TYPE="text/javascript">
        ...
        {    
        document.IMG_FORM.action = "<%=context%>/EmployeeDocWriterServlet?op=AttachImage&fileExtension=<%=fileExtension%>&empID=<%=empID%>&docType=<%=docType%>";
        document.IMG_FORM.submit();  
        }
        
        function cancelForm()
        {    
        document.IMG_FORM.action = "<%=context%>/EmployeeServlet?op=ListEmployee";
        document.IMG_FORM.submit();  
        }
