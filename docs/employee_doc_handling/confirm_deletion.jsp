...
<HTML>
    ...
    <SCRIPT LANGUAGE="JavaScript" TYPE="text/javascript">
        ...
        function submitForm()
        {    
        document.ISSUE_FORM.action = "<%=context%>/EmployeeDocReaderServlet?op=Delete&docID=<%=docID%>&empID=<%=empID%>";
        document.ISSUE_FORM.submit();  
        }

        function cancelForm()
        {    
        document.ISSUE_FORM.action = "<%=context%>/EmployeeDocReaderServlet?op=ListDoc&empID=<%=empID%>";
        document.ISSUE_FORM.submit();  
        }
