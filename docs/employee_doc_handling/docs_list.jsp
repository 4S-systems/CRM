...
<HTML>
    ...
    String dir=null;
    String style=null;
    String lang,langCode,tit,save,cancel,TT,IG,AS,QS,BO,CD,PN,NAS,PL,NF,IMA,att;
    if(stat.equals("En")){
 ...
 function reloadAE(nextMode){
    ...
    <body>
        ...
        <DIV align="left" STYLE="color:blue;">
            ...
            <button    onclick="cancelForm('<%=context%>/EmployeeServlet?op=ListEmployee')" class="button"><%=cancel%> <IMG VALIGN="BOTTOM"  HEIGHT="15" SRC="images/leftarrow.gif"></button>
        </DIV> 
                ...
                <tbody id="planetData2">
                    ...
                    <TD nowrap CLASS="cell"  BGCOLOR="#D7FF82" STYLE="padding-left:10;<%=style%>">
                        <DIV ID="links">
                            ...
                            <A HREF="<%=context%>/EmployeeDocReaderServlet?op=ViewDocument&docType=<%=doc.getDocumentType()%>&docID=<%=(String) doc.getAttribute("docID")%>&metaType=<%=(String) doc.getAttribute("metaType")%>">
                                <%=docTitles[3]%>
                            </A>
                    ...
                    <TD nowrap CLASS="cell"  BGCOLOR="#D7FF82" STYLE="padding-left:10;<%=style%>">
                        <DIV ID="links">
                            <A HREF="<%=context%>/EmployeeDocReaderServlet?op=DocDetails&docID=<%=doc.getAttribute("docID")%>&metaType=<%=doc.getAttribute("metaType")%>&empID=<%=empID%>">
                                <%=docTitles[4]%>...
                            </A>
                        </DIV>
                    </TD>
                    ...
                    <TD nowrap CLASS="cell"  BGCOLOR="#D7FF82" STYLE="padding-left:10;<%=style%>">
                        <DIV ID="links">
                            <A HREF="<%=context%>/EmployeeDocWriterServlet?op=GetEditForm&docID=<%=(String) doc.getAttribute("docID")%>&docTitle=<%=(String) doc.getAttribute("docTitle")%>&empID=<%=empID%>">
                                <%=docTitles[5]%>
                            </A>
                    ...
                    <TD nowrap CLASS="cell"  BGCOLOR="#D7FF82" STYLE="padding-left:10;<%=style%>">
                        <DIV ID="links">
                            <A HREF="<%=context%>/EmployeeDocReaderServlet?op=ConfirmDelete&docID=<%=(String) doc.getAttribute("docID")%>&empID=<%=empID%>&docTitle=<%=(String) doc.getAttribute("docTitle")%>">
                                <%=docTitles[6]%>
                            </A>
