...
<%
            ...
            String fieldCode = "ITEM_ID";
            String fieldName = "ITEM_DESC";
            if (stat.equals("Ar")) {
                code = "&#1575;&#1604;&#1603;&#1608;&#1583;";  //
                name = "&#1575;&#1604;&#1573;&#1587;&#1605;";
                listLabel = "قائمة قطع الغيار";
                list_title_page = "قائمة قطع الغيار";
    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function refreshForm() {
                ...
                var url = "<%=context%>/ReportsServletThree?op=listSpareParts&rowsPerPage=" + rowsPerPage + "&selectionType=" + selectionType;
                if(fieldName != null){
            ...
            function goToPage(pageIndex) {
                ...
                var url = "<%=context%>/ReportsServletThree?op=listSpareParts&Index=" + pageIndex + "&rowsPerPage=" + rowsPerPage + "&selectionType=" + selectionType;
            ...
            function sendSparPartsInfo(id, name){
                var id=id;
                var name = name;
                window.opener.document.getElementById('partId').value = id;
                window.opener.document.getElementById('sparePart').value = name;
                window.close();
            }
        </script>
    </head>
                        ...
                        <table width="500">
                            ...
                            <%
                                ...
                                for (int i = 0; i < data.size(); i++) {
                                    ...
                                    String codeValue = wbo.getAttribute("itemId").toString();
                                    if (codeValue.equalsIgnoreCase((String) request.getAttribute("itemId"))) {
                                        continue;
                                    }
                                    String nameValue = "";
                                    try{
                                        nameValue = wbo.getAttribute("itemDesc").toString();
                                    } catch(Exception ex){
                                        nameValue = "لا يوجد إسم عربي";
                                    }
                                    iTotal++;

                                    event = "onclick=\"return sendSparPartsInfo('" + codeValue + "', '" + nameValue + "')\"";
                            %>
                            <tr>
