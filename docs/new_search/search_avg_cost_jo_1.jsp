       ...
       <script LANGUAGE="JavaScript" TYPE="text/javascript">
        ...
        function submitForm(){
            if(document.getElementById("Other").checked){
                ...
                document.SEARCH_MAINTENANCE_FORM.action = "PDFReportServlet?op=resultCostByAvgJO";
            }
            else{
                ...
                if(from > to){
                 ...
                 document.SEARCH_MAINTENANCE_FORM.action = "PDFReportServlet?op=resultCostByAvgJOMaintNum";
            }
            //openCustom('');
                    ...
                    <TABLE id="Others" BGCOLOR="#ffffb9" ALIGN="center" DIR="<%=dir%>" WIDTH="90%" CELLSPACING=5 CELLPADDING=0 BORDER="0" style="display: none;">
                        ...
                        <TR>
                            ...
                            <TD ROWSPAN="3" BGCOLOR="#ffffb9" STYLE="border-bottom-width:0px;border-left-width:0px;border-right-width:0px;border-top-width:0px;text-align:center;padding:5px" WIDTH="33%">
                                ...
                                <select name="site" multiple onChange="selectAllSites(this.id,'siteAll');" on id="site" size="5" style="font-size:12px;font-weight:bold;width:100%; height: 100%; margin: 0px">
                                    <option value="selectAll" style="color:#989898;font-weight:bold;font-size:16px"><%=selectAll%></option>
                        ...
                        <TR>
                            ...
                            <TD style="text-align:center;font:bold 15px;border-bottom-width:0px;border-left-width:0px;border-right-width:0px;border-top-width:0px" bgcolor="#ffffb9"  valign="MIDDLE" >
                                ...
                                <input type="button" name="search" id="search" class="button" value="<%=selectByCode%>" onclick="return getDataInPopup('ReportsServletThree?op=listSpareParts' + '&fieldName=ITEM_ID&fieldValue=' + getASSCIChar(document.getElementById('sparePart').value));" STYLE="height: 25px;font-size:15px;color:black;font-weight:bold;width:60px" />
                                <input type="button" name="search" id="search" class="button" value="<%=selectByName%>" onclick="return getDataInPopup('ReportsServletThree?op=listSpareParts' + '&fieldName=ITEM_DESC&fieldValue=' + getASSCIChar(document.getElementById('sparePart').value));" STYLE="height: 25px;font-size:15px;color:black;font-weight:bold;width:60px" />
