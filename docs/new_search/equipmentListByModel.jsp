    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function refreshForm() {
                ...
                var url = "<%=context%>/EquipmentServlet?op=ListEquipments&rowsPerPage=" + rowsPerPage + "&selectionType=" + selectionType;
                /*if(fieldName != null){
            ...
            function goToPage(pageIndex) {
                ...
                //var fieldValue = getASSCIChar(getOperationOrFieldValue("fieldValue"));
                //var operation  = getOperationOrFieldValue("operator");
                var url = "<%=context%>/EquipmentServlet?op=ListEquipments&Index=" + pageIndex + "&rowsPerPage=" + rowsPerPage + "&selectionType=" + selectionType;
                /*if(fieldName != null){
                    url += "&fieldName=" + fieldName;
                    if(fieldValue != null || fieldValue != ""){
            ...
            function viewElement(id){
                var viewer = window.opener.document.getElementById("viewer");
                $(viewer).html('<img src="images/Loading2.gif"> loading ...');
                $.ajax({
                    type: "POST",
                    url: "<%=context%>/UnitDocReaderServlet",
                    data: "op=ViewImages&single=single&equipmentID="+id,
                ...
                <fieldset class="border" style="width: auto;">
                    ...
                    <div style="padding: 5px; background: #d3d5d4;">
                        <TABLE ID="tableSearch" class="blueBorder" ALIGN="center" DIR="<%=dir%>" CELLPADDING="0" CELLSPACING="0" width="90%">
                            ...
                            <input type="<%=inputType%>" name="parentId" id="parentId" value="<%=field_value%>" />
                            <%
                                }
                                if (j == 1) {
                            ...
                            <TR>
                                <TD CLASS="" STYLE="text-align: <%=textAlign%>;font-size:15px;">
                                    <%--<select id="fieldName">
                                        <option value="ID" <%=selectedCode%> ><%=code%></option>
                                        <option value="MAINTENANCE_TITLE" <%=selectedName%> ><%=name%></option>
                                    </select>--%>
                                </TD>
                                <TD CLASS="" STYLE="text-align: <%=textAlign%>;" id="CellData" colspan="2">
                                    <input type="text" dir="ltr" value="<%=field_value%>"  name="eqpName" id="eqpName" size="30" />&ensp;
                            ...
                            <TR>
                                ...
                                <TD CLASS="" STYLE="text-align: <%=textAlign%>;" id="CellData" colspan="2">
                                    <input type="text" dir="ltr" value="" name="eqpName" ID="eqpName" size="30" />&ensp;
                                    <button id="btnSearch" value="" style="text-align: <%=textAlign%>;" ONCLICK="JavaScript: refreshForm()" ><img src="images/refresh.png" alt="<%=refreshSearchLabel%>" title="<%=refreshSearchLabel%>" align="middle" width="24" height="24"/></button>
                                </TD>
                            </TR>
                            <%
