...
<HTML>
    <%
        ...
        String dir = null;
        String style = null;
        String lang, langCode, sTitle, sCancel, sOk, sScheduleName, exportReport, before, mainCatName,
                select,updateCounter,updatedCounter,notUpdatedCounter,name;
        String getReport;
        if (stat.equals("En")) {
            align = "left";
            dir = "LTR";
            ...
            lang = "   &#1593;&#1585;&#1576;&#1610;    ";
            sTitle = "Report Update counter of Machine";
            sCancel = "Cancel";
            sOk = "Search";
            langCode = "Ar";
            ...
            updatedCounter="counter was updated";
            notUpdatedCounter="not updated because of error happened";
            name = "Equipment Name";
            ...
            select="&#1573;&#1582;&#1578;&#1575;&#1585;";
            updateCounter="&#1578;&#1581;&#1583;&#1610;&#1579; &#1602;&#1585;&#1575;&#1569;&#1577; &#1575;&#1604;&#1605;&#1593;&#1583;&#1577;";
            updatedCounter="&#1578;&#1605; &#1578;&#1581;&#1583;&#1610;&#1579; &#1575;&#1604;&#1602;&#1585;&#1575;&#1569;&#1577; &#1604;&#1604;&#1605;&#1593;&#1583;&#1575;&#1578;";
            notUpdatedCounter="&#1604;&#1605; &#1610;&#1578;&#1605; &#1575;&#1604;&#1578;&#1581;&#1583;&#1610;&#1579; &#1576;&#1587;&#1576;&#1576; &#1608;&#1580;&#1608;&#1583;";
            name = " &#1575;&#1587;&#1605; &#1575;&#1604;&#1605;&#1593;&#1583;&#1607; ";
            getReport="&#1573;&#1587;&#1578;&#1582;&#1585;&#1575;&#1580; &#1575;&#1604;&#1578;&#1602;&#1585;&#1610;&#1585;";
        }
    ...
    <SCRIPT LANGUAGE="JavaScript" TYPE="text/javascript">
        function submitForm() {
            ...
            var url = "<%=context%>/AverageUnitServlet?op=getUpdateReadingUnitByTrip&mainCatId="+mainCatId;
        ...
        function getEquipments()
        {
            ...
            openWindowTasks('ReportsServlet?op=listEquipmentsByTypeRate&mainName='+res+'&formName='+formName+'&typeRate=all');
        }
       function openWindowTasks(url) {
            openCustomDialog(url, "toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=yes, resizable=yes, copyhistory=no, width=800, height=400");
        }
        ...
        function getEquipments()
        {
            var formName = document.getElementById('update_counter_form').getAttribute("name");
            ...
            res = res.substr(0, res.length - 1);
            openWindowTasks('ReportsServlet?op=listEquipmentsByTypeRate&unitName='+res+'&formName='+formName+'&typeRate=all');
        }
    </SCRIPT>
    <BODY>
        <FORM action="" id="update_counter_form"  NAME="REPORT_FORM" METHOD="POST">
                    ...
                    <br>
                      <% if(status != null && !status.equals("")){ 
                            ...
                            <center>
                                <table>   
                            <TR>    
                            <TD CLASS="backgroundTable" STYLE="text-align:center; padding-<%=align%>: 10px; color: red; font-size:15px; height: 40px; font-weight: bold" width="25%">
                                <b><%=updatedCounter%></b>
                            </TD>
                            <%}else if(status.equals("false")){ %>
                            <TD CLASS="backgroundTable" STYLE="text-align:center;padding-<%=align%>: 10px; color: red; font-size:15px; height: 40px; font-weight: bold" width="25%">
                                <b><%=notUpdatedCounter%></b>
                            </TD>
                            <% } %>
                            </TR>
                                </table>
                    ...
                    <TABLE ID="tableSearch"  ALIGN="center" DIR="<%=dir%>" CELLPADDING="0" CELLSPACING="3" width="70%" style="height: 100%">
                        ...
                        <TR>
                            ...
                            <TD STYLE="text-align:center;color: black;font-size:15px;background-color: #EDEDED; height: 40px" width="40%">
                                <input type="button" id="btnExportReport" value="<%=getReport%>" style="text-align:center;font-size:14px;font-weight: bold;width: 85%" ONCLICK="JavaScript: submitForm()">
                            </TD>
                        </TR>
                    </TABLE>
                    <br>
