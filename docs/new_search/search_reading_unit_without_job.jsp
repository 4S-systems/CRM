...
<HTML>
    ...
    <SCRIPT LANGUAGE="JavaScript" TYPE="text/javascript">
        function submitForm() {
            ...
            var url = "<%=context%>/AverageUnitServlet?op=resaultReadingUnitWithoutJobReport&mainCatId="+mainCatId+"&scheduleId=" + scheduleId + "&scheduleName=" + scheduleName +"&searchAll=" + searchAll;
