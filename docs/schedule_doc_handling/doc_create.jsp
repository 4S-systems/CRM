...
<SCRIPT LANGUAGE="JavaScript" TYPE="text/javascript">
        ...
        if(source=="mainCat"){
            document.DOC_FORM.action = "<%=context%>/ScheduleDocWriterServlet?op=SaveDoc&scheduleID=<%=scheduleID%>&docType=<%=docType%>&mainCatId=<%=schWbo.getAttribute("mainCatTypeId")%>&source=<%=source%><%=sType%>";
        }else if(source=="Cat"){
            document.DOC_FORM.action = "<%=context%>/ScheduleDocWriterServlet?op=SaveDoc&scheduleID=<%=scheduleID%>&docType=<%=docType%>&equipmentCat=<%=schWbo.getAttribute("equipmentCatID")%>&source=<%=source%><%=sType%>";
        }else{
            document.DOC_FORM.action = "<%=context%>/ScheduleDocWriterServlet?op=SaveDoc&scheduleID=<%=scheduleID%>&docType=<%=docType%>&equipmentID=<%=schWbo.getAttribute("equipmentID")%>&source=<%=source%>";
        }
    ...
    function cancelForm()
        ...
        if(source=="mainCat"){
            document.DOC_FORM.action = "<%=context%>/ScheduleServlet?op=ViewSchedule&periodicID=<%=scheduleID%>&mainCatId=<%=schWbo.getAttribute("mainCatTypeId")%>&source=<%=source%><%=sType%>";
        }else if(source=="Cat"){
            document.DOC_FORM.action = "<%=context%>/ScheduleServlet?op=ViewSchedule&periodicID=<%=scheduleID%>&equipmentCat=<%=schWbo.getAttribute("equipmentCatID")%>&source=<%=source%><%=sType%>";
        }else{
            document.DOC_FORM.action = "<%=context%>/ScheduleServlet?op=ViewSchedule&periodicID=<%=scheduleID%>&equipmentID=<%=schWbo.getAttribute("equipmentID")%>&source=<%=source%>";
        }
