...
<HTML>
    ...
    <SCRIPT LANGUAGE="JavaScript" TYPE="text/javascript">
        ...
        %>
        window.location = "<%=context%>/ScheduleDocReaderServlet?op=ListDoc&scheduleID=<%=scheduleID%>&equipmentCat=<%=request.getParameter("equipmentCat")%>&source=\'cat\'<%=sType%>";
        <%
        } else {
        %>
        window.location = "<%=context%>/ScheduleDocReaderServlet?op=ListDoc&scheduleID=<%=scheduleID%>&equipmentID=<%=request.getParameter("equipmentID")%>&source=eqp";
        <%
        }
        %>
        } 
