...
<html>
    <%
        ...
        if (state.equals("En")) {
            ...
            intervalTitle = "Closed Each";
        } else {
            dir = "RTL";
            title = "قواعد ألأغلاق الاتوماتيكى";
            departmentTitle = "اﻷدارة";
            intervalTitle = "إغلاق بعد (الفترة بالساعات)";
        }
    %>
    <head>
        ...
        <script LANGUAGE="JavaScript" TYPE="text/javascript">
            ...
            function saveScheduler(id) {
                ...
                if ($("#interval" + id).val() !== "") {
                    ...
                    var objectType = '<%=CRMConstants.QUARTZ_OBJECT_TYPE_CLIENT_COMPLAINT%>';
                    var action = '<%=CRMConstants.QUARTZ_ACTION_CLIENT_COMPLAINT_CLOSED%>';
                    ...
                    $.ajax({
                        type: "post",
                        url: '<%=context%>/QuartzSchedulerConfigurationServlet?op=clientCompliantClosedQuartzSave',
                        data: {
                            quartzId: quartzId,
                            objectId: objectId,
            ...
            function startScheduler(id) {
                ...
                if ($("#interval" + id).val() !== "") {
                    ...
                    $.ajax({
                        type: "post",
                        url: '<%=context%>/QuartzSchedulerConfigurationServlet?op=clientCompliantClosedQuartzUpdateRunning',
                        data: {
                            quartzId: quartzId,
                            objectId: objectId,
                            objectType: objectType,
