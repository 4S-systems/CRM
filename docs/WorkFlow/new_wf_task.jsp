...
<HTML>
    ...
    String code,department,taskType,orderDate,userName;
    ...
    <SCRIPT LANGUAGE="JavaScript" TYPE="text/javascript">
        ...
        {    
            ...
            if (!validateData("req", this.TASK_FORM.wfTaskName, "Please, enter Work Flow Task Name.") || !validateData("minlength=3", this.TASK_FORM.wfTaskName, "Please, enter a valid Work Flow Task Name.")){
                ...
                document.TASK_FORM.action = "<%=context%>/WFTaskServlet?op=savewfTask";
        ...
        if(status.equalsIgnoreCase("ok")){
            ...
            <TABLE dir="<%=dir%>" align="<%=align%>" CELLPADDING="0" CELLSPACING="0" BORDER="0">
                ...
                <TR>
                    ...
                    <TD STYLE="<%=style%>" class='td'>
                        <input type="TEXT" name="wfTaskCode" ID="wfTaskCode" size="34" value="" readonly >
                    </TD>
                </TR>
                ...
                <TR>
                    ...
                    <TD STYLE="<%=style%>" class='td'>
                        <input type="TEXT" name="wfTaskName" ID="wfTaskName" size="34" value=""maxlength="255">
                    </TD>
                </TR>
                ...
                <TR>
                    ...
                    <TD STYLE="<%=style%>" class='td'>
                        <TEXTAREA rows="5" name="wfTaskDesc" ID="wfTaskDesc" cols="27"></TEXTAREA>
                    </TD>
                </TR>
            </TABLE>
        </FORM>
