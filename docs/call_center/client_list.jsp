...
<%
    ...
    List<WebBusinessObject> data = (List<WebBusinessObject>) request.getAttribute("clientsList");
    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function refreshForm() {
                ...
                var url = "<%=context%>/ClientServlet?op=getClients&rowsPerPage=" + rowsPerPage + "&selectionType=" + selectionType;
                if (fieldName != null) {
            ...
            function goToPage(pageIndex) {
                ...
                var url = "<%=context%>/ClientServlet?op=getClients&Index=" + pageIndex + "&rowsPerPage=" + rowsPerPage + "&selectionType=" + selectionType;
...
//                alert('id = '+id+' &name = '+name);
                ...
                window.opener.document.getElementById('id').onchange();
                window.close();
                        ...
                        <table width="500">
                            ...
                            <%
                                ...
                                for (int i = 0; i < data.size(); i++) {
                                    ...
                                    idValue = wbo.getAttribute("clientNO").toString();
                                    String idValue2 = wbo.getAttribute("id").toString();
//                                    if (idValue.equalsIgnoreCase((String) request.getAttribute("clientId"))) {
//                                        continue;
//                                    }
                                    ...
                                    event = "onclick=\"return sendCarInfo('" + idValue2 + "', '" + nameValue + "')\"";
                            %>
                            <tr>
