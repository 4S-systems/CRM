...
<%
    ...
    List<WebBusinessObject> allEmployees = new ArrayList<WebBusinessObject>();
    ...
    IssueByComplaintAllCaseMgr issueByComplaint2Mgr = IssueByComplaintAllCaseMgr.getInstance();
...
//Get request data
    ...
    int iTotal = 0;
    String printTask, scheduleCase, executionCase, onHoldCase, fontSize, issueNo, issueTit, equip, issueStatus, clientOperation;
...
<body>
    <FORM NAME="CLIENT_COMPLAINT_FORM" METHOD="POST">
        ...
        <div  id="call_center" class="show">
            ...
            <div style="width: 100%;">
                <table style="width: 101%;margin-top: 7px;margin-bottom: 10px;" class="table">
                    <tr algin="center">
                        <td colspan="2" class="blueBorder blueHeaderTD" style="font-size:17px;">مركز التحكم والمتابعه</td>
                    </tr>
                </table>
                    ...
                    <fieldset style="width:97.5%;background-color:#b9d2ef;">
                        ...
                        <table width="100%" dir="rtl" style="border-left:0px;" class="table">
                            <tbody>
                                <tr>
                                    <td>
                                        <table width="70%" dir="rtl" style="border-left:0px;background: #f9f9f9;border: none" class="table">
                            <tr>
                            ...
                            <tr style="">
                                <td  style="text-align: right;background: #f1f1f1;" >المصدر</td>
                                    <td style="text-align:right;padding-right: 30px;background: #f1f1f1;">
                        ...
                        <fieldset style="width: 97.5%;background-color: FFFF99" >
                            ...
                            <div style="width: 47%;float: right;">
                                <table border="1px" width="100%" class="table" align="right" style="float: right;margin: 0px !important;">
                                    ...
                                    <tr>
                                        <td style="text-align: right;width:1%;" >كـــــــــود </td>
                                        <td style="text-align:right;padding-right: 30px">
                                    ...
                                    <tr style="display: <%=showDetails ? "" : "none"%>">
                                        ...
                                        <TD style="text-align:right;width: 60%;padding-right: 30px">
                                            ...
                                            <textarea rows="3" id="complaintTA"  hidden="true" style="width: 98%;" ><%=sCompl%></textarea>
                                            <img src="images/ok2.png"  hidden="true" height="20px" title="حفظ" id="SaveEditedComment" onclick="updateComplaintComment('<%=wbo.getAttribute("clientComId")%>')" /> 
                                            <img src="images/icons/edit.png"  height="20px" title="تعديل التعليق" id="ShowEditC" /> 
                                            <% }%> 
                                            <!--
                                    ...
                                    <tr>
                                        <td style="text-align: right;min-width: 100px"   >الحــــــالة</td>
                                        <td style="<%=style%>;padding-right: 30px;">
                                            <%
                                                String statusName = "";
                                    ...
                                    <tr>
                                        <td   style="text-align: right"   >المــــــدير</td>
                                <td style="<%=style%>;padding-right: 30px;">
                                            <%
                                    ...
                                    <tr>
                                        <td   style="text-align: right"   >المسئــول</td>
                            ...
                            <div style="margin-right: 50%;" id="cc">
                                <%   if (prvType.size() > 0) {
                                ...
                                <div class="buttons-input">
                                    <ul>
                                        ...
                                        <li style="display : <%=printComplaint ? "" : "none"%>">
                                            <input type="button" class="print_complaint_btn" onclick="getClientComplaintWithComments('<%=clientCompId%>'); return false;"/>
                                        </li>
            ...
            <div class="login" style="width: 85%;margin-bottom: 10px;margin-left: auto;margin-right: auto;">
                <table class="" style="width:100%;text-align: right;border: none;margin-bottom: 20px;" class="table" >
                    ...
                    <td width="70%" style="border:0px;text-align: right;">
                        <textarea rows="5"  id="compNotes" style="width: 100%;margin-top: 10px;" ></textarea>
                    </td>
                    </tr>
            ...
            <div class="login" style="width: 150%;margin-bottom: 10px;margin-left: auto;margin-right: 10%;">
                <table  border="0px"  style="width:100%;"  class="table">
                    <tr>
                        ...
                        <td style="width: 70%;" >
                            <input id="newCode" value="<%=wbo.getAttribute("businessCompId")%>" style="width: 180px;"/>
                        </td>
                    </tr> 
                </table>
