...
<%
            ...
            if (stat.equals("Ar")) {
                code = "&#1575;&#1604;&#1603;&#1608;&#1583;";  //
                name = "&#1575;&#1604;&#1573;&#1587;&#1605;";
                listLabel = "قائمة السيارات";
                list_title_page = "قائمة السيارات";
            ...
            List<WebBusinessObject> data = (List<WebBusinessObject>) request.getAttribute("carList");
    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function refreshForm() {
                ...
                var url = "<%=context%>/ClientServlet?op=getCustomers&rowsPerPage=" + rowsPerPage + "&selectionType=" + selectionType;
                if(fieldName != null){
            ...
            function goToPage(pageIndex) {
                ...
                var url = "<%=context%>/EquipmentServlet?op=getCars&Index=" + pageIndex + "&rowsPerPage=" + rowsPerPage + "&selectionType=" + selectionType;
            ...
            function defaultView(){
                ...
                var url = "<%=context%>/EquipmentServlet?op=getCars&rowsPerPage=" + rowsPerPage + "&selectionType=" + selectionType;
                if(fieldName != null){
                    url += "&fieldName=" + fieldName;
                    if(fieldValue != null || fieldValue != ""){
                        ...
                        <table width="500">
                            ...
                            <%
                                ...
                                for (int i = 0; i < data.size(); i++) {
                                    ...
                                    idValue = wbo.getAttribute("id").toString();
                                    if (idValue.equalsIgnoreCase((String) request.getAttribute("itemId"))) {
                                        continue;
                                    }
                                    
                                    try{
                                        nameValue = wbo.getAttribute("name").toString();
                                    } catch(Exception ex){
                                        nameValue = "?? ???? ??? ????";
                                    }
                                    iTotal++;

                                    event = "onclick=\"return sendCarInfo('" + idValue + "', '" + nameValue + "')\"";
                            %>
                            <tr>
                                ...
                                <td>
                                    <a  href="#" <%=event%>>
                                        <b style="text-decoration: none"><font color="black" size="3"> <%=idValue%> </font> </b>
                                    </a>
                                </td>
                                <td>
                                    <a  href="#" <%=event%>>
                                        ...
                                        <input type="hidden" name="codeValue" value="<%=idValue%>"/>
                                    </a>
                                </td>
                            </tr>
