...
<%
    ...
    clientCompVector = employeeViewMgr.getOnArbitraryKey(request.getParameter("compId").toString(), "key5");
...
<!--<a href="IssueServlet?op=clientOperation&clientId=<%=clientId%>&issueId=<%=clientId%>&compId=<%=clientCompId%>"><%=clientOperation%></a>-->
        ...
        <div style="display: none;">
            <div id="report" class="easyui-window" data-options="modal:true,closed:true" title="مراحل الطلب" style="width:600px;height:auto;padding:10px;text-align: right;">
                    ...
                    <table style="width:100%;text-align: right;border: none;margin-bottom: 20px;" class="table" dir="rtl">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td style="width: 40%; text-align: center;"><label id="requestDate"></label></TD>
                                <td style="width: 40%;"><label id="">-----</label></TD>
                            </TR>
                            <tr id="assign">
                                <td style="width: 20%;"> <label style="width: 100px;"> التوزيع  </label></TD>
                                <td style="width: 40%;"><label id="assignDate"></label></TD>
                                <td style="width: 40%;"><label id="assignPeriod"></label></TD>
                            </tr>
                            <tr id="open">
                                <td style="width: 20%;"> <label style="width: 100px;"> المتابعة  </label></TD>
                                <td style="width: 40%;"><label id="openDate"></label></TD>
                                <td style="width: 40%;"><label id="openPeriod"></label></TD>
                            </tr>
                            <tr id="finish">
                                <td style="width: 20%;"> <label style="width: 100px;">   الإنهاء </label></TD>
                                <td style="width: 40%;"><label id="finishDate"></label></TD>
                                <td style="width: 40%;"><label id="finishPeriod"></label></TD>
                            </TR>
                            <tr id="close">
                                <td style="width: 20%;"> <label style="width: 100px;"> الإغلاق </label></TD>
                                <td style="width: 40%;"><label id="closeDate"></label></TD>
                                <td style="width: 40%;"><label id="closedPeriod"></label></TD>
                            </TR>
                            <tr>
                                <td colspan="3">
                            ...
                            <tr id="total">
                                ...
                                <td style="width: 40%;text-align: center;"><label id="totalTime"></label></TD>
                            </TR>
                                ...
                                <tr>
                                    ...
                                    <td style="text-align:right;">
                                        <%if (issueWbo.getAttribute(
                                                    "callType") != null && issueWbo.getAttribute("callType").toString().equals("incoming")) {%> 
                                        <label>واردة</label>

                                        <%}%>

                                        <%if (issueWbo.getAttribute(
                                                    "callType") != null && issueWbo.getAttribute("callType").toString().equals("out_call")) {%> 
                                        <label>صادرة</label>                   
                            ...
                            <div style="margin-right: 69%;" id="cc">
                                ...
                                <div style="width:98%;margin-right:auto;margin-top: auto;">
                                    ...
                                    <div style="margin-right: auto;margin-left: auto;"> <input type="button"  onclick="popupFinishO(this);" class="button_finis"></div>
                                        <%} else {%>
                                    <div style="margin-right: auto;margin-left: auto;"> <input type="button"  onclick="notAllowed('لقد تم الإنهاء مسبقا')" class="button_finis"></div>
                                        <%  }
