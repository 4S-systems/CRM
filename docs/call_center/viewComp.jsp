...
<%
    ...
    String sourceName = "";
    String issueType = "";
    WebBusinessObject user = new WebBusinessObject();
    if (issueWbo != null) {
        /**
        ...
        user = UserMgr.getInstance().getOnSingleKey((String) issueWbo.getAttribute("userId"));
    ...
    clientCompVector = IssueByComplaintUniqueMgr.getInstance().getOnArbitraryKey(request.getParameter("compId").toString(), "key5");
    ...
    String jobOrderEmployeeName = "----", jobOrderCraetedByName = "----", jobOrderDate = "----", jobOrderComment = "", jobOrderUnitID = "";
    ...
    WebBusinessObject appointment = appointmentMgr.getOnSingleKey("key4", clientCompId);
    ArrayList<WebBusinessObject> purcheUnits = (ArrayList<WebBusinessObject>) request.getAttribute("purcheUnits");
    if (purcheUnits == null) {
        purcheUnits = new ArrayList<>();
    }
    if (appointment != null) {
        jobOrderEmployeeName = UserMgr.getInstance().getByKeyColumnValue((String) appointment.getAttribute("userId"), "key3");
        jobOrderCraetedByName = UserMgr.getInstance().getByKeyColumnValue((String) appointment.getAttribute("createdBy"), "key3");
        jobOrderDate = (String) appointment.getAttribute("appointmentDate");
        jobOrderComment = (String) appointment.getAttribute("comment");
        jobOrderUnitID = (String) appointment.getAttribute("option6");
    }
    ...
    int iTotal = 0;
    String printTask, viewD, scheduleCase, executionCase, onHoldCase, fontSize, issueNo, issueTit, equip, issueStatus, clientOperation;
    ...
    String currentOwnerId = (String) wb.getAttribute("userId");
    
    String socketMsg = "Your request by number "+issueWbo.getAttribute("businessID")+"finished";
%>
                        ...
                        $.ajax({
                            ...
                            url: "<%=context%>/ComplaintEmployeeServlet?op=finishComp&issueId=<%=issueId%>&compId=<%=clientCompId%>",
                                ...
                                function closeComplaint(obj) {
                                    ...
                                    $.ajax({
                                        type: "post",
                                        url: "<%=context%>/ComplaintEmployeeServlet?op=closeComp&issueId=<%=issueId%>&compId=<%=clientCompId%>&subject=<%=finReqSubject%>&comment=<%=finReqComment%>&complaintId=<%=clientCompId%>&objectType=" + $("#businessObjectType2").val(),
                                        data: {
                                            notes: notes,
                                            clientId: <%=clientId%>,
                                            endDate: endDate,
                                        ...
                                        url: "<%=context%>/ComplaintEmployeeServlet?op=rejectedComplaint&issueId=<%=issueId%>&compId=<%=clientCompId%>",
                                                    ...
                                                    success: function (jsonString) {
                                                        ...
                                                        if (info.status == 'ok') {
                                                            ...
                                                            $("#rejectedMsg").html("لم يتم الإلغاء");
                                                        }
                                                    }
                                                });
...
//                        $("#responsibleEmp").html(responsibleEmp);
    ...
    <style type="text/css">
        ...
        .button_job_order {
            ...
            display: inline-block;
            background-color: transparent;
            background-image:url(images/buttons/job_order.png);
        }
    </style>
</head>

<body>
    <input type="hidden" id="userSocket" value="<%= user != null ? user.getAttribute("fullName") : ""%>" />
    ...
    <FORM NAME="CLIENT_COMPLAINT_FORM" METHOD="POST">
        ...
        <div id="client_joborder" style="width: 40%;display: none; position: fixed">
            <div style="clear: both;margin-left: 93%;margin-top: 0px;margin-bottom: -38px;z-index: -10000000;">
                <img src="images/close_popup.png" width="32" height="32" style="background-repeat: no-repeat;   
                     -webkit-box-shadow: 0px 0px 17px rgba(255, 255, 255, 1.0);background-color: transparent;
                     -moz-box-shadow:    0px 0px 17px rgba(255, 255, 255, 1.0);
                     box-shadow:         0px 0px 17px rgba(255, 255, 255, 1.0);
                     -webkit-border-radius: 100px;
                     -moz-border-radius: 100px;
            ...
            <div class="login" style="width: 95%;margin-bottom: 10px;margin-left: auto;margin-right: auto;">
                <h1 align="center" style="vertical-align: middle; background-color: #006daa;">عرض أمر شغل <img src="images/icons/visit_icon.png" alt="phone" width="24px"/></h1>
                <table class="table" style="width:100%;">
                    <tr>
                        <td style="color:#f1f1f1; font-size: 16px;font-weight: bold; text-align: left;">اسم العميل : </td>
                        <td style="text-align:right">
                            <label id="clientName"><%=client.getAttribute("name")%></label>
                        </td>
                    </tr>
                    <tr>
                        <td style="color:#f1f1f1; font-size: 16px;font-weight: bold; text-align: left;">رقم الموبايل : </td>
                        <td style="text-align:right">
                            <label id="clientName"><%=(client.getAttribute("mobile") == null) ? "" : client.getAttribute("mobile")%></label>
                        </td>
                    </tr>
                    <tr>
                        <td style="color:#f1f1f1; font-size: 16px;font-weight: bold; text-align: left;">العنوان : </td>
                        <td style="text-align:right">
                            <label id="clientName"><%=(client.getAttribute("address") == null) ? "" : client.getAttribute("address")%></label>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td style="text-align:right">
                            <select id="unitID" name="unitID" style="font-size: 12px; width: 200px;">
                                <sw:WBOOptionList wboList="<%=purcheUnits%>" displayAttribute="productName" valueAttribute="projectId" scrollToValue="<%=jobOrderUnitID%>"/>
                            </select>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td style="text-align:right">
                            <label id="joborderEmployee"><%=jobOrderEmployeeName%></label>
                        </td>
                    </tr>
                    <tr>
                        <td style="color:#f1f1f1; font-size: 16px;font-weight: bold; text-align: left;">عامل الأتصال : </td>
                        <td style="text-align:right">
                            <label id="joborderEmployee"><%=jobOrderCraetedByName%></label>
                        </td>
                    </tr>
                    <tr>
                        <td style="color:#f1f1f1; font-size: 16px;font-weight: bold; text-align: left;">تاريخ الصيانة : </td>
                        <td style="text-align:right">
                            <input id="joborderDate" name="joborderDate" type="text" value="<%=(jobOrderDate != null) ? jobOrderDate.split(" ")[0] : "---"%>" readonly="false" title="Date Format: yyyy/MM/dd" style="width: 180px;"/>
                        </td>
                    </tr>
                    <tr>
                        <td style="color:#f1f1f1; font-size: 16px;font-weight: bold; text-align: left;">تعليق : </td>
                        <td style="text-align:right">
                            <textarea cols="26" rows="10" id="comment" style="width: 99%; background-color: #FFF7D6;" readonly><%=jobOrderComment%></textarea>
                        </td>
                    </tr>
                </table>
            </div>  
        ...
        <div id="redistributionComp"  style="width:40%;display: none;">
            ...
            <div class="login" style="width: 90%;float: left;margin-bottom: 3px;">
                ...
                <div style="width: 100%;text-align: center;margin-left: auto;margin-right: auto;">
                    ...
                    <input type="button" id="redistBtn" onclick="JavaScript:redistributionComplaintToEmployee(this);" value="" class="managerBt" style="margin-top: 15px;font-family: sans-serif">
        ...
        <div id="call_center" class="show" style="border: none">
            <br>
            <div style="width: 95%;">
                <table align="center" cellpadding="0" cellspacing="0" style="width: 100%">
                    <tr>
                        <td style="width: 100%" class="titlebar">
                            <font color="#005599" size="4">مركز التحكم والإتصال</font>
                        </td>
                    </tr>
                </table>
                <div id="showDiv" style="width: 100% !important;margin-left: auto;margin-right: auto;display: none">
                ...
                <div style="width: 100%;">
                    <fieldset style="width:97.5%;background-color:#b9d2ef;">
                            ...
                            <tr>
                                ...
                                <td style="text-align:right;">
                                   <table >
                                    ...
                                    <%--
                                    <td   style="background-color:#A0A0A0;" >الحالة</td>
                                    <td style="<%=style%>">
                                        <%
                                            String statusName = "";
                                    ...
                                    <%--
                                    <td   style="background-color:#A0A0A0;"   >المدير</td>
                                    <td style="<%=style%>">
                                        <%
                                            String managerName = "";
                                    ...
                                    <%-- <td   style="background-color:#A0A0A0;"   >الموظف المسئول</td>
                        ...
                        <%-- <br>
                         ...
                         <button onclick="getClientComplaintWithComments('<%=clientCompId%>');
                ...
                <div style="width: 99%;">
                    <%--
                      <div style="width: 35%;float: right;display: block;">
                          <fieldset style="width:100%;padding: 10px;">
                              <legend style="color: #FF3300;">بيانات المعاملة</legend>
                            ...
                            <table width="100%"   dir="rtl" style="border-left:0px;" class="table">
                                ...
                                <tr>
                                    <td width="30%"  style="background-color:#A0A0A0;" >المدة</td>
                                    <td style="text-align:right;">
                                        <strong><%=age%></strong>
                                    </td>
                                </tr>
                                <tr>
                                    <td width="30%"  style="background-color:#A0A0A0;" >إتجاه المعاملة</td>
                                    ...
                                    <td style="text-align:right;">
                                        ...
                                        <%if (issueWbo.getAttribute("callType") != null && issueWbo.getAttribute("callType").toString().equals("out_call")) {%> 
                                ...
                                <tr>
                                    <td  style="background-color:#A0A0A0;"  >نوع المعاملة</td>
                    ...
                    %>
                    <div style="width: 100.8%;display: block;float: left;" id="section">
                        <fieldset style="width: 98%;background-color: FFFF99;" >
                            ...
                            <div style="width: 41.2%;float: right;">
                                <table border="1px" width="100%" class="table" align="right" style="float: right;margin: 0px !important;">
                                    ...
                                    <tr>
                                        <td style="text-align: right;" >عنـــــوان </td>
                                        <td style="text-align:right;padding-right: 30px">
                                    ...
                                    <tr style="display: <%=showDetails ? "" : "none"%>">
                                        <TD style="text-align: right;" ><b><%=compType%></b></TD>
                                        <TD style="text-align:right;width: 60%;padding-right: 30px">
                                            ...
                                            <div id="complaintComment" style="width: 500px; font-size: larger; background-color: white; border: #005599 thin inset; padding: 5px;"><%=sCompl%></div>
                                ...
                                <div class="buttons-input">
                                    <ul>
                                        ...
                                        <!--li style="display <%--=!isClosed ? "" : "none"--%>;">
                                            <input type="button" class="button_close_nofinish" onclick="popupCloseO(this);"/>
                                        </li-->
                                        <li style="display : <%=clientCompWbo.getAttribute("ticketType").toString().equals("12") ? "" : "none"%>">
                                            <input type="button" class="button_job_order" onclick="popupJoborder();"/>
                                        </li>
                                        <li style="display : <%=!isClosed ? "" : "none"%>">
                                        ...
                                        <li style="display : <%=deleteComplaint ? "" : "none"%>">
                                            <input type="button" class="re-delete" onclick="deleteComplaint('<%=issueId%>', '<%=clientCompId%>');
                                                    return false;" />
                                        </li>
                                        <li style="display : <%=reFinishComplaint ? "" : "none"%>">
                                            <input type="button" class="re-open" onclick="popupFinishO(this);
                                                    return false;"/>
                                        </li>
                                    </ul>
                                </div>
                ...
                <table class="" style="width:100%;text-align: right;border: none;margin-bottom: 20px;" class="table">
                    ...
                    <tr>
                        ...
                        <td width="70%" style="border:0px;text-align: right;">
                            <textarea rows="5"  id="compNotes" style="width: 100%;margin-top: 10px;"></textareae>
                        </td>
                    </tr>
                </table>
            </div>
