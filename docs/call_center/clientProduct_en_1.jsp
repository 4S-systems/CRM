...
//Get request data
 ...
 TradeMgr tradeMgr = TradeMgr.getInstance();
    ...
    String stat = (String) request.getSession().getAttribute("currentMode");
     String dir = null;
    String style = null;
    String  birthDate, search, noRating;
    if (stat.equals("En")) {
...
//                            transition: 'slideDown'});
                    ...
                    function sellUnit() {
                        ...
                        $.ajax({
                            ...
                            <%
                                if (privilegesList.contains("UNDO_PURCHASE")) {
                            %>
                                            + "<TD style='text-align:center;background: #f1f1f1;font-size: 14px;'>"
                         ...
                         <table style="width: 60%; margin-<fmt:message bundle="${getcompl3}"  key="align" /> :15% ">
                            ...
                            <TR style=" " dir='<fmt:message bundle="${getcompl3}"  key="direction" />'>
                                ...
                                <TD id="btnscolumn" style="border: none; width:20%;">
                                              ...
                                              <TD id="btnscolumn" style="border: none; width:20%;">
                                                ...
                                                <div class="dropdown" style="display: inline-table;">
                                                  ...
                                                  <div class="submenuattach">
                                                    <ul class="root">
                                                     <li ><a href="#" style="text-align: right"  onclick="JavaScript: popupAttach2(this);">إضافة ملف</a></li>
                                                        <li ><a href="#" style="text-align: right" onclick="JavaScript: showAttachedClientFiles(this);">مشاهدة الملفات</a></li>
                                                    </ul>
                                                    </div>
                                       ...
                                       <TD id="btnscolumn" style="border: none; width:20%;">
                                             <div class="dropdown" style="display: inline-table; ">
                                        <input type="button" class="button_commen button2 <fmt:message bundle="${getcompl3}"  key="css-comment" />" value='<fmt:message bundle="${getcompl3}"  key="comment" />' />
                      ...
                      <div  style="width: 100%;">
                        ...
                        <div  style="width: 100%;">
                          ...
                          <TABLE id="interestedUnit" class="blueBorder" ALIGN="center" dir='<fmt:message bundle="${getcompl3}"  key="direction"/>'  width="100%" cellpadding="0" cellspacing="0" > 
                            ...
                            <TD CLASS="silver_header" STYLE="border-left: none; text-align:center;color:black;font-size:14px;font-weight: bold; width: 1%;" nowrap ><b></b></TD>
                             </TR>
                            ...
                            <TR style="padding: 1px;">
                                ...
                                <TD style="text-align:center;background: #f1f1f1;font-size: 14px; width: 25%;">
                                 ...
                                 <td style="border-right: none; text-align:center;background: #f1f1f1;font-size: 14px; ">
            ...
            <h1>متابعة عميل</h1>
                <table class="table " style="width:100%;">
                    ...
                    <tr>
                        ...
                        <td style="text-align:right;width: 70%;">
                            <textarea cols="26" rows="3" id="comment">
...
<!--                    <tr>
                        ...
                        <td style="width: 70%;" >
                            ...
                            <textarea  placeholder="" style="width: 100%;height: 60px;" id="appNote" class="login-input"></textarea>
                        </td>
