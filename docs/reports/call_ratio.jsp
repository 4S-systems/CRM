...
Enumeration e = complaintCountsVec != null ? complaintCountsVec.elements() : null;
int totalComplaintsCount = request.getAttribute("totalComplaintsCount") != null ? (Integer) request.getAttribute("totalComplaintsCount") : 0;
...
if(stat.equals("En")){
    ...
    lang="English";
    langCode="En";
    title="التوزيع النسبي لقنوات الأتصال";
    save="&#1573;&#1603;&#1587;&#1600;&#1600;&#1604;";
    cancel="&#1593;&#1608;&#1583;&#1607;";
    TT="العدد الكلي";
    departmentStr="النوع";
    ...
    Percent="&#1575;&#1604;&#1606;&#1587;&#1576;&#1577;";
    pageTitleTip="نسب توزيع المكالمات طبقاً للنوع";
}
%>
...
<script language="javascript" type="text/javascript">
        ...
        function submitForm() {
            document.Stat.action = "<%=context%>/ReportsServletThree?op=callRatio";
            document.Stat.submit();
        }
...
<TABLE class="blueBorder" ALIGN="CENTER" DIR="RTL" ID="code" CELLPADDING="0" CELLSPACING="0" width="350" STYLE="border-width:1px;border-color:white;display: block;" >
    <TR>
    ...
    <TR>
        <td bgcolor="#dedede" valign="middle">
            <select id="userID" name="userID" STYLE="width:80%;font-size: medium;"
            ...
            <input type="hidden" name="op" value="callRatio"/>
        </td>
    </TR>
</TABLE>
...
<CENTER>
    ...
    <TABLE WIDTH="400" ALIGN="<%=align%> " DIR="<%=dir%>" CELLPADDING="0" CELLSPACING="0" >
        ...
        <TR>
            <TD>
                <%=wbo.getAttribute("callType")%>
            </TD>
            <TD>
                <%=wbo.getAttribute("callCount")%>
            </TD>
        </TR>      
        <%
            }
