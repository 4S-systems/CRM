...
String EqReadReport=(String)request.getAttribute("EqReadReport");
...
String sTitle, sCancel, sOk, sSearchTitle, sSearchStatus, AddCode, AddName,tit,allEq,alert;
String scheduleTitle,equipmentTitle;
if(stat.equals("En")){
    ...
    allEq="Select All Equipments";
    alert="You Must Select Vaild Equipment";
    scheduleTitle="Schedule maintenance of equipments report";
    equipmentTitle="Operation of the equipment report";
}else{
    ...
    allEq="&#1575;&#1582;&#1578;&#1610;&#1575;&#1585; &#1580;&#1605;&#1610;&#1593; &#1575;&#1604;&#1605;&#1593;&#1583;&#1575;&#1578;";
    alert="&#1605;&#1606; &#1601;&#1590;&#1604;&#1603; &#1575;&#1582;&#1578;&#1585; &#1605;&#1593;&#1583;&#1607; &#1605;&#1608;&#1580;&#1608;&#1583;&#1607;";
    scheduleTitle="&#1578;&#1602;&#1585;&#1610;&#1585; &#1580;&#1583;&#1575;&#1608;&#1604; &#1575;&#1604;&#1589;&#1610;&#1575;&#1606;&#1577; &#1604;&#1604;&#1605;&#1593;&#1583;&#1575;&#1578;";
    equipmentTitle="&#1578;&#1602;&#1585;&#1610;&#1585; &#1581;&#1585;&#1603;&#1577; &#1578;&#1588;&#1594;&#1610;&#1604; &#1575;&#1604;&#1605;&#1593;&#1583;&#1575;&#1578;";
}
%>
     ...
     function submitForm()
        {
         ...
         var EqReadReport="<%=EqReadReport%>"
         if(document.getElementById('all').checked && EqReadReport=="no")
            {
                    document.USERS_FORM.action = "<%=context%>/EquipmentServlet?op=eqTablesReport&get=All";
                    document.USERS_FORM.submit();
            }
         if(document.getElementById('all').checked && EqReadReport=="yes")
            {
                    document.USERS_FORM.action = "<%=context%>/EquipmentServlet?op=eqReadingReport&get=All";
                    document.USERS_FORM.submit();
            }
         if(document.getElementById('all').checked==false && EqReadReport=="no")
            {       
                if(document.getElementById('equipmentId').value==""||document.getElementById('equipmentId').value=="Auto Select Code"){
                    ...
                    document.USERS_FORM.action = "<%=context%>/EquipmentServlet?op=eqTablesReport&get=eq";
                    document.USERS_FORM.submit();
                }
            }       
         if(document.getElementById('all').checked==false && EqReadReport=="yes")
            {
                if(document.getElementById('equipmentId').value==""||document.getElementById('equipmentId').value=="Auto Select Code"){
                    alert("You Must Select Or write code or name of Equipment");
                    document.getElementById('equipmentId').focus()
                    ...
                    document.USERS_FORM.action = "<%=context%>/EquipmentServlet?op=eqReadingReport&get=eq";
                    document.USERS_FORM.submit();
                }
            }
        }
            ...
            <fieldset class="set" align="center">
                ...
                <TABLE ALIGN="CENTER" DIR="<%=dir%>" ID="code" CELLPADDING="0" CELLSPACING="0" width="650" STYLE="border-width:1px;border-color:white;">
                    ...
                    <tr>
                        ...
                        <TD CLASS="cell" ALIGN="<%=align%>" bgcolor="#99cccc" STYLE="text-align:center;font-size:14;border-width:1px;border-color:white" WIDTH="175">
                            <input type="checkbox" name="all" id="all" value="all" onclick="disable();">
                        </td> 
                    </tr>
                    
                    <TR>
                        <TD CLASS="cell" ALIGN="<%=align%>" bgcolor="#99cccc" STYLE="text-align:center;font-size:14;border-width:1px;border-color:white;" WIDTH="175">
                            <input type="radio" name="SelectOption" id="SelectOption" onClick="mod('name');"><b><%=AddName%></b>
                        </TD>
                    ...
                    <TR>
                        <TD CLASS="cell" ALIGN="<%=align%>" bgcolor="#99cccc" STYLE="text-align:center;font-size:14;border-width:1px;border-color:white" WIDTH="175">
                            <input type="radio" name="SelectOption" id="SelectOption" onClick="mod('code');" checked><b><%=AddCode%></b>                   
                        </TD>
                    </TR>
