...
<%
    ...
    String align, dir, style, sTitle, message, model, fromDate, toDate, search, min, max;
    if (stat.equals("En")) {
        align = "center";
        dir = "LTR";
...
<HTML>
    ...
    <script type="text/javascript">
        ...
        function getClientInfo2(obj) {
            var beDate = $("#fromDate").val();
            var enDate = $("#toDate").val();
            
            document.CLIENT_FORM.action = "<%=context%>/SearchServlet?op=searchForUnitBetween2Dates&beDate=" + beDate + "&enDate=" + enDate;
...
//            var unitCategoryId = document.getElementById("unitCategoryId").value;
	    ...
	    var unitStatus = $('input[name=unitStatus]:checked').val();
            var beDate = $("#fromDate").val();
            var enDate = $("#toDate").val();
	    var url = "<%=context%>/SearchServlet?op=searchForUnitBetween2DatesExcel&unitStatus=" + unitStatus+"&fromDate="+beDate+"&toDate="+enDate;
    ...
    <BODY>
        <FORM NAME="CLIENT_FORM" METHOD="POST">
            <div style="margin-left: auto;margin-right: auto;width: 96%" class="set">
                ...
                <table style="display: <%=userPrevList.contains("EXCEL") ? "" : "none"%>; direction: <%=dir%>; width: 60%; padding-bottom: 2%; padding-top: 2%; margin-bottom: 2%; margin-top: 2%;">
                        <tr>
                            ...
                            <td bgcolor="#F7F6F6" style="text-align:center; width: 30%; border: none;" valign="middle" rowspan="2">
                    ...
                    <tr>
                        ...
                        <td width="70%"style="text-align:right;">
                            <div style="width: 100%;">
                                ...
                                <input type="button" onclick="JavaScript: openSearch(this);" value="بحث"  id="bReserv" name="bReserv" />
