...
<HTML>
    ...
    <SCRIPT LANGUAGE="JavaScript" TYPE="text/javascript">
        ...
        function submitForm()
        {    
        document.ISSUE_FORM.action = "<%=context%>/SearchServlet?op=MaintenanceListProject";
        ...
        <FORM NAME="ISSUE_FORM" METHOD="POST">
            ...
            <TABLE CELLPADDING="0" CELLSPACING="0" BORDER="0">
                ...
                <TD class='td'>
                    ...
                    <TD class='td'>
                        <LABEL FOR="Project_Name">
                            <p><b><%=tGuide.getMessage("maintenance")%><font color="#FF0000">*</font></b>&nbsp;
                        </LABEL>
                    </TD>
                    <TD class='td'>
                        <SELECT name="maintenanceID">
                            <sw:WBOOptionList wboList='<%=maintenanceMgr.getCashedTableAsBusObjects()%>' displayAttribute = "maintenanceName" valueAttribute="maintenanceName"/>
                        </SELECT>
                    </TD>
                </TR>                         
            </TABLE>
