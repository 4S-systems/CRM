...
<%
    ...
    String title, fromDate, toDate, search, num, clntNm, mob, email, emp, createdBy, creationTime,
            group, employ;
    if (stat.equals("En")) {
        title = "Clients Without Communication Channels Customization Report";
        fromDate = "From Date";
        toDate = "To Date";
        search = "Search";
        num = "No.";
        ...
        title = "تقرير التخصيص لعملاء بدون قنوات إتصال";
        fromDate = "من تاريخ";
        toDate = "إلى تاريخ";
        search = "بحث";
        num = "م";
    ...
    <head>
        ...
        <script>
            ...
            function search(){
                ...
                document.LOCKED_CLIENT_FORM.action = "<%=context%>/AppointmentServlet?op=getAllCustomizedClntsWithoutComChannel&beginDate=" + sBeginDate + "&endDate=" + sEndDate+"&employee="+employee+"&groupId="+groupId;
