...
int totalComplaintsCount = (Integer) request.getAttribute("totalComplaintsCount");
...
if(stat.equals("En")){
    ...
    lang="   &#1593;&#1585;&#1576;&#1610;    ";
    langCode="Ar";
    title="Complaint Distribution Rates";
    save=" Excel Sheet";
    cancel="Back To List";
    TT="Total Complaints ";
    ...
    lang="English";
    langCode="En";
    title="نسب توزيع الشكاوى";
    save="&#1573;&#1603;&#1587;&#1600;&#1600;&#1604;";
    cancel="&#1593;&#1608;&#1583;&#1607;";
    TT="&#1593;&#1583;&#1583; &#1575;&#1604;&#1588;&#1603;&#1575;&#1608;&#1609; ";
    departmentStr="الإدارة";
    complaintsCountStr="عدد الشكاوى";
    Percent="&#1575;&#1604;&#1606;&#1587;&#1576;&#1577;";
    pageTitleTip="نسب توزيع الشكاوى طبقاً للإدارة";
}
%>
...
<CENTER>
    ...
    <TABLE WIDTH="400" ALIGN="<%=align%> " DIR="<%=dir%>" CELLPADDING="0" CELLSPACING="0" >
        ...
        <TR>
            <TD>
                <%=wbo.getAttribute("departmentName")%>
            </TD>
            <TD>
