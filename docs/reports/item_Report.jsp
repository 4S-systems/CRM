...
String lang,langCode, cancel, title,total,excel;
...
if(stat.equals("En")){
    ...
    langCode = "Ar";
    cancel = "Cancel";
    title = "Equipments list for category";
    ...
    langCode = "En";
    cancel = "&#1573;&#1606;&#1607;&#1575;&#1569;";
    title = "&#1578;&#1602;&#1585;&#1610;&#1585; &#1576;&#1606;&#1608;&#1583; &#1575;&#1604;&#1589;&#1610;&#1575;&#1606;&#1607; &#1604;&#1604;&#1589;&#1606;&#1601;";
        ...
        <FORM NAME="EQP_REPORT_FORM" METHOD="POST">
            ...
            <center>
                <table dir="<%=dir%>" align="<%=align%>">
                    <tr>
                        <td bgcolor="#FFFFFF">
                            <b><font size="5" color="blue"><%=title%>:&nbsp;</font><font color="red" size="5"><%=catWbo.getAttribute("unitName")%></font></b>
                        </td>
                    </tr>
                </table>
                <br>
            ...
            for(int i=0; i<items.length; i++){
                headerItem = (String)itemHeaders.get("Att"+(String)items[i]);
                        ...
                        <td align="center" style="border-style: ridge;border-width: 1px;border-color: black;">
                            ...
                            <%=taskTitle%>
                            <%}else{
                            if(itemWbo.getAttribute(headerItem)!=null){
                            %>
                ...
                <table width="90%"  bgcolor="#E6E6FA">
                    <tr>
                        ...
                        <td width="60%" align="center" colspan="<%=items.length+2%>" style="border-style: ridge;border-width: 1px;border-color: black;">
