...
<HTML>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function submitForm()
        {
            ...
            document.EmployeesLoads.action = "<%=context%>/ReportsServlet?op=employeesLoadDynamicReport&id=" + id + "&searchBy=" + searchBy;
        ...
        <FORM name="EmployeesLoads" method="post">
            <FIELDSET class="set" style="width:85%;border-color: #006699">
                ...
                <TABLE class="blueBorder" ALIGN="center" DIR="RTL" ID="code" CELLPADDING="0" CELLSPACING="0" width="85%" STYLE="border-width:1px;border-color:white;" >
                    <TR>
                        <TD style="text-align:right" bgcolor="#dedede"  valign="MIDDLE" >
                            <ul style="padding-top: 10px; font-weight: bold; font-size: 16px; color: blue; list-style-type: none;">
                                <li>
                                    <input type="radio" id="searchByDepartment" name="searchBy" onchange="switchSearch();">
                                    بالقسم:
                                    <ul>
                                        <select style="width: 50%; font-weight: bold; font-size: 13px" disabled="disabled" id="departmentId" name="departmentId">
                            ...
                            <ul style="font-weight: bold; font-size: 16px; color: blue; list-style-type: none;">
                                <li>
                                    <input type="radio" id="searchByGroup" name="searchBy" onchange="switchSearch();" />
                                    بالمجموعة:
                                    <ul>
                                        <select style="width: 50%; font-weight: bold; font-size: 13px;" disabled="disabled" id="groupId" name="groupId">
                                            <sw:WBOOptionList displayAttribute="groupName" valueAttribute="group_id" wboList="<%=groups%>" scrollToValue='<%=request.getParameter("group_id")%>' />
                                        </select>
                                    </ul>
                                </li>
                            </ul>
                    ...
                    <TR>
                        <td  bgcolor="#dedede"  style="text-align:center; padding-bottom: 5px; padding-top: 5px" valign="middle">
                ...
                <br/>
                <div id="containerPie" style="width: 100%; height: 50%; margin: 0 auto"></div>
                <br/>
                <center><hr style="width: 85%" /></center>
                <%}%>
                <br/>
