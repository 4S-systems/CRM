...
<html>
    <%
        ...
        List<WebBusinessObject> appointmentsList = (List) request.getAttribute("appointmentsList");
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function() {
                chart = new Highcharts.Chart({
                    ...
                    title: {
                        text: 'متابعات "' + $("#userId option:selected").text() + '" في الربع ' + $("#quarter option:selected").text() + ' لعام ' + $("#year option:selected").text()
                    },
                    subtitle: {
                        text: ''
                    },
                    xAxis: {
                        ...
                        categories: [<% if (appointmentsList != null) {
                                for (int i = 0; i < appointmentsList.size(); i++) {
                                    WebBusinessObject wbo_ = appointmentsList.get(i);
                                    if (i > 0) {
                                        out.write(",");
                                    }
            ...
            {
                var id = $("#userId").val();
                document.ProductivityByUser.action = "<%=context%>/ReportsServletThree?op=getAppointmentsByUserReport&id=" + id;
                ...
                <div style="width: 85%;margin-right: auto;margin-left: auto;" id="showClients">
                    <table ALIGN="<%=align%>" dir="<%=dir%>" WIDTH="100%" id="clients" style="">
                        ...
                        <tbody>
                            <%
                            int total = 0;
                            for (WebBusinessObject wbo_ : appointmentsList) {
                                try {
                        ...
                        <tfoot>
                            <tr>
                                <th style="color: #005599 !important;font-size: 14px; font-weight: bold;" colspan="2">أجمالي المتابعات</th>
