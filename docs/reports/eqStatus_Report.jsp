...
String mainInfo,maintItems,spareParts,eqName,joNum,serviceEntryDATE,numHours,startWokingDate,actualEndDate,joName,eqJO,eqAge;
String joStartDate,joEndDate,joDate,notStarted,notFinished;
if(stat.equals("En")){
    align="left";
    dir = "LTR";
    ...
    totalJO="&#1575;&#1580;&#1605;&#1575;&#1604;&#1609; &#1575;&#1608;&#1575;&#1605;&#1585; &#1575;&#1604;&#1588;&#1594;&#1604; &#1581;&#1578;&#1609; &#1575;&#1604;&#1610;&#1608;&#1605;";
    lastReading="&#1575;&#1582;&#1585; &#1602;&#1585;&#1575;&#1569;&#1607; &#1604;&#1604;&#1605;&#1593;&#1583;&#1607;";
    serviceEntryDATE="&#1578;&#1575;&#1585;&#1610;&#1582; &#1583;&#1582;&#1608;&#1604; &#1575;&#1604;&#1582;&#1583;&#1605;&#1607;";
    eqAge="&#1593;&#1605;&#1585; &#1575;&#1604;&#1605;&#1593;&#1583;&#1607;";
        ...
        <FORM NAME="EQP_REPORT_FORM" METHOD="POST">
            ...
            <center>
                ...
                <table dir="<%=dir%>"  align="center" width="90%">
                        ...
                        <td style="border:2px;border-right-width:2px;border-color:Black;border-style: solid;">
                            <table dir="<%=dir%>"  align="<%=align%>" width="100%">
                                <tr>
                                    ...
                                    <td class="td" width="10%" style="<%=style%>;font:BOLD 12px arial;">
                                    ...
                                    <td class="td" width="15%" style="<%=style%>;font:BOLD 12px arial;">
                                        <b> <font color="black" size="2">
                                    ...
                                    <td class="td" bgcolor="#DCDCDC" style="<%=style%>;font:BOLD 12px arial;">
                                        <b><font color="black" size="2"> <%=serviceEntryDATE%>:</font></b>
                                    </td>
                                    <td class="td" width="20%" style="<%=style%>;font:BOLD 12px arial;">
                                        
                                        <%if((String)equipmentWbo.getAttribute("serviceEntryDATE")!=null){%>
                                        <b> <font color="black" size="2">
                    ...
                    <tr>
                        <td style="font:BOLD 12px arial;" bgcolor="#CCCCFF">
                            <b><font size="3" color="blue"><%=totalJO%>&nbsp;:&nbsp;<%=eqIssues.size()%></font></b>
                        </td>
                    </tr>
                                ...
                                <tr>
                                    ...
                                    <td style="<%=style%>;font:BOLD 12px arial;">
                                        <table dir="<%=dir%>"  align="<%=align%>" width="100%">
                                            ...
                                            <%}}else{%>
                                            <tr>
                                                <td class="td" style="text-align:<%=align%>;font:BOLD 12px arial;">
