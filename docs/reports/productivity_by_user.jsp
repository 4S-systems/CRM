...
<html>
    <%
        ...
        if (stat.equals("En")) {
            ...
            title = "Productivity by Employee";
            print = "get report";
        } else {
            align = "center";
            dir = "RTL";
            style = "text-align:Right";
            title = "اﻷنتاجية بالموظف";
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function() {
                chart = new Highcharts.Chart({
                    ...
                    title: {
                        text: 'أنتاجية "' + $("#userId option:selected").text() + '" في الربع ' + $("#quarter option:selected").text() + ' لعام ' + $("#year option:selected").text()
                    },
                    subtitle: {
                        text: ''
                    },
            ...
            {
                var id = $("#userId").val();
                document.ProductivityByUser.action = "<%=context%>/ReportsServletThree?op=getProductivityByUser&id=" + id;
