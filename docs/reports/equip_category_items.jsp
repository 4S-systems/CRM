    ...
    String cMode= (String) request.getSession().getAttribute("currentMode");
        ...
        if(stat.equals("En")){
            ...
            part_unit="Part unit";
            part_code="Part code";
            eq_cat_name="Equipment category name";
            cat="Catergory";
            part_price="Part price";
            title_1="List equipment category parts";
        ...
        <SCRIPT LANGUAGE="JavaScript" TYPE="text/javascript">
            ...
            document.ITEMS_FORM.action = "ItemsServlet?op=EquipmentCatItemsReport";
            document.ITEMS_FORM.submit();	
            }
             function cancelForm()
            {    
