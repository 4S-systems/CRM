...
<HTML>
    <%
        ...
        if (stat.equals("En")) {
            ...
            langCode = "Ar";
            groupByStr = "&#1575;&#1604;&#1602;&#1587;&#1605; ";
            title = "Appointments Productions";
            print = "get report";
            status = "Status";
            beginDate="From Date";
            endDate="To Date";
                    ...
                    xAxis: {
                        ...
                        categories: [<% if (loads != null) {
                                for (int i = 0; i < loads.size(); i++) {
                                    ...
                                    out.write("'" + (String) wbo_.getAttribute("fullName") + "'");
                                }
                            }%>],
                        title: {
                            text: null
    ...
    <script language="javascript" type="text/javascript">
        ...
        function submitForm()
        {
            ...
            document.EmployeesLoads.action = "<%=context%>/ReportsServlet?op=getFollowupProductions&id=" + id;
                ...
                <TABLE class="blueBorder" ALIGN="center" DIR="RTL" ID="code" CELLPADDING="0" CELLSPACING="0" width="85%" STYLE="border-width:1px;border-color:white;" >
                    ...
                    <TR>
                        ...
                        <TD style="text-align:right" bgcolor="#dedede"  valign="MIDDLE" >
                                        ...
                                        String startDate =null;String toDate =null;
                    ...
                    <TABLE ALIGN="<%=align%>" dir="<%=dir%>" WIDTH="100%" id="clients" style="">
                        ...
                        <tbody>
                            ...
                            <tr style="cursor: pointer" id="row">
                                <TD>
                                    <%if (wbo_.getAttribute("fullName") != null) {%>
                                    <b><%=wbo_.getAttribute("fullName")%></b>
                                    <% }%>
                                </TD>
                        ...
                        <tfoot>
                            <tr>
                                <th style="color: #005599 !important;font-size: 14px; font-weight: bold;">أجمالي المقابلات</th>
