<%-- 
    Document   : search_my_clients2
    Created on : Feb 25, 2021, 11:05:12 AM
    Author     : mariam
--%>
...
<fmt:setBundle basename="Languages.searchClient.searchClient"  />
    ...
    <%
        ...
        String clientNoStatus = request.getAttribute("clientNoStatus")!=null ? (String) request.getAttribute("clientNoStatus"): "";
        ...
        ArrayList<WebBusinessObject> clients = (ArrayList<WebBusinessObject>) request.getAttribute("clientsVec");
        String[] tableHeader = new String[5];
        String align = null;
        String dir = null;
        String style = null;
        String sTitle, message, client,infoTitle,titleNOStatus;

        if (stat.equals("En")) {
            align = "center";
            dir = "LTR";
            style = "text-align:left";
            sTitle = "My Rated Client Search";
            tableHeader[0] = "id";
            ...
            titleNOStatus=" No client rated or owned by user ";
        } else {
            align = "center";
            dir = "RTL";
            ...
            message = "";
            client = " عميل جديد ";
            infoTitle="معلومات عن التقرير";
            titleNOStatus="لا يوجد عملاء تم تقيمهم او يعودون الى المستخدم";
        }
    %>
            ...
            function getClientInfo2(obj) {
                ...
                if ($("#searchValue").val().length >= 3) {
                    ...
                    if (value == 'clientNo') {
                        ...
                        document.CLIENT_FORM.action = "<%=context%>/SearchServlet?op=searchForClients2&searchBy=" + value + "&valueSearch=" + searchByValue;
    ...
    <body>
        <form name="CLIENT_FORM" method="POST">
            <div style="margin-left: auto;margin-right: auto;width: 96%" class="set">
                    ...
                    <fieldset class="set" align="center" width="100%" style="width: 70%;margin-bottom: 10px;">
                        <legend align="center">
                            <table dir="<%=dir%>" align="center">
                                <tr>
                                    <td class="td" style="width: 465px;text-align: center;">
                                        <font color="blue" size="6">
                                        <%=sTitle%>
                                        </font><img src="images/icons/info.png" width="10%" onclick="javascript:getPageInfo();"/>
                                    </td>
                                </tr>
                            </table>
                        </legend>
                                        
                        <div style="width: 350px;margin-left: auto;margin-right: auto;height: 37px;">
                            <input type="button"  onclick="JavaScript:newClient();" style="float: right;margin-right:85px; display: <%=displayClient ? "block" : "none"%>;" class="button2" value='<%=client%>' />
                        </div>
                ...
                <p style="font-weight: bold;color: brown;"><%=titleNOStatus%></p>
                <%}%>
            </div>
        </form>
            <div id="infoPopupDiv" style="display: none;margin: 400px">
                <div style="border: 5px solid #3a87ad;background-color: whitesmoke;border-radius: 7px;">
                    <H4 style="text-align: center;color:blue;"><%=infoTitle%></H4>
                <SPAN>هذا التقرير يبحث عن العملاء الذى تم تقيمهم من خلال المستخدم</SPAN>
                </DIV>
            </div>
    </body>
</html>     
