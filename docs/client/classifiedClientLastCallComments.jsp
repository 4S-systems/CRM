...
<HTML>
    <%
        ...
        int t = clientsAttributes.length;
        String attName = null;
        ...
        String align, xAlign, fromDate,cmntD, toDate, display, classification, clntCom, com, dir, fApp, Src, appDate, appTyp,
                projectStr, lstCmntDtStr, lstCmntStr;
        if (stat.equals("En")) {
            align = "center";
            xAlign = "right";
            dir = "LTR";
            ...
            fApp = "First Comment";
            Src = "Source";
            appDate = "Comment Date";
            appTyp = "Comment Type";
            projectStr = " Projects ";
            lstCmntDtStr = " Last Comment Date ";
            lstCmntStr = " Last Comment ";
        } else {
            align = "center";
            xAlign = "left";
            dir = "RTL";
            ...
            fApp = " أول تعليق ";
            Src = "المعلق";
            appDate = "تاريخ التعليق";
            appTyp = "نوع التعليق";
            projectStr = " المشاريع ";
            lstCmntDtStr = " تاريخ أخر تعليق ";
            lstCmntStr = " أخر تعليق ";
        }
        ...
        <script type="text/javascript">
            ...
            function exportToExcel() {
                if(checkSpace()){
                    ...
                    var url = "<%=context%>/ClientServlet?op=getClassifiedClientsLastCommentsExcel&toDate=" + toDate + "&fromDate=" + fromDate + "&mainClientRate=" + clientRate + "&projectID=" + $("#projectID option:selected").val() + "&hashTag=" + $("#hashTag").val();
            ...
            function submitForm(){
                if(checkSpace()){
                    document.CLASSIFICATION_FORM.action = "<%=context%>/ClientServlet?op=getClassifiedClientsLastCallComments";
    ...
    <body>
        ...
        <b style="float: <%=xAlign%>; font-size: 16px; color: #005599; font-style: oblique; margin-<%=xAlign%>: 80px;">
            Clients' Last Call Comments اخر التعليقات لمكالمات العملاء
        </b>
                ...
                <table class="blueBorder" align="center" dir="<%=dir%>" id="code" cellpadding="0" cellspacing="0" style="width: 50%;" >
                    ...
                    <tr>
                        <td bgcolor="#dedede" valign="middle" style="width: 50%;" colspan="3">
                            <input type="text" style="width: 90%;" id="fromDate" name="fromDate" size="20" maxlength="100" title="<%=cmntD%>" readonly="true"
                                   value="<%=request.getAttribute("fromDate") == null ? "" : request.getAttribute("fromDate")%>"/>
                        </td>
                        
                        <td bgcolor="#dedede" valign="middle" style="width: 50%;" colspan="3">
                            <input type="text" style="width:90%;" id="toDate" name="toDate" size="20" maxlength="100" readonly="true" title="<%=cmntD%>" 
                            ...
                            %>
                                    <tr>
                                       <%-- <td style="text-align:right;">
                                        ...
                                        <td>
                                            <b>
                                                 <%=clientWbo.getAttribute("comDate").toString().split(" ")[0]%> 
                                            </b>
                                        </td>

                                        <td>
                                           <b>
                                                <%=clientWbo.getAttribute("lstCom")%> 
                                           </b>
                                        </td>
