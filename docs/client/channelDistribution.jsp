<%-- 
    Document   : channelDistribution
    Created on : Apr 22, 2018, 9:29:50 AM
    Author     : fatma
--%>
...
<html>
    ...
    <body>
        <fieldset class="set" style="border-color: #006699; width: 90%;margin-top: 10px;border-radius: 5px;">
            <form name="SEARCH_CLIENT_FORM" action="<%=context%>/ClientServlet?op=channelsDistributionAnalysis" method="POST">
                ...
                <table ALIGN="center" DIR="<%=dir%>" WIDTH="50%" CELLSPACING=2 CELLPADDING=1>
                    ...
                    <tr>
                        <td STYLE="text-align:center" bgcolor="#dedede" colspan="2">
                            <button type="submit" onclick="JavaScript: search();"  STYLE="color: #27272A;font-size:15px;margin: 10px;font-weight:bold; width: 180px; "> Generate Report <IMG HEIGHT="15" SRC="images/search.gif" ></button>  
                        </td>
                    </tr>
                </table>
                <br/><br/>
                        ...
                        <TABLE ALIGN="<%=align%>" dir="<%=dir%>" WIDTH="100%" id="channels">
                            <thead>
                                <tr>
                                    ...
                                    <th style="color: #005599 !important;font: 14px; font-weight: bold;">Total Amount (LE)</th>
                                    <th style="color: #005599 !important;font: 14px; font-weight: bold;">Cost per Client</th>
                                </tr>
                            </thead>
                            <tbody>
                                <%
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: center; font-size: 14px; font-weight: bold;" valign="middle">
                                        <%=df.format(Double.valueOf((String) channelWbo.getAttribute("totalAmount")))%>
                                    </td>
                                    <td style="text-align: center; font-size: 14px; font-weight: bold;" valign="middle">
                                        <%=df.format(Double.valueOf((String) channelWbo.getAttribute("totalAmount")) / Double.valueOf((String) channelWbo.getAttribute("total")))%>
                                    </td>
                                </tr>
                                <%
                                        }
