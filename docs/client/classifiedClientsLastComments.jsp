...
<HTML>
    <%
        ...
        String align, xAlign, fromDate, toDate, display, classification, clntCom, com, dir, fApp, Src, appDate, appTyp,
    ...
    <HEAD>
        ...
        <script type="text/javascript">
            ...
            function submitForm(){
                if(checkSpace()){
                    document.CLASSIFICATION_FORM.action = "<%=context%>/ClientServlet?op=getClassifiedClientsLastComments";
