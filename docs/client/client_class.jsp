...
<HTML>
    <%
        ...
        String align = null, xAlign, fromDate, toDate, display, classification, clntCom, com;
        String dir = null, fApp, Src, appDate, appTyp, distType, all, campaign;
        if (stat.equals("En")) {
            align = "center";
            xAlign = "right";
            dir = "LTR";
...
//                            alert("تم التقييم");
            ...
            function exportToExcel() {
                ...
                var url = "<%=context%>/ClientServlet?op=getClientClassExcel&toDate=" + toDate + "&fromDate=" + fromDate + "&mainClientRate=" + clientRate +"&campaignID="+campaignID+"&type="+type;
            ...
            <form name="CLASSIFICATION_FORM" action="<%=context%>/ClientServlet?op=getClientClass" method="POST">
                ...
                <table class="blueBorder" align="center" dir="rtl" id="code" cellpadding="0" cellspacing="0" width="650" style="border-width: 1px; border-color: white; display: block;" >
                    ...
                    <tr>
                        ...
                        <td class="blueBorder blueHeaderTD" style="font-size:18px;">
                            <b><font size=3 color="white"><%=distType%></b>
                        </td>
                    </tr>
                    <tr>
                        <td bgcolor="#dedede" valign="middle">
				...
				<option value=""> <%=all%> </option>
                    ...
                    <tr>
                        <td class="blueBorder blueHeaderTD" style="font-size:18px;" colspan="2">
                            <b><font size=1.5 color="white"><%=campaign%></b>
                        </td>
                    </tr>
                    <tr>
                        <td bgcolor="#dedede" valign="middle" colspan="2">
                        ...
                        <thead>
                            <tr>
                               <th><%=clientsListTitles[3]%></th>
                                ...
                                %>
                                <th>
                                    <B>Last Appointment Date</B>
                                </th>
                                <th>
                                    <B>Last Appointment Comment</B>
                                </th>
                        ...
                        <tbody>
                            ...
                            <tr>
                               <td style="text-align:right;">
                                ...
                                <%}else{%>
                                    <a href="#"><img style="height:20px;" src="images/icons/my-appointments.png" title="My Appointments" onclick="JavaScript: popupMyClientAppointments( <%=clientWbo.getAttribute("id")%>);"/></a>
                                 <%}%>
                                    <%
                                        }
                                    %>
                                ...
                                <td>
                                   <b><%=clientWbo.getAttribute("lstAppCom")%></b>
                                </td>
