...
<html>
    ...
    <body>
        ...
        <div style="width: 100%; text-align: center;"> <b> <font size="3" color="red"> <%=PN%> : <%=data.size()%> </font><br/><font size="3" color="blue"> <%=campaign%> : <%=campaignWbo != null ? campaignWbo.getAttribute("campaignTitle") : ""%> </font></b></div> 
        <br/>
