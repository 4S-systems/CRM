...
<%
    ...
    if (stat.equals("En")) {
        ...
        dir = "RTL";
        title = "أخر التعليقات على العملاء";
        beginDate = "&#1605;&#1606; &#1578;&#1575;&#1585;&#1610;&#1582;";
        endDate = "&#1575;&#1604;&#1609; &#1578;&#1575;&#1585;&#1610;&#1582;";
        ...
        <SCRIPT LANGUAGE="JavaScript" TYPE="text/javascript">
            ...
            function getComplaints() {
                ...
                if (from === null || from === "") {
                    ...
                    document.COMP_FORM.action = "<%=context%>/CommentsServlet?op=getLastCommentWithClient&createdBy=" + createdBy + "&from=" + from + "&to=" + to + "&interCode=" + interCode;
                        ...
                        <FIELDSET class="set" style="width:98%;border-color: #006699">
                            ...
                            <table align="center" dir="rtl" width="99%" cellspacing="2" cellpadding="1">
                                <tr>
                                    ...
                                    <td class="blueBorder blueHeaderTD" style="font-size:18px;"WIDTH="20%" id="hide">
                                ...
                                <tr>
                                    <td style="text-align:center" bgcolor="#dedede"  valign="MIDDLE" >
                                        <input title="تاريخ دخول العميل" id="from" readonly name="from" type="text" value="<%=from%>" style="width: 180px; cursor: hand" />                 
                                        <br><br>
                                    </td>
                                    <td  bgcolor="#dedede"  style="text-align:center" valign="middle">
                                        <input title="تاريخ دخول العميل" id="to" readonly name="to" type="text" value="<%=to%>" style="width: 180px; cursor: hand" />
                                        <br><br>
                                    </td>
                                    <td style="text-align:center" bgcolor="#dedede"  valign="MIDDLE" id="hide">
                                    ...
                                    <td style="text-align:center" bgcolor="#dedede"  valign="MIDDLE">
                                        <select id="departmentID" name="departmentID" style="font-size: 14px;font-weight: bold; width: 180px;" >
                                    ...
                                    <table class="display" id="requests" align="center" DIR="<%=dir%>" WIDTH="100%" CELLPADDING="0" cellspacing="0">
                                        <thead>
                                            <tr>
                                                ...
                                                <TH STYLE="text-align:center;font-size:<%=(stat.equals("En")) ? "14px" : "16px"%>; font-weight: bold" width="11%"><b>الحملة</b></TH>
                                        ...
                                        <tbody>
                                            <%
                                                ...
                                                String customerName, lastCommenter, phone, mobile, interPhone, campaign,description, comment, callDuration;
                                                for (WebBusinessObject wbo : data) {
                                                    ...
                                                    formatted2 = DateAndTimeControl.getFormattedDateTime((String) wbo.getAttribute("clCreation_time"), stat);
                                                    ...
                                                    campaign=(wbo.getAttribute("CAMPAIGN_TITLE") != null && !wbo.getAttribute("CAMPAIGN_TITLE").toString().equalsIgnoreCase("UL")) ? (String) wbo.getAttribute("CAMPAIGN_TITLE") : "";
                                            ...
                                            <tr id="row">
                                                ...
                                                <td width="11%"><b><%=campaign%></b></td>  
                                                <td width="11%"><b><%=lastCommenter%></b></td>            
                                                <td width="10%"><font color="red"><%=formatted2.getAttribute("day")%> - </font><b><%=formatted2.getAttribute("time")%></b></td>
