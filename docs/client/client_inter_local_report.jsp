            ...
            function getGroupUsers(isPost) {
                ...
                $.ajax({
                    ...
                    success: function (jsonString) {
                        try {
                            var output = [];
                            var currentOwnerID = $("#currentOwnerID");
                            $(currentOwnerID).html("");
                            ...
                            currentOwnerID.html(output.join(''));
                            if (isPost && '' !== '<%=currentOwnerID%>') {
            ...
            <table align="center" width="100%" cellpadding="0" cellspacing="0" style="">
                <tr>
                    <td width="100%" class="titlebar">
                        <font color="#005599" size="4">العملاء الدوليين والمحليين لموظف</font>
                    </td>
                </tr>
            </table>
            <br/>
            <form name="stat_form" method="POST">
                <table align="<%=align%>" dir="<%=dir%>" cellpadding="0" cellspacing="0" style="border: 2px solid #d3d5d4">
                    <tr>
                        ...
                        <td style="text-align: right; color: black; font-size: 14px; padding-left: 5px; border-left-width: 0px" nowrap class="silver_even_main" >
                            <select id="currentOwnerID" name="currentOwnerID" style="font-size: 14px; width: 150px;">
                            </select>
                        </td>
