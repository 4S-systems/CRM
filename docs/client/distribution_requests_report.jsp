...
<html>
    <head>
        ...
        <script type="text/javascript">
            ...
            function getResults() {
                ...
                document.stat_form.action = "<%=context%>/ClientServlet?op=getDistributionRequestsReport&depratmentID=" + depratmentID + "&beginDate=" + beginDate + "&endDate=" + endDate + "&userID=";
            ...
            function popupViewComplaints(userID, type, typeName, clientName) {
                ...
                $.ajax({
                    type: "post",
                    url: '<%=context%>/ClientServlet?op=getRequestsByOwnerInPeriod',
                    data: {
                        userID: userID,
                        type: type,
                        fromDate: '<%=fromDate%>',
                    ...
                    success: function (data) {
                        divTag.html(data).dialog({
                            modal: true,
                            title: "طلبات المسؤول " + clientName + " (" + typeName + ")",
                            show: "fade",
                            hide: "explode",
                            width: 950,
                            position: {
    ...
    <body>
        <form name="stat_form" method="POST">
            ...
            <div style="margin-left: auto; margin-right: auto;"><h1 style="color: #0000ff;">تقرير توزيع الطلبات</h1></div>
