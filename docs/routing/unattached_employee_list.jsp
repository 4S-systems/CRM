    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function refreshForm() {
                ...
                var url = "<%=context%>/ComplaintEmployeeServlet?op=getEmpByGroup&rowsPerPage=" + rowsPerPage + "&selectionType=" + selectionType;
                if (fieldValue != null) {
            ...
            function goToPage(pageIndex) {
                ...
                var url = "<%=context%>/ComplaintEmployeeServlet?op=getEmpByGroup&Index=" + pageIndex + "&rowsPerPage=" + rowsPerPage + "&selectionType=" + selectionType;
                submitForm(url);
            }
