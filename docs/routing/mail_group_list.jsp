...
String[] supplierListTitles =new String[3];
...
//    supplierListTitles[3]="Delete";
    ...
    QS="&#1605;&#1593;&#1604;&#1608;&#1605;&#1575;&#1578; &#1587;&#1585;&#1610;&#1593;&#1577;";
    BO="&#1593;&#1605;&#1604;&#1610;&#1575;&#1578; &#1571;&#1587;&#1575;&#1587;&#1610;&#1577;";
    supplierListTitles[0]="اسم مجموعة البريد";
    supplierListTitles[1]="&#1605;&#1588;&#1575;&#1607;&#1583;&#1607;";
    supplierListTitles[2]="مشاهدة الأعضاء";
//    supplierListTitles[3]="&#1581;&#1584;&#1601;";
    CD=" &#1604;&#1575; &#1578;&#1587;&#1578;&#1591;&#1610;&#1593; &#1581;&#1584;&#1601; &#1575;&#1604;&#1605;&#1608;&#1602;&#1593;";
    PN="عدد مجموعات البريد";
    PL="عرض مجموعات البريد";
    ...
    <TABLE ALIGN="<%=align%>" dir="<%=dir%>" WIDTH="400" CELLPADDING="0" CELLSPACING="0" STYLE="border-right-WIDTH:1px;">
        ...
        <TR>
            ...
            <TD nowrap CLASS="<%=bgColor%>" BGCOLOR="#D7FF82" STYLE="padding-right:10;<%=style%>">
                <DIV ID="links">
                    <A HREF="<%=context%>/ComplaintEmployeeServlet?op=viewMailGroup&id=<%=wbo.getAttribute("id")%>">
            ...
            <TD nowrap CLASS="<%=bgColor%>"  BGCOLOR="#D7FF82" STYLE="padding-right:10;<%=style%>">
                <DIV ID="links">
                    <A HREF="<%=context%>/ComplaintEmployeeServlet?op=membersOfMailGroup&id=<%=wbo.getAttribute("id")%>">
...
<!--            <TD nowrap CLASS="<%=bgColor%>"  BGCOLOR="#D7FF82" STYLE="padding-right:10;<%=style%>">
                <DIV ID="links">
                    <A HREF="<%=context%>/ComplaintEmployeeServlet?op=confirmDeleteMailGroup&id=<%=wbo.getAttribute("id")%>&clientName=<%=wbo.getAttribute("name")%>&clientNo=<%=wbo.getAttribute("clientNO")%>">
