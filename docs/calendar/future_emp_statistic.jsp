...
<html>
    ...
    <%
        ...
        String stat = cMode;
        String align = null;
        String dir = null, tit, inter, from, to, dep, noDep, disp, empNm, futureClsNo,
                futureMetNo, totalClntsNo;

        if (stat.equals("En")) {
            align = "center";
            dir = "LTR";
            tit = "Future Appointments Plan";
            inter = "Interval:";
            from = "From :";
            to = "To :";
            dep = "Department :";
            ...
            disp = "Display";
            empNm = "Employee Name";
            futureClsNo = "Future Calls No";
            futureMetNo = "Future Meetings No";
            totalClntsNo = "Total Clients No";
        } else {
            align = "center";
            dir = "RTL";
            tit = "خطة المتابعات المستقبليه";
            inter = "خلال:";
            from = "من :";
            to = "الى :";
            dep = "الاداره :";
            ...
            disp = "عرض";
            empNm = "اسم الموظف";
            futureClsNo = "عدد المكالمات المستقبليه";
            futureMetNo = "عدد المقابلات المستقبليه";
    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function getResults() {
                ...
                document.stat_form.action = "<%=context%>/AppointmentServlet?op=viewFutureCallCenterStatistics&depratmentID=" + depratmentID + "&beginDate=" + beginDate + "&endDate=" + endDate;
    ...
    <body>
        <fieldset class="set">
            <legend>
                <font style="font-weight: bold; color: blue;" size="5">
                    <%=tit%>
                </font>    
            </legend>
                ...
                <TABLE ALIGN="<%=align%>" dir="<%=dir%>" WIDTH="100%" id="Employee" style="">
                    <thead>
                        <tr>
                            ...
                            <th style="color: #005599 !important;font: 14px; font-weight: bold;"><%=futureClsNo%></th>
                            <%--<th style="color: #005599 !important;font: 14px; font-weight: bold;">اجمالي وقت المكالمان</th>--%>
                            <th style="color: #005599 !important;font: 14px; font-weight: bold;"><%=futureMetNo%></th>
                            ...
                            <th style="color: #005599 !important;font: 14px; font-weight: bold;"><%=totalClntsNo%></th>
                        </tr>
                    <thead>
                    <tbody >  
                        <%
                        ...
                        <tr>
                            ...
                            <TD>
                                <a target="blanck" href="<%=context%>/AppointmentServlet?op=getFutureEmpClientsDetails&type=call&departmentID=<%=departmentID%>&beginDate=<%=beginDate%>&endDate=<%=endDate%>&userID=<%=wbo.getAttribute("userID")%>&userName=<%=wbo.getAttribute("userName")%>"><%=wbo.getAttribute("call")%></a>
                            ...
                            <TD>
                                <a target="blanck" href="<%=context%>/AppointmentServlet?op=getFutureEmpClientsDetails&type=meeting&departmentID=<%=departmentID%>&beginDate=<%=beginDate%>&endDate=<%=endDate%>&userID=<%=wbo.getAttribute("userID")%>&userName=<%=wbo.getAttribute("userName")%>"><%=wbo.getAttribute("meeting")%></a>
