...
<HTML>  
    <%
	    ...
	    cmmnt = " التعليق ";
	    nDir = "left";
	    nt = " سيتم وضع المتابعات مهملة إذا لم تتم متابعتها بعد "+metaMgr.getHoursBeforeNeglect()+" ساعة ";
    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function showCalendar(obj) {
                ...
                document.part_form.action = "<%=context%>/CalendarServlet?op=getUsersAppointmentCalendar&selectedYear=" + selectedYear + "&selectedMonth=" + selectedMonth;
