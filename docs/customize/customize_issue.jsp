...
<HTML>
    ...
    Customization customizationShift = customizeJOMgr.getCustomization(CustomizeJOMgr.SHIFT_ELEMENT);
    Customization customizationTrade = customizeJOMgr.getCustomization(CustomizeJOMgr.TRADE_ELEMENT);
    ...
    String dir=null;
    String style=null;
    String lang,langCode,shift,trade;
  //  if(stat.equals("En")){
...
//
   ...
   // }
    ...
    <BODY STYLE="background-color:#F5F5F5">
        <FORM NAME="ISSUE_CUSTOMIZATION_FORM" METHOD="POST" action="">
            ...
            <CENTER>
                <FIELDSET class="set" style="border-color: #006699; width: 95%">
                    <TABLE class="blueBorder" dir="<%=dir%>" align="center" width="100%" cellpadding="0" cellspacing="0" style="">
                        <TR>
                            <TD style="text-align:center;border-color: #006699;" width="100%" class="blueBorder blueHeaderTD">
                                <FONT color='#F3D596' SIZE="4">Customize Job Order Screen</FONT>
                            </TD>
                        </TR>
                    </TABLE>
                    <br>
                    ...
                    <TABLE CELLPADDING="0" CELLSPACING="0" BORDER="0" dir="RTL" align="<%=align%>" width="80%">
                        <TR>
                            <TD STYLE="height:30px;color:white;font-weight:bold;font-style:oblique;font-size:18px" BGCOLOR="#696565">
                                Hide
                            </TD>
                            <TD BGCOLOR="#696565" STYLE="color:white;font-weight:bold;font-style:oblique;font-size:18px">
                                Name of Field
                            </TD>
                        </TR>
                        <TR STYLE="padding-top:5px;padding-bottom:3px; cursor: pointer" onmouseover="this.className = 'rowHilight'" onmouseout="this.className = ''">
                            <TD class='borderStyle' STYLE="padding-left:20px;padding-right:20px">
                                <input type="checkbox" id="checkShift" name="checkShift" <%if(!customizationShift.display()){%> checked <%}%>/>
                            </TD>
                        ...
                        <TR STYLE="padding-top:5px;padding-bottom:3px; cursor: pointer" onmouseover="this.className = 'rowHilight'" onmouseout="this.className = ''">
                            <TD class='borderStyle' STYLE="padding-left:20px;padding-right:20px">
                                <input type="checkbox" id="checkTrade" name="checkTrade" <%if(!customizationTrade.display()){%> checked <%}%>/>
                            </TD>
                            <TD class='borderStyle' STYLE="font-weight:bold;text-align:center">
                                <%=trade%>
                            </TD>
