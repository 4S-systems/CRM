...
<%
    ...
    String isTrnsprtStn;
    String isMngmntStn;
    String lang, langCode,mainProject, locationType, futile, tit, save, cancel, TT, SNA, SNO, DESC,availableUnits,totalUnits,str2,str3,str4,str5,str6,str7,str8,unitNo,model;
    ...
    if (stat.equals("En")) {
        ...
        availableUnits="الوحدات المتاحه";
        totalUnits="الوحدات الكليه";
        str3="مساحة الوحده";
...
<!--            <TABLE class="blueBorder" dir="<%=dir%>" align="center" width="100%" cellpadding="0" cellspacing="0" style="">
            ...
            <FORM NAME="PROJECT_VIEW_FORM" METHOD="POST">
                ...
                <table ALIGN="<%=align%>" DIR="<%=dir%>" >
                    ...
                    <TR>
                        <TD style="<%=style%>;width: 40%;text-align: center " class="td2 formInputTag boldFont boldFont backgroundHeader" id="CellData">
                            <LABEL FOR="str_Project_Name">
                                <p><b> <%=mainProject%> <font color="#FF0000">*</font></b>&nbsp;
                            </LABEL>
                        </TD>
                        <TD colspan="3" class="blueBorder backgroundTable">
                            <input type="TEXT" dir="<%=dir%>" name="mainProject" ID="mainProject" size="20" value="<%=request.getAttribute("mainProject").toString()%>" maxlength="20">
                        </TD>
                    </TR>
                    ...
                    <TR>
                        ...
                        <TD colspan="3" class="blueBorder backgroundTable" >
                            <input disabled type="TEXT" STYLE="width:230px" name="coordinate" ID="coordinate" size="3" value="<%=project.getAttribute("coordinate")%>" maxlength="3">
                        </TD>
                    </TR>
...
<!--                    <TR>
                        <TD style="<%=style%>" class="td2 formInputTag boldFont boldFont backgroundHeader">
                            <LABEL FOR="str_Function_Desc">
                                <p><b><%=availableUnits%></b>&nbsp;
                            </LABEL>
                        </TD>
                        <TD colspan="3" class="blueBorder backgroundTable" >
                            <input disabled type="TEXT" name="option_three" ID="option_three" size="3" value="<%=project.getAttribute("optionThree")%>" maxlength="3">
                        </TD>
                    </TR>
                    <TR>
                       <TD style="<%=style%>" class="td2 formInputTag boldFont boldFont backgroundHeader">
                       ...
                       <TD colspan="3" class="blueBorder backgroundTable" >
                           <input disabled type="TEXT" name="isMngmntStn" ID="isMngmntStn" size="3" value="<%=project.getAttribute("optionOne")%>" maxlength="3">
                       </TD>
                   </TR>-->
                </TABLE>
            </FORM>
