...
<%
    ...
    String isTrnsprtStn;
    String isMngmntStn;
    String lang, langCode, locationType, futile, tit, save, cancel, TT, SNA, SNO, DESC, availableUnits, totalUnits;
            ...
            <FORM NAME="PROJECT_VIEW_FORM" METHOD="POST">
                ...
                <table ALIGN="<%=align%>" DIR="<%=dir%>" >
                    ...
                    <%
                        ...
                        if (stat.equals("En")) {
                            enableSup = futile_En_Yes;
                            disableSup = futile_En_NO;
                        } else {
                            enableSup = futile_Ar_Yes;
                            disableSup = futile_Ar_NO;
                        }
                    ...
                    <input checked disabled type="radio" name="enableSup" ID="writeFutile" ><%=enableSup%>
                    <%} else {%>
                    <input checked disabled type="radio" name="disableSup" ID="disableSup" ><%=disableSup%>
                    <%}%>
                </TD>
            </TR>-->
                    <TR>
                    ...
                    <TR>
                        ...
                        <TD colspan="3" class="blueBorder backgroundTable" >
                            <input disabled type="TEXT" name="option_one" ID="option_one" size="33" value="<%=project.getAttribute("optionOne")%>" maxlength="255">
                        </TD>
                    </TR>
                    <TR>
                        <TD style="<%=style%>;width: 40%;text-align: center " class="td2 formInputTag boldFont boldFont backgroundHeader">
                        ...
                        <TD colspan="3" class="blueBorder backgroundTable" >
                            <input disabled type="TEXT" name="option_two" ID="option_two" size="33" value="<%=project.getAttribute("optionTwo")%>" maxlength="255">
                        </TD>
                    </TR>
                </TABLE>
            </FORM>
