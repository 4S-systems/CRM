...
<HTML>
    ...
    <%
        ...
        String futile = request.getAttribute("futile").toString();
        ...
        String selectAll, main_project_name_label, searchTitle, byName, byCode, successMsg;
        if (stat.equals("En")) {
            ...
            title_1 = "إضافة عنصر فرعي جديد ل ( ";
    ...
    <HEAD>
        ...
        <SCRIPT LANGUAGE="JavaScript" TYPE="text/javascript">
            function submitForm()
            {
                if (!validateData("req", this.PROJECT_FORM.project_name, "Please, enter Site Name.") || !validateData("minlength=3", this.PROJECT_FORM.project_name, "Please, enter a valid Site Name.")){
                ...
                } else if (!validateData("req", this.PROJECT_FORM.eqNO, "Please, enter Site Number.") || !validateData("alnumhyphen", this.PROJECT_FORM.eqNO, "Please, enter a valid Number for Site Number.")){
                    ...
                    $.ajax({
                        ...
                        data: "op=SaveNewLocation&backTo=projTree&mainProjectId=<%=(String) request.getAttribute("mainProjectId")%>&backTo=projTree&"+form.serialize(),
    ...
    <BODY>
        <FORM NAME="PROJECT_FORM" id="newProjectForm" METHOD="POST">
                ...
                <fieldset class="set" style="border-color: #006699; width: 90%">
                    ...
                    <table align="<%=align%>" dir="<%=dir%>">
                        ...
                        <TR>
                            ...
                            <TD colspan="3" class="blueBorder backgroundTable">
                                <input type="TEXT" dir="<%=dir%>" name="project_name" ID="project_name" size="32" value="<%=request.getAttribute("mainProjName").toString()%> - " maxlength="255">
                            </TD>
                        </TR>
                        <TR>
                            <TD style="<%=style%>" class="td2 formInputTag boldFont boldFont backgroundHeader" id="CellData">
                            ...
                            <TD colspan="3" class="blueBorder backgroundTable" >
                                <SELECT class="blackFont fontInput" style="width: 230px; font-size: 16px;" name="location_type" onchange="JavaScript: getBrand(this.value)">
                                       ...
                                       for(int i=0; i<locationTypesList.size();i++){
                                        WebBusinessObject wbo = (WebBusinessObject) locationTypesList.get(i);
                                        
                                        if(defaultLocationName!= null && defaultLocationName.equals(wbo.getAttribute("arDesc"))){
                                            choosen = "selected";
                                        }else{
                                            choosen ="" ;
                                        }
                                       %> 
                                       <option value="<%=wbo.getAttribute("typeCode")%>" <%=choosen%>> <%=wbo.getAttribute("arDesc")%></option>
