...
<%
    ...
    String context = metaMgr.getContext();
     ...
     String equipmentcordinate = (String) request.getAttribute("equipmentcordinate");
     Pattern pattern = Pattern.compile("\\(.*\\)$");
     String cord="(21.422949491565994, 39.82664388997273)";
     if(!(equipmentcordinate==null||equipmentcordinate.equals(""))){
     Matcher matcher = pattern.matcher(equipmentcordinate);
     
     if(matcher.find())
       cord=equipmentcordinate;
     }
