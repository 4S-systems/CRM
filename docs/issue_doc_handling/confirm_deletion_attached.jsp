...
<HTML>
    <%
        ...
        String dir = null;
        String style = null;
        String lang, langCode, tit, save, cancel, tit1;
        if (stat.equals("En")) {
            align = "center";
            dir = "LTR";
    ...
    <MEeTA HTTP-EQUIV="Expires" CONTENT="0">
        ...
        <SCRIPT LANGUAGE="JavaScript" TYPE="text/javascript">
            ...
            function submitForm()
            {
                document.ISSUE_FORM.action = "<%=context%>/IssueDocServlet?op=DeleteAttachFile&docID=<%=docID%>&issueId=<%=issueId%>";
                        document.ISSUE_FORM.submit();
                    }
                    function cancelForm()
                    {
                        document.ISSUE_FORM.action = "<%=context%>/IssueDocServlet?op=ListAttachedDocs&issueId=<%=issueId%>";
                                document.ISSUE_FORM.submit();
                            }
        </SCRIPT>
