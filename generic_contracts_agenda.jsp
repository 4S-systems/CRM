...
<html>
    ...
    <%
        ...
        String selectedTab = selectedTabMap.get(CRMConstants.SELECTED_TAB_GENERIC_CONTRACTS_KEY);
        if (selectedTab == null) {
            selectedTab = "1";
            securityUser.getSelectedTab().put(CRMConstants.SELECTED_TAB_GENERIC_CONTRACTS_KEY, selectedTab);
        }
        if (stat.equals("En")) {
        } else {
        }
        ...
        <center>
            <div style="border:0px solid gray; width:100%; margin:auto;float: left; padding: 10px;margin-bottom: 0px;" id="tab">
                <ul id="tabs" class="shadetabs" style="margin-right:21px;margin-bottom: 0px;">
                    <li style="float: left;font-size: 16px;color: #005599; font-style: oblique"> <b>Generic Contracts</b></li>
                    <li class="active"><a id="div1" style="height: 30px;"href="javascript:showDev1();" ><span style="display: inline-block;padding: 2px;">أشعارات العقود<img src="images/icons/Phone-icon.png"width="22px" height="22px"onclick="javascript:showDev1();" ></span></a></li>
                </ul>
                <div dir="rtl" id="con1" style="display:block;border:0px solid gray; width:100%; margin: 0px; ">
                    <jsp:include page="/docs/generic_contracts/contracts_notifications.jsp" flush="true"></jsp:include>
                </div>
                <br>
            </div>
        </center>
