...
<HTML>
    ...
    <%
        ...
        String input, closedIssue, appointmentNotification, apartments;
            ...
            <center>
                ...
                <div style="border:0px solid gray; width:100%; margin:auto;float: left; padding: 10px;margin-bottom: 0px;" id="tab">
                    <ul id="tabs" class="shadetabs" style="margin-right:21px;margin-bottom: 0px;">
                        <li style="float: left;font-size: 16px;color: #005599;">Marketing - التسويق</li>  
                        <li ><a id="div6"  style="height: 30px;"href="javascript:showDev6();" ><SPAN style="display: inline-block;padding: 2px;"><%=apartments%><IMG src="images/building.gif" width="22px" height="22px"  onclick="javascript:showDev6();"></SPAN></a></li>
<!--                        <li ><a id="div4" style="height: 30px;"href="javascript:showDev4();" ><SPAN style="display: inline-block;padding: 2px;"><%=appointmentNotification%><IMG src="images/icons/clock_time.png" width="25px" height="25px" onclick="javascript:showDev4();"></SPAN></a></li>
                        ...
                        <li ><a id="div5"  style="height: 30px;"href="javascript:showDev5();" ><SPAN style="display: inline-block;padding: 2px;">طلبات القسم<IMG src="images/icons/closedIssue.png" width="22px" height="22px"  onclick="javascript:showDev5();"></SPAN></a></li>
                        ...
                        <li class="active"><a id="div1"  style="height: 30px;"href="javascript:showDev1();" ><SPAN style="display: inline-block;padding: 2px;"><%=input%><IMG src="images/client.png"width="22px" height="22px"onclick="javascript:showDev1();" ></SPAN></a></li>
                    </ul>
...
<!--                    <div  dir="rtl" id="con2" style="display:none;border:0px solid gray; width:100%; margin: 0px; ">
                    ...
                    <div  dir="rtl" id="con6" style="display:none;border:0px solid gray; width:100%; margin: 0px; ">
                        <jsp:include page="/docs/marketing/sales_list_apartments.jsp" flush="true"></jsp:include>
                    </div>
                    <br>
                </div>
            </center>
