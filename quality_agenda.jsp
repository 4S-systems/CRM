...
<%
    ...
    String statusOfIssue = "41";
    if (request.getParameter("statusOfIssue") != null)
    {
        if (request.getParameter("statusOfIssue").equals("all"))
        {
            statusOfIssue = "";
        }
        else
        {
            statusOfIssue = (String) request.getParameter("statusOfIssue");
        }
    }
    ...
    List<WebBusinessObject> data = issueByComplaintMgr.getAllComplaintsByDateLastCommenter(loggedUserId, beginD, endD,
...
<HTML>
    <head>
        ...
        <SCRIPT LANGUAGE="JavaScript" TYPE="text/javascript">
            ...
            /*function getAttatchedWorkItemList(divID)
            {
                $("#" + divID).dialog({height: 'auto', width: '60%', dialogClass: 'myTitleClass'})
                            ...
                            <center>
                                <div style="width: 97%">
                                    <table class="display" id="requests" align="center" DIR="<%=dir%>" WIDTH="100%" CELLPADDING="0" cellspacing="0">
                                        <thead>
                                            <tr>
                                                <TH STYLE="text-align:center;font-size:<%=(stat.equals("En")) ? "12px" : "14px"%>; font-weight: bold" width="10%" colspan="8"><img src="images/icons/operation.png" width="24" height="24"/></TH>  
                                            ...
                                            <%
                                                ...
                                                for (WebBusinessObject wbo : data)
                                                {
                                                    ...
                                                    /*if ((issueStatusName == null) || CRMConstants.CLIENT_COMPLAINT_STATUS_RECEIVED.equalsIgnoreCase((String) wbo.getAttribute("issueStatusCode")) || CRMConstants.ISSUE_STATUS_REJECTED.equalsIgnoreCase((String) wbo.getAttribute("issueStatusCode"))) {
                                                     issueStatusName = "مرفوض";
                                                     className = "canceled";
                                                     } else if (wbo.getAttribute("statusCode").equals(CRMConstants.CLIENT_COMPLAINT_STATUS_SENT)) {
                                                     issueStatusName = "لم يكتمل";
                                                     className = "not-completed";


                                                     } else if (wbo.getAttribute("statusCode").equals(CRMConstants.CLIENT_COMPLAINT_STATUS_FINISHED)) {
                                                     issueStatusName = "مقبول بالملاحظات";
                                                     className = "confirmed";
                                                     }*/
                                            %>
                                            <tr id="row">
                                                ...
                                                <td width="2.5%">
                                                    <a href="JavaScript: getAttatchedWorkItemList2('<%=wbo.getAttribute("issue_id")%>')">
                                                ...
                                                <td width="2.5%">
                                                    <a href="JavaScript: getTimeReport('<%=wbo.getAttribute("issue_id")%>')">
                                                        <img style="margin: 3px" src="images/timer.png" width="28" height="28" title="اﻷداء الزمني"/>
                                                    </a>
                                                </td>
                                                <td width="2.5%">
                                                    <a href="JavaScript: openCommentsListDialog('<%=wbo.getAttribute("compId")%>')">
                                                        <img style="margin: 3px" src="images/icons/view_comments.jpg" width="28" height="28" title="مشاهدة التعليقات"/>
                                                    </a>
                                                </td>
                                                <td width="2.5%">
