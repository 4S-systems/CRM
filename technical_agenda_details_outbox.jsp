...
<HTML>
    ...
    <%
        ...
        String resp = "1";
        issuesVector = employeeView2Mgr.getComplaintsWithoutDate(2, value, key, "key7", resp, null, null, null);//.getOnArbitraryKeyOrdered(userWbo.getAttribute("userId").toString(), "key3", "key7");
    ...
    <CENTER>
        <FIELDSET class="set" style="width:100%;" >
            ...
            <TABLE   id="outboxMsg" align="center" DIR="<%=dir%>" WIDTH="100%" CELLPADDING="0" cellspacing="0">
                <thead><TR>
                        <TH  ><SPAN ></SPAN></TH>
