...
<HTML>
    ...
    <%
        ...
        if(request.getParameter("toDateCancel") != null) {
            toDateVal = request.getParameter("toDateCancel");
            withinIntervals.put("toDateCancel", "" + toDateVal);
        } else if (withinIntervals.containsKey("toDateCancel")) {
            toDateVal = withinIntervals.get("toDateCancel");
        }
        cal.add(Calendar.DAY_OF_MONTH, -1);
        nowTime = sdf.format(cal.getTime());
        String fromDateVal = nowTime;
        if(request.getParameter("fromDateCancel") != null) {
            fromDateVal = request.getParameter("fromDateCancel");
            withinIntervals.put("fromDateCancel", "" + fromDateVal);
        } else if (withinIntervals.containsKey("fromDateCancel")) {
            fromDateVal = withinIntervals.get("fromDateCancel");
        }
        issuesVector = issueByComplaintMgr.getComplaintsWithoutDate(2, value, key, "key7", resp, null, new java.sql.Date(sdf.parse(fromDateVal).getTime()), new java.sql.Date(sdf.parse(toDateVal).getTime()));//.getOnArbitraryKeyOrdered(userWbo.getAttribute("userId").toString(), "key3", "key7");
    ...
    <SCRIPT LANGUAGE="JavaScript" TYPE="text/javascript">
        ...
        {
            document.within_form_cancel.submit();
        }
                ...
                <table class="blueBorder" id="code2" align="center" dir="<%=dir%>" width="650" cellspacing="2" cellpadding="1"
                    ...
                    <tr>
                        <td style="text-align: center; font-size: 14px; border-width: 1px; border-color: white;" bgcolor="#EEEEEE" valign="middle">
                            <input class="fromToDate" id="fromDateCancel" name="fromDateCancel" type="text" value="<%=fromDateVal%>" readonly/><img src="images/showcalendar.gif"/>
                            <br/><br/>
                        </td>
                        <td style="text-align: center; font-size: 14px; border-width: 1px; border-color: white;" bgcolor="#EEEEEE" style="text-align:right" valign="middle">
                            <input class="fromToDate" id="toDateCancel" name="toDateCancel" type="text" value="<%=toDateVal%>" readonly/><img src="images/showcalendar.gif"/>
                            <br/><br/>
                        </td>
                    </tr>
                </table>
            </form>
            <TABLE  id="cancelMsg" align="center" DIR="<%=dir%>" WIDTH="100%" CELLPADDING="0" cellspacing="0">
                <thead><TR>
                        <TH  ><SPAN ></SPAN></TH>
