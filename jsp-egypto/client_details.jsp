...
<html>
    ...
    <%
        ...
        String align, xAlign, dir, style, noClientExistMsg, successMsg, failMsg, sendEmail, client, possible, chance, oncontact, notfound, yes, no;
        if (stat.equals("En")) {
            align = "left";
            xAlign = "left";
            dir = "LTR";
    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            var selectedValue = $("#nextAction option:selected").val();
                    if (selectedValue === "Follow" || selectedValue === "meeting" || selectedValue === "Waiting" || selectedValue === "Done"
            ...
            changeMonth: true,
                    ...
                    $("#calldate").datetimepicker({dateFormat: 'yy/mm/dd', minDate: new Date()});
            ...
            $('#displayClients').css("display", "block");
                    $('#displayClients').bPopup({easing: 'easeInOutSine', //uses jQuery easing plugin
                    speed: 400,
                    transition: 'slideDown'});
            }
            ...
            var clientid = "<%=clientWbo != null ? clientWbo.getAttribute("clientNO") : ""%>";
                    ...
                    url: "<%=context%>/ClientServlet?op=getmailbox",
                            data: {clientemail: clientemail, clientname: clientname},
        ...
        <style> 
            .edit-icon {content:url('images/user_red_edit.png');}
            .print-icon {content:url('images/pdf_icon.gif');}
            .unbookmark-icon {content:url('images/star1.jpg');}
            .bookmark-icon {content:url('images/star2.jpg');}
            .finical-icon {content:url('images/finical-rebort.png');}
            .contract-icon {content:url('images/contract_icon.jpg');}
            .attach-icon {content:url('images/attach.png');}
            .view-file-icon {content:url('images/Foldericon.png');}
            .recommend-icon {content:url('images/recommend_client.gif');}
            .view-client-icon {content:url('images/client_vip.png');}
            .delete-icon {content:url('images/icons/delete_ready.png');}
            .reserved-icon {content:url('images/reserved_house.JPG');}
            .details-icon {content:url('images/communication.png');}
            .followup-icon {content:url('images/icons/follow_up.png');}
            .comment-icon {content:url('images/dialogs/comment_public.ico');}
            .view-comment-icon {content:url('images/dialogs/comment_channel.png');}
            .appointment-icon {content:url('images/dialogs/planning.png');}
            .view-appointment-icon {content:url('images/icons/calendar-256.png');}
            .mailbox-icon {content:url('images/dialogs/mailbox.png');}
            .campaign-icon {content:url('images/icons/add_event2.png');}
            .view-request-icon {content:url('images/icons/listing.png');}
            .session-icon {content:url('images/session-icon.png');}
            .request-icon {content:url('images/icons/icon-claims.png');}
            .unit-icon {content:url('images/icons/units.png');}
            .email-icon {content:url('images/icons/email.png');}
...
//                                        });
            ...
            var clientId = $("#clientId").val();
                    ...
                    console.log("saveAppoientment appType");
                    console.log(appType);
                    var appointmentPlace = $(obj).parent().parent().parent().find("#appointmentPlace").val();
        ...
        <fieldset align=center class="set" style="width: 90%">
            ...
            <div style="margin-left: auto; margin-right: auto; width: 1100px;">
                <div id="toolbar" dir="<fmt:message key="dir"/>" style="padding: 4px; border: 1px solid #dfdfdf; border-radius: 3px; width: 1100px;"></div>
            </div>
            <script type="text/javascript">
                $(function () {
                $('#toolbar').w2toolbar({
                ...
                %>
                        {
                        type: 'html', id: 'editClient',
                                html: function (item) {
                                var html =
                                        '<a href="#"><img style="height:35px;" class="edit-icon" title="Edit" onclick="JavaScript: updateClientInformation();"/></a>';
                                        return html;
                                }
                        },
                        {type: 'break'},
                ...
                %>
                        {
                        type: 'html', id: 'printClient',
                                html: function (item) {
                                var html =
                                        '<a href="#"><img style="height:35px;" class="print-icon" title="Datasheet" onclick="JavaScript: printClientInformation(this);"/></a>';
                                        return html;
                                }
                        },
                        {type: 'break'},
                ...
                %>
                        {
                        type: 'html', id: 'unbookmarked', hidden: <%=bookmarksList == null || !bookmarksList.isEmpty()%>,
                                html: function (item) {
                                var html =
                                        '<a href="#"><img style="height:35px;" class="unbookmark-icon" title="Bookmark" onclick="JavaScript: popupCreateBookmark(this, \x27<%=clientWbo.getAttribute("id")%>\x27, \x27<%=clientWbo.getAttribute("name")%>\x27);"/></a>';
                                        return html;
                                }
                        },
                        {
                        type: 'html', id: 'bookmarked', hidden: <%=bookmarksList != null && bookmarksList.isEmpty()%>,
                                html: function (item) {
                                var html =
                                        '<a href="#"><img style="height:35px;" class="bookmark-icon" title="Bookmark Details" onclick="JavaScript: deleteBookmark(this, \x27<%=bookmarkId%>\x27, \x27<%=clientWbo.getAttribute("id")%>\x27);"/></a>';
                                        return html;
                                }
                        },
                        {type: 'break'},
                ...
                %>
                        {
                        type: 'html', id: 'finical',
                                html: function (item) {
                                var html =
                                        '<a href="#"><img style="height:35px;" class="finical-icon" title="Financials" onclick="JavaScript: printClientFincancial(this);"/></a>';
                                        return html;
                                }
                        },
                        {type: 'break'},
                ...
                %>
                        {
                        type: 'html', id: 'contract',
                                html: function (item) {
                                var html =
                                        '<a href="#"><img style="height:35px;" class="contract-icon" title="Contracts" onclick="JavaScript: viewClientContract();"/></a>';
                                        return html;
                                }
                        },
                        {type: 'break'},
                ...
                %>
                        {
                        type: 'html', id: 'attachFile',
                                html: function (item) {
                                var html =
                                        '<a href="#"><img style="height:35px;" class="attach-icon" title="Attach File" onclick="JavaScript: popupAttach();"/></a>';
                                        return html;
                                }
                        },
                        {type: 'break'},
                ...
                %>
                        {
                        type: 'html', id: 'viewFiles',
                                html: function (item) {
                                var html =
                                        '<a href="#"><img style="height:35px;" class="view-file-icon" title="View Files" onclick="JavaScript: showAttachedFiles();"/></a>';
                                        return html;
                                }
                        },
                        {type: 'break'},
                ...
                %>
                        {
                        type: 'html', id: 'recommend',
                                html: function (item) {
                                var html =
                                        '<a href="#"><img style="height:35px;" class="recommend-icon" title="Recommend Client" onclick="JavaScript: popupCreateClient();"/></a>';
                                        return html;
                                }
                        },
                        {type: 'break'},
                ...
                %>
                        {
                        type: 'html', id: 'viewClient',
                                html: function (item) {
                                var html =
                                        '<a href="#"><img style="height:35px;" class="view-client-icon" title="Clients" onclick="JavaScript: popupClientsList();"/></a>';
                                        return html;
                                }
                        },
                        {type: 'break'},
                ...
                %>
                        {
                        type: 'html', id: 'deleteClient',
                                html: function (item) {
                                var html =
                                        '<a href="<%=context%>/ClientServlet?op=ConfirmDeleteClient&clientID=<%=clientWbo.getAttribute("id")%>&clientName=<%=clientWbo.getAttribute("name")%>&clientNo=<%=clientWbo.getAttribute("clientNO")%>&fromPage=customSearch"><img style="height:35px;" class="delete-icon" title="Delete"/></a>';
                                        return html;
                                }
                        },
                        {type: 'break'},
                ...
                %>
                        {
                        type: 'html', id: 'reserved',
                                html: function (item) {
                                var html =
                                        '<a href="#"><img style="height:35px;" class="reserved-icon" title="Reserved"/></a>';
                                        return html;
                                }
                        },
                        {type: 'break'},
                ...
                %>
                        {
                        type: 'html', id: 'details',
                                html: function (item) {
                                var html =
                                        '<a href="#"><img style="height:35px;" class="details-icon" title="Client\x27s Details" onclick="JavaScript: viewClientCommunications();"/></a>';
                                        return html;
                                }
                        },
                        {type: 'break'},
                ...
                %>
                        {
                        type: 'html', id: 'followup',
                                html: function (item) {
                                var html =
                                        '<a href="<%=context%>/ClientServlet?op=ViewClientMenu&clientNo=<%=clientWbo.getAttribute("clientNO")%>&clientID=<%=clientWbo.getAttribute("id")%>&button=directCall"><img style="height:35px;" class="followup-icon" title="Direct Call"/></a>';
                                        return html;
                                }
                        },
                        {type: 'break'},
                <%
                            ...
                            if (userPrevList.contains("ADD_COMMENT")) {
                %>
                        {
                        type: 'html', id: 'comment',
                                html: function (item) {
                                var html =
                                        '<a href="#"><img style="height:35px;" class="comment-icon" title="Comment" onclick="JavaScript: popupAddComment();"/></a>';
                                        return html;
                                }
                        },
                        {type: 'break'},
                ...
                %>
                        {
                        type: 'html', id: 'viewComment',
                                html: function (item) {
                                var html =
                                        '<a href="#"><img style="height:35px;" class="view-comment-icon" title="List Comments" onclick="JavaScript: popupShowComments();"/></a>';
                                        return html;
                                }
                        },
                        {type: 'break'},
                ...
                %>
                        {
                        type: 'html', id: 'appointment',
                                html: function (item) {
                                var html =
                                        '<a href="#"><img style="height:35px;" class="appointment-icon" title="Plan Appointment" onclick="JavaScript: popupAddPlanningAppointment();"/></a>';
                                        return html;
                                }
                        },
                        {type: 'break'},
                ...
                %>
                        {
                        type: 'html', id: 'viewAppointment',
                                html: function (item) {
                                var html =
                                        '<a href="#"><img style="height:35px;" class="view-appointment-icon" title="List Appointments" onclick="JavaScript: popupClientAppointments();"/></a>';
                                        return html;
                                }
                        },
                        {type: 'break'},
                ...
                %>
                        {
                        type: 'html', id: 'mailbox',
                                html: function (item) {
                                var html =
                                        '<a href="#"><img style="height:35px;" class="mailbox-icon" title="MailBox" onclick="JavaScript: popupMailBox();"/></a>';
                                        return html;
                                }
                        },
                        {type: 'break'},
                ...
                %>
                        ...
                        type: 'html', id: 'campaign',
                                html: function (item) {
                                var html =
                                        '<a href="#"><img style="height:35px;" class="campaign-icon" title="Add Campaign" onclick="JavaScript: popupAddCampaign();"/></a>';
                                        return html;
                                }
                        },
                        {type: 'break'},
                ...
                %>
                        ...
                        type: 'html', id: 'requests',
                                html: function (item) {
                                var html =
                                        '<a href="#"><img style="height:35px;" class="view-request-icon" title="View Client\x27s Requests" onclick="JavaScript: popupViewComplaints();"/></a>';
                                        return html;
                                }
                        },
                        {type: 'break'},
                ...
                %>
                        ...
                        type: 'html', id: 'session',
                                html: function (item) {
                                var html =
                                        '<a href="<%=context%>/ClientServlet?op=ViewClientMenu&clientNo=<%=clientWbo.getAttribute("clientNO")%>&clientID=<%=clientWbo.getAttribute("id")%>"><img style="height:35px;" class="session-icon" title="Open Session"/></a>';
                                        return html;
                                }
                        },
                        {type: 'break'},
                ...
                %>
                        ...
                        type: 'html', id: 'newRequest',
                                html: function (item) {
                                var html =
                                        '<a href="#"><img style="height:35px;" class="request-icon" title="New Request / Query" onclick="JavaScript: openInNewWindow(\x27<%=context%>/ClientServlet?op=getNewRequest&clientID=<%=clientWbo.getAttribute("id")%>\x27);"/></a>';
                                        return html;
                                }
                        },
                        {type: 'break'},
                ...
                %>
                        ...
                        type: 'html', id: 'unit',
                                html: function (item) {
                                var html =
                                        '<a href="#"><img style="height:35px;" class="unit-icon" title="Units" onclick="JavaScript: openInNewWindow(\x27<%=context%>/IssueServlet?op=clientUnits&clientID=<%=clientWbo.getAttribute("id")%>\x27);"/></a>';
                                        return html;
                                }
                        },
                        {type: 'break'},
                ...
                %>
                        ...
                        type: 'html', id: 'email',
                                html: function (item) {
                                var html =
                                        '<a href="#"><img style="height:35px;" class="email-icon" title="Send Email" onclick="JavaScript: openEmailDialog(\x27<%=clientWbo.getAttribute("name")%>\x27,\x27<%=clientWbo.getAttribute("email")%>\x27,\x27<%=sendEmail%>\x27);"/></a>';
                                        return html;
                                }
                        },
                        {type: 'break'}
                    ...
                    <td class="td">
                        <table style="width: 100%;">
                            <tr>
                                ...
                                <td  style="text-align:right;">
                                    ...
                                    <select name="clientRate" id="clientRate" style="width: 200px; direction: rtl;"
                                            onchange="JavaScript: changeClientRate('<%=clientWbo.getAttribute("id")%>');">
                            ...
                            <TR>
                                ...
                                <td class="td dataTD">
                                    <label><%=clientWbo.getAttribute("gender")%></label>
                                </td>
                                <td class="td titleTD">
                                    <fmt:message key="address" />
                                </td>
                                <td class="td dataTD">
                                    <label><%=clientWbo.getAttribute("address") != null && !clientWbo.getAttribute("address").equals("UL") ? clientWbo.getAttribute("address") : ""%></label>
                                </td>
                            </TR>
                            <TR>
                                ...
                                <td class="td dataTD">
                                    <label><%=clientWbo.getAttribute("matiralStatus")%></label>
                                </td>
                                ...
                                <td class="td dataTD">
                                    <label><%=clientWbo.getAttribute("email") != null && !clientWbo.getAttribute("email").equals("UL") ? clientWbo.getAttribute("email") : ""%></label>
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="td dataTD">
                                    <label><%=clientWbo.getAttribute("clientSsn") != null && !clientWbo.getAttribute("clientSsn").equals("UL") ? clientWbo.getAttribute("clientSsn") : ""%></label>
                                </td>
                                <td class="td titleTD">
                                ...
                                <td class="td dataTD">
                                    <label><%=clientWbo.getAttribute("option1") != null && clientWbo.getAttribute("option1").equals("1") ? yes : no%></label>
                                </td>
                            </tr>
                            <tr>
                                <td class="td titleTD">
                            ...
                            <tr>
                                ...
                                <td class="td dataTD" >
                                    <label><%=clientWbo.getAttribute("branchName") != null ? clientWbo.getAttribute("branchName") : ""%></label> 
                                </td>
                            </tr>
                            <tr>
                                <td class="td titleTD" >
                                                ...
                                                <tr>
                                                    ...
                                                    <td td style="text-align:right;" id="callResultTD">
                                                        <select id="nextAction" name="nextAction" STYLE="width: 225px;font-size: medium; font-weight: bold;" onchange="JavaScript: callResultsChange()">
                                                            ...
                                                            <option value="Don’t Call Me Any More">Don’t Call Me Any More</option>
