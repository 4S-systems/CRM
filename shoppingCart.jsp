...
//    String complaintId = (String) request.getAttribute("complaintId");
    ...
    ArrayList<WebBusinessObject> reservedUnit = (ArrayList<WebBusinessObject>) request.getAttribute("reservedUnit");
...
//    }
    ...
    String codeStr, projectStr, distanceStr, deleteStr, responsibleStr, unit,
            birthDate, search, noRating, tit, tit1, units,reserv,purch;
    if (stat.equals("En")) {
        align = "center";
        dir = "LTR";
...
//        request.setAttribute("complaintsList", new ArrayList(projectMgr.getOnArbitraryKeyOracle((String) wboComplaint.getAttribute("projectID"), "key2")));
    ...
    String ClientNm =(String)request.getAttribute("ClientNm");
...
//            return false;
    ...
    $('input[name="reserveUnit"]').attr('disabled', true);
            ...
            type: "post",
                    ...
                    var day = d.getDate();
                            ...
                            $("#reservedUnit").html($("#reservedUnit").html() + "<TR style='padding: 1px;'>\n\
                                <TD style=\"text-align:center;background: #f1f1f1;font-size: 14px;\">\n\
                                    <div style=\"\" class=\"remove\" id=\"remove\" onclick=\"removeResUnit('" + info.rowId + "', '" + info.resID + "', '" + info.issueStatusID + "', this);\" value=\"\"> </div>\n\
                                </TD>\n\
                            <TD style='text-align:center;background: #f1f1f1;font-size: 14px;'>\n\
                    ...
                    alert("لم يتم الحجز, ربما تكون الوحدة في معاينات العميل");
...
//            transition: 'slideDown'});
    ...
    // Handle change event on #sourceClient
    $('#sourceClient').change(function() {
        var selectedValue = $(this).val();
        
        // Make AJAX request with selectedValue in the URL
        $.ajax({
            url: '<%=context%>/ProjectServlet?op=getEoiName&sourceClientId=' + selectedValue,  // Use '&' to separate parameters
            type: 'GET',
            success: function(response) {
                // Handle the response here
                $('#result').html(JSON.stringify(response.mainCatsTypesBuildingBroker));
            $("#sourceClientName").chosen();

                // Update the dateAndName dropdown with 'name' column
                var selectOptions = '';
                $.each(response.mainCatsTypesBuildingBroker, function(index, item) {
                    selectOptions += '<option value="' + item.name + '">' + item.name + '</option>';
                });
                $('#sourceClientName').html(selectOptions);
                                    $("#sourceClientName").trigger("chosen:updated");
...
//    }
                                            ...
                                            divID = "unit_content";
                                                    ...
                                                    $('#unit_content').bPopup(); //.bPopup({easing: 'easeInOutSine', //uses jQuery easing plugin
//            speed: 400,
//            transition: 'slideDown'});
                                            ...
                                            $('#msg').text("");
                                                    ...
                                                    var priceWish = $('#priceWish').val();
                                                    var perCentWish = $('#perCentWish').val();
                                                    var amountWish = $('#amountWish').val();
                                                    var paymentSystemInterested = $('#paymentSystemInterested').val();
                                                    var sourceClient = $('#sourceClient').val();
                                                    var sourceClientName = $('#sourceClientName').val();
                                                    var unitNotes = $('#unitNotes').val();
                                                    if (notes == "" || notes == null) {
                                            notes = "  ";
                                            }
                                            ...
                                            //var productId = "1364111290870";
                                            var productId = $('#mainProduct').val();
...
//        var period = $('#period').val();
                                                    ...
                                                    type: "post",
                                                            ...
                                                            clientId: clientId,
                                                                    ...
                                                                    typeUnit: typeUnit,
                                                                    priceWish: priceWish,
                                                                    perCentWish: perCentWish,
                                                                    amountWish: amountWish,
                                                                    paymentSystemInterested: paymentSystemInterested,
...
//                            transition: 'slideDown'});
                                            ...
                                            function sellUnit() {
                                                                                                                                                    var clientId = $("#clientId").val();
                                                                                                                                                            ...
                                                                                                                                                            type: "post",
                                                                                                                                                                ...
                                                                                                                                                                %>
                                                                                                                                                                    + "<TD style='text-align:center;background: #f1f1f1;font-size: 14px;'>"
                                                                                                                                                                            + "<div class='remove' id='remove' onclick='removeRow(this)' value='" + info.rowId + "'></div>"
                           ...
                           + "<TD style='text-align:center;background: #f1f1f1;font-size: 14px;'>\n\
                                    ...
                                    <input type='text' id='rowId' value=" + info.projectID + " />  </TD>\n\
                                <TD style='text-align:center;background: #f1f1f1;font-size: 14px;'>\n\
                                    <b id='2'>  " + info.projectName + " </br>       </TD>\n\\n\
                                <TD style='text-align:center;background: #f1f1f1;font-size: 14px;'>\n\
                                    <b id='2'>  " + info.productCategoryName + " </br>       </TD>\n\\n\
                                <TD style='text-align:center;background: #f1f1f1;font-size: 14px;'>\n\
                                    <b id='2'>  " + info.cuseDescription + " </br>       </TD>\n\\n\
                                <TD style='text-align:center;background: #f1f1f1;font-size: 14px;'>\n\
                                    <b id='2'>  " + info.area + " </br>       </TD>\n\\n\
                                <TD style='text-align:center;background: #f1f1f1;font-size: 14px;'>\n\
                                    <b id='2'>  " + info.price + " </br>       </TD>\n\
                            </TR>").show();
                                                                                                                                                                            showCalendar(true);*/
                                                                                                                                                                    } else if (eqpEmpInfo.status == 'no') {
                                                                                                                                                                    alert("لم يتم البيع");
...
//                            transition: 'slideDown'});
                                            ...
                                            function removeRowsc(obj) {
                                                var x = confirm("هل أنت متاكد من الحذف");
                                                if (x == true) {
                                                var id = $(obj).parent().parent().find("#scrowId").val();
                                                console.log("id "+ id);
                                                    $.ajax({
                                                    type: "post",
                                                            url: "<%=context%>/ProjectServlet?op=removeInterestedProduct",
    ...
    function intrestReserved (id, name, parentID) {
        popupReservation();
        document.getElementById('unitId').value = id;
        document.getElementById('unitCode').value = name;
...
<body>
    ...
    <!--<div style="width:40%;direction: <%=dir%>;" class="titlebar">
        <legend style="color: #005599 ;font-size: 25px;font-weight: bold"><span> <%=tit%> <font style="color: red;"/><%=ClientNm%> <br> <font style="color: #005599;"/> <%=tit1%> <font style="color: red;"/><%=ClientNo%></span></legend>
    </div>-->
    <table style="width: 70%;direction: <%=dir%>;">
        <tr>
            <td style="font-size: 20px;"><%=units%></td>
            <td class="titlebar" style="font-size: 20px;"><%=tit%></td>
            <td style="color:red;font-size: 20px;"><%=ClientNm%></td>
            <td class="titlebar" style="font-size: 20px;"><%=tit1%></td>
            <td style="color:red;font-size: 20px;"><%=ClientNo%></td>
        </tr>
    </table>
        ...
        <div style="width: 95%;margin-left: auto;margin-right:auto;margin-top: 8px;border: none;">
            ...
            <center>
                ...
                <div style="width: 100%; margin-top: 20px;">
                    <fieldset style="width:95%;background-color: #BCC8CC;align:center">
                        <%--<legend style="color: black ;font-size: 25px;"><span> الوحدات </span></legend>--%>
                        ...
                        <div style="width: 98%;display: block;margin-top: 10px;float: right;border: none;" id="tblDataDivInterest">
                            ...
                            <div style="float: right;width: 100%;">
                                <div> <b style="float: left;clear: both;">EOI</b></div>
                            </div><br />
                            <TABLE id="interestedUnit"  style="margin-right: 3%;display: table;margin-top: 10px;" class="blueBorder" align="center" dir="<%=dir%>" width="95%" cellpadding="0" cellspacing="0">
                                <TR>
                                    <TD CLASS="silver_header" STYLE="text-align:center;color:black;font-size:14px;font-weight: bold" nowrap ><b>Code</TD>
                                    <TD CLASS="silver_header" STYLE="text-align:center;color:black;font-size:14px;font-weight: bold; display: <%=userPrevList.contains("DELETE_INTERESTED") ? "block" : "none"%>;" nowrap ><b></b></TD>
                                    <TD CLASS="silver_header" STYLE="text-align:center;color:black;font-size:14px;font-weight: bold" nowrap  id="empNameShown" value=""><b><fmt:message key="followb2" /></TD>
                                    <TD CLASS="silver_header" STYLE="text-align:center;color:black;font-size:14px;font-weight: bold" nowrap ><b><fmt:message key="followc2" /></TD>
                                    <TD CLASS="silver_header" STYLE="text-align:center;color:black;font-size:14px;font-weight: bold" nowrap ><b><fmt:message key="followd2" /></TD>
                                    <TD CLASS="silver_header" STYLE="text-align:center;color:black;font-size:14px;font-weight: bold" nowrap><b><fmt:message key="followf2" /></TD>
                                    <TD CLASS="silver_header" STYLE="text-align:center;color:black;font-size:14px;font-weight: bold" nowrap ><b><fmt:message key="followg2" /></TD>
                                    <TD CLASS="silver_header" STYLE="text-align:center;color:black;font-size:14px;font-weight: bold" nowrap ><b><fmt:message key="followi4" /></TD>
                                ...
                                %>
                                <TR style="padding: 1px; background: #f1f1f1;">
                                    
                                    <TD style="text-align:center;background: #f1f1f1;font-size: 14px;">

                                        <%if (wbo2.getAttribute("unitValue") != null) {%>
                                        <b id="5"><%=wbo2.getAttribute("unitValue")%></b>
                                        <%}%>

                                    </TD>

                                    <td style="text-align:center;background: #f1f1f1;font-size: 14px;  display: <%=userPrevList.contains("DELETE_INTERESTED") ? "" : "none"%>;" nowrap>
                                        ...
                                        <input id="ID"  type="hidden" value="<%=wbo2.getAttribute("id")%>"/>
                                    ...
                                    <TD style="text-align:center;background: #f1f1f1;font-size: 14px;">
                                        ...
                                        <%if (wbo2.getAttribute("paymentSystem") != null && wbo2.getAttribute("paymentSystem").equals("1")) {%>
                                        <b id="1">Cash</b>
                                        <%}else if (wbo2.getAttribute("paymentSystem") != null && wbo2.getAttribute("paymentSystem").equals("2")) {%>
                                        <b id="2">Cheques</b>
                                        <%}else if (wbo2.getAttribute("paymentSystem") != null && wbo2.getAttribute("paymentSystem").equals("3")) {%>
                                        <b id="3">Bank Transfer</b>
                                        <%}else if (wbo2.getAttribute("paymentSystem") != null && wbo2.getAttribute("paymentSystem").equals("4")) {%>
                                        <b id="4">Visa</b>
                                        <%}%>
                                    ...
                                    <TD style="text-align:center;background: #f1f1f1;font-size: 14px;">
                                        ...
                                        <%if (wbo2.getAttribute("creationTime") != null) {
                                        %>
                                        <b><%=wbo2.getAttribute("creationTime").toString().split(" ")[0]%></b>
                                        <font style="color:red"/>
                                        <%
                                            String creationTime = (String) wbo2.getAttribute("creationTime").toString().split(" ")[1];
                                            String time = creationTime.substring(0, 5);
                                        %>
                                        <%=time%>
                                        <%}%>
                                    ...
                                    <TD style="text-align:center;background: #f1f1f1;font-size: 14px;">
                                        ...
                                        <%if (wbo2.getAttribute("createdBy") != null) {%>
                                        <b><%=wbo2.getAttribute("createdBy")%></b>
                                        <%}%>
                                    ...
                                    <TD style="text-align:center;background: #f1f1f1;font-size: 14px; width: 25%;">
                                        ...
                                        <%if (wbo2.getAttribute("note") != null && !((wbo2.getAttribute("note")).toString()).equals("UL")){
                            ...
                            <div style="margin-top: 10px;">
                                <img src="images/icons/interest.png" title="Add Survey" type="button" onclick="popup(this)" style="width:65px;height:60px;cursor:pointer"/>
                            </div>
                        ...
                        <div style="width: 98%;display: block;margin-top: 10px;float: right;border: none;" id="tblDataDivReserve">
                            ...
                            <div style="float: right;width: 100%;">
                                <div> <b style="float: left;clear: both;"><%=reserv%></b></div>
                            </div><br />
                            <TABLE id="reservedUnit" class="blueBorder" ALIGN="center" dir="<%=dir%>"  width="95%" cellpadding="0" cellspacing="0" style="margin-top: 10px;margin-right: 3%;">
                                <TR>
                                    <TD CLASS="silver_header" STYLE="text-align:center;color:black;font-size:14px;font-weight: bold; display: <%=userPrevList.contains("DELETE_RESERVATION") ? "" : "none"%>;" nowrap><b></b></TD>
                                    <TD CLASS="silver_header" STYLE="text-align:center;color:black;font-size:14px;font-weight: bold" nowrap ><b><fmt:message key="followk2" /></b></TD>
                                    <TD CLASS="silver_header" STYLE="text-align:center;color:black;font-size:14px;font-weight: bold" nowrap  id="empNameShown" value=""><fmt:message key="followl2" /></b></TD>
                                    <TD CLASS="silver_header" STYLE="text-align:center;color:black;font-size:14px;font-weight: bold" nowrap ><b><fmt:message key="followm2" /></b></TD>
                                    <TD CLASS="silver_header" STYLE="text-align:center;color:black;font-size:14px;font-weight: bold" nowrap  ><b><fmt:message key="follown2" /></b></TD>
                                    <TD CLASS="silver_header" STYLE="text-align:center;color:black;font-size:14px;font-weight: bold" nowrap  ><b><fmt:message key="followo2" /></b></TD>
                                    <TD CLASS="silver_header" STYLE="text-align:center;color:black;font-size:14px;font-weight: bold" nowrap ><b><fmt:message key="followp2" /></b></TD>
                                    <TD CLASS="silver_header" STYLE="text-align:center;color:black;font-size:14px;font-weight: bold" nowrap><b><fmt:message key="followq2" /></b></TD>
                                    <TD CLASS="silver_header" STYLE="text-align:center;color:black;font-size:14px;font-weight: bold" nowrap ><b><fmt:message key="followr2" /></b></TD>
                                    <TD CLASS="silver_header" STYLE="text-align:center;color:black;font-size:14px;font-weight: bold" nowrap ><b><fmt:message key="follows2" /></b></TD>
                                    <TD CLASS="silver_header" STYLE="text-align:center;color:black;font-size:14px;font-weight: bold" nowrap ><b><fmt:message key="followt2" /></b></TD>
                                </TR>
                                <%
                                ...
                                <TR style="padding: 1px;">
                                    ...
                                    <TD style="text-align:center;background: #f1f1f1;font-size: 14px; display: <%=userPrevList.contains("DELETE_RESERVATION") ? "" : "none"%>;">
                                        <div style="" class="remove" id="remove" onclick="removeResUnit('<%=wbo1.getAttribute("rowId")%>', '<%=wbo1.getAttribute("resID")%>', '<%=wbo1.getAttribute("issID")%>', this);" value=""> </div>
                                    </TD>

                                    <TD style="text-align:center;background: #f1f1f1;font-size: 14px;">

                                        <%if (wbo1.getAttribute("productName") != null) {%>
                                        <b><%=wbo1.getAttribute("productName")%></b>
                                        <%}%>

                                    </TD>
                                    <TD style="text-align:center;background: #f1f1f1;font-size: 14px;width: 13%;">

                                        <%if (wbo1.getAttribute("productCategoryName") != null) {%>
                                        <b><%=wbo1.getAttribute("productCategoryName")%></b>
                                        <%}
                                        %>
                                     ...
                                     <TD style="text-align:center;background: #f1f1f1;font-size: 14px;">
                                        ...
                                        <b><%=wbo1.getAttribute("area")%></b>

                                    </TD>
                                     <TD style="text-align:center;background: #f1f1f1;font-size: 14px;">

                                        <b><%=wbo1.getAttribute("price")%></b>

                                    </TD>
                                    <TD style="text-align:center;background: #f1f1f1;font-size: 14px;">
                                        <%if (!wbo1.getAttribute("desc").equals("UL")) {%>
                                            <b><%=wbo1.getAttribute("desc")%></b>
                                        <%} else {%>
                                            <b>---</b>
                                        <%}%>
                                    </TD>
                                    ...
                                    <TD style="text-align:center;background: #f1f1f1;font-size: 14px;">
                                        ...
                                        <%if (wbo1.getAttribute("paymentSystem") != null) {%>
                                            <b><%=wbo1.getAttribute("paymentSystem")%></b>
                                        <%}%>

                                    </TD>
                                    <TD style="text-align:center;background: #f1f1f1;font-size: 14px;">

                                        <%if (wbo1.getAttribute("period") != null) {%>
                                        <b><%=wbo1.getAttribute("period")%></b>
                                        <%}%>
                                    ...
                                    <TD style="text-align:center;background: #f1f1f1;font-size: 14px;">
                                        <b><%=wbo1.getAttribute("productId") != null && wbo1.getAttribute("productId").equals("reserved") ? "حجز عادي" : "حجز مرتجع"%></b>
                                    </TD>
                                    
                                    <TD style="text-align:center;background: #f1f1f1;font-size: 14px;">
                                        <b><%=wbo1.getAttribute("creationTime").toString().split(" ")[0]%></b>
                                        <font style="color:red"/>
                                        <%
                                            String creationTime = (String) wbo1.getAttribute("creationTime").toString().split(" ")[1];
                                            String time = creationTime.substring(0, 5);
                                        %>
                                        <%=time%>
                                    </TD>
                                    <TD style="text-align:center;background: #f1f1f1;font-size: 14px;">
                                        <b><%=wbo1.getAttribute("createdBy")%></b>
                                    </TD>
                            ...
                            <div style="margin-top: 10px; display: <%=metaMgr.getDataMigration().equals("1") && userPrevList.contains("Reserve_Unit") ? "" : "none"%>;">
                                <img src="images/icons/reservations.png" title="حجز وحده" onclick="popupReservation(this)" style="width:60px; height:55px;cursor: pointer;" />
                            </div>
                        ...
                        <div style="width: 98%;display: block;margin-top: 10px;float: right;border: none;" id="tblDataDivSell">
                            ...
                            <div style="float: right;width: 100%;">
                                <div> <b style="float: left;clear: both;"><%=purch%></b></div>
                            </div><br />
                            <TABLE id="purcheUnits" class="blueBorder" ALIGN="center" dir="<%=dir%>"  width="95%" cellpadding="0" cellspacing="0" style="margin-top: 10px;margin-right: 3%;">
                                <TR>
                                    
                                    <TD CLASS="silver_header" STYLE="text-align:center;color:black;font-size:14px;font-weight: bold; display: <%=userPrevList.contains("UNDO_PURCHASE") ? "" : "none"%>;" nowrap ><b></b></TD>
                                            
                                    <TD CLASS="silver_header" STYLE="text-align:center;color:black;font-size:14px;font-weight: bold" nowrap ><b><fmt:message key="followa3" /></b></TD>
                                    <TD CLASS="silver_header" STYLE="text-align:center;color:black;font-size:14px;font-weight: bold" nowrap id="empNameShown" value=""><b><fmt:message key="followb3" /></b></TD>
                                    <TD CLASS="silver_header" STYLE="text-align:center;color:black;font-size:14px;font-weight: bold" nowrap ><b><fmt:message key="followc3" /></b></TD>
                                    <TD CLASS="silver_header" STYLE="text-align:center;color:black;font-size:14px;font-weight: bold" nowrap ><b><fmt:message key="followd3" /></b></TD>
                                    <TD CLASS="silver_header" STYLE="text-align:center;color:black;font-size:14px;font-weight: bold" nowrap ><b><fmt:message key="followe3" /></b></TD>
                                    <TD CLASS="silver_header" STYLE="text-align:center;color:black;font-size:14px;font-weight: bold" nowrap ><b><fmt:message key="followf3" /></b></TD>
                                    <TD CLASS="silver_header" STYLE="text-align:center;color:black;font-size:14px;font-weight: bold" nowrap ><b><fmt:message key="followg3" /></b></TD>
                                </TR>                       
                                <%
                                    for (WebBusinessObject wboUnit : purcheUnits) {
                                %>
                                <TR style="padding: 1px;">
                                    <td style="text-align:center;background: #f1f1f1;font-size: 14px; display: <%=userPrevList.contains("UNDO_PURCHASE") ? "" : "none"%>;">
                                        <div style="" class="remove" id="remove" onclick="removeRow(this)" value="<%=wboUnit.getAttribute("rowId")%>"> </div>
                                        <input type="hidden" id="rowId" value='<%=wboUnit.getAttribute("rowId")%>' />
                                    </td>
                                    <TD style="text-align:center;background: #f1f1f1;font-size: 14px;">
                                        <%if (wboUnit.getAttribute("projectName") != null) {%>
                                        <b><%=wboUnit.getAttribute("projectName")%></b>
                                        <%}%>
                                        <input type="hidden" id="rowId" value='<%=wboUnit.getAttribute("rowId")%>' />
                                    </TD>
                                    <TD style="text-align:center;background: #f1f1f1;font-size: 14px;width: 13%;">
                                    ...
                                    <TD style="text-align:center;background: #f1f1f1;font-size: 14px;">
                                        <%if (wboUnit.getAttribute("productDesc") != null) {%>
                                        <%if (!wboUnit.getAttribute("productDesc").equals("UL")) {%>
                                                <b><%=wboUnit.getAttribute("productDesc")%></b>
                                            <%} else {%>
                                                <b>---</b>
                                        <%}}%>
                                    </TD>
                                    <TD style="text-align:center;background: #f1f1f1;font-size: 14px;">
                                        <%if (wboUnit.getAttribute("area") != null) {%>
                                            <b><%=wboUnit.getAttribute("area")%></b>
                                        <%}%>
                                    </TD>
                                    <TD style="text-align:center;background: #f1f1f1;font-size: 14px;">
                                        <%if (wboUnit.getAttribute("price") != null) {%>
                                            <b><%=wboUnit.getAttribute("price")%></b>
                                        <%}%>
                                    </TD>
                                    
                                    <TD style="text-align:center;background: #f1f1f1;font-size: 14px;">
                                        <b><%=wboUnit.getAttribute("creationTime").toString().split(" ")[0]%></b>
                                        <font style="color:red"/>
                                        <%
                                            String creationTime = (String) wboUnit.getAttribute("creationTime").toString().split(" ")[1];
                                            String time = creationTime.substring(0, 5);
                                        %>
                                        <%=time%>
                                    </TD>
                                    <TD style="text-align:center;background: #f1f1f1;font-size: 14px;">
                                        <b><%=wboUnit.getAttribute("createdBy")%></b>
                                    </TD>
                                </TR>
                                <%
                                    }
                            ...
                            <div style="margin-top: 10px; display: <%=metaMgr.getDataMigration().equals("1") && userPrevList.contains("Sell_Unit") ? "block" : "none"%>">
                                <img src="images/icons/sell.png" title="بيع وحده" onclick="popupSell(this)" style="width:65px;height:60px;cursor: pointer;"/>
                            </div>
                        </div>            
                        <% }%>
                    </fieldset>
    ...
    <div id="unit_content" style="display: none;width: 30%;position: fixed; z-index: 1000;">
        ...
        <div class="login" style="width: 85%;margin-bottom: 10px;margin-left: auto;margin-right: auto;">
            <table  border="0px" class="table" dir="<%=dir%>" style="width:100%;<%=style%>;" >
                ...
                <tr style="border: none">
                    <td style="color:#f1f1f1; font-size: 16px;font-weight: bold;width: 30%;" ><fmt:message key="followa4" /></td>
                ...
                <tr style="border: none">
                    <td style="color:#f1f1f1; font-size: 16px;font-weight: bold;width: 30%;" ><fmt:message key="followb4" /></td>
                    <td width="70%" style="<%=style%>;">
                ...
                <tr>
                    <td width="30%" style="color:#f1f1f1; font-size: 16px;font-weight: bold;width: 30%;"><fmt:message key="followc4" /></td>
                    <td style="<%=style%>;">
                        <select id="typeUnit" name="typeUnit">
                            <option value="01">Apartment 3 Rooms</option>
                            <option value="02">Apartment 4 Rooms</option>
                            <option value="03">Duplex</option>
                ...
                <tr>
                    <td width="30%" style="color:#f1f1f1; font-size: 16px;font-weight: bold;width: 30%;"><fmt:message key="followd4" /></td>
                    <td style="<%=style%>;">
                ...
                <tr>
                    <td width="30%" style="color:#f1f1f1; font-size: 16px;font-weight: bold;width: 30%;"><fmt:message key="followe4" /></td>
                    <td style="<%=style%>;">
                        <select id="priceWish" name="priceWish">
                            ...
                            <option value="170000-200000">170000-200000</option>
                            <option value="200000-230000">200000-230000</option>
                            <option value="230000-260000">230000-260000</option>
                            <option value="260000-290000">260000-290000</option>
                            <option value="290000-320000">290000-320000</option>
                        </select>
                    </td>
                </tr>
                 <tr>
                    <td width="30%" style="color:#f1f1f1; font-size: 16px;font-weight: bold;width: 30%;"><fmt:message key="followf4" /></td>
                    <td style="<%=style%>;">
                        <input type="text" name="perCentWish" id="perCentWish" value=""/>
                    </td>
                </tr>
                <tr>
                    <td width="30%" style="color:#f1f1f1; font-size: 16px;font-weight: bold;width: 30%;"><fmt:message key="followg4" /></td>
                    <td style="<%=style%>;">
                        <input type="text" name="amountWish" id="amountWish" value=""/>
                    </td>
                </tr>
                <tr>
                    <td width="30%" style="color:#f1f1f1; font-size: 16px;font-weight: bold;width: 30%;"><fmt:message key="followh4" /></td>
                    <td style="<%=style%>;">
                ...
                <tr>
                    <td width="30%" style="color:#f1f1f1; font-size: 16px;font-weight: bold;width: 30%;"><fmt:message key="followi4" /></td>
                    <td style="<%=style%>;">
                        <input type="text" name="unitNotes" id="unitNotes" value=""/>
                        </td>
                </tr>
                <tr>
                    <td width="30%" style="color:#f1f1f1; font-size: 16px;font-weight: bold;width: 30%;"><fmt:message key="followj4" /></td>
                    <td style="<%=style%>;">
                        <select id="sourceClient" name="sourceClient">
                            <option value="">Select</option>
                            <option value="1">عميل مباشر</option>
                            <option value="2">وسيط عقاري</option>
                            <option value="3">ترشيح من عميل</option>
                            <option value="4">ترشيح من موظف</option>
                        </select>
                    </td>
                </tr>
                <tr>
                    <td width="30%" style="color:#f1f1f1; font-size: 16px;font-weight: bold;width: 30%;">Choose</td>
                    <td style="<%=style%>;">
                        <select name="sourceClientName" id="sourceClientName" style="font-weight: bold; font-size: 16px; width: 175px; direction: <%=dir%>; text-align: <fmt:message key="align"/>;"> <!-- Replace with your select element ID -->
            <!-- Options will be dynamically added here -->
                    ...
                    <tr>
                        <td colspan="2" style="color:#f1f1f1; font-size: 16px;font-weight: bold;width: 30%;text-align: center;"> 
                            ...
                            <input type="button" value="Save" id="addUnit" onclick="javascript: addUnitRecord(this)" style="font-size: 15px;font-family: serif;display: none;"/>
    ...
    <% }%>
            ...
            <div class="backgroundTable" style="text-align: center; width: 100%">
                <table  width="100%" cellpadding="0" cellspacing="0" style="">
                    <tr>
                       <td>
                        ...
                        <th class="titlebar">
                            <font color="#005599" size="4"><fmt:message key="followa5" /></font>
                        </th>
                    </tr>
                </table>
                ...
                <TABLE class="backgroundTable" width="100%" CELLPADDING="0" CELLSPACING="8" ALIGN="CENTER" DIR="<%=dir%>">
                    ...
                    <tr>
                        <td class="titlebar" colspan="4">
                            <font color="red" size="3"><fmt:message key="followb5" /></font>
                        </td>
                    </tr>
                    
                    <tr>
                        <td width="20%"  style="text-align: right;" class="backgroundHeader" nowrap><fmt:message key="followk5" /></td>
                    ...
                    <tr>   
                        <td width="20%" style="text-align: right;" class="backgroundHeader" nowrap><fmt:message key="followj5" /></td>
                        <td width="30%"style="text-align:right;" class="backgroundHeader">
                            <input type="number" size="7" maxlength="7" id="buildingArea" name="buildingArea" style='width:170px;'/>
                        </td>
                        <td width="20%" style="text-align: right;" class="backgroundHeader" nowrap><fmt:message key="followc5" /> </td>
                        <td width="30%"style="text-align:right;" class="backgroundHeader">
                    ...
                    <tr>
                        <td width="20%"  style="text-align: right;" class="backgroundHeader" nowrap><fmt:message key="followi5" /></td>
                        <td width="30%"style="text-align:right;" class="backgroundHeader">
                            <input type="text" size="7" maxlength="40" name="floorNumber" id="floorNumber" style='width:170px;'/>
                        </td>
                        <td width="20%"  style="text-align: right;" class="backgroundHeader" nowrap><fmt:message key="followd5" /></td>
                        <td width="30%"style="text-align:right;" class="backgroundHeader">
                    ...
                    <tr>
                        <td width="20%" style="text-align: right;" class="backgroundHeader" nowrap><fmt:message key="followh5" /></td>
                        <td width="30%"style="text-align:right;" class="backgroundHeader">
                         ...
                         <td width="2%" style="text-align: right;" class="backgroundHeader" nowrap><fmt:message key="followe5" /></td>
                 ...
                 <tr align="left">
                     ...
                     <td width="20%" style="text-align: right;" class="backgroundHeader" nowrap><fmt:message key="followg5" /></td>
                        <td width="30%"style="text-align:right;" class="backgroundHeader">
                     ...
                     <td width="20%" style="text-align: right;" class="backgroundHeader" nowrap><fmt:message key="followf5" /></td>
                   <td width="40%"style="text-align:right;" class="backgroundHeader">
                    ...
                    <tr>
                        <td class="titlebar" colspan="4">
                            <font color="red" size="3"><fmt:message key="followv5" /></font>
                        </td>
                    </tr>
                    
                    <tr>
                        <td width="25%" style="text-align: right;" class="backgroundHeader" nowrap><fmt:message key="followu5" /></td>
                        ...
                        <td width="25%" style="text-align: right;" class="backgroundHeader" nowrap><fmt:message key="followm5" /></td>
                        <td width="25%"style="text-align:right;" class="backgroundHeader">
                    ...
                    <tr>
                        <td width="25%" style="text-align: right;" class="backgroundHeader" nowrap><fmt:message key="followt5" /></td>
                        <td width="25%"style="text-align:right;" class="backgroundHeader">
                   ...
                   <td width="20px" style="text-align: right;" class="backgroundHeader" nowrap><fmt:message key="follown5" /></td>
                   <td width="40%"style="text-align:right;" class="backgroundHeader">
               ...
               <tr> 
                   <td width="25%" style="text-align: right;" class="backgroundHeader" nowrap><fmt:message key="follows5" /></td>
                        <td width="25%"style="text-align:right;" class="backgroundHeader">
                 ...
                 <td width="20%" style="text-align: right;" class="backgroundHeader" nowrap><fmt:message key="followo5" /></td>
                   <td width="40%"style="text-align:right;" class="backgroundHeader">
                       <textarea name="reservationValueText" id="reservationValueText" style='width:250px; height: 50px; background: #FFFF99'></textarea>
                        </td> 
                    </tr>
                    <tr>
                        <td width="25%" style="text-align: right;" class="backgroundHeader" nowrap><fmt:message key="followr5" /></td>
                        <td width="25%"style="text-align:right;" class="backgroundHeader">
                        ...
                        <td width="20%" style="text-align: right;" class="backgroundHeader" nowrap><fmt:message key="followp5" /></td>
                        <td width="30%"style="text-align:right;" class="backgroundHeader">
                    ...
                    <tr>
                        <td width="25%" style="text-align: right;" class="backgroundHeader" nowrap><fmt:message key="followq5" /></td>
        ...
        <div id="sellDialog" style="display: none;width: 30%;position: fixed; z-index: 1000;" >
            ...
            <div class="login" style="width: 90%;text-align: center">
                <table class="table " style="width:100%;">
                    ...
                    <tr>
                        <td width="30%" style="color:#f1f1f1; font-size: 16px;font-weight: bold;" nowrap><fmt:message key="followx5" /></td>
        ...
        <div id="onholdDialog" style="display: none;width: 35%;position: fixed; z-index: 1000;" >
            ...
            <div class="login" style="width: 90%;text-align: center">
                <table class="table " style="width:100%;">
                    ...
                    <tr>
                        <td width="30%" style="color:#f1f1f1; font-size: 16px;font-weight: bold;" nowrap><b><fmt:message key="followx5" /></td>
                        <td width="70%" style="color:#f1f1f1; font-size: 16px;font-weight: bold; text-align: right;">
                        <%=(String) loggedUser.getAttribute("userName")%>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td width="30%" style="color:#f1f1f1; font-size: 16px;font-weight: bold;" nowrap><fmt:message key="followu5" /> </td>
                        <td width="70%"style="text-align:right;">
                    ...
                    <tr>
                        <td width="30%" style="color:#f1f1f1; font-size: 16px;font-weight: bold;"><fmt:message key="followc4" /></td>
                        <td width="70%"style="text-align:right;">
                    ...
                    <tr>
                        <td colspan="2" style="color:#f1f1f1; font-size: 16px;font-weight: bold;"> 
                            <input id="onholdBtn" type="submit" value="<fmt:message key="followw5" />" onclick="javascript: onholdUnit(this)"/>
                        </td>
