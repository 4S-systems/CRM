...
<HTML>
    ...
    <%
        ...
        issuesVector = responsibiltyCompViewMgr.getComplaintsWithoutDate(2, value, key, "key7", resp, null, null, null);
    ...
    <SCRIPT LANGUAGE="JavaScript" TYPE="text/javascript">
        ...
        function deleteComp() {
            var selectedProductArr = $('#assistantMsg').find(':checkbox:checked');
            var x = "";
            var compId;
            $(selectedProductArr).each(function(index, complaint) {
                //                productId = $(product).val();
                compId = $(complaint).parent().parent().find('#compId').val();
                x = x + compId + ",";
                alert(x);
            });
            $.ajax({
...
<!--                <TABLE class="blueBorder" DIR="<%=dir%>" CELLPADDING="0" cellspacing="0" style="padding-top: 2px; padding-bottom: 4px; padding-left: 10px; padding-right: 10px; margin-top: 10px; width: auto">
                    <TR>
                        ...
                        <td>
                            <input type="button" value="delete" onclick="deleteComp()" />
                        </td>
                    </TR>
                </TABLE>-->
            </DIV><br />
            <TABLE   id="assistantMsg" align="center" DIR="<%=dir%>" WIDTH="100%" CELLPADDING="0" cellspacing="0">
                <thead><TR>
                        <TH  ><SPAN ></SPAN></TH>
                ...
                <tbody  >  
                    ...
                    <TR>
                        ...
                        %>
                        <TD><SPAN style="display: inline-block;height: 20px;">
                                <INPUT type="checkbox" value="<%=wbo.getAttribute("clientComId")%>" name="selectedIssue" />
                                <IMG width="19px" height="19px" src="images/icons/bookmark_uns.png" style="margin: -4px 0"/></SPAN>
                            <input type="hidden" value="<%=wbo.getAttribute("clientComId")%>" id="compId"/>
                        </TD>
                        ...
                        <%
                            ...
                            if (senderInf.getAttribute("userName") != null && !senderInf.getAttribute("userName").equals("")) {
                                senderName = (String) senderInf.getAttribute("userName");
                            } else {
                                senderName = "";
                            }
                        %>
                ...
                <!--                <center>
                                    <TR>
                                        ...
                                        <TD CLASS="blueBorder blueBodyTD" BGCOLOR="#808080" colspan="3" STYLE="text-align:center;color:white;font-size:14px;">
                                            <B><%=iTotal%></B>
                                        </TD>
                                    </TR>
                                </center>-->
