...
<HTML>
    ...
    <%
        ...
        String selectedTab = selectedTabMap.get(CRMConstants.SELECTED_TAB_PROJECT_MANAGER_KEY);
        if (selectedTab == null) {
            selectedTab = "4";
            securityUser.getSelectedTab().put(CRMConstants.SELECTED_TAB_PROJECT_MANAGER_KEY, selectedTab);
        }
        ...
        String input, output, closedIssue, removed, help, notification, projectNotifications;
        ...
        if (stat.equals("En")) {
            ...
            projectNotifications = "أشعارات المشروع";
        }
    %>
        ...
        function setSeletedTab(seletedTab) {
            $.ajax({
                ...
                data: {
                    ...
                    forPage: '<%=CRMConstants.SELECTED_TAB_PROJECT_MANAGER_KEY%>'
                }
            });
        }
    ...
    <center>
        ...
        <div style="border:0px solid gray; width:100%; margin:auto;float: left; padding: 10px;margin-bottom: 0px;" id="tab">
            <ul id="tabs" class="shadetabs" style="margin-right:21px;margin-bottom: 0px;">
                <li style="display: <%=isManager == null || isManager.equals("0") ? "none" : ""%>;"><a id="div5"  style="height: 30px;"href="javascript:showDev5();" ><SPAN style="display: inline-block;padding: 2px;"><%=projectNotifications%><IMG src="images/icons/Phone-icon.png"width="22px" height="22px"onclick="javascript:showDev5();" ></SPAN></a></li>
                <li style="float: left;font-size: 16px;color: #005599; font-style: oblique"> <b>Project Management أدارة المشروعات</b></li>
                <li class="active"><a id="div4"  style="height: 30px;"href="javascript:showDev4();" ><SPAN style="display: inline-block;padding: 2px;"><%=notification%><IMG src="images/icons/closedIssue.png" width="22px" height="22px"  onclick="javascript:showDev4();"/></SPAN></a></li>
                ...
                <li ><a id="div1"  style="height: 30px;"href="javascript:showDev1();" ><SPAN style="display: inline-block;padding: 2px;"><%=input%><IMG src="images/icons/Phone-icon.png"width="22px" height="22px"onclick="javascript:showDev1();" ></SPAN></a></li>
            </ul>
                ...
                <div  dir="rtl" id="con1" style="display:none;border:0px solid gray; width:100%; margin: 0px; " >
                    <jsp:include page="/docs/Search/search_for_vendor.jsp" flush="true"></jsp:include>
                </div>
                ...
                <div dir="rtl" id="con5" style="display:block;border:0px solid gray; width:100%; margin: 0px; ">
                    <jsp:include page="/docs/notification_system/project_notifications.jsp" flush="true"></jsp:include>
                </div>
            <br>
