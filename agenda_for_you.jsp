...
<HTML>
    ...
    <CENTER>
        <FIELDSET class="set" style="width:100%;" >
            ...
            <TABLE   id="inbox" align="center" DIR="<%=dir%>" WIDTH="100%" CELLPADDING="0" cellspacing="0">
                <thead><TR>
                        <TH  ><SPAN ></SPAN></TH>
                ...
                <tbody  >  
                    ...
                    <TR>
                        ...
                        %>
                        <TD ><SPAN style="display: inline-block;height: 20px;"><INPUT type="checkbox" value="<%=wbo.getAttribute("clientComId")%>" name="selectedIssue" onclick="removeComp(<%=wbo.getAttribute("issue_id")%>,<%=wbo.getAttribute("clientComId")%>);"/><IMG width="19px" height="19px" src="images/icons/bookmark_uns.png" style="margin: -4px 0"/></SPAN></TD>
