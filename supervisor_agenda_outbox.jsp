...
<HTML>
    ...
    <%
        ...
        String resp = "1";
//        issuesVector = issueByComplaintMgr.getComplaintsWithEntryDate(2, value, key, "key7", bDate, eDate, resp);//.getOnArbitraryKeyOrdered(userWbo.getAttribute("userId").toString(), "key3", "key7");
        issuesVector = employeeViewMgr.getComplaintsWithoutDate2(3, value, key, "key7", resp, null, null, null);
            ...
            <TABLE   id="outbox" align="center" DIR="<%=dir%>" WIDTH="100%" CELLPADDING="0" cellspacing="0">
                ...
                <tbody >  
                    ...
                    <TR>
                        ...
                        <TD  style="width: 10%;" ><b><%=wbo.getAttribute("customerName").toString()%></b></TD>

                        <TD  style="width: 5%;" ><b><%=compType%></b></TD>
...
%>
                        <TD  STYLE="text-align:center;padding:<%=align%>; font-size: 12px;" width="20%"><b><%=sCompl%></b></TD>
                        <% } else {%>
                        <TD  ><b><%=sCompl%></b></TD>
                        <% }%>
                        <% } else {%>
                        ...
                        <TD nowrap  STYLE="text-align:center;padding: 5px; font-size: 12px;width: 10%;"><font color="red"><%=sDay%> - </font><b><%=sDate + " " + sTime%></b></TD>
