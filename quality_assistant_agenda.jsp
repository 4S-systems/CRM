        ...
        <SCRIPT LANGUAGE="JavaScript" TYPE="text/javascript">
            ...
            function getComplaints() {
                ...
                if ((beginDate == null || beginDate == "")) {
                    ...
                    document.COMP_FORM.action = "<%=context%>/main.jsp?op=getRequestsQForAll&beginDate=" + beginDate + "&endDate=" + endDate + "&engineerID=" + engineerID + "&contractorID=" + contractorID + "&itemID=" + itemID + "&projectID=" + projectID;
            ...
            function openNewCommentDialog(clientComplaintId) {
                divAttachmentTag = $("div[name='divAttachmentTag']");
                $.ajax({
                    type: "post",
                    url: '<%=context%>/CommentsServlet?op=getNewCommentForm',
                    data: {
                        businessObjectId: clientComplaintId
                    },
                    success: function (data) {
                        divAttachmentTag.html(data)
                                .dialog({
                                    ...
                                    <table class="display" id="requests" align="center" DIR="<%=dir%>" WIDTH="100%" CELLPADDING="0" cellspacing="0">
                                        ...
                                        <tbody>
                                            ...
                                            <tr id="row">
                                                ...
                                                <td width="2.5%">
                                                    <a href="JavaScript: openNewCommentDialog('<%=wbo.getAttribute("compId")%>')">
                                                        <img style="margin: 3px" src="images/dialogs/comment_public.ico" width="28" height="28" title="أضافة تعليق"/>
                                                    </a>
                                                </td>
