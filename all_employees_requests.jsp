...
<html>
    <%
        ...
        if (request.getParameter("reqTyp1") != null) {
            reqList = employeeMgr.getAllMyRequests(request.getParameter("fromDate1"), request.getParameter("toDate1"), session, request.getParameter("reqTyp1"), request.getParameter("statusReq"), empID);
            request.setAttribute("reqStatus", request.getParameter("statusReq"));
            request.setAttribute("reqTyp1", request.getParameter("reqTyp1"));
            request.setAttribute("fromDate1", request.getParameter("fromDate1"));
            request.setAttribute("toDat1", request.getParameter("toDate1"));
        }
        SimpleDateFormat sdf = new SimpleDateFormat(jDateFormat);
        String sBDate = (String) request.getParameter("fromDate1");
        String sEDate = (String) request.getParameter("toDate1");
        String Utype = (String) request.getParameter("Utype") == null ? "2" : (String) request.getParameter("Utype");
        String req = (String) request.getParameter("reqTyp1");

        String EmpID = (String) request.getAttribute("EmpID") == null ? " " : (String) request.getAttribute("EmpID");
        ProjectMgr projectMgr = ProjectMgr.getInstance();
        ArrayList<WebBusinessObject> reqTypLst = (ArrayList<WebBusinessObject>) request.getAttribute("reqTypLst") == null ? new ArrayList<WebBusinessObject>(projectMgr.getOnArbitraryKey("ERQ", "key4")) : (ArrayList<WebBusinessObject>) request.getAttribute("reqTypLst");
        ArrayList<LiteWebBusinessObject> MyEmpList = (ArrayList<LiteWebBusinessObject>) request.getAttribute("MyEmpList");
        ArrayList<WebBusinessObject> reqStutsLst = (ArrayList<WebBusinessObject>) request.getAttribute("reqStutsLst") == null ? employeeMgr.AllEmployeeReqStatus() : (ArrayList<WebBusinessObject>) request.getAttribute("reqStutsLst");
        String reqStatus = (String) request.getParameter("statusReq") == null ? " " : (String) request.getParameter("statusReq");
        ...
        <form name="EmployeesLoads" method="post"> 
            ...
            <fieldset class="set" style="width:85%;border-color: #006699">
                ...
                <table ALIGN="center" DIR="RTL" WIDTH="60%" CELLSPACING=2 CELLPADDING=1>
                    ...
                    <tr>
                        <td style="text-align:center" bgcolor="#dedede" valign="middle">
                            <input id="fromDate1" name="fromDate1" type="text" readonly value="<%=startDate%>"/><img src="images/showcalendar.gif"/> 
                            <br/><br/>
                        </td>
                        <td bgcolor="#dedede" style="text-align:center" valign="middle">
                            <input id="toDate1" name="toDate1" type="text" readonly value="<%=toDateValue%>"/><img src="images/showcalendar.gif"/>
                            <br/><br/>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td bgcolor="#dedede" style="text-align:center" valign="middle"  >
                            <SELECT id="reqTyp1" name="reqTyp1" style="width: 50%">
                ...
                <div style="width: 90%;margin-right: auto;margin-left: auto;" id="showClients">
                    <table width="100%" id="EmpRequests" align="<%=align%>" dir="<%=dir%>" cellpadding="2" cellspacing="1">
                        <thead>
                            <tr>
