...
public class TradeTypeMgr extends RDBGateWay {
    ...
    private static TradeTypeMgr tradeTypeMgr = new TradeTypeMgr();
    protected ArrayList cashedTable;

    private TradeTypeMgr() {
    }
    ...
    public boolean saveObject(WebBusinessObject wbo, HttpSession session) {
        ...
        try {
            ...
            getInfo.setSQLQuery(getQuery("insertData").trim());
