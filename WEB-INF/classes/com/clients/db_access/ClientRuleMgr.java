...
public class ClientRuleMgr extends RDBGateWay {

    public static ClientRuleMgr clientRuleMgr = new ClientRuleMgr();

    public static ClientRuleMgr getInstance() {
        logger.info("Getting ClientRuleMgr Instance ....");
        return clientRuleMgr;
    }
    ...
    protected void initSupportedForm() {
        ...
        if (supportedForm == null) {
            try {
                supportedForm = new BusinessForm(DOMFabricatorBean.getDocument(metaDataMgr.getMetadata("client_rule.xml")));
            } catch (Exception e) {
    ...
    public ArrayList<WebBusinessObject> getClientsRules(String[] statusTitles) {
        ...
        try {
            ...
            String sql = getQuery("getClientsRules").trim();
            String tempSum = ", MAX(Decode(x.client_status, 'statusTitle', x.is_checked)) \"statusTitle\"";
    ...
    public boolean saveObject(WebBusinessObject clientRuleWbo, WebBusinessObject loggedUser) {
        Vector params = new Vector();
        SQLCommandBean forInsert = new SQLCommandBean();
        int queryResult;
        String Id = UniqueIDGen.getNextID();
        params.addElement(new StringValue(Id));
        params.addElement(new StringValue((String) clientRuleWbo.getAttribute("departmentID")));
        params.addElement(new StringValue((String) clientRuleWbo.getAttribute("clientStatus")));
        ...
        try {
            ...
            forInsert.setSQLQuery(getQuery("insertClientRule").trim());
