...
public class RateActionMgr extends RDBGateWay {

    public static RateActionMgr rateActionMgr = new RateActionMgr();

    public static RateActionMgr getInstance() {
        logger.info("Getting RateActionMgr Instance ....");
        return rateActionMgr;
    }
    ...
    protected void initSupportedForm() {
        ...
        if (supportedForm == null) {
            try {
                supportedForm = new BusinessForm(DOMFabricatorBean.getDocument(metaDataMgr.getMetadata("rate_action.xml")));
    ...
    public boolean saveObject(WebBusinessObject wbo) {
        ...
        try {
            ...
            String sql = getQuery("insertRateAction").trim();
