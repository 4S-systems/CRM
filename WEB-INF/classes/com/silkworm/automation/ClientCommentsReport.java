...
public class ClientCommentsReport implements Job {

    public ClientCommentsReport() {
    }
    ...
    public void execute(JobExecutionContext context) throws JobExecutionException {
        ...
        try {
            String daysNo = confiuration.getClientCommentsDaysNo();
            ...
            byte[] bytes = Tools.getClientsCommentsReport(bDate, eDate);
            String emails = confiuration.getEmailsEscalation();
            String title = "Clients by Comments Report";
