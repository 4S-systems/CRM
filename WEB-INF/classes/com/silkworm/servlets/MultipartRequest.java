...
import com.silkworm.servlets.multipart.MultipartParser;
import com.silkworm.servlets.multipart.Part;
import com.silkworm.servlets.multipart.FilePart;
import com.silkworm.servlets.multipart.ParamPart;
import com.silkworm.servlets.multipart.FileRenamePolicy;
...
public class MultipartRequest {
    ...
    private static final int DEFAULT_MAX_POST_SIZE = 1024 * 1024 * 5;  // 5 Meg
    ...
    public MultipartRequest(HttpServletRequest request,
            String saveDirectory) throws IOException, IncorrectFileType {
     ...
     * thrown. This constructor actually parses the
     * <tt>multipart/form-data</tt> and throws an IOException if there's any
     * problem reading or parsing the request.
     *
     * @param request the servlet request.
    ...
    public MultipartRequest(HttpServletRequest request,
            ...
            int maxPostSize) throws IOException, IncorrectFileType {
    ...
    public MultipartRequest(HttpServletRequest request,
            String saveDirectory,
            String encoding) throws IOException, IncorrectFileType {
    ...
    public MultipartRequest(HttpServletRequest request,
            String saveDirectory,
            int maxPostSize,
            FileRenamePolicy policy) throws IOException, IncorrectFileType {
