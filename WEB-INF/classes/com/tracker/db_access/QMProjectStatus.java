...
public class QMProjectStatus implements IQueryMgr {
    ...
    public String getQuery(String forOperation, String param) {
        ...
        if (forOperation.equalsIgnoreCase("StatusProjectListALL")) {
            return sqlMgr.getSql("selectProjectStatusProjectListALL").trim();
        }

        if (forOperation.equalsIgnoreCase("NoStatus")) {

            return sqlMgr.getSql("selectProjectNoStatus").trim();
        }
        return null;
    }
