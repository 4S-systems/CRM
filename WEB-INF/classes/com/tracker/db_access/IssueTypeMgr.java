...
public class IssueTypeMgr extends RDBGateWay {

    private static IssueTypeMgr issueTypeMgr = new IssueTypeMgr();
    SqlMgr sqlMgr = SqlMgr.getInstance();

//    private static final String insertIssueSQL = "INSERT INTO issue_type VALUES (?,?,now(),?)";
    public static IssueTypeMgr getInstance() {
        logger.info("Getting IssueTypeMgr Instance ....");
        return issueTypeMgr;
    }
    ...
    protected void initSupportedForm() {
        ...
        if (supportedForm == null) {
            try {
                supportedForm = new BusinessForm(DOMFabricatorBean.getDocument(metaDataMgr.getMetadata("issue_type.xml")));
            } catch (Exception e) {
    ...
    public boolean saveObject(WebBusinessObject wbo, HttpSession s) throws NoUserInSessionException {
        ...
        try {
            ...
            forInsert.setSQLQuery(sqlMgr.getSql("insertIssueType").trim());
    ...
    public ArrayList getCashedTableAsBusObjects() {
        ...
        for (int i = 0; i < cashedTable.size(); i++) {
            ...
            cashedData.add((String) wbo.getAttribute("issueName"));
        }
    ...
    public boolean updateIssueType(WebBusinessObject wbo) throws NoUserInSessionException {
        ...
        try {
            ...
            forUpdate.setSQLQuery(sqlMgr.getSql("updateIssueType").trim());
