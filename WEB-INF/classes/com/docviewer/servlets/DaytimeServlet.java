 ...
 * DaytimeServlet.java
 *
 * Created on March 20, 2004, 9:52 PM
 */
...
import com.silkworm.servlets.RemoteDaemonHttpServlet;
...
class DaytimeConnection extends Thread {
  ...
  public void run() {
    ...
    try {
          FileOutputStream fos = new FileOutputStream(new File("c:\\DocumentHandler\\Mozaker.gif"));
