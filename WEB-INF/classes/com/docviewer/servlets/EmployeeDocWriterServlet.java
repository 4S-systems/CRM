...
public class EmployeeDocWriterServlet extends ImageHandlerServlet {
...
//    
    ...
    private EmployeeDocMgr employeeDocMgr = EmployeeDocMgr.getInstance();
...
//    public String filterValue =null;
    ...
    throws ServletException, IOException {
        ...
        switch (operation) {
            case 1:
                servedPage = "/docs/employee_doc_handling/doc_create.jsp";
            ...
            case 2:
                ...
                try {
                    ...
                    servedPage = "/docs/employee_doc_handling/attach_files.jsp";
            ...
            case 3:
//                
//                servedPage = "/docs/employee_doc_handling/attach_file.jsp";
//                
...
//                folder = employeeDocMgr.getOnSingleKey(docID);
                fileExtension = request.getParameter("fileExtension");
                docType=request.getParameter("docType");
                
                numFiles = usrDirContents.length;
                boolean result = employeeDocMgr.saveDocument(request, session,docImageFilePath);
...
//                //Get Client Name
//                folder = employeeDocMgr.getOnSingleKey(folderID);
//                // folder.printSelf();
...
//
//                Document doc = (Document) employeeDocMgr.getOnSingleKey(instId);
//
...
//
            ...
            case 10:
                ...
                if (null==doc) {
                    ...
                    servedPage = "/docs/employee_doc_handling/doc_update.jsp";
                    request.setAttribute("page",servedPage);
                ...
                break;
            case 11:
                if(employeeDocMgr.updateDocument(request, session)) {
                    request.setAttribute("Status","OK");
                } else {
            ...
            case 12:
                ...
                servedPage = "/docs/employee_doc_handling/select_file.jsp";
