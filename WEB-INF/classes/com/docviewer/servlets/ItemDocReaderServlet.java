...
public class ItemDocReaderServlet extends ImageHandlerServlet {
    String RIPath = null;
    String docID = null;
    String docType = null;
    ...
    throws ServletException, IOException {
        ...
        try {
            switch (operation) {
                case 1:
//
//                    servedPage = "/docs/item_doc_handling/docs_list.jsp";
//
//                    docsList = itemDocMgr.getDocsList(request.getParameter("op"),"");
//
...
//
                ...
                case 2:
                    ...
                    if(docType.equalsIgnoreCase("jpg")) {
                        servedPage = "/docs/item_doc_handling/image_renderer.jsp";
                        request.setAttribute("page",servedPage);
                        ...
                        docID = request.getParameter("docID");
                        gifData = new BufferedInputStream(itemDocMgr.getImage(docID));
                        ...
                        BufferedInputStream pdfData =
                                new BufferedInputStream(itemDocMgr.getImage(docID));
                ...
                case 3:
                    ...
                    categoryId = request.getParameter("categoryId");
                    servedPage = "/docs/item_doc_handling/confirm_deletion.jsp";
                ...
                case 4:
                    docID = request.getParameter("docID");
                    itemDocMgr.deleteOnSingleKey(docID);
                    itemID = request.getParameter("itemID");
                    categoryId = request.getParameter("categoryId");
                    servedPage = "/docs/item_doc_handling/docs_list.jsp";
                    ...
                    docsList = itemDocMgr.getListOnLIKE(request.getParameter("op"),itemID);
                    request.setAttribute("data",docsList);
                    request.setAttribute("itemID",itemID);
                    request.setAttribute("categoryId",categoryId);
                    request.setAttribute("data", docsList);
...
//                    servedPage = "/docs/item_doc_handling/doc_details.jsp";
//                    request.setAttribute("page",servedPage);
//
//                    docID = request.getParameter("docID");
//                    // ------------------------------------------
...
//                    // --------------------------------------------
//
//                    doc = (Document) itemDocMgr.getOnSingleKey(docID);
//
...
//                    servedPage = "/docs/item_doc_handling/client_interval_search.jsp";
...
//                    try {
//                        servedPage = "/docs/item_doc_handling/docs_list.jsp";
//                        docsList = itemDocMgr.getAccountDocsInRange(request.getParameter("op"),filterValue);
//
//                        request.setAttribute("data", docsList);
//
//                        request.setAttribute("page",servedPage);
...
//
                ...
                case 8:
//
//                    servedPage = "/docs/item_doc_handling/like_form.jsp";
                    request.setAttribute("page",servedPage);
//
...
//
//                    docsList = itemDocMgr.getListOnLIKE(request.getParameter("op"),filterValue);
//                    request.setAttribute("data",docsList);
//
                    this.forwardToServedPage(request, response);
                    break;
...
//
//                    docID = request.getParameter("docID");
//                    BufferedInputStream xlsData = new BufferedInputStream(itemDocMgr.getImage(docID));
//
//
//                    // ------------------------
//
...
//
//                    docID = request.getParameter("docID");
//                    BufferedInputStream htmlData = new BufferedInputStream(itemDocMgr.getImage(docID));
//
//
//                    // ------------------------
//
...
//                    servedPage = "/docs/item_doc_handling/searchdoc_form.jsp";
                    request.setAttribute("page",servedPage);
...
//
                ...
                case 25:
//
//                    servedPage = "/docs/item_doc_handling/interval_search.jsp";
...
//                    try {
//                        servedPage = "/docs/item_doc_handling/docs_list.jsp";
//                        docsList = itemDocMgr.getDocsInRange(request.getParameter("op"),filterValue3);
//
//                        request.setAttribute("data", docsList);
//
                    request.setAttribute("page",servedPage);
...
//                    }
                ...
                case 27:
//
//                    servedPage = "/docs/item_doc_handling/latest_trans.jsp";
                    request.setAttribute("page",servedPage);
...
//                    if(null!=account) {
//                        docID= itemDocMgr.getLatestForClient(account);
//                    } else {
...
//
//                    if(null!=docID) {
//                        latest = (Document)  itemDocMgr.getLatestTransactionDoc(op,docID);
//                        oneDoc.add(latest);
//                        latest.printSelf();
...
//                        docsList = itemDocMgr.getListOnLIKE(request.getParameter("op"),docID);
//                    } else {
//                        docsList = itemDocMgr.getListOnLIKE("ListSptrUser", docID);
//                    }
//
//                    request.setAttribute("data", docsList);
...
//                    app = (String) fileDescriptor.getAttribute("app");
//
                    itemDocMgr = ItemDocMgr.getInstance();
...
//                    String[] header= {"Item Code","Item Name","Quantity","Item Price","Total Cost"};
//                    String[] attribute = {"itemCode","itemDscrptn","itemQuantity","itemPrice","totalCost"};
//                    String[] dataType = {"String","String","Number","Number","Number"};
//                    
//                    HSSFWorkbook workBook = excelCreator.createSparePartsExcel(header, attribute, dataType, configureItems, actualItems, quantifiedItems, 4);
//                    
//                    
//                    response.setHeader("Content-Disposition",
//                            "attachment; filename=\""+"Spare_Parts.xls");
//                    
...
//                    break;
    ...
    protected int getOpCode(String opName) {
        ...
        if(opName.equalsIgnoreCase("ViewPartsExcel"))
            return 38;
