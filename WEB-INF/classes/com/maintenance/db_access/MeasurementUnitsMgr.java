 ...
 * @author khaled abdo
 */
public class MeasurementUnitsMgr extends RDBGateWay {

    SqlMgr sqlMgr = SqlMgr.getInstance();
    private static MeasurementUnitsMgr measureMgr = new MeasurementUnitsMgr();

    public MeasurementUnitsMgr() {
    }

    public static MeasurementUnitsMgr getInstance() {
    ...
    protected void initSupportedForm() {
        if (supportedForm == null) {
            try {
                ...
                supportedForm = new BusinessForm(DOMFabricatorBean.getDocument(metaDataMgr.getMetadata("measurement_units.xml")));
            } catch (Exception e) {
    ...
    public boolean saveObject(HttpServletRequest request, HttpSession s) throws NoUserInSessionException {
        ...
        params.addElement(new StringValue((String) request.getParameter("unitbase")));
        params.addElement(new StringValue((String) request.getParameter("arabicname")));
        params.addElement(new StringValue((String) request.getParameter("englishname")));
        params.addElement(new StringValue((String) request.getParameter("unitsystem")));
