...
public class UserStoresMgr extends RDBGateWay {

    private static UserStoresMgr userStoresMgr = new UserStoresMgr();
    SqlMgr sqlMgr = SqlMgr.getInstance();
    SecurityUser securityUser = new SecurityUser();

    public UserStoresMgr() {
    }

    public static UserStoresMgr getInstance() {
        logger.info("Getting UserStoresMgr Instance ....");
        return userStoresMgr;
    }
    ...
    protected void initSupportedForm() {
        ...
        if (supportedForm == null) {
            try {
                supportedForm = new BusinessForm(DOMFabricatorBean.getDocument(metaDataMgr.getMetadata("user_stores.xml")));
            } catch (Exception e) {
...
//                    params.addElement(new StringValue(""));
    ...
    public ArrayList<String> getUserPrivilegeCodes(String userId) {
        ...
        try {
            ...
            forQuery.setSQLQuery(sqlMgr.getSql("getUserPrivilegeCodes").trim());
...
/// get client prev or compliant prev by type 1 for  compalint and 2 for client

    public ArrayList<WebBusinessObject> getUserPrivligesByType(String type, String id) throws SQLException, NoSuchColumnException {
        ...
        try {
            ...
            forQuery.setConnection(connection);
            forQuery.setSQLQuery(sqlMgr.getSql("getUserPrevliges").trim());
            forQuery.setparams(params);
            queryResult = forQuery.executeQuery();
