...
public class UserCompaniesMgr extends RDBGateWay {

    private final static UserCompaniesMgr USER_COMPANIES_MGR = new UserCompaniesMgr();
    private final SqlMgr sqlMgr = SqlMgr.getInstance();
    SecurityUser securityUser = new SecurityUser();
    
    public UserCompaniesMgr() {
    }

    public static UserCompaniesMgr getInstance() {
        logger.info("Getting UserCompaniesMgr Instance ....");
        return USER_COMPANIES_MGR;
    }
    ...
    protected void initSupportedForm() {
        ...
        if (supportedForm == null) {
            try {
                supportedForm = new BusinessForm(DOMFabricatorBean.getDocument(metaDataMgr.getMetadata("user_companies.xml")));
            } catch (Exception e) {
    ...
    public boolean saveUserCompanies(String userID, Vector userProjects, String projectIdDefault, HttpSession session) {
...
//
//        } catch (SQLException ex) {
//            Logger.getLogger(UserCompaniesMgr.class.getName()).log(Level.SEVERE, null, ex);
//
