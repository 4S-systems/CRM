...
import com.externalReports.servlets.PDFReportsTreeServlet;
 ...
 * @version
 */
public class EquipmentServlet extends TrackerBaseServlet {
        ...
        try {
            ...
            switch (operation) {
                case 1:
                    ...
                    servedPage = "/docs/equipment/new_equipment_category.jsp";
                ...
                case 2:
                    ...
                    ht.put("manufacturer", request.getParameter("country"));
                    ht.put("location", request.getParameter("locations"));
                    //ht.put("dept", request.getParameter("departmentName"));
                    ht.put("dept", "0");
                    ht.put("status", "NON");
                    //ht.put("empID", request.getParameter("empNO"));
                    ht.put("empID", "0");
...
//                    break;
                case 5:
                    ...
                    servedPage = "/docs/equipment/category_list.jsp";
                    ...
                    break;
                case 6:
                    servedPage = "/docs/equipment/view_category.jsp";
                    ...
                    String unitName = (String) categoryWBO.getAttribute("unitName");
                    String yearModel,
                     nameModel,
                     brandModel = "";

                    if (unitName.contains("-")) {
                        String[] unName = unitName.split("-");
                        brandModel = unName[0];
                        nameModel = unName[1];
                        yearModel = unName[2];
                        request.setAttribute("yearModel", yearModel);
                        request.setAttribute("nameModel", nameModel);
                ...
                case 7:
                    ...
                    unitName = (String) categoryWBO.getAttribute("unitName");
                    yearModel = "";
                    nameModel = "";
                    brandModel = "";
                    if (unitName.contains("-")) {
                    ...
                    servedPage = "/docs/equipment/update_equipment_category.jsp";
                ...
                case 8:
                    ...
                    ht.put("desc", request.getParameter("catDescription"));
                    ht.put("countryOfOrigin", request.getParameter("countryOfOrigin"));
                ...
                case 9:
                    ...
                    servedPage = "/docs/equipment/confirm_delete_category.jsp";
...
//              if (wbo.getAttribute("isMaintainable").toString().equalsIgnoreCase("1") && wbo.getAttribute("isDeleted").toString().equalsIgnoreCase("0")) {
                    ...
                    servedPage = "/docs/equipment/equipment_list.jsp";
                    ...
                    break;
                case 12:
                    servedPage = "/docs/equipment/view_equipment.jsp";
                ...
                case 13:
                    ...
                    if (!mainCategoryLists.isEmpty()) {
                        ...
                        categoryList = Tools.toArrayList(maintainableMgr.getParentIdAndName(equipmentWBO.getAttribute("maintTypeId").toString()));
                    }
                    unitDocMgr = unitDocMgr.getInstance();
                    Vector Image_List = unitDocMgr.getImagesList(request.getParameter("equipmentID"));
                    ...
                    for (int i = 0; i < Image_List.size(); i++) {
                        ...
                        gifData = new BufferedInputStream(unitDocMgr.getImage(doc_ID));
                        myImage = ImageIO.read(gifData);
                        ImageIO.write(myImage, "jpeg", docImage);
                        Images_Path.add(absPath);
                    }
                    servedPage = "/docs/equipment/update_equipment.jsp";
...
//                }
                ...
                case 15:
                    ...
                    servedPage = "/docs/equipment/confirm_delequipment.jsp";
                ...
                case 16:
                    ...
                    try {
                        ...
                        Logger.getLogger(EquipmentServlet.class.getName()).log(Level.SEVERE, null, ex);
                    } catch (Exception ex) {
...
//                  request.getSession().setAttribute("isDelete","deleted");
                    ...
                    break;
                case 17:
                    servedPage = "/docs/equipment/equipment_site_list.jsp";
...
//                }
                    ...
                    servedPage = "/docs/equipment/equipment_category.jsp";
...
//                request.setAttribute("data", category);
                    ...
                    break;
                case 19:
                    servedPage = "/docs/equipment/equipment_Tree.jsp";
...
//                    index=(count+1)*10;
                    ...
                    break;
                case 22:
                    servedPage = "/docs/equipment/search_equipment.jsp";
                    UserProjectsMgr userProjectsMgr = UserProjectsMgr.getInstance();
                ...
                case 23:
                    ...
                    if (searchEqNo != null && !searchEqNo.equals("")) {
                        ...
                        if (vecEquipment.size() > 0) {
                            ...
                            servedPage = "/docs/equipment/search_result.jsp";
                ...
                case 25:
                    ...
                    forward("/docs/equipment/future_maintenance.jsp", request, response);
                    break;
                case 26:
                    ...
                    forward("/docs/equipment/last_maintenance.jsp", request, response);
                    break;
                case 27:
                    maintainableMgr = MaintainableMgr.getInstance();
                ...
                case 29:
                    ...
                    servedPage = "/docs/equipment/new_change.jsp";
                    request.setAttribute("equipmentID", equipmentID);
                    request.setAttribute("page", servedPage);
                    this.forwardToServedPage(request, response);
                    break;
                ...
                case 31:
                    ...
                    servedPage = "/docs/equipment/changes_list.jsp";
                    request.setAttribute("equipmentID", equipmentID);
                    request.setAttribute("data", vecChanges);
                    request.setAttribute("page", servedPage);
                    this.forwardToServedPage(request, response);
                ...
                case 32:
                    ...
                    servedPage = "/docs/equipment/equipment_job_orders.jsp";
                    request.setAttribute("equipmentID", equipmentID);
                    request.setAttribute("page", servedPage);
                    this.forwardToServedPage(request, response);
                    break;
...
//                    request.getSession().setAttribute("topMenu",topMenu);
//                    session.removeAttribute("CategoryID");
                    servedPage = "/docs/equipment/equipment_list_underWarranty.jsp";
                    request.setAttribute("numOfEqps", "" + categoryTemp.size());
                    request.setAttribute("count", "" + count);
                    request.setAttribute("noOfLinks", "" + links);
                    request.setAttribute("data", category);
...
//                    index=(count+1)*categoryTemp.size();
                    ...
                    session.removeAttribute("CategoryID");
                    servedPage = "/docs/equipment/equipment_list_outWarranty.jsp";
                    request.setAttribute("numOfEqps", "" + categoryTemp.size());
                    request.setAttribute("count", "" + count);
                    request.setAttribute("noOfLinks", "" + links);
                    request.setAttribute("data", category);
                    ...
                    break;
                case 36:
                    servedPage = "/docs/equipment/search_equipment_By_Department.jsp";
                    request.setAttribute("page", servedPage);
                    this.forwardToServedPage(request, response);
                    break;
                case 37:
...
//                    index=(count+1)*10;
                ...
                case 38:
                    ...
                    servedPage = "/docs/equipment/new_equipment_supplier.jsp";
                ...
                case 40:
                    ...
                    servedPage = "/docs/equipment/supplier_list.jsp";
                ...
                case 41:
                    ...
                    break;
                case 42:
                    servedPage = "/docs/equipment/search_equipment_By_productioLine.jsp";
                    request.setAttribute("page", servedPage);
                    this.forwardToServedPage(request, response);
                    break;
                case 43:
...
//                    index=(count+1)*10;
                ...
                case 48:
                    ...
                    servedPage = "/docs/equipment/update_equipment_manufacturing.jsp";
                    request.setAttribute("equipmentWBO", equipmentWBO);
                    request.setAttribute("categoryList", categoryList);
                    request.setAttribute("page", servedPage);
                    this.forwardToServedPage(request, response);
                ...
                case 50:
                    ...
                    servedPage = "/docs/equipment/update_equipment_operation.jsp";
                    request.setAttribute("equipmentWBO", equipmentWBO);
                    request.setAttribute("categoryList", categoryList);
                    request.setAttribute("page", servedPage);
                    this.forwardToServedPage(request, response);
                ...
                case 52:
                    ...
                    servedPage = "/docs/equipment/update_equipment_warranty.jsp";
                    request.setAttribute("equipmentWBO", equipmentWBO);
                    request.setAttribute("categoryList", categoryList);
                    request.setAttribute("page", servedPage);
                    this.forwardToServedPage(request, response);
...
//                            }
                ...
                case 55:
                    ...
                    ht = new Hashtable();
                    String user_Home = (String) loggedUser.getAttribute("userHome");
                    DocViewerFileRenamePolicy ourPolicy1 = new DocViewerFileRenamePolicy();
                    boolean finallyResult = false;
                    String user_Backend_Home = web_inf_path + "/usr/" + user_Home + "/";
                    File usrDir1 = new File(user_Backend_Home);
                    String[] usr_DirContents1 = usrDir1.list();
                    imageDirPath = getServletContext().getRealPath("/images");
                    String user_Image_Dir = imageDirPath + "/" + user_Home;
                    ourPolicy1.setDesiredFileExt("jpg");
                    File old_File = new File(user_Backend_Home + ourPolicy1.getFileName());
                    old_File.delete();
                    try {
                        mpr = new MultipartRequest(request, user_Backend_Home, 5 * 1024 * 1024, "UTF-8", ourPolicy1);
                    } catch (IncorrectFileType e) {
                    }
                    parentWbo = (WebBusinessObject) maintainableMgr.getOnSingleKey(mpr.getParameter("parentCategory"));

                    //maintenable unit data
                    ht.put("id", mpr.getParameter("eID"));
                    ht.put("parentId", mpr.getParameter("parentCategory"));
                    ht.put("unitLevel", parentWbo.getAttribute("unitLevel").toString());
                    ht.put("unitNo", mpr.getParameter("equipmentNo"));

                    if (mpr.getParameter("engineNo").toString().equalsIgnoreCase("") || mpr.getParameter("engineNo").toString() == null) {
                        ht.put("engineNo", "&#1575;&#1604;&#1605;&#1587;&#1578;&#1582;&#1583;&#1605; &#1604;&#1605; &#1610;&#1583;&#1582;&#1604; &#1576;&#1610;&#1575;&#1606;&#1575;&#1578;");
                    } else {
                        ht.put("engineNo", mpr.getParameter("engineNo"));
                    }
...
//                    ht.put("manufacturer", request.getParameter("manufacturer"));
                    ht.put("location", mpr.getParameter("locations"));
                    ht.put("dept", mpr.getParameter("departmentName"));
                    ht.put("status", mpr.getParameter("status"));
                    ht.put("desc", mpr.getParameter("equipmentDescription"));
                    ht.put("productionLine", mpr.getParameter("proLine"));
                    if (mpr.getParameter("serialNo").toString().equalsIgnoreCase("") || mpr.getParameter("serialNo").toString() == null) {
                        ht.put("serialNo", "Empty Data");
                    } else {
                        ht.put("serialNo", mpr.getParameter("serialNo"));
                    }
                    ht.put("manufacturer", mpr.getParameter("manufacturer"));
                    ht.put("user", userId);
                    String imageName1 = mpr.getParameter("imageName");
                    if (imageName1 != null) {
                        File newFile = new File(user_Backend_Home + ourPolicy1.getFileName());
                        if (newFile.exists()) {
                            usrDir1 = new File(imageName1);
                            usr_DirContents1 = usrDir1.list();
                            String docImageFilePath = user_Backend_Home + ourPolicy1.getFileName();
                            FileIO.copyFile(docImageFilePath, user_Image_Dir + "\\" + ourPolicy1.getFileName());
                            String docType = mpr.getParameter("docType");
                            unitDocMgr.getInstance();
                            finallyResult = unitDocMgr.saveImageDocument(mpr, session, docImageFilePath);
                        }
                    }
                    unitDocMgr = unitDocMgr.getInstance();
                    Vector ImageList = unitDocMgr.getImagesList(mpr.getParameter("equipmentID"));
                    Vector ImagesPath = new Vector();
                    String RandoMe,
                     RandFiLeName = null;
                    int LeN = 0;
                    for (int i = 0; i < ImageList.size(); i++) {
                        RandoMe = UniqueIDGen.getNextID();
                        LeN = RandoMe.length();
                        String doc_ID = ((WebBusinessObject) ImageList.get(i)).getAttribute("docID").toString();
                        RandFiLeName = new String("ran" + RandoMe.substring(5, LeN) + ".jpeg");
                        RIPath = user_Image_Dir + "/" + RandFiLeName;
                        absPath = "images/" + user_Home + "/" + RandFiLeName;
                        docImage = new File(RIPath);
                    ...
                    String servDate = mpr.getParameter("serviceEntryDate").toString();
...
//                    serviceEntryDate=new java.sql.Date(eYear-1900,eMonth-1,eDay);
                    ...
                    if (mpr.getParameter("checkIsStandalone") == null) {
                        ...
                        if (mpr.getParameter("checkIsStandalone").toString().equals("0")) {
                            ht.put("isStandalone", "0");
                        } else {
                            ht.put("isStandalone", "1");
                        }
                    ...
                    ht.put("mainCat", mpr.getParameter("mainCategory"));
                    try {
                        // if (!maintainableMgr.getDoubleNameforUpdate(eID, request.getParameter("equipmentName"))) {
                ...
                case 57:
                    ...
                    servedPage = "/docs/equipment/add_warranty_data.jsp";
                ...
                case 59:
                    ...
                    eqID = (String) request.getParameter("equipmentID");
                    mode = (String) request.getParameter("currentMode");
                    servedPage = "/docs/equipment/view_warranty_data.jsp";
                ...
                case 60:
                    ...
                    servedPage = "/docs/equipment/new_main_category.jsp";
                ...
                case 62:
                    ...
                    servedPage = "/docs/equipment/main_category_list.jsp";
                ...
                case 63:
                    servedPage = "/docs/equipment/view_main_category.jsp";
                    categoryID = request.getParameter("categoryID");
                    mainCategoryTypeMgr = MainCategoryTypeMgr.getInstance();
                ...
                case 64:
                    ...
                    servedPage = "/docs/equipment/update_main_category.jsp";
                    request.setAttribute("categoryWBO", categoryWBO);
                    request.setAttribute("page", servedPage);
                    this.forwardToServedPage(request, response);
                    break;
...
//                        request.setAttribute("name","double");
                ...
                case 67:
                    ...
                    // ArrayList eqx = new ArrayList();
                    //eqps=maintainableMgr.getAllParentSortingById();
                    ...
                    servedPage = "/docs/equipment/select_eq_report.jsp";
                ...
                case 68:
                    ...
                    if (eqID.equalsIgnoreCase("all")) {
                        ...
                        servedPage = "/docs/equipment/equipment_Report_All.jsp";
                    } else {
                        ...
                        servedPage = "/docs/equipment/equipment_Report.jsp";
                ...
                case 69:
                    ...
                    servedPage = "/docs/equipment/select_eq_report_mainType.jsp";
                    request.setAttribute("currentMode", "Ar");
                ...
                case 70:
                    ...
                    servedPage = "/docs/equipment/equipment_Report_MainType.jsp";
...
//                            } else {
//                                empWbo = employeeMgr.getOnSingleKey(unitWbo.getAttribute("empID").toString());
//                                if (empWbo != null) {
//                                    empName = empWbo.getAttribute("empName").toString();
//                                } else {
//                                    empName = "No User";
...
////                    response.getOutputStream().close();
                ...
                case 88:
                    ...
                    servedPage = "/docs/equipment/eqps_By_MainType_List.jsp";
...
//                case 90:
//                    empBasicMgr = EmpBasicMgr.getInstance();
//                    servedPage = "/docs/equipment/new_simple_equipment.jsp";
//                    equipBase = request.getParameter("base");
//                    EqpSequenceMgr eqpSequenceMgr=EqpSequenceMgr.getInstance();
...
//                        ht.put("dept", mpr.getParameter("departmentName"));
//                        ht.put("status", "NON");
//                        String empId = (String) mpr.getParameter("empNO");
...
//                    ht.put("noOfHours", new Integer(0));
//                    
//                    costCode = mpr.getParameter("costCode");
//                    
//                    if (costCode == null || costCode.equalsIgnoreCase("")) {
//                        costCode = "";
//                    }
//                    
//                    ht.put("productionLine", costCode);
//                    ht.put("erpFlag", erpFlag);
//                    ht.put("user", userId);
//                    ht.put("empName", empName);
//
...
//                        request.setAttribute("Status", ex.getMessage());
//                    }
//                    boolean saveClient = false;
//                    if (mpr.getParameter("client").toString().equals("1")) {
//                        saveClient = eqpClientMgr.saveClient(mpr.getParameter("client"), ID);
//                        if (saveClient == true) {
...
//                        }
//                    } else {
//                        saveClient = eqpClientMgr.saveClient(mpr.getParameter("clientID"), ID);
//                        if (saveClient == true) {
//                            System.out.println("Save successfully");
//                        } else {
//                            System.out.println("Fail in saving");
...
//                            servedPage = "/docs/equipment/new_prima_equipment.jsp";
//                        } else {
//                            servedPage = "/docs/equipment/new_simple_equipment.jsp";
//                        }
//                    } else {
...
//                    break;
                ...
                case 93:
                    ...
                    mode = (String) request.getParameter("currentMode");
                    servedPage = "/docs/equipment/update_eqp_operation.jsp";
                    request.setAttribute("equipmentID", eqID);
                    request.setAttribute("currentMode", mode);
...
//                metaMgr.closeDataSource();
                    servedPage = "/docs/equipment/print_Equipment.jsp";
...
//                                categoryTemp = maintainableMgr.getOnArbitraryNumberKey(3,params,keys);
                    ...
                    servedPage = "/docs/equipment/list_equipments.jsp";
...
//                    if(maintainableMgr.updateEqpOperation(operationWbo,now))
                ...
                case 97:
                    servedPage = "/docs/equipment/search_eqp_By_site.jsp";
                    request.setAttribute("page", servedPage);
                    this.forwardToServedPage(request, response);
                    break;
                ...
                case 98:
                    ...
                    servedPage = "/docs/equipment/list_sites.jsp";
...
//                        }
                    ...
                    servedPage = "/docs/equipment/list_mainCats.jsp";
                ...
                case 103:
                    ...
                    mode = (String) request.getParameter("currentMode");
                    servedPage = "/docs/equipment/add_eqp_manuf_data.jsp";
                    request.setAttribute("equipmentID", eqID);
                    request.setAttribute("currentMode", mode);
                    request.setAttribute("eqWbo", eqWbo);
                    request.setAttribute("page", servedPage);
...
//                    }
                ...
                case 105:
                    ...
                    mode = (String) request.getParameter("currentMode");
                    servedPage = "/docs/equipment/update_warranty_data.jsp";
                    request.setAttribute("equipmentID", eqID);
                    request.setAttribute("currentMode", mode);
                    request.setAttribute("equipmentName", (String) eqWbo.getAttribute("unitName"));
...
//                  request.getSession().setAttribute("isDelete","deleted");
                ...
                case 108:
                    servedPage = "/docs/equipment/future_maintenance_pupop.jsp";
                    equipmentMaintenanceMgr = EquipmentMaintenanceMgr.getInstance();
                ...
                case 110:
                    ...
                    servedPage = "/docs/equipment/confirm_delete_maint_cat.jsp";
                    request.setAttribute("categoryID", categoryID);
                    request.setAttribute("categoryName", categoryName);
                    request.setAttribute("page", servedPage);
                    this.forwardToServedPage(request, response);
...
//                    this.forward(servedPage, request, response);
                ...
                case 116:
                    ...
                    break;
                case 117:
                    servedPage = "docs/equipment/mainType_Tree1_1.jsp";
                    Brands = new Vector();
                    Eqp = new Vector();
                    mainCatTypes = new ArrayList();
                    mainCategoryTypeMgr = MainCategoryTypeMgr.getInstance();
...
//                    servedPage = "/docs/reports/maint_Items_Report.jsp";
//                    issueMgr = IssueMgr.getInstance();
//                    statisticsItems = new Vector();
//                    issueTasksMgr = IssueTasksMgr.getInstance();
//                    taskMgr = TaskMgr.getInstance();
//                    allTasks = taskMgr.getCashedTableAsBusObjects();
//                    tasks = new Vector();
//                    taskWbo = new WebBusinessObject();
//                    taskId = "";
//                    count = 0;
...
//                    break;
                ...
                case 119:
                    servedPage = "/docs/equipment/search_Brand.jsp";
                    request.setAttribute("page", servedPage);
                    this.forwardToServedPage(request, response);
                    break;
                case 120:
                    ...
                    String goToViewEquipment = request.getParameter("goToViewEquipment");
                    Vector listEquipments = new Vector();
                    String reloadUrl = "";

                    Vector listBrands = new Vector();
                    count = 0;
                    url = "EquipmentServlet?op=GetCategory";
                    maintainableMgr = MaintainableMgr.getInstance();
                    ...
                    try {
                        if (brandName != null && !brandName.equals("") && !brandName.equals("null")) {
                            listEquipments = maintainableMgr.getBrandsByName(brandName);
                        } else {
                            listEquipments = maintainableMgr.getOnArbitraryKey("0", "key3");
                        }
                    } catch (Exception ex) {
                        logger.error(ex.getMessage());
                    }

                    Size = listBrands.size();
                    tempcount = (String) request.getParameter("count");
                    if (tempcount != null) {
                        count = Integer.parseInt(tempcount);
                    }
                    ...
                    if (goToViewEquipment != null && goToViewEquipment.equalsIgnoreCase("ok")) {
                        servedPage = "/docs/equipment/brands_list_view.jsp";
                    }
                    ...
                    request.setAttribute("fullUrl", url);
                    request.setAttribute("url", url);
                    request.setAttribute("unitName", brandName);
                    request.setAttribute("formName", formName);
                ...
                case 121:
//                    servedPage = "/docs/equipment/view_brand.jsp";
//                    parentId = request.getParameter("brandId");
//                    maintainableMgr = MaintainableMgr.getInstance();
...
//                    eqpMenu = new Vector();
//                    mode = (String) request.getSession().getAttribute("currentMode");
//                    eqpMenu = parseSideMenu.parseSideMenu(mode, "brand_menu.xml", "");
//
//                    metaMgr.closeDataSource();
//
//                    /* Add ids for links*/
...
//                    style = (Hashtable) eqpMenu.get(0);
//                    title = style.get("title").toString();
//                    title += "<br>" + categoryWBO.getAttribute("unitName").toString();
//                    style.remove("title");
//                    style.put("title", title);
//
//                    for (int i = 1; i < eqpMenu.size() - 1; i++) {
...
//                        link = (String) linkVec.get(1);
//
//                        link += categoryWBO.getAttribute("id").toString();
//
//                        linkVec.remove(1);
//                        linkVec.add(link);
//                    }
...
//
//
//                    String fullNamee = categoryWBO.getAttribute("unitName").toString();
//                    String[] names;
//                    if (fullNamee.contains("-")) {
//                        names = fullNamee.split("-");
//                        categoryWBO.setAttribute("firstPart", names[0]);
//                        categoryWBO.setAttribute("note", "");
//                    } else {
//                        categoryWBO.setAttribute("firstPart", "");
//                        categoryWBO.setAttribute("note", "There Isn't Manufactory For This Brand");
//                    }
//
//                    request.getSession().setAttribute("sideMenuVec", eqpMenu);
//                    request.setAttribute("categoryWBO", categoryWBO);
...
//
                ...
                case 122:
//                    servedPage = "/docs/equipment/update_brand.jsp";
//                    parentId = request.getParameter("brandId");
//                    maintainableMgr = MaintainableMgr.getInstance();
//                    categoryWBO = maintainableMgr.getOnSingleKey(parentId);
//                    mainCategoryTypeMgr = MainCategoryTypeMgr.getInstance();
...
//                        categoryWBO.setAttribute("mainCatName", "Main Category Not Found");
//                    }
//                    fullNamee = categoryWBO.getAttribute("unitName").toString();
//
//                    if (fullNamee.contains("-")) {
//                        names = fullNamee.split("-");
//                        categoryWBO.setAttribute("firstPart", names[0]);
//                        categoryWBO.setAttribute("note", "");
//                    } else {
//                        categoryWBO.setAttribute("firsrPart", "");
//                        categoryWBO.setAttribute("note", "There Isn't Manufactory For This Brand");
//                    }
//                    request.setAttribute("brandId", parentId);
//                    request.setAttribute("categoryWBO", categoryWBO);
//                    request.setAttribute("page", servedPage);
//                    this.forwardToServedPage(request, response);
                    break;
                ...
                case 123:
                    ...
                    //categoryWBO.setAttribute("note",null);
                    maintainableMgr = MaintainableMgr.getInstance();
                    categoryTemp = maintainableMgr.getAllParentSortingById();
                ...
                case 124:
                    servedPage = "/docs/schedule/schedule_by_equipment_list_search_poup.jsp";
                    ...
                    break;
                case 125:
                    servedPage = "/docs/schedule/schedule_by_equipment_list_search.jsp";
                    maintainableMgr = MaintainableMgr.getInstance();
                    scheduleMgr = ScheduleMgr.getInstance();
                    ...
                    try {
                        schedulesVec = scheduleMgr.getOnArbitraryDoubleKey(request.getParameter("unitId"), "key2", "Eqp", "key5");
                    } catch (Exception ex) {
                        System.out.println("Schedule Listing Exception =" + ex.getMessage());
                    }
                    request.setAttribute("unitName", request.getParameter("unitName"));
                    request.setAttribute("allSchedule", schedulesVec);
                    request.setAttribute("page", servedPage);
                    this.forwardToServedPage(request, response);
                    break;

                case 126:
                    servedPage = "/docs/schedule/schedule_by_equipment_list_result.jsp";
                    scheduleMgr = ScheduleMgr.getInstance();
                    String periodicID = null;
                    WebBusinessObject schedulewebo = new WebBusinessObject();
                    periodicID = request.getParameter("periodicID");
                    schedulewebo = scheduleMgr.getOnSingleKey(periodicID);
                    request.setAttribute("unitName", request.getParameter("unitName"));
                    request.setAttribute("schedule", schedulewebo);
                    this.forward(servedPage, request, response);
                    break;
                case 127:
//                    empBasicMgr = EmpBasicMgr.getInstance();
...
//                    this.forwardToServedPage(request, response);
                ...
                case 129:
                    servedPage = "/docs/equipment/search_quipment_review.jsp";
                    request.setAttribute("page", servedPage);
                    this.forwardToServedPage(request, response);
                    break;
                case 128:
...
//                    }
//
//                    String taskName = (String) request.getParameter("taskCode");
//
//                    maintenableUnit = MaintainableMgr.getInstance();
//                    //////////////////// To Search By Date /////////////////////////////////////////////
//                    try {
//                        tasks = maintenableUnit.getAllIEquipmentByDate(beginDate, endDate);
//
//                    } catch (Exception ex) {
...
//                        links = 0;
//                    }
//                    servedPage = "/docs/equipment/view_equipment_Review.jsp";
//                    total = "" + tasks.size();
...
//                    this.forwardToServedPage(request, response);
                    break;
                case 130:
                    servedPage = "/docs/equipment/map_equipment_view.jsp";
                    maintainableMgr = MaintainableMgr.getInstance();
                    String equiId = (String) request.getParameter("equipmentID");
                    WebBusinessObject tempWbo = new WebBusinessObject();
                    tempWbo = maintainableMgr.getOnSingleKey(equiId);
                    request.setAttribute("equipmentcordinate", tempWbo.getAttribute("serialNo"));
                    this.forward(servedPage, request, response);
                    break;
                case 131:
                    servedPage = "/docs/equipment/map_equipment_insert.jsp";
                    maintainableMgr = MaintainableMgr.getInstance();
                    equiId = (String) request.getParameter("equipmentID");
                    String coordinate = (String) request.getParameter("coordinate");
                    tempWbo = new WebBusinessObject();

                    if (!(coordinate == null || coordinate.equals(""))) {
                        maintainableMgr.updateequipmapData(coordinate, equiId);

                    }
                    tempWbo = maintainableMgr.getOnSingleKey(equiId);
                    request.setAttribute("equipmentcordinate", tempWbo.getAttribute("serialNo"));
                    request.setAttribute("equipmentID", equiId);

                    this.forward(servedPage, request, response);
                    break;
                case 132:
                    servedPage = "/docs/Search/All_Locations.jsp";
                    projectMgr = ProjectMgr.getInstance();
                    ArrayList getallLocation = (ArrayList) projectMgr.getAllLocation();
                    ...
                    for (int i = 0; i < getallLocation.size(); i++) {
                        ...
                        parentId = pwbo.getAttribute("mainProjId").toString();
                ...
                case 133:
                    ...
                    Vector attachedMeasurementsVec = null;

                    // assuming a tire is attached to only one equipment
                    attachedMeasurementsVec = mainTypeMeasurementMgr.getOnArbitraryDoubleKey(mainTypeId, "key1", measurementId, "key2");

                    if (!attachedMeasurementsVec.isEmpty()) {
                        mainTypeMeasurementMgr.deleteOnArbitraryDoubleKey(mainTypeId, "key1", measurementId, "key2");
                ...
                case 134:
                    ...
                    String model_id = request.getParameter("categoryID");
                    String model_name = request.getParameter("catname");
                ...
                case 135:
                    servedPage = "/docs/equipment/addBranchEqp.jsp";
                    equipmentID = request.getParameter("equipmentID");//get  equipment id from url
                    request.setAttribute("equipmentId", equipmentID);
                    this.forward(servedPage, request, response);
                    break;
                ...
                case 136:
                    ...
                    eqpName = request.getParameter("eqpName");
                    DateFormat dateFormat = new SimpleDateFormat("yyyy/MM/dd");

                    status = request.getParameter("status");
                    Id = UniqueIDGen.getNextID();
                    WebBusinessObject eqpInfo = maintainableMgr.getOnSingleKey(equipmentId);
                    //save in maintainable unit
                    wbo.setAttribute("id", Id);
                    wbo.setAttribute("parentId", equipmentId);
                    wbo.setAttribute("unitLevel", (String) eqpInfo.getAttribute("unitLevel"));
                    wbo.setAttribute("unitNo", assetNo);
                    wbo.setAttribute("engineNo", (String) eqpInfo.getAttribute("engineNo"));
                    wbo.setAttribute("modelNo", (String) eqpInfo.getAttribute("modelNo"));
                    wbo.setAttribute("serialNo", (String) eqpInfo.getAttribute("serialNo"));
                    wbo.setAttribute("unitName", eqpName);
                    wbo.setAttribute("manufacturer", (String) eqpInfo.getAttribute("manufacturer"));
                    wbo.setAttribute("location", (String) eqpInfo.getAttribute("site"));
                    wbo.setAttribute("dept", (String) eqpInfo.getAttribute("department"));
                    wbo.setAttribute("status", status);
                    if ((String) eqpInfo.getAttribute("empID") != null) {
                        wbo.setAttribute("empID", (String) eqpInfo.getAttribute("empID"));
                    } else {
                        wbo.setAttribute("empID", "NON");
                    }
                    wbo.setAttribute("isMaintainable", Integer.parseInt((String) eqpInfo.getAttribute("isMaintainable")));
                    wbo.setAttribute("noOfHours", Integer.parseInt((String) eqpInfo.getAttribute("noOfHours")));
                    if ((String) eqpInfo.getAttribute("desc") != null) {
                        wbo.setAttribute("desc", (String) eqpInfo.getAttribute("desc"));
                    } else {
                        wbo.setAttribute("desc", "NON");
                    }
                    wbo.setAttribute("rateType", (String) eqpInfo.getAttribute("rateType"));
                    wbo.setAttribute("opType", (String) eqpInfo.getAttribute("opType"));
                    if ((String) eqpInfo.getAttribute("productionLine") != null) {
                        wbo.setAttribute("productionLine", (String) eqpInfo.getAttribute("productionLine"));
                    } else {
                        wbo.setAttribute("productionLine", "NON");
                    }
                    if ((String) eqpInfo.getAttribute("statusFlag") != null) {
                        wbo.setAttribute("statusFlag", (String) eqpInfo.getAttribute("statusFlag"));
                    } else {
                        wbo.setAttribute("statusFlag", "NON");
                    }
                    if ((String) eqpInfo.getAttribute("erpFlag") != null) {
                        wbo.setAttribute("erpFlag", (String) eqpInfo.getAttribute("erpFlag"));
                    } else {
                        wbo.setAttribute("erpFlag", "NON");
                    }
                    wbo.setAttribute("isStandalone", (String) eqpInfo.getAttribute("isStandalone"));
                    wbo.setAttribute("mainCat", (String) eqpInfo.getAttribute("maintTypeId"));
                    if ((String) eqpInfo.getAttribute("erpFlag") != null) {
                        wbo.setAttribute("userEnterEq", (String) eqpInfo.getAttribute("userEnterEq"));
                    } else {
                        wbo.setAttribute("userEnterEq", "NON");
                    }
                    //save in operation order
                    if (maintainableMgr.saveInMaintainableUnit(wbo)) {
                        request.setAttribute("status", "ok");
                    } else {
                        request.setAttribute("status", "NO");
                    }
                ...
                case 137:
                    servedPage = "/docs/equipment/search_main_type.jsp";
                    request.setAttribute("page", servedPage);
                    this.forwardToServedPage(request, response);
                    break;
...
//
//                    count = 0;
//                    url = "EquipmentServlet?op=getMainType";
//
//                    if (mainTypeName != null && !mainTypeName.equals("") && !mainTypeName.equals("null")) {
//                        mainTypeName = Tools.getRealChar(mainTypeName);
//                    }
//
//                    try {
//                        if (mainTypeName != null && !mainTypeName.equals("") && !mainTypeName.equals("null")) {
//                            listEquipments = mainCategoryTypeMgr.getMainTypesByName(mainTypeName);
//                        } else {
//                            listEquipments = mainCategoryTypeMgr.getAllBasictypeBySorting();
//                        }
//                    } catch (Exception ex) {
//                        logger.error(ex.getMessage());
//                    }
...
//
//                    if (goToViewEquipment != null && goToViewEquipment.equalsIgnoreCase("ok")) {
//                        servedPage = "/docs/equipment/main_types_list_view.jsp";
//                    }
//
//                    // to reload the parant
//                    if (reload != null && reload.equals("ok")) {
...
//                    request.setAttribute("fullUrl", url);
//                    request.setAttribute("url", url);
//                    request.setAttribute("unitName", mainTypeName);
//                    request.setAttribute("formName", formName);
//                    request.setAttribute("data", subListEquipments);
//                    request.setAttribute("page", servedPage);
//                    this.forward(servedPage, request, response);
//                    break;
                ...
                case 139:
                    servedPage = "docs/Search/search_equipments_by_model.jsp";
                ...
                case 140:
//                    servedPage = "/docs/equipment/model_list.jsp";
//
...
//                     
//                    filter.setConditions(conditions);
//                    List<WebBusinessObject> modelList = new ArrayList<WebBusinessObject>(0);
//           
//                    try {
//                        modelList = maintainableMgr.paginationEntity(filter);
//
//                    } catch (Exception e) {
//                        System.out.println(e);
//                    }
...
//                    break;
                ...
                case 141:
                    servedPage = "/docs/equipment/update_sites_of_equipments.jsp";
                    model_id = request.getParameter("unitId");
                    Vector equipmentVec = new Vector();

                    if (!(model_id == null || model_id.equals(""))) {
                        equipmentVec = eqpMoveHistoryMgr.
                                getMovementHistoryForModelChildren(model_id);

                    }

                    unitWbo = maintainableMgr.getOnSingleKey(model_id);

                    request.setAttribute("modelName", (String) unitWbo.getAttribute("unitName"));
                    request.setAttribute("equipmentVec", equipmentVec);
                    request.setAttribute("page", servedPage);
                    this.forwardToServedPage(request, response);
...
//                    String newSiteId = request.getParameter("newSiteId");
//                    String newSiteName = request.getParameter("newSiteName");
//                    beginDate = request.getParameter("beginDate");
//                    String reason = request.getParameter("reason");
//                    
//                    wbo.setAttribute("equipmentID", equipId);
//                    wbo.setAttribute("location", newSiteId);
//                    wbo.setAttribute("beginDate", dateParser.formatSqlDate(beginDate));
//                    wbo.setAttribute("reason", reason);
//
//                    if(eqpMoveHistoryMgr.saveObject(wbo)) {
//                        wbo.setAttribute("status", "Ok");
//                        wbo.setAttribute("newSiteName", newSiteName);
//
//                    } else {
...
//                    break;
                case 143:
                    ...
                    Vector mainTypesNames = new Vector();
                    Vector parentEqpVec = new Vector();
                    Vector dataVec = new Vector();
                    Vector eqpsVec = new Vector();
                    Hashtable parentNames = new Hashtable();
                    eqpsVec = (Vector) request.getSession().getAttribute("data");
                    brandByBasicTypeId = (Hashtable) request.getSession().getAttribute("brandByBasicTypeId");
                    parentNames = (Hashtable) request.getSession().getAttribute("eqpByParentId");
                    mainTypesNames = (Vector) request.getSession().getAttribute("basicTypeVec");
                    repParams.put("allMaintTypes", mainTypesNames.size());
                    repParams.put("allEquipments", eqpsVec.size());
                    eqpsVec = new Vector();
                    Vector finalData = new Vector();
                    for (int i = 0; i < mainTypesNames.size(); i++) {
                        WebBusinessObject itemWbo = new WebBusinessObject();
                        itemWbo = (WebBusinessObject) mainTypesNames.get(i);
                        //itemWbo.setAttribute("allEquipments", eqpsVec.size());
                        //eqpsVec= new Vector();
                        String mainName = (String) itemWbo.getAttribute("typeName");
                        itemWbo.setAttribute("mainTypeName", mainName);
                        // itemWbo.setAttribute("allMaintTypes", mainTypesNames.size());
                        parentEqpVec = (Vector) brandByBasicTypeId.get(itemWbo.getAttribute("id").toString());

                        for (int x = 0; x < parentEqpVec.size(); x++) {
                            WebBusinessObject itemWbo2 = new WebBusinessObject();
                            itemWbo2 = (WebBusinessObject) parentEqpVec.get(x);
                            String parentName = (String) itemWbo2.getAttribute("unitName");
                            itemWbo2.setAttribute("parentName", parentName);
                            eqps = (Vector) parentNames.get(itemWbo2.getAttribute("id").toString());
                            itemWbo2.setAttribute("equipmentsPerModel", eqps.size());
                            for (int j = 0; j < eqps.size(); j++) {
                                WebBusinessObject itemWbo3 = (WebBusinessObject) eqps.get(j);
                                String description = (String) itemWbo3.getAttribute("desc");
                                if (description == null || description.equals("") || description.equalsIgnoreCase("No Description") || description.equalsIgnoreCase("Not Found") || description.equalsIgnoreCase("No Data")) {
                                    description = "لا يوجد وصف";
                                }
                                itemWbo3.setAttribute("desc", description);
                                eqpsVec.add(itemWbo3);
                            }
                            itemWbo2.setAttribute("equipments", eqpsVec);

                            eqpsVec = new Vector();
                            dataVec.add(itemWbo2);
                        }
                        itemWbo.setAttribute("parents", dataVec);

                        dataVec = new Vector();
                        finalData.add(itemWbo);
                    }
                    eqps = finalData;

                    try {
                        connection = AllMaintenanceInfoMgr.getInstance().getReportConn();
                    } catch (SQLException ex) {
                        Logger.getLogger(ReportsServlet.class.getName()).log(Level.SEVERE, null, ex);
                    }
                    Tools.createPdfReport("EquipmentsAllTypes", repParams, eqps, getServletContext(), response, request);
                ...
                case 144:
                    ...
                    HashMap repParam = new HashMap();
                    Vector eqVec = new Vector();
                    Vector allParents = new Vector();
                    int xx;
                    WebBusinessObject equpWbo = new WebBusinessObject();
                    WebBusinessObject equpWbo2 = new WebBusinessObject();
                    //eqs = (Hashtable) request.getSession().getAttribute("eqpByParentId");
                    eqps = (Vector) request.getSession().getAttribute("equipsData");
                    repParam.put("allEquipments", eqps.size());
                    allParents = (Vector) request.getSession().getAttribute("parentEqpVec");
                    repParam.put("allParents", allParents.size());
                    finalData = new Vector();

                    for (int i = 0; i < eqps.size(); i++) {
                        equpWbo = (WebBusinessObject) eqps.get(i);
                        String eqpParent = (String) equpWbo.getAttribute("parentId");
                        String unitId = (String) equpWbo.getAttribute("id");
                        String unitNo = (String) equpWbo.getAttribute("unitNo");
                        String description = (String) equpWbo.getAttribute("desc");
                        if (description == null || description.equals("") || description.equalsIgnoreCase("No Description") || description.equalsIgnoreCase("Not Found") || description.equalsIgnoreCase("No Data")) {
                            description = "لا يوجد وصف";
                        }
                        equpWbo.setAttribute("desc", description);
                        String parentName = maintainableMgr.getParentName(eqpParent, unitId, unitNo);
                        equpWbo.setAttribute("parentName", parentName);
                        eqVec.add(equpWbo);
                        xx = eqVec.size();
                    }
                    System.out.print("----size of sent data=" + eqVec.size());
                    //finalData.addAll(eqVec);
                    eqps = eqVec;
                    eqVec = new Vector();
                    try {
                        connec = AllMaintenanceInfoMgr.getInstance().getReportConn();
                    } catch (SQLException ex) {
                        Logger.getLogger(ReportsServlet.class.getName()).log(Level.SEVERE, null, ex);
                    }
                    Tools.createPdfReport("EquipmentsAllModels", repParam, eqps, getServletContext(), response, request);
                    ...
                    break;
                case 145:
                    servedPage = "/docs/Search/All_Locations2.jsp";
                    projectMgr = ProjectMgr.getInstance();
                    getallLocation = (ArrayList) projectMgr.getAllLocation();
                    ...
                    break;
                case 146:
                    servedPage = "/docs/Search/All_Regions.jsp";
                    projectMgr = ProjectMgr.getInstance();
                    metaMgr = MetaDataMgr.getInstance();
                    
                    list = new ArrayList<WebBusinessObject>();
                    
                    Vector<WebBusinessObject> mainRegion = projectMgr.getOnArbitraryDoubleKeyOracle(metaMgr.getRegionsMainCode(), "key2", "rgns", "key6");
                    if (mainRegion.size() > 0) {
                        for (int j = 0; j < mainRegion.size(); j++) {
                            ArrayList<WebBusinessObject> allRegions = new ArrayList(projectMgr.getOnArbitraryDoubleKeyOracle((String) mainRegion.get(j).getAttribute("projectID"), "key2", "rgns", "key6"));
                            
                            parent = 0;
                            for (int i = 0; i < allRegions.size(); i++) {
                                parent = 0;
                                size++;
                                pwbo = allRegions.get(i);
                                String nameParent = pwbo.getAttribute("mainProjId").toString();
                                System.out.println("getProjName" + nameParent);
                                parentId = pwbo.getAttribute("mainProjId").toString();
                                pwbo.setAttribute("size", size);
                                ...
                                parent = size;
                                Vector childNode = new Vector();
                                id = (String) allRegions.get(i).getAttribute("projectID");
...
//                            for (WebBusinessObject wboTemp : list) {
//                                if (wboTemp.getAttribute("projectID").equals(mainRegion.get(0).getAttribute("projectID"))) {
//                                    list.remove(wboTemp);
//                                }
//                            }
                        }
            ...
            logger.error("Eqipment without parent 1.1 " + ex.getMessage());
        } catch (Exception ex) {
            logger.error("Eqipment without parent 1.2 " + ex.getMessage());
        }
    }
    ...
    public void getTree(String id, List<WebBusinessObject> list, int parent) {
        ...
        int counter = 0;
        try {
            childNode = projectMgr.getOnArbitraryKey(id, "key2");
            if (childNode.size() > 0) {
...
//        }
        ...
        if (opName.equals("showReportTree")) {
            return 117;
        }
        if (opName.equals("MaintenanceItemsReport2")) {
            return 118;
        }
        if (opName.equals("searchByName")) {
            return 119;
        }
        if (opName.equals("GetCategory")) {
            return 120;
        }
        if (opName.equals("viewBrand")) {
            return 121;
        }
        if (opName.equals("updateBrand")) {
            return 122;
        }
        if (opName.equals("saveBrand")) {
            return 123;
        }
        if (opName.equals("listEquipmentsPopupSearch")) {
            return 124;
        }
        if (opName.equals("listEquipmentsSearch")) {
            return 125;
        }
        if (opName.equals("showEquipmentSchedule")) {
            return 126;
        }
        ...
        if (opName.equals("showEquipmentReview")) {
            return 128;
        }
        if (opName.equals("searchEquipmentReview")) {
            return 129;
        }
        if (opName.equals("viewEquipmentMap")) {
            return 130;
        }
        if (opName.equals("insertEquipmentMap")) {
            return 131;
        }
        if (opName.equals("getAllBranches")) {
            return 132;
        }
        if (opName.equals("detachMeasurementFromMainType")) {
            return 133;
        }
        if (opName.equals("addpart")) {
            return 134;
        }
        if (opName.equals("attachedEqptoMainEqp")) {
            return 135;
        }
        if (opName.equals("saveAttachEqp")) {
            return 136;
        }
        if (opName.equals("searchMainType")) {
            return 137;
        }
        if (opName.equals("getMainType")) {
            return 138;
        }
        if (opName.equals("getSearchEquipmentsByModelForm")) {
            return 139;
        }
        if (opName.equals("listModelsInPopup")) {
            return 140;
        }
        if (opName.equals("getEquipmentListByModel")) {
            return 141;
        }
        if (opName.equals("updateEquipSite")) {
            return 142;
        }

        if (opName.equals("extractToPdfByType")) {
            return 143;
        }
        if (opName.equals("extractToPdfByModel")) {
            return 144;
        }
        if (opName.equals("getAllArea")) {
            return 145;
        }
        if (opName.equals("getAllRegions")) {
            return 146;
        }
        return 0;
