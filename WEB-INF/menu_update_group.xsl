...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:template match="/">
        ...
        <xsl:for-each select="menu_list/menu">
            ...
            <tr>
                <td class="act_sub_heading" WIDTH="100" STYLE="text-align: right;padding-right:20;font_size:50px;">
                    <xsl:apply-templates select="nameAr"/>
                </td>
                <td  class="act_sub_heading" style="font_size:50px;">
            ...
            <xsl:if test="sub_menu">
                <xsl:for-each select="sub_menu">
                    ...
                    <xsl:if test="menu_element">
                        <tr>
                            <td class="act_sub_heading" WIDTH="100" STYLE="text-align: right; padding-right:40;font_size:50px;">
                                <xsl:apply-templates select="titleAr"/>
                            </td>
                            <td  class="act_sub_heading" style="text-align:center;font_size:50px;">
                                <xsl:if test="display = 1">
                        ...
                        <xsl:for-each select="menu_element">
                            ...
                            <xsl:variable name="id" select="@id"/>
                            <tr>
                                <td class="cell" STYLE="text-align:right; padding-right:60;font_size:50px;">
                                    <div id="links">
                                        <xsl:apply-templates select="nameAr"/>
                                    </div>
                                </td>
                                <td class="cell" style="text-align:center;font_size:50px;">
                                <xsl:if test="display = 1">
                    ...
                    <xsl:if test="not(menu_element)">
                        <tr>
                            <td class="cell" WIDTH="100" STYLE="text-align: right; padding-right:40;font_size:50px;">
                                <xsl:apply-templates select="titleAr"/>
                            </td>
                            <td class="cell" style="text-align:center;font_size:50px;">
                                <xsl:if test="display = 1">
