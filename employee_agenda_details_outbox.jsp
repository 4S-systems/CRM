...
<fmt:setBundle basename="Languages.employee_agenda.employee_agenda"  />
    ...
    <%
        ...
        int withinDetailsOutBx = 24;
        Map<String, String> withinIntervals = securityUser.getWithinIntervals();
        if (request.getParameter("withinDetailsOutBx") != null) {
            withinDetailsOutBx = new Integer(request.getParameter("withinDetailsOutBx"));
            withinIntervals.put("withinDetailsOutBx", "" + withinDetailsOutBx);
        } else if (withinIntervals.containsKey("withinDetailsOutBx")) {
            withinDetailsOutBx = (new Integer(withinIntervals.get("withinDetailsOutBx")));
        }
        ...
        issuesVector = employeeView2Mgr.getComplaintsWithoutDate(2, value, key, "key7", resp, null, new java.sql.Date(sdf.parse(fromDateVal).getTime()), new java.sql.Date(sdf.parse(toDateVal).getTime()));//.getOnArbitraryKeyOrdered(userWbo.getAttribute("userId").toString(), "key3", "key7");
    ...
    <CENTER>
        <FIELDSET class="set" style="width:100%;" >
            ...
            <TABLE   id="outboxMsg" align="center"  DIR=<fmt:message key="direction"/> WIDTH="100%" CELLPADDING="0" cellspacing="0">
                <thead><TR>
                        <!--TH  ><SPAN ></SPAN></TH-->
                        ...
                        <TH  ><img src="images/icons/Time.png" width="20" height="20" /><b><fmt:message key="reqdate"/></b></TH>
                        <TH ><b><%=ageComp%></b></TH>
                    </TR></thead>
                <tbody  >  
                    <%
                    ...
                    <TR>
                        ...
                        <!--TD >
                            <SPAN style="display: inline-block;height: 20px;">
                                ...
                                <IMG width="19px" height="19px" src="images/icons/bookmark_uns.png" /></SPAN></TD-->
                        ...
                        <TD  STYLE="text-align:center;padding-<fmt:message key="align"/>: 5px; font-size: 12px;" width="20%">
                            <% String sCompl = " ";
