            ...
            <tbody>
                <%
                    ...
                    for (WebBusinessObject wbo : appointments) {
                        ...
                        String compId = (String) wbo.getAttribute("option1");
                        ClientComplaintsMgr clientComplaintsMgr = ClientComplaintsMgr.getInstance();
                        WebBusinessObject compWbo = clientComplaintsMgr.getOnSingleKey(compId);
                        IssueStatusMgr issueStatusMgr = IssueStatusMgr.getInstance();
                        Vector v = new Vector();
                        v = issueStatusMgr.getOnArbitraryKey(compId, "key1");
                        boolean isFinish = false;
                        String statusCode = "";
                        if (v != null & !v.isEmpty()) {
                            for (int q = 0; q < v.size(); q++) {
                                WebBusinessObject webBusinessObject = new WebBusinessObject();
                                webBusinessObject = (WebBusinessObject) v.get(q);
                                if (webBusinessObject != null) {
                                    statusCode = (String) webBusinessObject.getAttribute("statusName");
                        ...
                        String issueId = "";
                        if (compWbo != null) {
                            issueId = (String) compWbo.getAttribute("issueId");
                        }
                ...
                <tr >
                    ...
                    <td >
                        <input  type="text" id="appTitleInput" style="float: right;display: none;" value="" />
                        <b id="appTitleText"><%=clientNO%></b>
                    </td>
                    <td onclick="popupShowClient(this)" style="cursor: pointer" >
                        <input  type="text" id="appTitleInput" style="float: right;display: none;" value="" />
                ...
                <!--<center> <input name="entryDate" id="appDate1" type="text" size="50" maxlength="50" style="width:80%;float: right;display: none;font-size: 12px;" value="<%=nowTime%>"/></center>-->
                    ...
                    <td style="background-color: #f00;">
                        <div style="width: 100%;display: inline-block">
                            ...
                            <div  id="reomveAppointment" class="" >تم الإنهاء</div>
                    ...
                    <td style="background-color: yellowgreen;">
                        <div  id="reomveAppointment" class="removeA" onclick="popupFinishO(this)">إنهاء</div>
